...
Begin VB.Form frmAssignRate2 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Assign Rate Code for Range"
   ClientHeight    =   8868
   ClientLeft      =   3924
   ClientTop       =   1884
   ClientWidth     =   12216
   Icon            =   "frmAssignRate2.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin LpLib.fpCombo fpcboRevenues 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmAssignRate2.frx":08CA
   End
   Begin LpLib.fpCombo fpComboRates2 
      Height          =   348
      Left            =   6090
      TabIndex        =   3
      Top             =   4080
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmAssignRate2.frx":0C29
   End
   Begin LpLib.fpCombo fpComboRates 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmAssignRate2.frx":0F5C
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAssignRate2.frx":128F
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdOK 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAssignRate2.frx":14A3
   End
   ...
   Begin VB.Label LabelB1 
      Alignment       =   1  'Right Justify
      BackStyle       =   0  'Transparent
      Caption         =   "For Customers with existing rate code:"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   12
         Charset         =   0
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Assign Rate Code Criteria"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   13.8
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmAssignRate2"
...
Private Sub Form_Load()
  ...
  For cnt = 1 To NumOfRateRecs
    ...
    fpComboRates2.AddItem RCode$ + QPTrim$(UBRateTblRec(1).RATEDESC)
  Next
  Close
...
End Sub
Private Sub fpComboRates2_KeyDown(KeyCode As Integer, Shift As Integer)
  If KeyCode = vbKeySpace Then
    fpComboRates2.ListDown = True
  End If
  If fpComboRates2.ListDown <> True Then
    If KeyCode = vbKeyDown Then
...
Private Sub SetRate2cust()
  ...
  Dim cnt As Long, RCnt As Integer, CustBook As Integer
  Dim FromBook As Integer, ThruBook As Integer, SCnt As Integer
  Dim RCode As String, ThisRate As String
  Dim UBRateTblRecLen As Integer, NumOfRateRecs As Integer
  ReDim UBRateTblRec(1) As UBRateTblRecType
  ...
  If fpComboRates.ListIndex = -1 Or fpComboRates2.ListIndex = -1 Then
    MsgBox "Invalid Rate Code.", vbOKOnly, "Invalid Entry"
    Exit Sub
  End If
  RateRec = fpComboRates.ListIndex + 1
  RateNew = fpComboRates2.ListIndex + 1
  ...
  Get Handle, RateNew, UBRateTblRec(1)
  NewRate$ = QPTrim$(UBRateTblRec(1).RATECODE)
  Close Handle
  DeActivateControls frmAssignRate
  FrmShowPctComp.Label1 = "Assign Rate ..."
  FrmShowPctComp.Show , Me
  UBLog "SetRate - " & ", book(" & fptxtRoute1 & "-" & fptxtRoute2 & "),Rate-" & fpComboRates2.Text
      ...
      If Not UBCustRec(1).DelFlag Then
        For SCnt = 1 To 15
          ...
          If WhatRate$ = ThisRate$ Then
            UBCustRec(1).serv(RevSource).RATECODE = NewRate$
...
UBLog "setrate:" & NewRate$ & " Using Util set rate"
MsgBox "Set Rate:" & NewRate$, vbOKOnly, " Rate"
'ReIndexSystem False
ActivateControls frmAssignRate
End Sub

...
Begin VB.Form frmChangeMultxx 
   ...
   Begin LpLib.fpCombo fpComboRates 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmChangeMultxx.frx":08CA
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmChangeMultxx.frx":0BC1
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdOK 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmChangeMultxx.frx":0DD5
   End
   ...
   End
End
Attribute VB_Name = "frmChangeMultxx"

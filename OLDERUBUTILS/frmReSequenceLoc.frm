...
Begin VB.Form frmReSequenceLoc 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   1890
   ClientWidth     =   12210
   Icon            =   "frmReSequenceLoc.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReSequenceLoc.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdOK 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReSequenceLoc.frx":0AA6
   End
   ...
   End
End
Attribute VB_Name = "frmReSequenceLoc"

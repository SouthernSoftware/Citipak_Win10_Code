...
Begin VB.Form frmChangeUserCodes 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   1890
   ClientWidth     =   12210
   Icon            =   "frmChangeUserCodes.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmChangeUserCodes.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdOK 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmChangeUserCodes.frx":0AA6
   End
   ...
   Begin EditLib.fpText fptxtRoute1 
      ...
      OLEDragMode     =   0
   End
   Begin EditLib.fpText fptxtUse1 
      Height          =   345
      Left            =   6330
      TabIndex        =   11
      Top             =   4140
      ...
      OLEDragMode     =   0
   End
   Begin EditLib.fpText fptxtUse1New 
      Height          =   345
      Left            =   6330
      TabIndex        =   12
      Top             =   4950
      ...
      OLEDragMode     =   0
   End
   Begin EditLib.fpText fptxtUse2 
      Height          =   345
      Left            =   8400
      TabIndex        =   13
      Top             =   4140
      ...
      OLEDragMode     =   0
   End
   Begin EditLib.fpText fptxtUse2New 
      Height          =   345
      Left            =   8430
      TabIndex        =   14
      Top             =   4950
   ...
   Begin VB.Label LabelB1 
      Alignment       =   1  'Right Justify
      BackStyle       =   0  'Transparent
      Caption         =   "For Customers with User Codes:"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmChangeUserCodes"
...
Private Sub fptxtUse1_KeyDown(KeyCode As Integer, Shift As Integer)
  If KeyCode = vbKeyReturn Then
    fptxtUse1New.SetFocus
  End If
End Sub
...
Private Sub fptxtUse1_ChangeMode(EditMode As Integer)
  EditMode = True
End Sub
...
Private Sub SetUseCode2cust()
  ...
  Dim Use1 As String, Use2 As String, Use1New As String, Use2New As String
  ReDim UBRateTblRec(1) As UBRateTblRecType
  Use1$ = QPTrim$(fptxtUse1)
  Use1New$ = QPTrim$(fptxtUse1New)
  Use2$ = QPTrim$(fptxtUse2)
  Use2New$ = QPTrim$(fptxtUse2New)
  If Check1.Value = 0 And Check2.Value = 0 Then
    MsgBox "You must select a code to search on", vbOKOnly
    Exit Sub
  End If
  If Check1New.Value = 0 And Check2New.Value = 0 Then
    MsgBox "You must select a code to change", vbOKOnly
    Exit Sub
  End If
  ...
  DeActivateControls frmChangeUserCodes
  FrmShowPctComp.Label1 = "Change codes ..."
  FrmShowPctComp.Show , Me
  UBLog "SetUsercodes - " & ", book(" & fptxtRoute1 & "-" & fptxtRoute2 & "),Use code-1 " & fptxtUse1.Text & " to " & fptxtUse1New.Text & "-2 " & fptxtUse2.Text & " to " & fptxtUse2New.Text
    ...
    If CustBook >= FromBook And CustBook <= ThruBook Then
      If Not UBCustRec(1).DelFlag Then
       ...
       If Check1.Value = 1 And Check2.Value = 0 Then
          If QPTrim$(UBCustRec(1).USERCODE1) = Use1$ Then
            If Check1New.Value = 1 Then UBCustRec(1).USERCODE1 = Use1New$
            If Check2New.Value = 1 Then UBCustRec(1).USERCODE2 = Use2New$
          End If
       ElseIf Check1.Value = 1 And Check2.Value = 1 Then
          If QPTrim$(UBCustRec(1).USERCODE1) = Use1$ And QPTrim$(UBCustRec(1).USERCODE2) = Use2$ Then
            If Check1New.Value = 1 Then UBCustRec(1).USERCODE1 = Use1New$
            If Check2New.Value = 1 Then UBCustRec(1).USERCODE2 = Use2New$
          End If
       ElseIf Check1.Value = 0 And Check2.Value = 1 Then
          If QPTrim$(UBCustRec(1).USERCODE2) = Use2$ Then
            If Check1New.Value = 1 Then UBCustRec(1).USERCODE1 = Use1New$
            If Check2New.Value = 1 Then UBCustRec(1).USERCODE2 = Use2New$
          End If
       End If
...
UBLog "set ,Use code-1 " & fptxtUse1.Text & " to " & fptxtUse1New.Text & "-2 " & fptxtUse2.Text & " to " & fptxtUse2New.Text & " Using Util set usecode"
MsgBox "Set usecode:Use code-1 " & fptxtUse1.Text & " to " & fptxtUse1New.Text & "-2 " & fptxtUse2.Text & " to " & fptxtUse2New.Text, vbOKOnly
'ReIndexSystem False
ActivateControls frmChangeUserCodes
End Sub

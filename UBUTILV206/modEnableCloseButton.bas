Attribute VB_Name = "modEnableCloseButton"
Option Explicit
...
'   Dim Cnt As Integer
'   For Cnt = 0 To WhatForm.Count - 1
'     Set X = WhatForm.Controls.Item(Cnt)
'     X.Enabled = True
'   Next
'   EnableCloseButton WhatForm.hwnd, True
'   DoEvents
End Sub
...
'     x.Enabled = False
'   Next
'   EnableCloseButton WhatForm.hwnd, False
'   DoEvents
End Sub

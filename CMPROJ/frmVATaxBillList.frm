...
Begin VB.Form frmVATaxBillList 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdTag 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxBillList.frx":0DCB
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxBillList.frx":0FAD
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdClear 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxBillList.frx":1195
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdTagAll 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxBillList.frx":1370
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdReset 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxBillList.frx":154D
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdClose 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxBillList.frx":1728
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdDetail 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxBillList.frx":1904
   End
...
'  ReDim BillTrans(0 To 0) As Long
  ...
  If ThisBillType = "R" Then
    OpenVARealPropFile RHandle, NumOfRRecs
  Else
    ThisOpt = "NA"
    fpList1.col = 5

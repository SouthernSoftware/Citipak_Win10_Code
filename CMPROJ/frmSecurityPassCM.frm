...
Begin VB.Form frmSecurityPassCM 
   BackColor       =   &H008A775B&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "CitiPak C/M Password Sign-In"
   ClientHeight    =   8916
   ClientLeft      =   36
   ClientTop       =   264
   ClientWidth     =   12216
   Icon            =   "frmSecurityPassCM.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Label Label2 
      ...
      Caption         =   "CASH MANAGEMENT PASSWORD"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   13.8
         Charset         =   0
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Enter Cash Management Password"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmSecurityPassCM"
  ...
  Else
    If Len(Dir$("Citipass.dat")) Then
      ...
      If Findnum > 0 And LevelPass > 0 Then
        Call CMLog("In CM, with Level " & LevelPass)
        frmCMMainMenu.Show
        Unload frmSecurityPassCM
      Else
        Notvalid = True
        If Findnum = -1 Then
          ...
          Call CMLog("Password in session, NO Access.")
          Notvalid = False
          txtPW = ""
          txtPW.SetFocus
        End If
    ...
    For cnt = 1 To NumPassRecs
      ...
      If pw$ = LookFor$ Then
        If Not Citipass.InUseFlag Then
          If Citipass.Module(8).FullAccess = True Then
            LevelPass = 1
          ElseIf Citipass.Module(8).ReportsOnly = True Then
              LevelPass = 3
          ElseIf Citipass.Module(8).PaymentAccess = True Then
              LevelPass = 2
          End If

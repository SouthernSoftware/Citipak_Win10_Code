...
Private Sub cmdExit_Click()
  ...
  End If
  Call LogSaves
  KillFile "taxpayGL.dat"
  If Exit2Pay = True Then
    If Exist("revglpay.dat") Then KillFile "revglpay.dat"
'    frmTaxPayMenu.Show
'    DoEvents
    Unload Me
    Exit Sub
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      ...
      KillFile "taxpayGL.dat"
      ClearInUse PWcnt
      TXLog ("cm.exe terminated via menu bar on frmTaxPayGLSetUp.")
      Call CMTerminate
      End
    End If
  End If
...
Private Sub Form_Load()
  ...
  TXLog ("User opened frmTaxPayGLSetUp.")
  Call LoadMe
End Sub
...
Private Sub LoadMe()
  ...
  One = 1
  AHandle = FreeFile
  Open "taxpayGL.dat" For Output As AHandle
  Print #AHandle, One
  Close AHandle
...
Private Sub LogSaves()
  ...
  If QPTrim$(TempOpt3DBAcct) <> ThisDesc Then
    TXLog ("-frmTaxBillSetUp: For Year " + CStr(TempYear) + ": " + Label13.Caption + " Debit was changed from " + QPTrim$(TempOpt3DBAcct) + " to " + ThisDesc + " and saved.")
  End If
  ...
  If QPTrim$(TempOpt3CRAcct) <> ThisDesc Then
    TXLog ("CM-frmTaxBillSetUp: For Year " + CStr(TempYear) + ": " + Label13.Caption + " Credit was changed from " + QPTrim$(TempOpt3CRAcct) + " to " + ThisDesc + " and saved.")
  End If

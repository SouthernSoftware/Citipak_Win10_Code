...
Begin VB.Form frmDepositPayment 
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdCharge 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositPayment.frx":0BED
   End
   Begin fpBtnAtlLibCtl.fpBtn fpcmdCheck 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositPayment.frx":0DCA
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositPayment.frx":209C
   End
   Begin fpBtnAtlLibCtl.fpBtn CmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositPayment.frx":2278
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdCash 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositPayment.frx":2454
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdInfo 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositPayment.frx":3725
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpcmdFind 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositPayment.frx":3900
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpcmdDrawer 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositPayment.frx":4BD1
   End

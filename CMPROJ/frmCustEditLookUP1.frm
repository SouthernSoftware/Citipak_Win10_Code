...
Begin VB.Form frmCustEditLookUP1 
   BackColor       =   &H008F8265&
   ...
   Icon            =   "frmCustEditLookUP1.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdSearch 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmCustEditLookUP1.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmCustEditLookUP1.frx":0AA7
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdChoice 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmCustEditLookUP1.frx":0CBB
   End
   ...
   End
End
Attribute VB_Name = "frmCustEditLookUP1"
  ...
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      If MsgBox("Are You Sure You Wish To Close The Program?", vbYesNo, "Close?") = vbNo Then
        Cancel = True
      Else
        CMLog "Closed via CustLookup by " + PWUser$
        CitiTerminate
      End If
    End If
  End If

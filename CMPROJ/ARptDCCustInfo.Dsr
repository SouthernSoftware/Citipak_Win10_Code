VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptDCCustInfo 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Decal Customer Information"
   ClientHeight    =   6540
   ClientLeft      =   36
   ClientTop       =   264
   ClientWidth     =   9384
   Icon            =   "ARptDCCustInfo.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   16552
   _ExtentY        =   11536
   SectionData     =   "ARptDCCustInfo.dsx":08CA
End
Attribute VB_Name = "ARptDCCustInfo"
...
ERRORSTUFF:
      Unload frmLoadingRpt
  Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "ARptDCCustInfo", "Fetch Data", Erl)
    Case emrExitProc:
      Resume Proc_Exit
    Case emrResume:
      Resume
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & "DCInf.xls"
        oEXL.Export Me.Pages
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & "DCInf.txt"
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","

VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptDCCustInq 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Decal Customer Inquiry Report"
   ClientHeight    =   7692
   ClientLeft      =   36
   ClientTop       =   264
   ClientWidth     =   10356
   Icon            =   "ARptDCCustInq.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   18267
   _ExtentY        =   13568
   SectionData     =   "ARptDCCustInq.dsx":08CA
End
Attribute VB_Name = "ARptDCCustInq"

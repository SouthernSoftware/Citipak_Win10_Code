VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptUBCustInfo 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Utility Customer Information"
   ClientHeight    =   7788
   ClientLeft      =   36
   ClientTop       =   264
   ClientWidth     =   9384
   Icon            =   "ARptUBCustInfo.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   16552
   _ExtentY        =   13737
   SectionData     =   "ARptUBCustInfo.dsx":08CA
End
Attribute VB_Name = "ARptUBCustInfo"

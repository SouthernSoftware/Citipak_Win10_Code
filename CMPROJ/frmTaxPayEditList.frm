...
Begin VB.Form frmTaxPayEditList 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPayEditList.frx":0D92
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdEdit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPayEditList.frx":0F70
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPayEditList.frx":114C
   End
...
'  Operator$ = "Operator # " + CStr(OPERNUM) + " " + PWUser
  Operator$ = "Operator # " + CStr(OperNum) + " " + "Bob"
...
Private Sub Loadme()
  ...
  FileName = "editpyment.dat" 'used when using the transaction history report
  ThisFile = FreeFile
...
'  Operator$ = "Operator # " + CStr(OPERNUM) + " " + PWUser
  ...
  Print #RptHandle, "Total Number of Receipts: " + CStr(NumOfPRecs)

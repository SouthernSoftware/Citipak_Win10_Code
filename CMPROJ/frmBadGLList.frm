...
Begin VB.Form frmBadGLList 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBadGLList.frx":08CA
   End
   Begin LpLib.fpList fpList1 
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmBadGLList.frx":0AA9
   End
   ...
   End
End
Attribute VB_Name = "frmBadGLList"

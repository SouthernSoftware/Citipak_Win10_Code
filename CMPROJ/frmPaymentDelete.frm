...
Dim Oper As String, PayListRec As Long, RecpPort As Integer, OPERNUM As Integer
...
Private Sub LoadPayList()
  ...
  Oper$ = Str$(OPERNUM)
  PayFileName$ = "UBPAY" + QPTrim(Oper$) + ".DAT"
  TPayFileName$ = "UBPAY" + QPTrim(Oper$) + ".$$$"
...
Private Sub LoadDepList()
  ...
  Oper$ = Str$(OPERNUM)
  PayFileName$ = "UBDEP" + QPTrim(Oper$) + ".DAT"
  TPayFileName$ = "UBDEP" + QPTrim(Oper$) + ".$$$"

...
Begin VB.Form frmVehDisplayList1 
   AutoRedraw      =   -1  'True
   BackColor       =   &H008F8265&
   ...
   EndProperty
   Icon            =   "frmVehDisplayList1.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin LpLib.fpList fpList1 
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmVehDisplayList1.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdOK 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVehDisplayList1.frx":0C1E
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVehDisplayList1.frx":0DF7
   End
   ...
   End
End
Attribute VB_Name = "frmVehDisplayList1"
...
'  frmCodeAddEdit.Endedit = True
  frmPayDecalEntry.fpVehRecNo = 0
  frmPayDecalEntry.GetVehInfo
  Unload Me
End Sub
...
Private Sub fpList1_DblClick()
  ...
  'load veh info in payment
    frmPayDecalEntry.fpVehRecNo = VehRec
    frmPayDecalEntry.GetVehInfo
  VehRec = 0
  Unload Me
End Sub

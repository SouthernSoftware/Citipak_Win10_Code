...
Begin VB.Form frmTaxReportOpt 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxReportOpt.frx":0000
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdGraphic 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxReportOpt.frx":01DC
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdText 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxReportOpt.frx":03BB
   End
   ...
   End
End
Attribute VB_Name = "frmTaxReportOpt"

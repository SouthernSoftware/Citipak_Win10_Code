...
Begin VB.Form frmDCDisplayList 
   ...
   Begin LpLib.fpList fpList1 
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmDCDisplayList.frx":0000
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdOK 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDCDisplayList.frx":0358
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDCDisplayList.frx":0531
   End
   ...
   End
End
Attribute VB_Name = "frmDCDisplayList"

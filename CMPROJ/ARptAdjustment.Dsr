VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptAdjustment 
   ...
   _ExtentX        =   16447
   _ExtentY        =   11811
   SectionData     =   "ARptAdjustment.dsx":08CA
End
Attribute VB_Name = "ARptAdjustment"
...
Errorstuff:
      Unload frmLoadingRpt
  Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "ARptAdjustment", "Fetch Data", Erl)
    Case emrExitProc:
      Resume Proc_Exit
    Case emrResume:
      Resume

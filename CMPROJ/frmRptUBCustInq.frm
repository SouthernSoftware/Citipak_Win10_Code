...
Begin VB.Form frmRptUBCustInq 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Utility Customer Inquiry"
   ClientHeight    =   8640
   ClientLeft      =   36
   ClientTop       =   540
   ClientWidth     =   12192
   Icon            =   "frmRptUBCustInq.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin EditLib.fpText fpDrvLic 
      ...
      OLEDragMode     =   0
   End
   Begin EditLib.fpText fpAllowCutoff 
      Height          =   324
      Left            =   3150
      TabIndex        =   35
      TabStop         =   0   'False
      ...
      OLEDragMode     =   0
   End
   Begin EditLib.fpText fpTaxExempt 
      Height          =   324
      Left            =   8430
      TabIndex        =   36
      TabStop         =   0   'False
   ...
   Begin EditLib.fpText fpBankAcct 
      ...
      OLEDragMode     =   0
   End
   Begin EditLib.fpText fpAcctBalance 
      Height          =   324
      Left            =   8424
      TabIndex        =   45
      TabStop         =   0   'False
   ...
   Begin EditLib.fpText fpCurrent 
      ...
      OLEDragMode     =   0
   End
   Begin EditLib.fpText fpPastDue 
      Height          =   324
      Left            =   8424
      TabIndex        =   47
      TabStop         =   0   'False
      ...
      OLEDragMode     =   0
   End
   Begin EditLib.fpText fpDeposit 
      Height          =   324
      Left            =   8424
      TabIndex        =   48
      TabStop         =   0   'False
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdOwner 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptUBCustInq.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdMsg 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptUBCustInq.frx":0ADE
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptUBCustInq.frx":0CF0
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptUBCustInq.frx":0F0A
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdConHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptUBCustInq.frx":111E
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdTranHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptUBCustInq.frx":1333
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdWorkHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptUBCustInq.frx":1548
   End
   Begin EditLib.fpText fpServAddr 
      ...
      OLEDragMode     =   0
   End
   Begin EditLib.fpText fpgroupcode 
      Height          =   324
      Left            =   8424
      TabIndex        =   71
      TabStop         =   0   'False
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpcmdPrintinfo 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptUBCustInq.frx":175D
   End
   ...
   End
End
Attribute VB_Name = "frmRptUBCustInq"
  ...
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      If MsgBox("Are You Sure You Wish To Close The Program?", vbYesNo, "Close?") = vbNo Then
        Cancel = True
      Else
        CMLog "Close via CustInq by " + PWUser$
        CitiTerminate
      End If
    End If
  End If
...
'do stuff here to call work order procedure to load list and send
'the record number
...
Private Sub LoadCustInfo2Form()
  ...
  RecNo& = Val(frmRptUBCustInq.fpCustRecNo)
  frmRptUBCustInq.fpCustRecNo = 0
  ...
  Open UBPath$ + "UBGrpCde.DAT" For Random Shared As ghandle Len = GrpCodeRecLen
    If tmpCustRec.GroupCodeRec > 0 Then
      ...
      If GroupCde.Deleted = 0 Then
        fpgroupcode.Text = QPTrim$(GroupCde.GroupCODE) + " " + QPTrim$(GroupCde.GroupCodeName)
      Else
        fpgroupcode.Text = QPTrim$(GroupCde.GroupCODE) + " Deleted"
      End If
    Else
      fpgroupcode.Text = "None"
    End If
    Close #ghandle
''''''''''''''''''''''''''''''''''''''
...
'  End Select
  ...
  fpBankAcct = "XXXXXXXXXXX"
  fpAcctBalance = Using$("$###,###,###.##", Str$((Round#(tmpCustRec.CurrBalance + tmpCustRec.PrevBalance))))
  fpCurrent = Using$("$###,###,###.##", Str$(Round#(tmpCustRec.CurrBalance)))
  fpPastDue = Using$("$###,###,###.##", Str$(Round#(tmpCustRec.PrevBalance)))
  fpDeposit = Using$("$###,###,###.##", Str$(Round#(tmpCustRec.DepositAmt)))
  DoEvents
End Sub
Private Sub PrintCustInq()  'this is graphics
  Dim UBRpt As Integer, ToPrint As String, ReportFile As String
  ReportFile$ = UBPath$ + "UBINQRPT.RPT"
  UBRpt = FreeFile
  Open ReportFile$ For Output As UBRpt

  ToPrint$ = ""
  ToPrint$ = LabelAcctNo.Caption + "~" + fpBook + "~" + fpSeqNumb
  ToPrint$ = ToPrint$ + "~" + fpStatus.Text + "~" + fpOpenDate.Text
  ToPrint$ = ToPrint$ + "~" + fpCustName.Text
  ToPrint$ = ToPrint$ + "~" + fpAddr1.Text
  ToPrint$ = ToPrint$ + "~" + fpAddr2.Text
  ToPrint$ = ToPrint$ + "~" + fpServAddr.Text
  ToPrint$ = ToPrint$ + "~" + fpCity.Text
  ToPrint$ = ToPrint$ + "~" + fpState.Text
  ToPrint$ = ToPrint$ + "~" + fpZip.Text
  ToPrint$ = ToPrint$ + "~" + fpHPhone.Text
  ToPrint$ = ToPrint$ + "~" + fpWPhone.Text
  ToPrint$ = ToPrint$ + "~" + fpSoSec.Text
  ToPrint$ = ToPrint$ + "~" + fpDrvLic.Text
  ToPrint$ = ToPrint$ + "~" + fpCustType.Text
  ToPrint$ = ToPrint$ + "~" + fpBillCopy.Text
  ToPrint$ = ToPrint$ + "~" + fpZone.Text
  ToPrint$ = ToPrint$ + "~" + fpAllowCutoff.Text
  ToPrint$ = ToPrint$ + "~" + fpTaxExempt.Text
  ToPrint$ = ToPrint$ + "~" + fpAcctType.Text
  ToPrint$ = ToPrint$ + "~" + fpBankName.Text
  ToPrint$ = ToPrint$ + "~" + fpBankLoc.Text
  ToPrint$ = ToPrint$ + "~" + fpTransit.Text
  ToPrint$ = ToPrint$ + "~" + "XXXXXXXXXXXX"
  ToPrint$ = ToPrint$ + "~" + fpAcctBalance.Text
  ToPrint$ = ToPrint$ + "~" + fpCurrent.Text
  ToPrint$ = ToPrint$ + "~" + fpPastDue.Text
  ToPrint$ = ToPrint$ + "~" + fpDeposit.Text
  ToPrint$ = ToPrint$ + "~" + fpgroupcode.Text

  Print #UBRpt, ToPrint$
  Close
  Load frmLoadingRpt
  frmLoadingRpt.setwherefrom frmRptUBCustInq
  ARptUBCustInq.txtDate = Now
  ARptUBCustInq.txtTown = TownName$
  ARptUBCustInq.GetName ReportFile$
  ARptUBCustInq.startrpt

End Sub

Private Sub PrintCustInq1()  'this is text
  Dim PageNo As Integer, Title As String, MaxLines As Integer
  Dim Dash80 As String, ReportFile As String
  Dim zz As Integer, CustCnt As Integer
  Dim UBRpt As Integer, ToPrint As String

  Title$ = "Customer Inquiry Report"
  Dash80$ = String$(80, "-")
  ReportFile$ = UBPath$ + "UBINQRPT.RPT"
  UBRpt = FreeFile
  Open ReportFile$ For Output As UBRpt
  ...
  Print #UBRpt, Dash80$
  Print #UBRpt,
  Print #UBRpt, Tab(10); "Customer Name: "; fpCustName.Text;
  Print #UBRpt, Tab(60); "Status: "; fpStatus.Text
  Print #UBRpt, Tab(10); "Account #: "; LabelAcctNo.Caption; Tab(10); "Location: "; fpBook; "-"; fpSeqNumb
  Print #UBRpt, Tab(10); "Address: "; fpAddr1.Text
  Print #UBRpt, Tab(19); fpAddr2.Text
  Print #UBRpt, Tab(19); fpServAddr.Text
  Print #UBRpt, Tab(19); fpCity.Text; " "; fpState.Text; " "; fpZip.Text;
  Print #UBRpt, Tab(45); "Group: "; fpgroupcode.Text
  Print #UBRpt, Tab(10); "Home Phone: "; fpHPhone.Text; Tab(45); "Work Phone: "; fpWPhone.Text
  Print #UBRpt, Tab(10); "Account Opened: "; fpOpenDate.Text; Tab(45); "Tax Exempt: "; fpTaxExempt.Text
  Print #UBRpt, Tab(10); "Allow Cutoff: "; fpAllowCutoff.Text;
  Print #UBRpt, Tab(45); "Customer Type: "; fpCustType.Text
  Print #UBRpt, Tab(10); "Social Security: "; fpSoSec.Text; Tab(45); "Bill Copies: "; fpBillCopy.Text
  Print #UBRpt, Tab(10); "Driver Lic: "; fpDrvLic.Text; Tab(45); "Zone Code: "; fpZone.Text
  Print #UBRpt, Tab(10); "------- Draft Information -------"
  Print #UBRpt, Tab(10); "Draft Account: "; fpAcctType.Text
  Print #UBRpt, Tab(10); "    Bank Name: "; fpBankName.Text
  Print #UBRpt, Tab(10); "Bank Location: "; fpBankLoc.Text
  Print #UBRpt, Tab(10); "      Transit: "; fpTransit.Text
  Print #UBRpt, Tab(10); " Bank Account: "; "XXXXXXXXXXXX"
  Print #UBRpt, Tab(10); "----Account Balance Information----"
  Print #UBRpt, Tab(10); "Account Balance: "; fpAcctBalance.Text
  Print #UBRpt, Tab(10); "        Current: "; fpCurrent.Text
  Print #UBRpt, Tab(10); "       Past Due: "; fpPastDue.Text
  Print #UBRpt, Tab(10); " Amt on Deposit: "; fpDeposit.Text
  Print #UBRpt,
  Print #UBRpt, Dash80$
  Print #UBRpt, Chr$(12)

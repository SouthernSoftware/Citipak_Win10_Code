...
Private Sub cmdDetail_Click()
  ...
  If fpList1Pers.SelCount > 0 Then
    ...
    If fpList1Pers.ListCount > 0 Then
      If fpList1Pers.SelCount = 0 Then
        Call VATaxMsg(900, "Please make a selection from the personal transactions list.")
        Exit Sub
      End If
    Else
      Call VATaxMsg(900, "No transactions available for personal detail report.")
      Exit Sub
    End If
  ...
  ElseIf fpList1Real.SelCount > 0 Then
    ...
    If fpList1Real.ListCount > 0 Then
      If fpList1Real.SelCount = 0 Then
        Call VATaxMsg(900, "Please make a selection from the real transactions list.")
        Exit Sub
      End If
    Else
      Call VATaxMsg(900, "No transactions available for real detail report.")
      Exit Sub
    End If
  ...
  Else
    Call VATaxMsg(900, "Please make a selection from a transactions list.")
    Exit Sub
  End If
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      TXLog ("CitiTaxes.exe terminated via menu bar on frmVATaxCustInfoTHist.")
      Call CMTerminate
      End
    End If
  End If
...
Private Sub LoadMe()
  ...
  BillType = "NA"
  OpenVATaxCustFile THandle, NumOfCustRecs
  ...
  If TaxRec.LastTrans > 0 Then
    fpCurrBalance = VAGetCustBalance(GCustNum, -1)
    fpCurrRealBal = VAGetCustRealBalance(GCustNum, -1)
    fpCurrPersBal = VAGetCustPersBalance(GCustNum, -1)
  Else
    fpCurrBalance = 0
    fpCurrRealBal = 0
    fpCurrPersBal = 0

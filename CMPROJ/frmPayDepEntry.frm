...
Begin VB.Form frmPayDepEntry 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Cash Management Deposit Payment"
   ClientHeight    =   8865
   ClientLeft      =   3930
   ClientTop       =   1890
   ClientWidth     =   12210
   Icon            =   "frmPayDepEntry.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin LpLib.fpCombo fpcboTenderType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPayDepEntry.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdCharge 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPayDepEntry.frx":0BF1
   End
   Begin fpBtnAtlLibCtl.fpBtn fpcmdCheck 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPayDepEntry.frx":0DCE
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPayDepEntry.frx":20A0
   End
   Begin fpBtnAtlLibCtl.fpBtn CmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPayDepEntry.frx":227C
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdCash 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPayDepEntry.frx":2458
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdInfo 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPayDepEntry.frx":3729
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpcmdFind 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPayDepEntry.frx":3904
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpcmdDrawer 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPayDepEntry.frx":4BD4
   End
   ...
   End
End
Attribute VB_Name = "frmPayDepEntry"
...
'  End If
  ...
  CMLog "OUT: CMDep Payment" + " Oper:" + Oper$
  UBLog "OUT: CMDep Payment" + " Oper:" + Oper$
  Unload Me
  DoEvents
End Sub
...
'    End If
  ...
  CMLog "Oper: " + Oper$ + "CM DepPay-Open Drawer"
  PortFile = FreeFile
...
Private Sub fpcmdFind_Click()
  ...
  frmCustEditLookUP.Wheretogo frmPayDepEntry, frmPayDepEntry
  Unload Me
  DoEvents
...
Exit Sub
ERRORSTUFF:
  Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "CMPayDepEntry", "cmdSave", Erl)
    Case emrExitProc:
      Resume Proc_Exit
    Case emrResume:
      Resume
  ...
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      If MsgBox("Are You Sure You Wish To Close The Program?", vbYesNo, "Close?") = vbNo Then
        Cancel = True
      Else
        CMLog "Closed via CMDepPay by " + PWUser$ + " operator-" + Oper$
        CitiTerminate
      End If
    End If
  End If
...
Private Sub Form_Load()
  ...
  LoadRevs
  lblOperator = OperNum
  lblSource.Caption = "CM Deposit"
  Oper$ = QPTrim(lblOperator.Caption)
  CMLog " IN Oper " + Oper$ + ": CMDepUTIL Payment"
  GetRcpInfo
End Sub
...
On Local Error GoTo ERRORSTUFF
 ...
 ' GoSub ClearForm
  ...
  Close CustFile
    CMLog "Oper:" + Oper$ + " Entering Deposit Payment for Account:" + Str$(CustAcct&)
...
Private Sub SaveTransaction()
  ...
  Dim RevAmts As Integer, CHandle As Integer, THandle As Integer
  Dim NextTransRec As Long, CMTrRecLen As Integer, TAmtPaid As Double
  ReDim UBCustRec(1) As NewUBCustRecType
  ReDim UBPaymentRec(1) As UBPaymentRecType
  Oper$ = QPTrim$(lblOperator.Caption)
...
'      UBPaymentRec(1).PaidOwed(cnt).AMTOWE1 = fpAmtOwed(cnt - 1)
  ...
  CMLog "Oper:" + Oper$ + " DepPay Updated Tempfile for Acct:" + Str$(UBPaymentRec(1).CustAcct)
  UBLog "Oper:" + Oper$ + " DepPay Updated CMTempfile for Acct:" + Str$(UBPaymentRec(1).CustAcct)
  ...
  If Len(QPTrim$(UBPaymentRec(1).Desc)) = 0 Then
    UBTransRec(1).TransDesc = "CM-DEPOSIT PAYMENT"
  Else
  ...
  Close
  CMLog "SAVED DepPAYMENT in Util ACCT:" + Str$(CustAcct&) + Oper$
  UBLog "SAVED DepPAYMENT in Util ACCT:" + Str$(CustAcct&) + Oper$
  ...
  Close CHandle
  CMLog "SAVED DepPAYMENT in CM ACCT:" + Str$(CustAcct&) + " Oper -" + Oper$
  UBLog "SAVED DepPAYMENT in CM ACCT:" + Str$(CustAcct&) + " Oper -" + Oper$
...
'  ReDim Preserve RevText$(1 To MaxRevsCnt)
  ...
  Print #RHandle, "CM UTILITY DEPOSIT PAYMENT"
...
If PrnRecp = True Then
 CMLog "Oper: " + Oper$ + " Print Dep receipt Acct:" + Str(UBPaymentRec(1).CustAcct)

VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptUBCustInq 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Utility Customer Inquiry Report"
   ClientHeight    =   7692
   ClientLeft      =   36
   ClientTop       =   264
   ClientWidth     =   10356
   Icon            =   "ARptUBCustInq.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   18267
   _ExtentY        =   13568
   SectionData     =   "ARptUBCustInq.dsx":08CA
End
Attribute VB_Name = "ARptUBCustInq"
...
ERRORSTUFF:
      Unload frmLoadingRpt
  Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "ARptUBCustInq", "Fetch Data", Erl)
    Case emrExitProc:
      Resume Proc_Exit
    Case emrResume:
      Resume
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    If KeyCode = vbKeyE Then
      ...
      DoEvents
      MsgBox "File - UBInq.xls, created in the Citipak Directory.", vbOKOnly
    End If
    If KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      MsgBox "File - UBInq.txt, created in the Citipak Directory.", vbOKOnly
    End If
  End If
End Sub
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & "UBInq.xls"
        oEXL.Export Me.Pages
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & "UBInq.txt"
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","

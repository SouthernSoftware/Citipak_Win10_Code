...
Private Sub fpcmdPrint_Click()
  ...
  For cnt = 0 To 6
    Print #UBRpt, Tab(2); Label1(cnt); Tab(22); Revs(cnt); Tab(35); Tax(cnt); Tab(46); CurRead(cnt); Tab(57); PreRead(cnt);
     Print #UBRpt, Tab(68); ReadEst(cnt)
  Next
  For cnt = 7 To 14
    Print #UBRpt, Tab(2); Label1(cnt); Tab(22); Revs(cnt); Tab(35); Tax(cnt)
  Next
  Close #UBRpt
  PrintTRDetlScreen

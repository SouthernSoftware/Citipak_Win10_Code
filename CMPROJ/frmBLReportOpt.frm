...
Begin VB.Form frmBLReportOpt 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBLReportOpt.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdGraphic 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBLReportOpt.frx":0AA6
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdText 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBLReportOpt.frx":0C85
   End
   ...
   End
End
Attribute VB_Name = "frmBLReportOpt"

...
Public Sub GetName(RName As String, SName As String, Detail As Boolean, RevSource As Integer)
  ...
  Rev = RevSource
  Part = Timer
  exfile = "GLUT" + Right$(QPTrim(Str(CLng(Part))), 4) + ".xls"
  txfile = "GLUT" + Right$(QPTrim(Str(CLng(Part))), 4) + ".txt"
End Sub
...
'      Me.Detail.Height = 810
  ...
  End If
  Me.Label19.Caption = Me.txtRptParm1
End Sub
...
Private Sub ActiveReport_QueryClose(Cancel As Integer, CloseMode As Integer)
  KillFile ReportFile$
  KillFile SubFile$
  frmRptTransJournal.TransSummary
End Sub

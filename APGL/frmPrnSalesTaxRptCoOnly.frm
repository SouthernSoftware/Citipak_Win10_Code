...
Begin VB.Form frmPrnSalesTaxRptCoOnly 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Sales Tax Report-Counties Only"
   ClientHeight    =   8892
   ClientLeft      =   36
   ClientTop       =   492
   ClientWidth     =   12192
   Icon            =   "frmPrnSalesTaxRptCoOnly.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8892
   ...
   Begin LpLib.fpCombo fpcboCoAcct 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnSalesTaxRptCoOnly.frx":08CA
   End
   Begin LpLib.fpCombo fpcboStAcct 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnSalesTaxRptCoOnly.frx":0CCD
   End
   Begin LpLib.fpCombo fpcboCombined 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnSalesTaxRptCoOnly.frx":10D0
   End
   Begin LpLib.fpCombo fpcboStateCode 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnSalesTaxRptCoOnly.frx":13FF
   End
   Begin LpLib.fpCombo fpcboRptType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnSalesTaxRptCoOnly.frx":172E
   End
   ...
   Begin VB.Image Image1 
      Height          =   276
      Left            =   2280
      Picture         =   "frmPrnSalesTaxRptCoOnly.frx":1A94
      Top             =   2376
      Width           =   288
   End
   ...
   End
End
Attribute VB_Name = "frmPrnSalesTaxRptCoOnly"

VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptTrialBal 
   ...
   _ExtentX        =   16193
   _ExtentY        =   10499
   SectionData     =   "ARptTrialBal.dsx":08CA
End
Attribute VB_Name = "ARptTrialBal"
...
Dim FDebit As Double, FCredit As Double, Diff As Double
Public ActYear As Integer
...
'    ' or user defined.
    Fields("Fund").Value = arr(0)
    Fields("FundName").Value = arr(1)
    Fields("AcctNum").Value = arr(2)
    Fields("AcctName").Value = arr(3)
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    If KeyCode = vbKeyE Then
      ...
      DoEvents
      MsgBox "File - TrialBal.xls, created in the Citipak Directory.", vbOKOnly
    End If
    If KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      MsgBox "File - TrialBal.txt, created in the Citipak Directory.", vbOKOnly
    End If
  End If
...
Private Sub ReportFooter_Format()
  If ActYear = 2 Then
    Set Me.SubReport1.object = New ARSubPriorBal
  End If
End Sub

Private Sub Detail_Format()
  FDebit = FDebit + Me.Fields("Debit").Value
  FCredit = FCredit + Me.Fields("Credit").Value
End Sub
...
Private Sub GroupFooter1_Format()
  If FDebit <> FCredit Then
    Diff# = Round#(FDebit# - FCredit#)
    If Diff# <> 0 Then
      Me.Label9.Visible = True
      Me.txtDiff.Visible = True
      Me.txtDiff.DataValue = Diff#
      Me.Shape1.Visible = True
    End If
  Else
    Me.Shape1.Visible = False
    Me.Label9.Visible = False
    Me.txtDiff.Visible = False
  End If
End Sub
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & "TrialBal.xls"
        oEXL.Export Me.Pages
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & "TrialBal.txt"
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","

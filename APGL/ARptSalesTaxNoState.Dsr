VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptSalesTaxNoState 
   ...
   ClientTop       =   264
   ClientWidth     =   9252
   Icon            =   "ARptSalesTaxNoState.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   16320
   _ExtentY        =   8382
   SectionData     =   "ARptSalesTaxNoState.dsx":08CA
End
Attribute VB_Name = "ARptSalesTaxNoState"
...
'    ' or user defined.
    Fields("State").Value = arr(0)
    Fields("County").Value = arr(1)
    Fields("StAmt").Value = arr(2)
    Fields("CoAmt").Value = arr(3)
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    If KeyCode = vbKeyE Then
      ...
      DoEvents
      MsgBox "File - SlsTaxRpt.xls, created in the Citipak Directory.", vbOKOnly
    End If
    If KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      MsgBox "File - SlsTaxRpt.txt, created in the Citipak Directory.", vbOKOnly
    End If
  End If
End Sub
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & "SlsTaxRpt.xls"
        oEXL.Export Me.Pages
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & "SlsTaxRpt.txt"
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","

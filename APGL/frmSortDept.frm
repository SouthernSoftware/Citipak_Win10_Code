VERSION 5.00
Begin VB.Form frmSortDept 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Sort Departments"
   ClientHeight    =   2700
   ClientLeft      =   48
   ClientTop       =   96
   ClientWidth     =   5448
   ...
   Begin VB.Label Label1 
      ...
      Caption         =   "Ready to Sort Department Index?"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   13.8
         Charset         =   0
...
Private Sub cmdOKSort_Click()
  Call MainLog("Sort Dept Started - Menu Option.")
  SortDeptIndex
  Call MainLog("Sort Dept Complet - Menu Option.")

VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARSubPriorBal 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   4380
   ClientLeft      =   36
   ClientTop       =   264
   ClientWidth     =   6600
   Icon            =   "ARSubPriorBal.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   11642
   _ExtentY        =   7726
   SectionData     =   "ARSubPriorBal.dsx":08CA
End
Attribute VB_Name = "ARSubPriorBal"

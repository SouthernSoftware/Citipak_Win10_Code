VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARSubChkFund 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   4380
   ClientLeft      =   36
   ClientTop       =   264
   ClientWidth     =   6684
   Icon            =   "ARSubChkFund.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   11790
   _ExtentY        =   7726
   SectionData     =   "ARSubChkFund.dsx":08CA
End
Attribute VB_Name = "ARSubChkFund"
...
'    ' or user defined.
    ...
    Fields("totChecks").Value = arr(1)
    Fields("totVoids").Value = arr(2)
    Fields("Total").Value = arr(3)

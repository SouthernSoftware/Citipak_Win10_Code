...
Begin VB.Form frmPFNCTBudvAct 
   ...
   Begin LpLib.fpCombo fpcboFunction2 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPFNCTBudvAct.frx":08CA
   End
   Begin LpLib.fpCombo fpcboFunction1 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPFNCTBudvAct.frx":0CB5
   End
   Begin LpLib.fpCombo fpcboSubtot 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPFNCTBudvAct.frx":10A0
   End
   Begin LpLib.fpCombo fpcboPagebrk 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPFNCTBudvAct.frx":1407
   End
   Begin LpLib.fpCombo fpcboRepNum 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPFNCTBudvAct.frx":176E
   End
   Begin LpLib.fpCombo fpcboDetSum 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPFNCTBudvAct.frx":1B2D
   End
   Begin LpLib.fpCombo fpcboRptType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPFNCTBudvAct.frx":1E94
   End
   ...
   End
End
Attribute VB_Name = "frmPFNCTBudvAct"

VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptBudVActME 
   ...
   ClientTop       =   270
   ClientWidth     =   12225
   Icon            =   "ARptBudVActME.dsx":0000
   StartUpPosition =   2  'CenterScreen
   WindowState     =   2  'Maximized
   _ExtentX        =   21564
   _ExtentY        =   12541
   SectionData     =   "ARptBudVActME.dsx":08CA
End
Attribute VB_Name = "ARptBudVActME"
...
Dim cnt As Integer
Dim FRevTotM As Double, FRevTotY As Double, FRevTotE As Double
Dim FExpTotM As Double, FExpTotY As Double, FExpTotE As Double
Public rptnum As Integer
Public detopt As Integer
Public deptpage As Boolean
Public overunder As Boolean
Public breakfund As Boolean
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    If KeyCode = vbKeyE Then
      ...
      DoEvents
      MsgBox "File - BudVAct.xls, created in the Citipak Directory.", vbOKOnly
    End If
    If KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      MsgBox "File - BudVAct.txt, created in the Citipak Directory.", vbOKOnly
    End If
  End If
End Sub
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & "BudVAct.xls"
        oEXL.Export Me.Pages
        
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & "BudVAct.txt"
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","

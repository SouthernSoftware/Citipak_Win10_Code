...
Begin VB.Form frmPostCD 
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Post Cash Disbursement Entries"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   13.8
         Charset         =   0
   ...
   Begin VB.Label lbInfo 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Before You Post, Make Sure You Have Printed A Cash Disbursement Report.  If You Haven't, Then Exit And Do So Now."
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   12
         Charset         =   0
...
Private Sub cmdOk_Click()
  ...
  CJType = 2
  PostCJTrans CJType, frmPostCD
  Call MainLog("Posted CD.")

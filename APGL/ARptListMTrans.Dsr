VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptListMTrans 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "List Marked Transactions"
   ClientHeight    =   4380
   ClientLeft      =   36
   ClientTop       =   264
   ClientWidth     =   8616
   Icon            =   "ARptListMTrans.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   15198
   _ExtentY        =   7726
   SectionData     =   "ARptListMTrans.dsx":08CA
End
Attribute VB_Name = "ARptListMTrans"
...
'    ' or user defined.
    ...
    Fields("Trans").Value = arr(7)
    Fields("NextTR").Value = arr(8)
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    If KeyCode = vbKeyE Then
      ...
      DoEvents
      MsgBox "File - MarkedTR.xls, created in the Citipak Directory.", vbOKOnly
    End If
    If KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      MsgBox "File - MarkedTR.txt, created in the Citipak Directory.", vbOKOnly
    End If
  End If
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & "MarkedTR.xls"
        oEXL.Export Me.Pages
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & "MarkedTR.txt"
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","

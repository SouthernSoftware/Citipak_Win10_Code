...
Begin VB.Form frmPrnBudAct2 
   ...
   Begin LpLib.fpCombo fpcboSubtot 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnBudAct2.frx":0000
   End
   Begin LpLib.fpCombo fpcboPagebrk 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnBudAct2.frx":032F
   End
   Begin LpLib.fpCombo fpcboRepNum 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnBudAct2.frx":065E
   End
   Begin LpLib.fpCombo fpcboDetSum 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnBudAct2.frx":09E5
   End
   Begin LpLib.fpCombo fpcboFund2 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnBudAct2.frx":0D14
   End
   Begin LpLib.fpCombo fpcboFund1 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnBudAct2.frx":10C7
   End
   ...
   Begin VB.Image Image1 
      Height          =   276
      Left            =   3120
      Picture         =   "frmPrnBudAct2.frx":147A
      Top             =   2112
      Width           =   288
   End
   ...
   End
End
Attribute VB_Name = "frmPrnBudAct2"
...
Private Sub CreateRecordset()
    rs.Fields.Append "Description", adVarChar, 30
    rs.Fields.Append "Budget", adCurrency
    rs.Fields.Append "MonthQTD", adCurrency
    rs.Fields.Append "YTD", adCurrency
    rs.Fields.Append "Variance", adCurrency
...
'      Linecnt = Linecnt + 2
  ...
  'Print #PRNFile, FF$
  Close
  RptBudVAct.title = GLUserName
  Set RptBudVAct.DataSource = rs
  RptBudVAct.Show 1, Me

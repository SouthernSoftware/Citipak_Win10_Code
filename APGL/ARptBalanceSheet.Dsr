VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptBalanceSheet 
   ...
   ClientTop       =   270
   ClientWidth     =   11010
   Icon            =   "ARptBalanceSheet.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   19420
   _ExtentY        =   12541
   SectionData     =   "ARptBalanceSheet.dsx":08CA
End
Attribute VB_Name = "ARptBalanceSheet"
...
'    ' or user defined.
    ...
    Fields("Acct").Value = arr(3)
    Fields("Title").Value = arr(4)
    Fields("Amt").Value = arr(5)
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    If KeyCode = vbKeyE Then
      ...
      DoEvents
      MsgBox "File - BalSheet.xls, created in the Citipak Directory.", vbOKOnly
    End If
    If KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      MsgBox "File - BalSheet.txt, created in the Citipak Directory.", vbOKOnly
    End If
  End If
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & "BalSheet.xls"
        oEXL.Export Me.Pages
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & "BalSheet.txt"
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","

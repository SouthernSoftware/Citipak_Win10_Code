...
Begin VB.Form frmAPReportsMenu 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdOpenPay 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPReportsMenu.frx":0AB0
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdOpenPayDate 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPReportsMenu.frx":0C95
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdOpenPOs 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPReportsMenu.frx":0E82
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPOHistGL 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPReportsMenu.frx":106E
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdAPChkList 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPReportsMenu.frx":125D
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPaidSupLst 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPReportsMenu.frx":1446
   End
   Begin fpBtnAtlLibCtl.fpBtn cmd1099Forms 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPReportsMenu.frx":1631
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSalesTaxRpt 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPReportsMenu.frx":181E
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSalesTaxCounty 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPReportsMenu.frx":1A06
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExitAPRptMenu 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPReportsMenu.frx":1BF5
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdClosedPOs 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPReportsMenu.frx":1DE7
   End
   Begin VB.Line Line2 

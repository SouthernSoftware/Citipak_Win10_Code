...
Begin VB.Form frmSecurityPassAP 
   BackColor       =   &H008A775B&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "CitiPak A/P Password Sign-In"
   ClientHeight    =   8916
   ClientLeft      =   36
   ClientTop       =   264
   ClientWidth     =   12216
   Icon            =   "frmSecurityPassAP.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Label Label2 
      ...
      Caption         =   "ACCOUNTS PAYABLE PASSWORD"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   13.8
         Charset         =   0
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Enter Accounts Payable Password"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmSecurityPassAP"
    ...
    If Len(Dir$("Citipass.dat")) Then
      ...
      Else
        ...
        If Findnum = -1 Then
          ...
          Call MainLog("Password in session, NO AP Access.")
          Notvalid = False
          txtPW = ""
          txtPW.SetFocus
        End If
      ...
      If pw$ = LookFor$ Then
        If Not Citipass.InUseFlag Then
          If Citipass.Module(2).FullAccess = True Then
            LevelPass = 1
          Else
            If Citipass.Module(2).ReportsOnly = True Then
              LevelPass = 2
            End If
          End If

VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptPreAudit 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "A/P PreAudit Report"
   ClientHeight    =   4380
   ClientLeft      =   30
   ClientTop       =   270
   ClientWidth     =   9180
   Icon            =   "ARptPreAudit.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   16193
   _ExtentY        =   7726
   SectionData     =   "ARptPreAudit.dsx":08CA
End
Attribute VB_Name = "ARptPreAudit"
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    If KeyCode = vbKeyE Then
      ...
      DoEvents
      MsgBox "File - PreAudRpt.xls, created in the Citipak Directory.", vbOKOnly
    End If
    If KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      MsgBox "File - PreAudRpt.txt, created in the Citipak Directory.", vbOKOnly
    End If
  End If
...
Private Sub GroupHeader2_Format()
  tempTot = Round(tempTot + Me.Fields("InvAmt").Value)
End Sub
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & "PreAudRpt.xls"
        oEXL.Export Me.Pages
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & "PreAudRpt.txt"
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","

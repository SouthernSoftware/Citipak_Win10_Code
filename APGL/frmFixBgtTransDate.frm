...
Begin VB.Form frmFixBgtTransDate 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Fix Budget Transaction Date"
   ClientHeight    =   8868
   ClientLeft      =   36
   ClientTop       =   540
   ClientWidth     =   12192
   Icon            =   "frmFixBgtTransDate.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8868
   ...
   Begin LpLib.fpCombo fpcboModule 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmFixBgtTransDate.frx":08CA
   End
   ...
   Begin VB.Label Label1 
      ...
      Caption         =   "Change Budget Transaction Date"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   13.8
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmFixBgtTransDate"
...
Private Sub ChangeBgtDate()
  ...
  Dim BTransRecLen As Integer, r5 As String
  ...
  For TRRec& = 1 To NumBTrans&
    FrmShowPctComp.ShowPctComp TRRec&, NumBTrans&
  ...
  r2$ = "Budget Trans Changed: " + Using$("#########", Str$(Changed))
  r3$ = "Total Debits : " + Using$("##,###,###.##", Str$(Debits#))
  r4$ = "Total Credits: " + Using$("##,###,###.##", Str$(Credits#))
  r5$ = " FixBgtTransDate: " + txtSearchDate + " TO " + txtReplaceDate + " TotChanged " + Str$(Changed)
  If Changed > 0 Then
    Print #RptFile,
    Print #RptFile, r1$
...
LogBgtDateChange:
   ...
   Mid$(ToPrint$, 17) = Format(DateAdd("d", (BTrans.TRDATE), "12-31-1979"), "mm/dd/yyyy")
   Mid$(ToPrint$, 28) = Left$(BTrans.Desc, 15)
   'MID$(ToPrint$, 36) = Trans.Ref
   Mid$(ToPrint$, 46) = Using$("##,###,###.##", Str$(BTrans.DrAmt))
   Mid$(ToPrint$, 59) = Using$("##,###,###.##", Str$(BTrans.CrAmt))
   Mid$(ToPrint$, 74) = BTrans.Src
   Print #RptFile, ToPrint$
   '--Change date in transaction file
   BTrans.TRDATE = NDate
   Put BTransFile, TRRec&, BTrans
   Changed = Changed + 1
   Debits# = Debits# + BTrans.DrAmt
   Credits# = Credits# + BTrans.CrAmt

...
DECLARE FUNCTION WEnvTest% ()
  ...
  IF NOT WEnvTest OR INSTR(COMMAND$, "TEST") THEN
    RUN "ubmisc"
  END IF
...
'  PRINT #UBRpt, q$; "Act No"; q$; ",";
'  PRINT #UBRpt, q$; "Location"; q$; ",";
'  PRINT #UBRpt, q$; "CustName"; q$; ",";
'  PRINT #UBRpt, q$; "Addr 1"; q$; ",";
'  PRINT #UBRpt, q$; "Addr 2"; q$; ",";
'  PRINT #UBRpt, q$; "City"; q$; ",";
'  PRINT #UBRpt, q$; "State"; q$; ",";
'  PRINT #UBRpt, q$; "Zip"; q$; ",";
'  PRINT #UBRpt, q$; "Serv Addr"; q$
  ...
  FOR Cnt = 1 TO NumOfRecs
    ...
    IF UBCustRec(1).DelFlag <> -1 AND UBCustRec(1).Status = "A" THEN
      ...
      PRINT #UBRpt, Q$; AcctNumber; Q$
      PRINT #UBRpt, Q$; LocationNumber$; Q$
      PRINT #UBRpt, Q$; RTRIM$(UBCustRec(1).CustName); Q$
      PRINT #UBRpt, Q$; QPTrim$(UBCustRec(1).ADDR1); Q$
      PRINT #UBRpt, Q$; QPTrim$(UBCustRec(1).ADDR2); Q$
      PRINT #UBRpt, Q$; QPTrim$(UBCustRec(1).city); Q$
      PRINT #UBRpt, Q$; QPTrim$(UBCustRec(1).State); Q$
      PRINT #UBRpt, Q$; Zip$; Q$
      PRINT #UBRpt, Q$; QPTrim$(UBCustRec(1).ServAddr); Q$
  ...
  ERASE IdxBuff, UBCustRec
   FOR ll = 8 TO 15
   LOCATE ll, 22: PRINT STRING$(38, 32);
   NEXT ll
   LOCATE 8, 23: COLOR 11
   LOCATE 8, 23: PRINT "File Created is UBEXPORT.TXT";
   LOCATE 10, 23: PRINT "File Consists of";
   LOCATE 11, 23: PRINT "Acct #, Location #";
   LOCATE 12, 23: PRINT "Name, Address Line 1, Address Line 2";
   LOCATE 13, 23: PRINT "City, State, Zip, Service Address";
   LOCATE 15, 23: PRINT "All encased in quotes";
'   SLEEP 20
'   LPRINT "Utility System File Export"
'   LPRINT
'   LPRINT "File Created: UBEXPORT.TXT"
'   LPRINT

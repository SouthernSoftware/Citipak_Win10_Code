...
Begin VB.Form frmPrnMastCustRep 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   540
   ClientWidth     =   12192
   Icon            =   "frmPrnMastCustRpt.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8640
   ...
   Begin LpLib.fpCombo fpcboRptType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnMastCustRpt.frx":08CA
   End
   Begin LpLib.fpCombo fpcboDetSum 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnMastCustRpt.frx":0C68
   End
   Begin LpLib.fpCombo fpcboRepNum 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnMastCustRpt.frx":0FCF
   End
   Begin LpLib.fpCombo fpcboPagebrk 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnMastCustRpt.frx":138E
   End
   Begin LpLib.fpCombo fpcboSubtot 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnMastCustRpt.frx":16F5
   End
   ...
   Begin VB.Image Image1 
      Height          =   276
      Left            =   3120
      Picture         =   "frmPrnMastCustRpt.frx":1A5C
      Top             =   2112
      Width           =   288
   End
   ...
   End
End
Attribute VB_Name = "frmPrnMastCustRep"

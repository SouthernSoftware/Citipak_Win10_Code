...
Begin VB.Form frmRptStreetList 
   ...
   Begin LpLib.fpCombo fpcboPrintOrder 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptStreetList.frx":0C68
   End
   Begin LpLib.fpCombo fpcboInactive 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptStreetList.frx":0FFB
   End
   Begin LpLib.fpCombo fpcboPageBreak 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptStreetList.frx":1399
   End
...
Private Sub CustStreetListing()
  ...
  Dim UsingAddr As Boolean, Reportfile As String
  UsingAcct = False
  UseStatus = False
  UsingName = False
  UsingBook = False
...
Private Sub CustStreetListing2()
  ...
  Dim ToPrnH2 As String, Reportfile As String
  UsingAcct = False
  UseStatus = False
  UsingName = False
  UsingBook = False
...
'  End If
  '*************************************
  '   Main body of Printing goes here
  ToPrint$ = UBCustRec(1).Book + "~" + UBCustRec(1).Book + "-" + UBCustRec(1).SEQNUMB + "~" + Str$(AcctNo&) + "~"

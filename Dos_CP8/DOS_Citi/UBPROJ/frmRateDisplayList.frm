...
Begin VB.Form frmRateDisplayList 
   ...
   Begin LpLib.fpList fpList1 
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmRateDisplayList.frx":0000
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdOK 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRateDisplayList.frx":02AC
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRateDisplayList.frx":0485
   End
   ...
   End
End
Attribute VB_Name = "frmRateDisplayList"
...
Private Sub fpList1_DblClick()
  ...
  If RateRec > 0 Then
    ...
    frmEditAddRateTable.fpRateRecNo.Text = RateRec
    
  Else
    tmpLastRate = 0
    frmEditAddRateTable.fpRateRecNo.Text = "0"
  End If

...
Begin VB.Form frmPrnBudAct 
   ...
   Begin LpLib.fpCombo fpcboPagebrk 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnBudAct.frx":0C31
   End
   Begin LpLib.fpCombo fpcboRepNum 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnBudAct.frx":0F98
   End
   Begin LpLib.fpCombo fpcboDetSum 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnBudAct.frx":1357
   End
   Begin LpLib.fpCombo fpcboFund2 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnBudAct.frx":16BE
   End
   Begin LpLib.fpCombo fpcboFund1 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnBudAct.frx":1AA9
   End
   Begin LpLib.fpCombo fpcboRptType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnBudAct.frx":1E94
   End

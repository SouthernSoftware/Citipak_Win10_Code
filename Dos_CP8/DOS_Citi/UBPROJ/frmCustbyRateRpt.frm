...
Begin VB.Form frmRptCustbyRate 
   ...
   Begin LpLib.fpCombo fpcboRptType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmCustbyRateRpt.frx":0C31
   End
   ...
   Begin MSComctlLib.StatusBar StatusBar1 
      ...
      EndProperty
   End
   Begin EditLib.fpBoolean fpActiveOnly 
      Height          =   348
      Left            =   5382
      TabIndex        =   2
      Top             =   4728
...
Private Sub cmdPrint_Click()
  ...
  ActiveOnly = fpActiveOnly.Text = "Y"
...
Private Sub UBCustbyRateRpt()
  ...
  Dim IdxNumOfRecs As Integer, Linecnt As Integer
  Dim Handle As Integer, UBCust As Integer
  Dim UBRateTblRecLen As Integer, NumOfRateRecs As Integer
  Dim UBRpt As Integer, CustCnt As Integer
  Dim Active As Integer, Final As Integer, InActive As Integer
  Dim Balance As Integer, UnKnown As Integer
  Dim RetCode As Integer
  Dim AbortFlag As Boolean, UBSetupLen As Integer
  Dim CBeach As Boolean, SCnt As Integer, MtrCnt As Integer
  Dim ThisRate As String, WhatRate As String
  Dim MtrNum As String, Mtr As String
  Dim Fmt4 As String
    ...
    If UBCustRec(1).DelFlag = 0 Then
      ...
      For SCnt = 1 To 15
        ...
        If WhatRate$ = ThisRate$ Then
          'Mtr$ = "   MTR NO: "
          Mtr$ = ""
          Print #UBRpt, UBCustRec(1).Book; "-"; UBCustRec(1).SEQNUMB; " "; Using$("#####", IdxBuff(cnt).RecNum); "  "; Left$(UBCustRec(1).CustName, 25); "  "; Left$(UBCustRec(1).SERVADDR, 30); " "; UBCustRec(1).Status
          CustCnt = CustCnt + 1
          If CBeach Then
            'Mtr$=
            For MtrCnt = 1 To 7
...
Private Sub UBCustbyRateRpt2()
  ...
  Dim Title As String, ReportFile As String
  Dim UBCustRecLen As Integer, IdxRecLen As Integer
  Dim IdxFileSize As Long, cnt As Long, DeletedCnt As Integer
  Dim IdxNumOfRecs As Integer, Linecnt As Integer
  Dim Handle As Integer, UBCust As Integer
  Dim UBRateTblRecLen As Integer, NumOfRateRecs As Integer
  Dim UBRpt As Integer, CustCnt As Integer
  Dim Active As Integer, Final As Integer, InActive As Integer
  Dim Balance As Integer, UnKnown As Integer
  Dim RetCode As Integer, SubRpt As Integer, SubRptFile As String
  Dim AbortFlag As Boolean, UBSetupLen As Integer
  Dim CBeach As Boolean, SCnt As Integer, MtrCnt As Integer
  Dim ThisRate As String, WhatRate As String
  Dim MtrNum As String, Mtr As String
    ...
    If UBCustRec(1).DelFlag = 0 Then
      ...
      For SCnt = 1 To 15
        ...
        If WhatRate$ = ThisRate$ Then
          'Mtr$ = "   MTR NO: "
          Mtr$ = ""
          ToPrint$ = UBCustRec(1).Book + "-" + UBCustRec(1).SEQNUMB + "~" + Using$("#####", IdxBuff(cnt).RecNum) + "~" + Left$(UBCustRec(1).CustName, 25) + "~" + Left$(UBCustRec(1).SERVADDR, 30) + "~" + UBCustRec(1).Status + "~ "
          CustCnt = CustCnt + 1
          Print #UBRpt, ToPrint$
          If CBeach Then

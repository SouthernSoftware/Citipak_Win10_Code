...
Begin VB.Form frmRptCycleSum 
   ...
   Begin LpLib.fpCombo fpcboRptType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptCycleSum.frx":08CA
   End
   ...
   End
End
Attribute VB_Name = "frmRptCycleSum"
...
'***************
  ...
  For zz = 0 To 99
    If Cycles(zz).CustCnt > 0 Then
      Print #UBRpt, Using("######", zz) + "~" + Using("######", Cycles(zz).CustCnt) + "~" + Using("######", Cycles(zz).PendCnt)
    End If
  Next

  If Cycles(-1).CustCnt > 0 Then
    Print #UBRpt, "    ??" + "~" + Using("######", Cycles(-1).CustCnt) + "~" + Using("######", Cycles(-1).PendCnt)
...
'ViewPrint "UBCYCLE.RPT", Title$
    ...
    ARptCycleSum.GetName ReportFile$

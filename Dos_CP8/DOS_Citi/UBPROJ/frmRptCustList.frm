...
Begin VB.Form frmRptCustList 
   ...
   Begin LpLib.fpCombo fpCombo1 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptCustList.frx":0C68
   End
...
Private Sub cmdPrint_Click()
  ...
  If fpcboRptType.ListIndex = 0 Then
    UBQuickCustList2 WhatOrder, Me
  ElseIf fpcboRptType.ListIndex = 1 Then
    UBQuickCustList WhatOrder, Me
  End If
  ActivateControls Me
  Me.fpCombo1.SetFocus
End Sub
...
Public Sub UBQuickCustList(LocFlag, Parent As Form)
  ...
  Dim Balance As Integer, UnKnown As Integer, DeletedCnt As Integer
  Dim RetCode As Integer, EntryPoint As Integer
  ...
  For cnt = 1 To IdxNumOfRecs
    ...
    If UBCustRec(1).DelFlag = 0 Then
      ...
      Print #UBRpt, Tab(11); Using$("#####", IdxBuff(cnt).RecNum);
...
End Sub
Public Sub UBQuickCustList2(LocFlag, Parent As Form)
  ...
  For cnt = 1 To IdxNumOfRecs
    ...
    If UBCustRec(1).DelFlag = 0 Then
      ...
      ToPrint$ = ToPrint$ + "~" + Using$("#####", IdxBuff(cnt).RecNum)

...
Begin VB.Form frmWarnNOPPD 
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      Begin fpBtnAtlLibCtl.fpBtn cmdOK 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmWarnNOPPD.frx":001C
      End
   ...
   End
End
Attribute VB_Name = "frmWarnNOPPD"
...
Private Sub cmdOk_Click()
  Unload frmWarnNOPPD
  DoEvents
  MainLog ("No pay period defaults set warning issued.")
End Sub

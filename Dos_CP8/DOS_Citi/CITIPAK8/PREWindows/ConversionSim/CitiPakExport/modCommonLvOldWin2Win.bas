Attribute VB_Name = "modCommonLvOldWin2Win"
Option Explicit
...
End Sub
Public Sub OpenOldErnCodeFile(OldErnCodeFileHandle As Integer)
  Dim OldErnCodeFileRec As OldErnCodeRecType
  Dim OldErnCodeRecLen As Integer
  OldErnCodeRecLen = Len(OldErnCodeFileRec)
  OldErnCodeFileHandle = FreeFile
  Open PRData + ErnCodeFileName For Random Shared As OldErnCodeFileHandle Len = OldErnCodeRecLen
End Sub

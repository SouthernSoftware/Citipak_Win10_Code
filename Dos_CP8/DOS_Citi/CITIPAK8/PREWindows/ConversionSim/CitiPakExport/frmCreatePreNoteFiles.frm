...
OpenMainDraftInfo:
  ...
  ReDim PRDraftRec(1) As PRDraftRecType 'use DraftInfoFile when building vb.net 7/5/06
  DraftFile = FreeFile
...
ProcessStep2:
  ...
  PRDraftRecord5(1).Field5 = PRDraftRec(1).FEDPREFX + PRDraftRec(1).FEDID

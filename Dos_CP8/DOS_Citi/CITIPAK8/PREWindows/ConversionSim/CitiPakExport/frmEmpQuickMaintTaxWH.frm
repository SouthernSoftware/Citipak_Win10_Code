...
Begin VB.Form frmEmpQuickMaintTaxWH 
   ...
   Begin FPSpread.vaSpread vaSpread 
      ...
      SpreadDesigner  =   "frmEmpQuickMaintTaxWH.frx":0C6D
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintTaxWH.frx":1C56D
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdEscape 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintTaxWH.frx":1C781
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExitNow 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintTaxWH.frx":1C995
   End

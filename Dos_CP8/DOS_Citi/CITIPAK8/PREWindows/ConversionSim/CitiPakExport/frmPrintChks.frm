...
Begin VB.Form frmPrintChks 
   ...
   Begin LpLib.fpCombo fpcboPrinters 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrintChks.frx":08CA
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdCancel 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPrintChks.frx":0C69
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPrintChks.frx":0E7F
   End
   ...
   Begin VB.Image Image1 
      Height          =   345
      Left            =   4245
      Picture         =   "frmPrintChks.frx":1094
      Top             =   1320
      Width           =   360
   End
End
Attribute VB_Name = "frmPrintChks"
...
Private Sub cmdCancel_Click()
  ...
  CancelDoAlign = True
  If ChkPrintOn = True And doAlign = True Then
    frmChkPrintInfo.fptxtStartChkNum.Text = Val(frmChkPrintInfo.fptxtStartChkNum.Text) - 1
  End If
  
  If ReprintChkOn = True And doAlign = True Then
    frmChkReprintInfo.fptxtRestart.Text = Val(frmChkReprintInfo.fptxtRestart.Text) - 1
  End If
...
Private Sub fpcboPrinters_GotFocus()
  HasFocus = 0
End Sub
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
  If HasFocus <> 0 And KeyCode = vbKeyReturn Then 'added 5/28/2004
    If HasFocus = 1 Then
      Call cmdPrint_Click
...
Private Sub cmdPrint_Click()
  ...
  If fpcboPrinters.ListIndex <> -1 Then
    ...
    If InStr(1, DPName, "\\", vbTextCompare) Then
      frmViewPrintChks.PrintWSet DPName, Copies
    Else
      frmViewPrintChks.PrintWSet DefPrinter, Copies
    End If
  Else

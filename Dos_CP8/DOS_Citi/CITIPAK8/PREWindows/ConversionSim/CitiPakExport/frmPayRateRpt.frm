...
Begin VB.Form frmPayRateRpt 
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      Begin LpLib.fpCombo fpcomboPrintOpt 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmPayRateRpt.frx":0CF9
      End
      Begin LpLib.fpCombo fpcmbLast 
         ...
         EditAlignH      =   0
         EditAlignV      =   0
         ColDesigner     =   "frmPayRateRpt.frx":110C
      End
      Begin LpLib.fpCombo fpcmbFirst 
         ...
         EditAlignH      =   0
         EditAlignV      =   0
         ColDesigner     =   "frmPayRateRpt.frx":15A3
      End
      ...
      Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmPayRateRpt.frx":1A3A
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdEscape 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmPayRateRpt.frx":1C51
      End
...
'  OpenPayRateIdxFile XHandle
  ...
  For x = 1 To NumOfPayRecs
    ...
    If TFlag = False Then
      If PayRec.EMPTDATE > 0 Then GoTo SkipIt
    End If
    OldPay = 0
    NewPay = 0
    ThisPct = 0

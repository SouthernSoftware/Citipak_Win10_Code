VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arTaxFringRpt 
   ...
   _ExtentX        =   20532
   _ExtentY        =   15399
   SectionData     =   "arTaxFringRpt.dsx":08CA
End
Attribute VB_Name = "arTaxFringRpt"
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    ElseIf KeyCode = vbKeyE Then
      ...
      DoEvents
      MsgBox "File - TaxFringRpt.xls, created in the Citipak Directory.", vbOKOnly
    ElseIf KeyCode = vbKeyT Then
      Screen.MousePointer = vbHourglass
      ExportReport 2
      Screen.MousePointer = vbDefault
      DoEvents
      MsgBox "File - TaxFringRpt.txt, created in the Citipak Directory.", vbOKOnly
    End If
  End If
End Sub
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & "TaxFringRpt.xls"
        oEXL.Export Me.Pages
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & "TaxFringRpt.txt"
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","
...
Private Sub ActiveReport_DataInitialize()
  hFile = FreeFile
  Open StartPath & "\PRRPTS\TAXFRING.RPT" For Input As #hFile
  Fields.Add "Employer"
  Fields.Add "EmpNum"
...
Private Sub ActiveReport_FetchData(eof As Boolean)
  ...
  Fields("TaxFring").Value = arr(4)
  Fields("GPay").Value = arr(5)
End Sub

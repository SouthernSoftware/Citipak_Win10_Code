...
ProcessDraft:
  ...
  Label4.Visible = True
  cmdOK.Visible = True
  fptxtFileName.Text = "DD" + DraftDate$
  MainLog ("Create Draft File processed.")
  
  Exit Sub
  
OpenMainDraftInformation:
  ReDim PRDraftRec(1) As PRDraftRecType 'use DraftInfoFileName when building vb.net 7/5/06
...
DraftProcessStep3:
  ...
  For cnt& = 1 To NumOfRecs&
    ...
    If PPDFInfo(1).NetPay = 166.23 Then Stop
...
DraftProcessStep5:
  ...
  outfile = FreeFile
  Open "DD" + DraftDate$ For Output As outfile 'len = 255

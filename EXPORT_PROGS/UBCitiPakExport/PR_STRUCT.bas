...
Type PeriodDefaultRecType 'I don't have to do
    PACTIVE  As Integer
    PERBEG   As Integer
    PEREND   As Integer
    USEDEF   As String * 1
...
Type TaxRetLiabType  'I don't have to do
   Acct As String * 14
End Type

Type RegDSysFileRecType 'Done
    USEIMP   As String * 1
...
Type PRPPDraftInfoType  'I don't have to do
    EmpRec     As Long
    DraftDate  As Integer
    NetPay     As Double
End Type

Type PRDraftRecType  'I don't have to do
...
Type UBDraftPayRecType  'I don't have to do
    CustAcctNum   As Long
    DraftAmt      As Double
End Type

Type ErnCodeRecType 'Done
...
Type StateTaxRecType 'Dont have to do
'--- Single
    TAX101 As Double
    TAX102 As Double
    TAX103 As Double
...
Type FederalTaxRecType 'Don't Have to do
'--- single
    FTSEMPSS As Double
    FTSEMRSS As Double
    FTSSSMW  As Double
...
Type EmpData2Type         'new emp 2 rec 'Done
    EmpNo    As String * 10
    EmpSSN   As String * 11
...
Type TransWageDistType                      'Transaction Wage Distributions ' Done
...
Type TransEarnDistType                      'Additional Earnings ' Done
    EAcct       As String * 14              'Default Add'l Earings Distribution Account (G/L)
    EAmt        As Double                   'Default Add'l Earings Amount
End Type

Type EmpListArrayType
    EmpNoId     As String * 10
    EmpLast     As String * 50
    EmpFirst    As String * 50
End Type

''''''''''''''
Type TransRecType
    TActive         As Integer             '1     'Active Transaction Flag 'Done
...
Type ManualTransRecType 'Don't have to do
...
Type DetailRecType 'Don't have to do
  ID          As String * 1
  Batch       As String * 5
  PCN         As String * 5
...
Type TrailerRecType 'Don't have to do
  ID          As String * 1

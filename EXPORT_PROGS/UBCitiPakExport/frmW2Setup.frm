...
Begin VB.Form frm914W2Setup 
   ...
   Begin FPSpread.vaSpread vaSpreadW2 
      ...
      SpreadDesigner  =   "frmW2Setup.frx":08CA
      StartingColNumber=   2
      VisibleCols     =   4
      TextTip         =   2
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmW2Setup.frx":0F2F
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmW2Setup.frx":1143
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdClear2 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmW2Setup.frx":1357
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdClear3 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmW2Setup.frx":1541
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdClear4 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmW2Setup.frx":172E
   End
   ...
   End
End
Attribute VB_Name = "frm914W2Setup"
...
Private Sub cmdSave_Click()
  ...
  KillFile "PRDATA\W2RPNIDX.DAT" 'added 10/10/03
'  MsgBox "Your information has been saved. "
  ...
  MainLog ("First W2 extraction saved.")
End Sub
...
Private Sub LoadThisForm()
   ...
   For x = 1 To 52
      ...
      ElseIf x = 2 Then
        ...
        GoTo Zero
      Else
'        Get DedCodeFileHandle, x - 1, DedCodeFileRec
        Get DedCodeFileHandle, x - 2, DedCodeFileRec '12/13/04
        vaSpreadW2.Col = 1
        vaSpreadW2.Row = x
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      ...
      MainLog ("Payroll.exe terminated via menu bar on frm914W2Setup.")
      End
    End If
  End If
End Sub
...
Private Sub mnuPrnScn_Click()
  PrintForm
  MainLog ("First W2 extraction setup screen printed.")
End Sub

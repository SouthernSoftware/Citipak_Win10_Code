...
Begin VB.Form frmW2ViewPrint 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdAlignment 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmW2ViewPrint.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrnScn 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmW2ViewPrint.frx":0AA5
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmW2ViewPrint.frx":0C87
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmW2ViewPrint.frx":0E62
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmW2ViewPrint.frx":103D
   End
End
Attribute VB_Name = "frmW2ViewPrint"
...
'''  to strReportFile DefPrinter'[ADDITIVE] | PortName]
  ...
  For CopyLoop = 1 To Copies
    ...
    Do
      If frmW2Print.cmdCancel = False Then
...
PrintAlignMask:
    ...
    Else
      MsgBox "The mask file needed to process this form has not been saved."
      Close LPTA, RptA
      Exit Sub
    End If
    Do
...
Private Sub Form_Load()
  ...
  If doAlign = False Then
    cmdAlignment.Visible = False
  End If
'  doAlign = False
End Sub

...
Begin VB.Form frmPayrollProcessingMenu 
   ...
   Begin fpBtnAtlLibCtl.fpBtn ACHBankDraftProcCmmd 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPayrollProcessingMenu.frx":0AEF
   End
   Begin fpBtnAtlLibCtl.fpBtn PrintPayChecksCmmd 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPayrollProcessingMenu.frx":0D14
   End
   Begin fpBtnAtlLibCtl.fpBtn SetPayPeriodDefaultsCmmd 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPayrollProcessingMenu.frx":0F34
   End
   Begin fpBtnAtlLibCtl.fpBtn AccrueLeaveBeneCmmd 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPayrollProcessingMenu.frx":1157
   End
   Begin fpBtnAtlLibCtl.fpBtn EnterEditPayTrans 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPayrollProcessingMenu.frx":1378
   End
   Begin fpBtnAtlLibCtl.fpBtn PrintRegisterCmmd 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPayrollProcessingMenu.frx":15A3
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdVoid 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPayrollProcessingMenu.frx":17BD
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdManTranEnt 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPayrollProcessingMenu.frx":19E4
   End
   Begin fpBtnAtlLibCtl.fpBtn exitCmd 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPayrollProcessingMenu.frx":1C08
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdClear 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPayrollProcessingMenu.frx":1E30
   End

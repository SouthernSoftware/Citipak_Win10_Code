...
Begin VB.Form frmACHBankDraftMenu 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdDraftTransFile 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmACHBankDraftMenu.frx":0AEF
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrenoteFile 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmACHBankDraftMenu.frx":0D1A
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrintDraftEmpList 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmACHBankDraftMenu.frx":0F40
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmACHBankDraftMenu.frx":1168
   End

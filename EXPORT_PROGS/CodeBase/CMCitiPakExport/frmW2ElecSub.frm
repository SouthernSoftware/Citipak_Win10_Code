...
Begin VB.Form frmW2ElecSub 
   ...
   Begin TabproLib.vaTabPro vaTabPro1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin EditLib.fpText fptxtEmprAgtEIN 
            ...
            Left            =   6624
            TabIndex        =   30
            ToolTipText     =   $"frmW2ElecSub.frx":1924
            Top             =   1680
            Width           =   1356
            _Version        =   196608
            _ExtentX        =   2392
         ...
         Begin EditLib.fpText fptxtAgent4EIN 
            ...
            Left            =   7632
            TabIndex        =   29
            ToolTipText     =   $"frmW2ElecSub.frx":19B2
            Top             =   1152
            Width           =   1356
            _Version        =   196608
            _ExtentX        =   2392
         ...
         Begin EditLib.fpText fptxtOtherEIN 
            ...
            Left            =   2112
            TabIndex        =   31
            ToolTipText     =   $"frmW2ElecSub.frx":1A3D
            Top             =   2256
            Width           =   1356
            _Version        =   196608
            _ExtentX        =   2392
      ...
      Begin VB.Frame Frame1 
         ...
         Begin LpLib.fpCombo fpcmbSubState 
            ...
            EditAlignH      =   0
            EditAlignV      =   0
            ColDesigner     =   "frmW2ElecSub.frx":1AED
         End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmW2ElecSub.frx":2AD8
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmW2ElecSub.frx":2CC0
   End
...
'  If QPTrim$(fpcmbAgentCode.Text) = "" Then
'    MsgBox "Please enter an Agent Code selection."
'    Close
'    vaTabPro1.ActiveTab = 1
'    fpcmbAgentCode.SetFocus
'    Exit Sub
...
'  Dim Blank12$, Blank1$
'  Dim Blank56$, Blank23$
'  Dim Blank176$, Blank15$
'  Dim Blank30$, Blank158$
...
'  Print #RptHandle, W2RERec.EmprState; W2RERec.EmprZip; W2RERec.EmprZipX; Blank5; Blank23;
'
...
''  If QPTrim$(W2RWRec.EmpFName) = "ANDERSON" Then Stop
...
'  Print #RptHandle, W2RWRec.Defr457b; W2RWRec.Defr501c18D; Blank11; W2RWRec.NQPlan457; "00000000000"; W2RWRec.NQPNot457;
'
...
'
'  '                 Blank 22 Employer Life Ins Cost Income from NonSta Stock Opts      Blank 56
'  Print #RptHandle, Blank22; W2RWRec.LifeIns; W2RWRec.NonStaStcks; Blank56;
'
...
'  '                 Blank 15 Total NonQualified 457  Blank 15 Tot NQ Not 457
''  Print #RptHandle, Blank15; W2RTRec.NQPlan457; Blank15; W2RTRec.NQPNot457;
'  '8/25/04...the 2004 version of accuwage required a field with 15 zeros instead of the blank field
'  'that was what the 2003 version wanted...the zeros assume that there are no employer contributions
'  'to health savings plans
'  Print #RptHandle, Blank15; W2RTRec.NQPlan457; "000000000000000"; W2RTRec.NQPNot457;
'  '                 Blank 30 Total Life Ins   Total 3rd Sick Pay Total NonStatutory Stock Options
'  Print #RptHandle, Blank30; W2RTRec.GrpTerm; W2RTRec.ThrdTaxPay; W2RTRec.NonStatStk;
'  '
'  Print #RptHandle, Blank158
'
'
...
'  Print #RptHandle, W2RWRec.Defr457b; W2RWRec.Defr501c18D; Blank11; W2RWRec.NQPlan457; Blank11; W2RWRec.NQPNot457;
  ...
  '                 Blank 22 Employer Life Ins Cost Income from NonSta Stock Opts      Blank 56
'  Print #RptHandle, Blank11; W2RWRec.LifeIns; W2RWRec.NonStaStcks; Blank56;

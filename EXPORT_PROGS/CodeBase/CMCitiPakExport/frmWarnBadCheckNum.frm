...
Begin VB.Form frmWarnBadCheckNum 
   BorderStyle     =   0  'None
   Caption         =   "Form1"
   ClientHeight    =   3750
   ClientLeft      =   0
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      FrameThreeDWidth=   4
      FrameWidth      =   8
      Picture         =   "frmWarnBadCheckNum.frx":0000
      ...
      Begin fpBtnAtlLibCtl.fpBtn cmdOK 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmWarnBadCheckNum.frx":001C
      End
   ...
   End
End
Attribute VB_Name = "frmWarnBadCheckNum"
...
Private Sub cmdOK_Click()
  ...
  DoEvents
  MainLog ("Bad check warning activated.")
End Sub

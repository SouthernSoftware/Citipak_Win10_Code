...
Begin VB.Form frmW2Print 
   ...
   Begin LpLib.fpCombo fpcboPrinters 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmW2Print.frx":08CA
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmW2Print.frx":0D11
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdCancel 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmW2Print.frx":0F26
   End
...
Private Sub cmdPrint_Click()
  ...
  If fpcboPrinters.ListIndex <> -1 Then
    ...
    If InStr(1, DPName, "\\", vbTextCompare) Then
      frmW2ViewPrint.PrintWSet DPName, Copies
    Else
      frmW2ViewPrint.PrintWSet DefPrinter, Copies
    End If
  Else

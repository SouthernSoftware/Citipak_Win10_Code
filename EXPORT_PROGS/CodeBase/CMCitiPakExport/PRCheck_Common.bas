...
'*NEW 01-16-96  Added calc here for (Vac, Sick, Hol, and Comp pay)
       ...
       Select Case PayType$
         Case "S"
           For FreqCnt = 1 To 7
             If EmpRec2(1).EMPPFREQ = FreqPay$(FreqCnt) Then
               Exit For
             End If
           Next
           Select Case FreqCnt
...
LaserMidPrintNR: 'ar reports
      ...
      '                         27                  28                 29                                30                                     31
      Print #CPFNHandle, Check(1).CompUsed; dlm; CompPay#; dlm; ""; dlm; Check(1).CompUsed; dlm; Check(1).CompBal; dlm;

...
Begin VB.Form frmEmpQuickMaintMenu 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdDirectDeposit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintMenu.frx":0AE5
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPersonalData 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintMenu.frx":0D04
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdTaxWithholding 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintMenu.frx":0F1D
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdMiscDeductions 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintMenu.frx":1138
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdAltEarnings 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintMenu.frx":135C
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdWageDistribution 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintMenu.frx":157A
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdBenefitSchedule 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintMenu.frx":1797
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintMenu.frx":19B3
   End

...
Begin VB.Form frmReportsProcessing 
   ...
   Begin fpBtnAtlLibCtl.fpBtn TerminatedEmployeesCmmd 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReportsProcessing.frx":0AE1
   End
   Begin fpBtnAtlLibCtl.fpBtn PrintEmployeeDataFileCmmd 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReportsProcessing.frx":0D05
   End
   Begin fpBtnAtlLibCtl.fpBtn ActiveEmployeeListCmmd 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReportsProcessing.frx":0F29
   End
   Begin fpBtnAtlLibCtl.fpBtn EmployeeEarningsHistCmmd 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReportsProcessing.frx":1149
   End
   Begin fpBtnAtlLibCtl.fpBtn PayrollDeductionsTakenCmmd 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReportsProcessing.frx":1365
   End
   Begin fpBtnAtlLibCtl.fpBtn ESCReportCmmd 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReportsProcessing.frx":1589
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdReprint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReportsProcessing.frx":1799
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdEmergency 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReportsProcessing.frx":19B4
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPayRate 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReportsProcessing.frx":1BD3
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSupRetRpts 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReportsProcessing.frx":1DEF
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdAnnWrkrsComp 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReportsProcessing.frx":200F
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSEPPCon 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReportsProcessing.frx":222F
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReportsProcessing.frx":244D
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdRetireRpts 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReportsProcessing.frx":266A
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdChecksbyNum 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReportsProcessing.frx":2881
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdChecksIss 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReportsProcessing.frx":2A9D
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdYTDWageDis 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReportsProcessing.frx":2CB7
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdLeaveBen 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReportsProcessing.frx":2ED9
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdTaxFringe 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReportsProcessing.frx":30F3
   End

...
Begin VB.Form frmReprint 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRDFs.frx":0CEF
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRDFs.frx":0F05
   End
   Begin CalObjXLib.fpPoster fpPoster1 
      Height          =   6576
      Left            =   1404
      TabIndex        =   1
      TabStop         =   0   'False
      ...
      BackColor       =   13684944
      ScrollBars      =   0   'False
      Picture         =   "frmRDFs.frx":1121
      BorderGrayAreaColor=   -2147483637
      OverlayPicture  =   "frmRDFs.frx":113D
      OverlayColor    =   16711935
      PictureWash     =   0
      BorderInnerStyle=   2
      BorderInnerHighlightColor=   -2147483634
      BorderInnerShadowColor=   -2147483642
      BorderInnerWidth=   1
      BorderOuterStyle=   2
      BorderOuterHighlightColor=   -2147483628
      BorderOuterShadowColor=   -2147483635
      BorderOuterWidth=   1
      BorderFrameWidth=   3
      BorderOutlineColor=   -2147483642
      BorderFrameColor=   -2147483634
      BorderOutlineWidth=   2
      BorderOutlineStyle=   1
      PictureStyle    =   0
      OverlayPictureStyle=   0
      AlignPictureH   =   0
      AlignPictureV   =   0
      AlignOverlayPictureH=   0
      AlignOverlayPictureV=   0
      AutoSize        =   0
      AutoSizeOffsetLeft=   0
      AutoSizeOffsetRight=   0
      AutoSizeOffsetTop=   0
      AutoSizeOffsetBottom=   0
      MouseIcon       =   "frmRDFs.frx":1159

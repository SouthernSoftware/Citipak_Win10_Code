...
'    Print #RptHandle, B & CheckForBad(TransRec.TranType);
'    Print #RptHandle, B & QPTrim$(TransRec.BillType);
...
'    Print #RptHandle, B & CheckForBad(TransRec.Posted2GL);
...
''    If TaxCust.Acct = 3096 Then Stop
...
'    '----------------------------------------------------------------------
'    Print #RptHandle, B & QPTrim$(Using$(M, TransRec.PersVal));
'    Print #RptHandle, B & GetRealRec(TransRec.RealPin);
'    Print #RptHandle, B & GetPersRec(TransRec.PersPin);
'    Print #RptHandle, B & QPTrim$(Using$(M, TransRec.PPTRAVal));
...
'  For x = 1 To NumOfRRecs
'    Get RHandle, x, RealRec
'    If QPTrim(RealRec.RealPin) = QPTrim$(RealPin) Then
'      GetRealRec = x
'      Exit For
'    End If
'  Next x
...
'End Function
'
'Private Function GetPersRec(ByVal PersPin As String) As Integer
'  GetPersRec = 0
'  Dim PersRec As PersonalRecType
'  Dim PHandle As Integer
'  Dim NumOfPRecs As Long
'  PersPin = QPTrim$(PersPin)
'  If PersPin = "0" Then Exit Function
'  Dim x As Integer
'  OpenPersPropFile PHandle, NumOfPRecs
'  For x = 1 To NumOfPRecs
'    Get PHandle, x, PersRec
'    If QPTrim(PersRec.PropPin) = PersPin Then
'      GetPersRec = x
'      Exit For
'    End If
'  Next x

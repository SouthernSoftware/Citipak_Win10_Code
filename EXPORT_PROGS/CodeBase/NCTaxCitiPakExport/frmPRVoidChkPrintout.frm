...
Begin VB.Form frmPRVoidChkPrintout 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdAbort 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPRVoidChkPrintout.frx":0BE6
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdVoid 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPRVoidChkPrintout.frx":0DC8
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPRVoidChkPrintout.frx":0FA9
   End
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   $"frmPRVoidChkPrintout.frx":1185
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   12
         Charset         =   0
...
'  TransRec.BaseRate = TransRec.BaseRate
'  TransRec.CheckNum = TransRec.CheckNum
'  TransRec.CheckDate = TransRec.CheckDate
'  TransRec.FedGrossPay = TransRec.FedGrossPay
'  TransRec.NetPay = TransRec.NetPay
'  TransRec.EmpPin = 1855
'  Put THandle, GlobalTransNum, TransRec
  Close THandle

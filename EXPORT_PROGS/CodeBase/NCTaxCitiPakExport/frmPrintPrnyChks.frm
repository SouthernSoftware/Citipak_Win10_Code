...
Begin VB.Form frmPrint 
   ...
   ClientTop       =   315
   ClientWidth     =   6915
   Icon            =   "frmPrintPrnyChks.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   2430
   ...
   Begin LpLib.fpCombo fpcboPrinters 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrintPrnyChks.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdCancel 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPrintPrnyChks.frx":0C69
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPrintPrnyChks.frx":0E7F
   End
   Begin VB.Image Image1 
      Height          =   345
      Left            =   4320
      Picture         =   "frmPrintPrnyChks.frx":1094
      Top             =   1155
      Width           =   360
   End
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
  ...
  If HasFocus <> 0 And KeyCode = vbKeyReturn Then 'added 5/28/04
    If HasFocus = 1 Then
      Call cmdPrint_Click

...
Begin VB.Form frmMessageW3Opts 
   BackColor       =   &H000000C0&
   ...
   ClientTop       =   435
   ClientWidth     =   7005
   Icon            =   "frmMessageW3Opts.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmMessageW3Opts.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdCont 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmMessageW3Opts.frx":0AA5
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdOption 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmMessageW3Opts.frx":0C84
   End
   ...
   End
End
Attribute VB_Name = "frmMessageW3Opts"

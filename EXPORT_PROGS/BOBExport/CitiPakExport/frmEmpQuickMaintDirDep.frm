...
Begin VB.Form frmEmpQuickMaintDirDep 
   ...
   Begin FPSpread.vaSpread vaSpread 
      ...
      SpreadDesigner  =   "frmEmpQuickMaintDirDep.frx":0C6D
      VisibleCols     =   9
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintDirDep.frx":1C0CE
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdEscape 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintDirDep.frx":1C2E2
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExitNow 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintDirDep.frx":1C4F6
   End

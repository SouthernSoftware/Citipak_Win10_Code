   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CheckBox chkNCTaxBilling 
            ...
            Width           =   1695
         End
         Begin VB.CheckBox chkVATaxBilling 
            Caption         =   "VA Tax Billing"
            Height          =   495
            Left            =   3360
            TabIndex        =   15
            Top             =   1680
...
Private Sub chkVATaxBilling_Click()
  Call FillFilesToConvertList
End Sub
...
Private Sub cmdProcess_Click()
  ...
  If ErrorCode = 0 Then
    ...
    If chkVATaxBilling.Value = 1 Then
      chkVATaxBilling.ForeColor = vbBlue
      Call ProcessVATaxCust
      Call ProcessVATaxReal
      Call ProcessVATaxPers2
      Call ProcessMortCodes
      Call ProcessOptSearches
      Call ProcessTownships
      Call ProcessSystemSetup
      Call ProcessLaserItemized
      Call ProcessMessages
      Call ProcessLaserStandard
      Call ProcessLateLetter
      Call ProcessRateTables
      Call ProcessPenaltyTables
      Call ProcessRealGLPay
      Call ProcessPersGLPay
      Call ProcessRealGLBill
      Call ProcessPersGLBill
      Call ProcessTransHist
      Call ProcessVAOptRevRateTables
      Call ProcessVATaxReal
      Call ProcessVABalance
 ...
 Private Sub ProcessEmployeeData()
  ...
  For x = 1 To NumOfERecs
    ...
    Else
      Print #Rpt3Handle, B & 0;
    End If
    Print #Rpt3Handle, B & Using$("########", EmpRec.EmpPin);

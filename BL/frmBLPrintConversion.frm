...
Begin VB.Form frmBLPrintConversion 
   ...
   Begin LpLib.fpCombo fpcboPrinters 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmBLPrintConversion.frx":0000
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBLPrintConversion.frx":03D7
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdCancel 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBLPrintConversion.frx":05B4
   End
   ...
   Begin VB.Image Image1 
      Height          =   276
      Left            =   4617
      Picture         =   "frmBLPrintConversion.frx":0790
      Top             =   1116
      Width           =   288
   End
End
Attribute VB_Name = "frmBLPrintConversion"
...
Private Sub cmdPrint_Click()
  ...
  If fpcboPrinters.ListIndex <> -1 Then
    ...
    If InStr(1, DPName, "\\", vbTextCompare) Then
      frmBLViewPrintConv.PrintWSet DPName, Copies
    Else
      frmBLViewPrintConv.PrintWSet DefPrinter, Copies
    End If
  Else

VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arBLCatListRpt 
   ...
   _ExtentX        =   20558
   _ExtentY        =   15637
   SectionData     =   "arBLCatListRpt.dsx":08CA
End
Attribute VB_Name = "arBLCatListRpt"
...
Private Sub ActiveReport_DataInitialize()
  Dim x As Integer
  hFile = FreeFile
  Open StartPath & "\BLRPTS\ARCODLST.RPT" For Input As #hFile
  Fields.Add ("fldTown") '0)
  Fields.Add ("fldCatCode") '1)
  Fields.Add ("fldCodeDesc") '2)
  Fields.Add ("fldRevNum") '3)
...
Private Sub ActiveReport_FetchData(eof As Boolean)
  ...
  Fields("fldCodeDesc").Value = arr(2)
  Fields("fldRevNum").Value = arr(3)

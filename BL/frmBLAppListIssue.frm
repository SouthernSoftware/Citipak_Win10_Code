...
Begin VB.Form frmBLAppListIssue 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   315
   ClientWidth     =   11655
   Icon            =   "frmBLAppListIssue.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8865
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      FrameThreeDStyle=   1
      FrameWidth      =   2
      Picture         =   "frmBLAppListIssue.frx":08CA
      Begin LpLib.fpCombo fpcmbPrintOpt 
         Height          =   405
         Left            =   2925
         TabIndex        =   3
         Tag             =   $"frmBLAppListIssue.frx":08E6
         Top             =   3165
         Width           =   3570
         _Version        =   196608
         _ExtentX        =   6297
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmBLAppListIssue.frx":099F
      End
      Begin LpLib.fpCombo fpcmbPrintOrder 
         Height          =   405
         Left            =   2925
         TabIndex        =   0
         Tag             =   $"frmBLAppListIssue.frx":0C96
         Top             =   1830
         Width           =   3570
         _Version        =   196608
         _ExtentX        =   6297
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmBLAppListIssue.frx":0D30
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdExit 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmBLAppListIssue.frx":1027
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
         ...
         TabIndex        =   5
         TabStop         =   0   'False
         Tag             =   $"frmBLAppListIssue.frx":1205
         Top             =   4365
         Width           =   1890
         _Version        =   131072
         _ExtentX        =   3334
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmBLAppListIssue.frx":12B0
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdCodeList 
         ...
         TabIndex        =   2
         TabStop         =   0   'False
         Tag             =   $"frmBLAppListIssue.frx":148F
         Top             =   2490
         Width           =   1890
         _Version        =   131072
         _ExtentX        =   3334
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmBLAppListIssue.frx":1548
      End
      Begin EditLib.fpText fptxtCatCode 
         Height          =   390
         Left            =   2685
         TabIndex        =   1
         Tag             =   $"frmBLAppListIssue.frx":172C
         Top             =   2490
         Width           =   1830
         _Version        =   196608
         _ExtentX        =   3238
      ...
      Begin fpBtnAtlLibCtl.fpBtn fpcmdHelp 
         ...
         TabIndex        =   11
         TabStop         =   0   'False
         Tag             =   $"frmBLAppListIssue.frx":1842
         Top             =   4365
         Width           =   2175
         _Version        =   131072
         _ExtentX        =   3836
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmBLAppListIssue.frx":1912
      End
   ...
   End
End
Attribute VB_Name = "frmBLAppListIssue"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      ClearInUse PWcnt
      MainLog ("BusinessLicense.exe terminated via menu bar on frmBLAppListIssue.")
      Call Terminate
      End
    End If
  End If
...
'  cmdProcess.ToolTipText = "Press to activate this report."
  One = 1
  DHandle = FreeFile
  Open "custappIssue.dat" For Output As DHandle Len = 2
  Print #DHandle, One
  Close DHandle
...
'    OpenSrchNameIdxFile IdxHandle
    ...
    If (CustRec.Deleted <> "Y") And QPTrim$(CustRec.SortName) <> "DELETED" Then
      If TCat$ = RTrim$(CustRec.BILLCAT1) Or TCat$ = RTrim$(CustRec.BILLCAT2) Or TCat$ = RTrim$(CustRec.BILLCAT3) Or TCat$ = RTrim$(CustRec.BILLCAT4) Or TCat$ = RTrim$(CustRec.BILLCAT5) Or TCat$ = "ALL" Then
        If LineCnt >= MaxLines Then
          ...
          GoSub PrintAppListHeader
        End If
        Print #RptHandle, "Cust #"; IdxRecs(cnt); Tab(15); "Bus. Name: "; CustRec.CustName
        Print #RptHandle, "         Applicant Name: "; CustRec.BillName
        Print #RptHandle, "                Address: ";
        Print #RptHandle, Tab(26); RTrim$(CustRec.ADDRESS1)
        Print #RptHandle, Tab(26); RTrim$(CustRec.ADDRESS2)
        Print #RptHandle, Tab(26); RTrim$(CustRec.City); ", "; CustRec.State; " "; CustRec.ZipCode
  ...
  If CustCnt = 0 Then
    ...
    frmBLMessageBoxJr.Show vbModal
  Else
    ViewPrint ReportFile, "Application Listing", True
  End If
  
  KillFile ReportFile$

  MainLog ("Business license customer application listing processed in text format.")
  Exit Sub
...
ERRORSTUFF:
   Unload frmBLShowPctComp
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmBLAppListIssue", "PrintText", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
'    OpenSrchNameIdxFile IdxHandle
  ...
  For cnt = 1 To NumOfCustIdxRecs 'NumOfCustRecs
    Get CustHandle, IdxRecs(cnt), CustRec
    If QPTrim$(CustRec.Inactive) = "Y" Then GoTo SkipIt
    If (CustRec.Deleted <> "Y") And QPTrim$(CustRec.SortName) <> "DELETED" Then
      If TCat$ = RTrim$(CustRec.BILLCAT1) Or TCat$ = RTrim$(CustRec.BILLCAT2) Or TCat$ = RTrim$(CustRec.BILLCAT3) Or TCat$ = RTrim$(CustRec.BILLCAT4) Or TCat$ = RTrim$(CustRec.BILLCAT5) Or TCat$ = "ALL" Then
        '                       0                         1
...
SkipIt:
  ...
  MainLog ("Business license customer application listing processed in graphic format.")
  Exit Sub
  
ERRORSTUFF:
   Unload frmBLShowPctComp
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmBLAppListIssue", "PrintGraphics", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

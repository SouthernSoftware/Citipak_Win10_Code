VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arBLSubTypCntLP 
   ...
   _ExtentX        =   9631
   _ExtentY        =   7726
   SectionData     =   "arBLSubTypCntLP.dsx":0000
End
Attribute VB_Name = "arBLSubTypCntLP"
...
Private Sub ActiveReport_DataInitialize()
  Dim x As Integer
  hFile = FreeFile
  Open StartPath & "\BLRPTS\ARTYSBLP.RPT" For Input As #hFile
  Fields.Add ("fld0") '0)
  Fields.Add ("fld1") '1)
  Fields.Add ("fld2") '2)
  Fields.Add ("fld3") '3)

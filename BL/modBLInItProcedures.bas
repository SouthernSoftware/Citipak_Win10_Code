Attribute VB_Name = "modBLInItProcedures"
Option Explicit
    ...
    If Len(Dir$("Citipass.dat")) Then
      ...
      If Not CitiPassFile = -1 Then
        ...
        If Not CitiPass.DelFlag Then
            If CitiPass.Module(1).FullAccess = True Then
               LevelPass = 1
            ElseIf CitiPass.Module(1).PaymentAccess = True Then 'added 12/17/2009
               LevelPass = 3
            ElseIf CitiPass.Module(1).ReportsOnly = True Then
               LevelPass = 2
            End If
...
'LevelPass = 1
'    If LevelPass > 0 Then
      Call MainLog("In Business License, with Level " & LevelPass)
      DoEvents
      FromBL = False
      Load frmBLMainMenu
      frmBLMainMenu.Show

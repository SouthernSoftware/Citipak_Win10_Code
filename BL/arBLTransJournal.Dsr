VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arBLTransJournal 
   ...
   ClientWidth     =   11655
   ControlBox      =   0   'False
   Icon            =   "arBLTransJournal.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   20558
   _ExtentY        =   15637
   SectionData     =   "arBLTransJournal.dsx":08CA
End
Attribute VB_Name = "arBLTransJournal"
...
Private Sub ActiveReport_DataInitialize()
  Dim x As Integer
  hFile = FreeFile
  Open StartPath & "\BLRPTS\ARTRANS.RPT" For Input As #hFile
...
'  If Fields("fldTrType").Value <> "110" Then Label28.Visible = False

...
Begin VB.Form frmBLTransEntry 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBLTransEntry.frx":1A37
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBLTransEntry.frx":1EB0
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdDelete 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBLTransEntry.frx":2565
   End
   Begin EditLib.fpCurrency fpcurrLicBal 
      Height          =   324
      Index           =   1
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdClear 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBLTransEntry.frx":3265
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdReset 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBLTransEntry.frx":358D
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdHelp 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBLTransEntry.frx":38A1
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdCash 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBLTransEntry.frx":3B90
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdCheck 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBLTransEntry.frx":3E7B
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdCharge 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBLTransEntry.frx":416A
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdInfo 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBLTransEntry.frx":4347
   End
   Begin VB.Line Line5 
  ...
  If GCustNum > 0 And GCustNum <= NumOfCustRecs Then
    If Exist("artmppen.dat") Then
      If EmpInPenProcess(CStr(GCustNum)) = True Then
        ...
        frmBLMessageBoxJr.Label1.Top = 800
        frmBLMessageBoxJr.Show vbModal
        MainLog ("User alerted that " + QPTrim$(CustRec.CustName) + " will is included in an unposted penalty file.")
      End If
    End If
...
Private Sub PrintReceipt(RctNum As Integer)
  ...
  On Error GoTo ERRORSTUFF
  Oper$ = CStr(OPERNUM)
  PayRecpName2$ = StartPath$ + "BLVLD" + Oper$ + ".Rpt"
  ...
  Print #RctHandle, QPTrim$(PayRec.City) + ", " + QPTrim$(PayRec.State) + "  " + QPTrim$(PayRec.ZipCode)
  Print #RctHandle, ""
  Print #RctHandle, QPTrim$(PayRec.DESC)
  Print #RctHandle, ""
  Print #RctHandle, "Total Owed: "; Using("$#,###,0.00", PayRec.TOTDUE)
  Print #RctHandle, ""
  If PayRec.CASHAMT > 0 Then
  ...
  Print #RctHandle, ""
  If PayRec.LICPAID1 <> 0 Then
    Print #RctHandle, QPTrim$(PayRec.CatDesc1); " " + Using("$#####.##", PayRec.LICPAID1)
  End If
  If PayRec.LICPAID2 <> 0 Then
    Print #RctHandle, QPTrim$(PayRec.CatDesc2); " " + Using("$#####.##", PayRec.LICPAID2)
  End If
  If PayRec.LICPAID3 <> 0 Then
    Print #RctHandle, QPTrim$(PayRec.CatDesc3); " " + Using("$#####.##", PayRec.LICPAID3)
  End If
  If PayRec.LICPAID4 <> 0 Then
    Print #RctHandle, QPTrim$(PayRec.CatDesc4); " " + Using("$#####.##", PayRec.LICPAID4)
  End If
  If PayRec.LICPAID5 <> 0 Then
    Print #RctHandle, QPTrim$(PayRec.CatDesc5); " " + Using("$#####.##", PayRec.LICPAID5)
  End If
  If PayRec.ISSPAID <> 0 Then
    Print #RctHandle, "ISSUANCE FEE"; " " + Using("$#####.##", PayRec.ISSPAID)
  End If
  If PayRec.PENPAID <> 0 Then
    Print #RctHandle, "PENALTY FEE"; " " + Using("$#####.##", PayRec.PENPAID)
  End If
  Print #RctHandle, ""
  Print #RctHandle, "Operator Number: " + CStr(OPERNUM)
  Print #RctHandle, ""
  Print #RctHandle, "Set Renewal Flag?" + " " + QPTrim$(fpcmbSetFlag.Text)
  Print #RctHandle, ""
...
69:
  PostDate = MakeRegDate(PayRec.TranDate)
  If QPTrim(PayRec.CASHCHK) = "Check" Or QPTrim(PayRec.CASHCHK) = "Cash & Check" Then
   If RctValidate Then
     RHandle2 = FreeFile
     ...
     Print #RHandle2, "Acct. No. "; PayRec.CustNumber
     ...
     Close LPTHandle
    Printer.EndDoc
    MainLog "Oper: " + Oper$ + " Print Validation Acct:" + Str(PayRec.CustNumber)
  End If
 End If

70:
  MainLog "Oper: " + Oper$ + " Print receipt Acct:" + Str(PayRec.CustNumber)
80:

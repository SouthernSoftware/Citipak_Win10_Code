VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arBLApp8 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Business License Application Renewal Form #8"
   ClientHeight    =   8730
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   11640
   ControlBox      =   0   'False
   Icon            =   "arBLApp8.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   20532
   _ExtentY        =   15399
   SectionData     =   "arBLApp8.dsx":08CA
End
Attribute VB_Name = "arBLApp8"
...
Private Sub ActiveReport_DataInitialize()
  Dim x As Integer
  hFile = FreeFile
  Open StartPath & "\BLRPTS\ARAPP8.RPT" For Input As #hFile
  Fields.Add ("fld0") '0)
  Fields.Add ("fld1") '1)
  Fields.Add ("fld2") '2)
  Fields.Add ("fld3") '3)
...
Private Sub ActiveReport_FetchData(eof As Boolean)
  ...
  Set sec = arBLApp8.Sections("Detail")
...
'    Line6.Visible = False
  ...
  If Len(QPTrim(arr(51))) = 0 And Len(QPTrim$(arr(79))) = 0 And Len(QPTrim$(arr(81))) = 0 Then
...
'    Line15.Visible = False
  ...
  If Len(QPTrim(arr(51))) > 0 Then 'step2
'    Line13.Visible = False
    Line14.Visible = False
'    Line15.Visible = False
    Line22.Visible = False
  ...
  If Len(QPTrim$(arr(79))) > 0 Then 'flat2
    Line10.Visible = False
    Line11.Visible = False
'    Line12.Visible = False
    Line14.Visible = False
'    Line15.Visible = False
  ...
  If Len(QPTrim$(arr(81))) > 0 Then 'multi2
    Line10.Visible = False
    Line11.Visible = False
'    Line12.Visible = False
'    Line13.Visible = False
  ...
  If Len(QPTrim(arr(88))) = 0 And Len(QPTrim(arr(116))) = 0 And Len(QPTrim(arr(118))) = 0 Then
...
'    Line23.Visible = False
  ...
  If Len(QPTrim(arr(88))) > 0 Then 'step3
'    Line19.Visible = False
    Line20.Visible = False
    Line21.Visible = False
'    Line23.Visible = False
  ...
  If Len(QPTrim(arr(116))) > 0 Then 'flat3
'    Line16.Visible = False
    Line17.Visible = False
    Line18.Visible = False
    Line20.Visible = False
...
'    Line23.Visible = False
  ...
  If Len(QPTrim(arr(118))) > 0 Then 'multi4
    Line17.Visible = False
    Line18.Visible = False
  End If
  
  If Len(QPTrim(arr(125))) = 0 And Len(QPTrim(arr(153))) = 0 And Len(QPTrim(arr(155))) = 0 Then
...
'    Line30.Visible = False
  ...
  If Len(QPTrim(arr(125))) > 0 Then 'step4
'    Line27.Visible = False
    Line28.Visible = False
    Line29.Visible = False
'    Line30.Visible = False
  ...
  If Len(QPTrim(arr(153))) > 0 Then 'flat4
'    Line24.Visible = False
    Line25.Visible = False
    Line26.Visible = False
    Line28.Visible = False
...
'    Line30.Visible = False
  ...
  If Len(QPTrim(arr(155))) > 0 Then 'multi4
'    Line24.Visible = False
    Line25.Visible = False
    Line26.Visible = False
'    Line27.Visible = False
  ...
  If Len(QPTrim(arr(162))) = 0 And Len(QPTrim(arr(190))) = 0 And Len(QPTrim(arr(192))) = 0 Then
...
'    Line38.Visible = False
  ...
  If Len(QPTrim(arr(162))) > 0 Then 'step5
'    Line35.Visible = False
    Line36.Visible = False
    Line37.Visible = False
'    Line38.Visible = False
  ...
  If Len(QPTrim(arr(190))) > 0 Then 'flat5
'    Line32.Visible = False
    Line33.Visible = False
    Line34.Visible = False
    Line36.Visible = False
...
'    Line38.Visible = False
  ...
  If Len(QPTrim(arr(192))) > 0 Then 'multi5
'    Line32.Visible = False
    Line33.Visible = False
    Line34.Visible = False
'    Line35.Visible = False
...
'  Next Y
'
'  If Len(QPTrim$(Fields("fld14").Value)) > 0 Then
'    For Y = 0 To 48
'      sec.Controls(Y).Visible = True
'    Next Y
'    For Y = 48 To 53

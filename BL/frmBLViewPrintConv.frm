...
Begin VB.Form frmBLViewPrintConv 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Business License ViewPrint"
   ClientHeight    =   8424
   ClientLeft      =   36
   ClientTop       =   312
   ClientWidth     =   10476
   Icon            =   "frmBLViewPrintConv.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdAlignment 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBLViewPrintConv.frx":08CA
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdPrnScn 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBLViewPrintConv.frx":0AA6
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBLViewPrintConv.frx":0C89
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBLViewPrintConv.frx":0E65
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBLViewPrintConv.frx":1041
   End
End
Attribute VB_Name = "frmBLViewPrintConv"
...
Private Sub cmdAlignment_Click()
  frmBLPrintConversion.Show 1
End Sub

Private Sub cmdExit_Click()
  Unload frmBLViewPrintConv
  DoEvents
End Sub
...
'''  to strReportFile DefPrinter'[ADDITIVE] | PortName]
  ...
  For CopyLoop = 1 To Copies
    ...
    Do
      If frmBLPrintConversion.cmdCancel = False Then

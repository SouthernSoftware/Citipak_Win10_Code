...
Begin VB.Form frmBLCustomerList 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdHelp 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBLCustomerList.frx":0E38
   End
   Begin VB.Label Label2 
      Alignment       =   2  'Center
      BackColor       =   &H00C0FFFF&
      Caption         =   $"frmBLCustomerList.frx":1053
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   10.5
         Charset         =   0
...
Private Sub LoadMe()
  ...
  If Not Exist("arcustnameidx.dat") Then 'no file there
    frmBLMessageBoxJr.Label1.Caption = "No Billing Name Index has been saved."
  ...
  For x = 1 To CustIdxRecNum
    ...
    If Len(QPTrim(CustRec.BillName)) = 0 Or QPTrim(CustRec.SortName) = "DELETED" Or CustRec.Deleted = "Y" Then GoTo BadCode
...
NotAMatch:
  ...
  If Found = True Then
    ...
    ElseIf Exist("transentry.dat") Then
      KillFile "custlistopen.dat"
      Unload frmBLCustomerList
      Call frmBLTransEntry.EnterEditChk
      Exit Sub
    End If

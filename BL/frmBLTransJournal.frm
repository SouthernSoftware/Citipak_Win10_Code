...
Begin VB.Form frmBLTransJournal 
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      Begin LpLib.fpCombo fpcmbCategory 
         ...
         Left            =   2928
         TabIndex        =   0
         Tag             =   $"frmBLTransJournal.frx":0C96
         Top             =   1836
         Width           =   3564
         _Version        =   196608
         _ExtentX        =   6286
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmBLTransJournal.frx":0FD5
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdExit 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmBLTransJournal.frx":12CC
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
         ...
         TabIndex        =   6
         TabStop         =   0   'False
         Tag             =   $"frmBLTransJournal.frx":14AA
         Top             =   4896
         Width           =   1884
         _Version        =   131072
         _ExtentX        =   3323
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmBLTransJournal.frx":1555
      End
      ...
      Begin fpBtnAtlLibCtl.fpBtn cmdHelp 
         ...
         TabIndex        =   12
         TabStop         =   0   'False
         Tag             =   $"frmBLTransJournal.frx":1734
         Top             =   4896
         Width           =   2040
         _Version        =   131072
         _ExtentX        =   3598
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmBLTransJournal.frx":1804
      End
...
'  cmdProcess.ToolTipText = "Press to activate the reporting process."
  ...
  fpcmbCategory.Text = "Total Class Analysis"
  fpcmbCategory.AddItem "Total Class Analysis"
...
Private Sub cmdProcess_Click()
  ...
  If fpcmbCategory.Text = "Total Class Analysis" Then
    Call ClassAnalysis
    Exit Sub
  End If
...
Private Sub PrintText()
  ...
  For cnt = CountNum To 1 Step -1
    ...
    Print #RptHandle, Tab(13); Left$(CustRec.BillName, 25);
...
PrintRptHeader2:
  ...
  End If
  If LicAndPenFlag = False Then
    Print #RptHandle, "  Date"; Tab(13); "Billing Name"; Tab(50); "Description"; Tab(75); "Amount"
    Print #RptHandle, String$(80, "=")
  Else
    Print #RptHandle, "  Date"; Tab(13); "Billing Name"; Tab(40); "Desc"; Tab(54); "Pen Total"; Tab(66); "Iss Total"; Tab(79); "Lic Total"; Tab(95); "Total"
...
Private Sub ClassAnalysis()
  ...
  Dim SmallNum$
  Dim Nextx As Double
  Dim x As Integer, y As Double, z As Integer
  Dim dlm$
  Dim TownName$
  Dim TownRec As TownSetUpType
  Dim TownHandle As Integer
  ...
  Dim TypeCnt As Integer
  Dim GTypeTot As Double
  Dim ChrgTot As Double
  Dim PayTot As Double
  Dim PenTot As Double
  Dim AdjPayDnTot As Double
  Dim AdjBillDnTot As Double
  Dim AdjBillUpTot As Double
  Dim CustRec As ARCustRecType
  Dim CHandle As Integer
  Dim MaxLines As Integer
  Dim LineCnt As Integer
  Dim Page As Integer
  Dim HeadLen1 As Integer
  Dim ThisCode$, ThatCode$
  Dim ThisCodeNum$, ThatCodeNum$
  Dim FF$, LicChrgTot As Double
  Dim NoLicTot As Double
'  On Error GoTo ERRORSTUFF
...
'  Close COHandle
  ...
  ReDim CatTot(1 To NumOfARCatRecs + 3) As Double 'added +1 = Iss Chrg; +2 = Iss Pay; +3 = Pen Pay
  ReDim CatTotByTransType(1 To NumOfARCatRecs, 1 To 6) As Double
  ...
  If TransCnt = 0 Then
    Close
    frmBLMessageBoxJr.Label1.Caption = "There are no transactions on file."
    frmBLMessageBoxJr.Label1.Top = 900
    frmBLMessageBoxJr.Show vbModal
    Exit Sub
  End If
...
'    Get CHandle, TransRec.CustomerNumber, CustRec
'    If CustRec.Deleted = "Y" Then GoTo SkipMe
    If TransRec.TransDate < BegDateNum Or TransRec.TransDate > EndDateNum Then
      GoTo SkipMe
    End If
    Get CHandle, TransRec.CustomerNumber, CustRec '3/25/08 moved this from above last if
    If CustRec.Deleted = "Y" Then GoTo SkipMe '3/25/08 moved this from above last if
    
'    If TransRec.IssAmt > 0 Then Stop
  
    For x = 1 To NumOfARCatRecs
      If x = TransRec.CatCodeRec1 Then
        If TransRec.CatCodeRec1 > 0 Then
          CatTot(x) = OldRound(CatTot(x) + TransRec.CatLicAmt1)
        End If
      End If
      If x = TransRec.CatCodeRec2 Then
        If TransRec.CatCodeRec2 > 0 Then
          CatTot(x) = OldRound(CatTot(x) + TransRec.CatLicAmt2)
        End If
      End If
      If x = TransRec.CatCodeRec3 Then
        If TransRec.CatCodeRec3 > 0 Then
          CatTot(x) = OldRound(CatTot(x) + TransRec.CatLicAmt3)
        End If
      End If
      If x = TransRec.CatCodeRec4 Then
        If TransRec.CatCodeRec4 > 0 Then
          CatTot(x) = OldRound(CatTot(x) + TransRec.CatLicAmt4)
        End If
      End If
      If x = TransRec.CatCodeRec5 Then
        If TransRec.CatCodeRec5 > 0 Then
          CatTot(x) = OldRound(CatTot(x) + TransRec.CatLicAmt5)
        End If
      End If
    Next x
   
'   If TransRec.IssAmt > 0 And TransRec.TransType = 2 Then Stop
   Select Case TransRec.TransType
      Case 1:
        ChrgTot = OldRound(ChrgTot + TransRec.TransAmount)
        If TransRec.CatCodeRec1 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec1, 1) = OldRound(CatTotByTransType(TransRec.CatCodeRec1, 1) + TransRec.CatLicAmt1)
          LicChrgTot = OldRound(LicChrgTot + TransRec.CatLicAmt1)
        End If
        If TransRec.CatCodeRec2 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec2, 1) = OldRound(CatTotByTransType(TransRec.CatCodeRec2, 1) + TransRec.CatLicAmt2)
          LicChrgTot = OldRound(LicChrgTot + TransRec.CatLicAmt2)
        End If
        If TransRec.CatCodeRec3 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec3, 1) = OldRound(CatTotByTransType(TransRec.CatCodeRec3, 1) + TransRec.CatLicAmt3)
          LicChrgTot = OldRound(LicChrgTot + TransRec.CatLicAmt3)
        End If
        If TransRec.CatCodeRec4 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec4, 1) = OldRound(CatTotByTransType(TransRec.CatCodeRec4, 1) + TransRec.CatLicAmt4)
          LicChrgTot = OldRound(LicChrgTot + TransRec.CatLicAmt4)
        End If
        If TransRec.CatCodeRec5 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec5, 1) = OldRound(CatTotByTransType(TransRec.CatCodeRec5, 1) + TransRec.CatLicAmt5)
          LicChrgTot = OldRound(LicChrgTot + TransRec.CatLicAmt5)
        End If
        If TransRec.IssAmt > 0 Then
          CatTot(NumOfARCatRecs + 1) = OldRound(CatTot(NumOfARCatRecs + 1) + TransRec.IssAmt)
        End If
      Case 2:
        PayTot = OldRound(PayTot + TransRec.TransAmount)
        If TransRec.CatCodeRec1 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec1, 2) = OldRound(CatTotByTransType(TransRec.CatCodeRec1, 2) + TransRec.CatLicAmt1)
        End If
        If TransRec.CatCodeRec2 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec2, 2) = OldRound(CatTotByTransType(TransRec.CatCodeRec2, 2) + TransRec.CatLicAmt2)
        End If
        If TransRec.CatCodeRec3 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec3, 2) = OldRound(CatTotByTransType(TransRec.CatCodeRec3, 2) + TransRec.CatLicAmt3)
        End If
        If TransRec.CatCodeRec4 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec4, 2) = OldRound(CatTotByTransType(TransRec.CatCodeRec4, 2) + TransRec.CatLicAmt4)
        End If
        If TransRec.CatCodeRec5 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec5, 2) = OldRound(CatTotByTransType(TransRec.CatCodeRec5, 2) + TransRec.CatLicAmt5)
        End If
        If TransRec.IssAmt > 0 Then
          CatTot(NumOfARCatRecs + 2) = OldRound(CatTot(NumOfARCatRecs + 2) + TransRec.IssAmt)
        End If
        If TransRec.PenAmt > 0 Then
          CatTot(NumOfARCatRecs + 3) = OldRound(CatTot(NumOfARCatRecs + 3) + TransRec.PenAmt)
        End If
      Case 6:
        PenTot = OldRound(PenTot + TransRec.TransAmount)
        If TransRec.CatCodeRec1 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec1, 3) = OldRound(CatTotByTransType(TransRec.CatCodeRec1, 3) + TransRec.CatLicAmt1)
        End If
        If TransRec.CatCodeRec2 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec2, 3) = OldRound(CatTotByTransType(TransRec.CatCodeRec2, 3) + TransRec.CatLicAmt2)
        End If
        If TransRec.CatCodeRec3 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec3, 3) = OldRound(CatTotByTransType(TransRec.CatCodeRec3, 3) + TransRec.CatLicAmt3)
        End If
        If TransRec.CatCodeRec4 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec4, 3) = OldRound(CatTotByTransType(TransRec.CatCodeRec4, 3) + TransRec.CatLicAmt4)
        End If
        If TransRec.CatCodeRec5 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec5, 3) = OldRound(CatTotByTransType(TransRec.CatCodeRec5, 3) + TransRec.CatLicAmt5)
        End If
      Case 13:
        AdjPayDnTot = OldRound(AdjPayDnTot + TransRec.TransAmount)
        If TransRec.CatCodeRec1 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec1, 4) = OldRound(CatTotByTransType(TransRec.CatCodeRec1, 4) + TransRec.CatLicAmt1)
        End If
        If TransRec.CatCodeRec2 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec2, 4) = OldRound(CatTotByTransType(TransRec.CatCodeRec2, 4) + TransRec.CatLicAmt2)
        End If
        If TransRec.CatCodeRec3 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec3, 4) = OldRound(CatTotByTransType(TransRec.CatCodeRec3, 4) + TransRec.CatLicAmt3)
        End If
        If TransRec.CatCodeRec4 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec4, 4) = OldRound(CatTotByTransType(TransRec.CatCodeRec4, 4) + TransRec.CatLicAmt4)
        End If
        If TransRec.CatCodeRec5 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec5, 4) = OldRound(CatTotByTransType(TransRec.CatCodeRec5, 4) + TransRec.CatLicAmt5)
        End If
        If TransRec.IssAmt > 0 Then
          CatTot(NumOfARCatRecs + 2) = OldRound(CatTot(NumOfARCatRecs + 2) - TransRec.IssAmt)
        End If
        ...
        End If
      Case 23:
        AdjBillDnTot = OldRound(AdjBillDnTot + TransRec.TransAmount)
        If TransRec.CatCodeRec1 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec1, 5) = OldRound(CatTotByTransType(TransRec.CatCodeRec1, 5) + TransRec.CatLicAmt1)
          LicChrgTot = OldRound(LicChrgTot - TransRec.CatLicAmt1)
        End If
        If TransRec.CatCodeRec2 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec2, 5) = OldRound(CatTotByTransType(TransRec.CatCodeRec2, 5) + TransRec.CatLicAmt2)
          LicChrgTot = OldRound(LicChrgTot - TransRec.CatLicAmt2)
        End If
        If TransRec.CatCodeRec3 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec3, 5) = OldRound(CatTotByTransType(TransRec.CatCodeRec3, 5) + TransRec.CatLicAmt3)
          LicChrgTot = OldRound(LicChrgTot - TransRec.CatLicAmt3)
        End If
        If TransRec.CatCodeRec4 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec4, 5) = OldRound(CatTotByTransType(TransRec.CatCodeRec4, 5) + TransRec.CatLicAmt4)
          LicChrgTot = OldRound(LicChrgTot - TransRec.CatLicAmt4)
        End If
        If TransRec.CatCodeRec5 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec5, 5) = OldRound(CatTotByTransType(TransRec.CatCodeRec5, 5) + TransRec.CatLicAmt5)
          LicChrgTot = OldRound(LicChrgTot - TransRec.CatLicAmt5)
        End If
        If TransRec.IssAmt > 0 Then
          CatTot(NumOfARCatRecs + 1) = OldRound(CatTot(NumOfARCatRecs + 1) - TransRec.IssAmt)
        ...
        End If
      Case 24:
        AdjBillUpTot = OldRound(AdjBillUpTot + TransRec.TransAmount)
        If TransRec.CatCodeRec1 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec1, 6) = OldRound(CatTotByTransType(TransRec.CatCodeRec1, 6) + TransRec.CatLicAmt1)
          LicChrgTot = OldRound(LicChrgTot + TransRec.CatLicAmt1)
        End If
        If TransRec.CatCodeRec2 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec2, 6) = OldRound(CatTotByTransType(TransRec.CatCodeRec2, 6) + TransRec.CatLicAmt2)
          LicChrgTot = OldRound(LicChrgTot + TransRec.CatLicAmt2)
        End If
        If TransRec.CatCodeRec3 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec3, 6) = OldRound(CatTotByTransType(TransRec.CatCodeRec3, 6) + TransRec.CatLicAmt3)
          LicChrgTot = OldRound(LicChrgTot + TransRec.CatLicAmt3)
        End If
        If TransRec.CatCodeRec4 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec4, 6) = OldRound(CatTotByTransType(TransRec.CatCodeRec4, 6) + TransRec.CatLicAmt4)
          LicChrgTot = OldRound(LicChrgTot + TransRec.CatLicAmt4)
        End If
        If TransRec.CatCodeRec5 > 0 Then
          CatTotByTransType(TransRec.CatCodeRec5, 6) = OldRound(CatTotByTransType(TransRec.CatCodeRec5, 6) + TransRec.CatLicAmt5)
          LicChrgTot = OldRound(LicChrgTot + TransRec.CatLicAmt5)
        End If
        If TransRec.IssAmt > 0 Then
          CatTot(NumOfARCatRecs + 1) = OldRound(CatTot(NumOfARCatRecs + 1) + TransRec.IssAmt)
...
ReportGraphics:
  ...
  ReportFile$ = "BLRPTS\ARCLSANL.RPT"
  RptHandle = FreeFile
  Open ReportFile$ For Output As #RptHandle
  
  For x = 1 To NumOfARCatRecs
    Get COHandle, x, CodeRec
    If CatTot(x) > 0 Then
      PrintCnt = PrintCnt + 1
      '                           0                          1                      2
      Print #RptHandle, QPTrim$(TownRec.TownName); dlm; fptxtBDate.Text; dlm; fptxtEDate.Text; dlm;
      '                          3                          4                                5
      Print #RptHandle, "Category Analysis"; dlm; QPTrim$(CodeRec.CODEDESC); dlm; QPTrim$(CodeRec.CatCode); dlm;
      '                     6
      Print #RptHandle, CatTot(x); dlm;
      For y = 1 To 6
        '                   7, 8, 9, 10, 11, 12
        Print #RptHandle, CatTotByTransType(x, y); dlm;
      Next y
      '                    13           14           14             16                17                  18
      Print #RptHandle, ChrgTot; dlm; PayTot; dlm; PenTot; dlm; AdjPayDnTot; dlm; AdjBillDnTot; dlm; AdjBillUpTot; dlm;
      '
      For y = 1 To 2
        '                         19, 20
        Print #RptHandle, CatTot(NumOfARCatRecs + y); dlm;
      Next y
      '                          21
      Print #RptHandle, CatTot(NumOfARCatRecs + 3)
    End If
  Next x
  ...
  If PrintCnt = 0 Then
    frmBLMessageBoxJr.Label1.Top = 800
    frmBLMessageBoxJr.Label1.Caption = "There are no transactions on file for this time period."
    frmBLMessageBoxJr.Show vbModal
    Exit Sub
  End If
  
  arBLTrnsJrnlCatAnalysis.Show
...
ReportText:
  ...
  For x = 1 To NumOfARCatRecs
    ...
    End If
    If CatTot(x) > 0 Then
      CodeRec.CatCode = CodeRec.CatCode
      GoSub PrintGroupHeader
      PrintCnt = PrintCnt + 1
      Print #RptHandle, Tab(20); "Charges:          "; Tab(50); Using$("$#,###,##0.00", CatTotByTransType(x, 1))
      Print #RptHandle, Tab(20); "Payments:         "; Tab(50); Using$("$#,###,##0.00", CatTotByTransType(x, 2))
'      Print #RptHandle, Tab(20); "Penalties         "; Tab(50); Using$("$#,###,##0.00", CatTotByTransType(x, 3))
      Print #RptHandle, Tab(20); "Adjust Pay Down:  "; Tab(50); Using$("$#,###,##0.00", CatTotByTransType(x, 4))
      Print #RptHandle, Tab(20); "Adjust Bill Down: "; Tab(50); Using$("$#,###,##0.00", CatTotByTransType(x, 5))
      Print #RptHandle, Tab(20); "Adjust Bill Up:   "; Tab(50); Using$("$#,###,##0.00", CatTotByTransType(x, 6))
      LineCnt = LineCnt + 5
    End If
  Next x
  ...
  ViewPrint ReportFile$, "Category Analysis Report", True
...
PrintHeader:
  Page = Page + 1
  Print #RptHandle, Tab(21); "Business License : Transactions Journal"
  Print #RptHandle, Tab(26); "Total Classification Analysis"
  Print #RptHandle, Tab(29); "Report Date: "; Date$; Tab(72); "Page #"; Page
  Print #RptHandle, ""
  Print #RptHandle, "Beginning Date: "; BegDate$
  Print #RptHandle, "   Ending Date: "; EndDate$
  Print #RptHandle, "Category Desc"; Tab(45); "Category Number"
  Print #RptHandle, String$(80, "=")
  LineCnt = 8
...
PrintGroupHeader:
  ...
  If LineCnt > 8 Then
    ...
    LineCnt = LineCnt + 1
  End If
  Print #RptHandle, QPTrim$(CodeRec.CODEDESC); Tab(50); QPTrim$(CodeRec.CatCode)
  Print #RptHandle, Tab(20); "Transaction Type"; Tab(45); "Transaction Amount"
  Print #RptHandle, String$(80, "-")
  LineCnt = LineCnt + 3
...
PrintFooter:
  ...
  Print #RptHandle, Tab(23); "All Issuance Charges: "; Tab(50); Using$("$#,###,##0.00", CatTot(NumOfARCatRecs + 1))
  Print #RptHandle, Tab(23); "All Penalty Charges: "; Tab(50); Using$("$#,###,##0.00", PenTot)
  Print #RptHandle, Tab(23); "All License Charges: "; Tab(50); Using$("$#,###,##0.00", LicChrgTot)
  Print #RptHandle, Tab(20); String$(43, "-")
  Print #RptHandle, Tab(20); "All Charges:          "; Tab(50); Using$("$#,###,##0.00", ChrgTot + PenTot)
  Print #RptHandle, Tab(20); String$(43, "-")
  Print #RptHandle, Tab(23); "All Issuance Payments: "; Tab(50); Using$("$#,###,##0.00", CatTot(NumOfARCatRecs + 2))
  Print #RptHandle, Tab(23); "All Penalty Payments: "; Tab(50); Using$("$#,###,##0.00", CatTot(NumOfARCatRecs + 3))
  Print #RptHandle, Tab(23); "All License Payments: "; Tab(50); Using$("$#,###,##0.00", OldRound(PayTot - CatTot(NumOfARCatRecs + 1) - CatTot(NumOfARCatRecs + 3)))
  Print #RptHandle, Tab(20); String$(43, "-")
  Print #RptHandle, Tab(20); "All Payments:         "; Tab(50); Using$("$#,###,##0.00", PayTot)
  Print #RptHandle, Tab(20); String$(43, "-")
  Print #RptHandle, Tab(20); "All Adjust Pay Down:  "; Tab(50); Using$("$#,###,##0.00", AdjPayDnTot)
  Print #RptHandle, Tab(20); "All Adjust Bill Down: "; Tab(50); Using$("$#,###,##0.00", AdjBillDnTot)
  Print #RptHandle, Tab(20); "All Adjust Bill Up:   "; Tab(50); Using$("$#,###,##0.00", AdjBillUpTot)
  Print #RptHandle, FF$

...
Begin VB.Form frmRptCustInq1 
   ...
   Begin EditLib.fpText fpOwner 
      ...
      OLEDragMode     =   0
   End
   Begin EditLib.fpText fpCashOnly 
      Height          =   324
      Left            =   8460
      TabIndex        =   25
      TabStop         =   0   'False
      ...
      OLEDragMode     =   0
   End
   Begin EditLib.fpText fpResidential 
      Height          =   324
      Left            =   8460
      TabIndex        =   26
      TabStop         =   0   'False
      ...
      OLEDragMode     =   0
   End
   Begin EditLib.fpText fpVehonfile 
      Height          =   324
      Left            =   8472
      TabIndex        =   27
      TabStop         =   0   'False
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptCustInq1.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdVehicles 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptCustInq1.frx":0ADE
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdTranHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptCustInq1.frx":0CF5
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdPrintInfo 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptCustInq1.frx":0F0A
   End
   Begin VB.Line Line4 
   ...
   End
End
Attribute VB_Name = "frmRptCustInq1"
  ...
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      If MsgBox("Are You Sure You Wish To Close The Program?", vbYesNo, "Close?") = vbNo Then
        Cancel = True
      Else
        DCLog "Close via CustInq by " + PWUser$
        CitiTerminate
      End If
    End If
  End If
...
Private Sub LoadCustInfo()
  ...
  If DCCustRec(1).LastTrans > 0 Then
    TransRec = DCCustRec(1).LastTrans
  End If

  LabelAcctNo.Caption = QPTrim$(DCCustRec(1).CUSTNUMB)
  fpSearch = RTrim$(DCCustRec(1).SORTNAME)
  fpCustName = DCCustRec(1).BILLNAME
  ...
  fpOpenDate = Num2Date(DCCustRec(1).DATEOPED)

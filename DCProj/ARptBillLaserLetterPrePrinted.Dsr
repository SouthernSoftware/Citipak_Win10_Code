VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptBillLaserLetterPrePrinted 
   ...
   ClientTop       =   264
   ClientWidth     =   9480
   Icon            =   "ARptBillLaserLetterPrePrinted.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   16722
   _ExtentY        =   11896
   SectionData     =   "ARptBillLaserLetterPrePrinted.dsx":08CA
End
Attribute VB_Name = "ARptBillLaserLetterPrePrinted"
...
Dim headers(1 To 106) As String
...
Private Sub ActiveReport_DataInitialize()
    ...
    headers(59) = "RevAmt9"
    headers(60) = "RevN10"
    headers(61) = "RevRate10"
    headers(62) = "RevAmt10"
    headers(63) = "RevN11"
    headers(64) = "RevRate11"
    headers(65) = "RevAmt11"
    headers(66) = "RevN12"
    headers(67) = "RevRate12"
    headers(68) = "RevAmt12"
    headers(69) = "RevN13"
    headers(70) = "RevRate13"
    headers(71) = "RevAmt13"
    headers(72) = "RevN14"
    headers(73) = "RevRate14"
    headers(74) = "RevAmt14"
    headers(75) = "RevN15"
    headers(76) = "RevRate15"
    headers(77) = "RevAmt15"
    headers(78) = "PrevCredD"
    headers(79) = "PrevCred"
    headers(80) = "PrevDesc"
    headers(81) = "PrevTot"
    headers(82) = "CurrDesc"

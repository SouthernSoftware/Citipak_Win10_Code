...
Begin VB.Form frmDepositApply 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Apply Customer Deposit"
   ClientHeight    =   8868
   ClientLeft      =   3924
   ClientTop       =   1884
   ClientWidth     =   12216
   Icon            =   "frmDepositApply.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositApply.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn CmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositApply.frx":0AA6
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdClear 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositApply.frx":0C82
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdTranHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositApply.frx":1F54
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdMsg 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositApply.frx":2131
   End
   ...
   Begin EditLib.fpDoubleSingle fpAmount 
      ...
      OLEDragMode     =   0
   End
   Begin EditLib.fpDoubleSingle fpTotCurrent 
      Height          =   324
      Left            =   5886
      TabIndex        =   35
      TabStop         =   0   'False
      ...
      OLEDragMode     =   0
   End
   Begin EditLib.fpDoubleSingle fpTotApplied 
      Height          =   324
      Left            =   7710
      TabIndex        =   36
      TabStop         =   0   'False
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdDist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositApply.frx":230F
   End
   Begin EditLib.fpDoubleSingle fpCurrent 
      Height          =   324
      Index           =   1
   ...
   End
End
Attribute VB_Name = "frmDepositApply"
...
Dim uselook As Boolean, Answer As Integer, AppOKFlag As Boolean
...
Private Sub cmdExit_Click()
  ...
  UBLog "OUT: UTIL ApplyDep"
  Load frmUBDepositMenu
  DoEvents
  frmUBDepositMenu.Show
  Unload frmDepositApply
  DoEvents
End Sub
...
Private Sub fpCmdClear_Click()
  ...
  Dim FntSize As Integer
    ...
    MsgText(1) = ""
    MsgText(2) = ""
    MsgText(3) = "Are You Sure You Wish To Clear Screen?"
    MsgText(4) = ""
    MsgText(5) = ""
...
Private Sub fpCmdTranHist_Click()
  ReDim MsgText(0 To 5) As String
  Dim FntSize As Integer
  If Len(fptxtAccount.Caption) > 0 Then
    If CustAcct& > 0 Then
  ...
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      If MsgBox("Are You Sure You Wish To Close The Program?", vbYesNo, "Close?") = vbNo Then
        Cancel = True
      Else
        UBLog "Closed via DepApply by " + PWUser$
        CitiTerminate
      End If
    End If
  End If
...
'  End If
  ...
  Close CustFile
  fptxtAccount.Caption = Str$(CustAcct&)
...
Private Sub Autodist()
  ...
  NumofRevs = MaxRevsCnt
  TempDepAmt# = fpDeposit.DoubleValue
  ...
  Next
   ...
   If TempDepAmt# > 0 Then
    ThisAmt# = (Val(fpAmount(0)) + TempDepAmt#)
    fpAmount(0) = ThisAmt#
   End If
End If
If CleveFlag Then
  ...
  Do While ThisTran& > 0
    ...
    Case TranDepositPayment, TranDepositPayment + 100
      ...
      Next
'added void trans type 4/20/04
    Case TranAppliedDeposit, TranRefundDeposit, TranDepPaymentVoid
      For DZCnt = 1 To 15
...
Private Sub SaveTransaction()
  ...
  Transamt# = fpTotApplied.DoubleValue
  ...
  UBCustRec(1).CurrBalance = Round#(fpTotActual.DoubleValue)
...
Private Sub CheckApplyInfo()
  ...
  If TestDate < 0 Then
    ...
    GoTo BadApp
  End If
  If fpTotApplied.DoubleValue <> fpDeposit.DoubleValue Then
    AppOKFlag = False
    MsgBox "Invalid Amount. The Total Applied Must Equal The Total Deposit.", vbOKOnly, "Request Canceled."
    GoTo BadApp
  End If
  Exit Sub
BadApp:

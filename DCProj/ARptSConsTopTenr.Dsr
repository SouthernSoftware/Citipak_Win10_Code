VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptSConsTopTenr 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Consumption Top Ten List"
   ClientHeight    =   4380
   ClientLeft      =   36
   ClientTop       =   264
   ClientWidth     =   8952
   Icon            =   "ARptSConsTopTenr.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   15790
   _ExtentY        =   7726
   SectionData     =   "ARptSConsTopTenr.dsx":08CA
End
Attribute VB_Name = "ARptSConsTopTenr"

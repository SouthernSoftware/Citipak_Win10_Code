...
Begin VB.Form frmLockBoxPay 
   ...
   Begin VB.Label Label1 
      ...
      Caption         =   "Please Enter The Lock Box Payment File Name:"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmLockBoxPay"
...
'  If txtFileName.Visible = True Then
  frmUBPaymentMenu.BoxFileName = QPTrim$(txtFileName)
'  End If
  Unload Me
End Sub

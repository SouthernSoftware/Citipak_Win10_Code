...
Begin VB.Form frmCodeAddEdit1 
   ...
   Begin LpLib.fpCombo fpcboInactive 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmCodeAddEdit1.frx":08CA
   End
   Begin LpLib.fpCombo fpcboAcctNumNa2 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmCodeAddEdit1.frx":0C68
   End
   Begin LpLib.fpCombo fpcboAcctNumNa1 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmCodeAddEdit1.frx":10A3
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmCodeAddEdit1.frx":14DE
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmCodeAddEdit1.frx":16B9
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdPrintInfo 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmCodeAddEdit1.frx":1894
   End
   ...
   End
End
Attribute VB_Name = "frmCodeAddEdit1"
...
Dim ChkOKFlag As Boolean, stuff As Boolean, WhatCode As Integer
...
Private Function CheckSaveCodeFile%()
  ...
  If WhatCode > 0 Then
    ...
    Get CodeFile, WhatCode, DCCodeRec
    Close CodeFile

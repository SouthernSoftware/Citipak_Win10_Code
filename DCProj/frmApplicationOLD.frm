...
Begin VB.Form frmApplicationOLD 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Application Letter Information"
   ClientHeight    =   8868
   ClientLeft      =   3924
   ClientTop       =   1884
   ClientWidth     =   12216
   Icon            =   "frmApplicationOLD.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin LpLib.fpCombo fpcboLogo 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmApplicationOLD.frx":08CA
   End
   ...
   Begin VB.Label Label10 
      Alignment       =   1  'Right Justify
      BackStyle       =   0  'Transparent
      Caption         =   "Print Town Logo on Application:"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   10.2
         Charset         =   0
   ...
   Begin VB.Label Label6 
      BackStyle       =   0  'Transparent
      Caption         =   "Application Leter Information"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   10.2
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmApplicationOLD"
...
'  ReportFile$ = DCPath$ + "DCAppLtr.PRN"
''    UBRptT = FreeFile
...
'      End If
'    End If
'    ARptLetterApplication.Head1 = QPTrim(fpTxtHead1)
'    ARptLetterApplication.Head2 = QPTrim(fpTxtHead2)
'    ARptLetterApplication.LblOpt1 = QPTrim(fptxtOpt1)
'    ARptLetterApplication.LblOpt2 = QPTrim(fpTxtOpt2)
'    ARptLetterApplication.LblOpt3 = QPTrim(fpTxtOpt3)
'    ARptLetterApplication.LblOpt4 = QPTrim(fpTxtOpt4)
'    ARptLetterApplication.LblPgph1 = QPTrim(fptxtPgph(0))
'    ARptLetterApplication.LblPgph2 = QPTrim(fptxtPgph(1))
'    ARptLetterApplication.LblPgph3 = QPTrim(fptxtPgph(2))
'    ARptLetterApplication.LblPgph4 = QPTrim(fptxtPgph(3))
'    ARptLetterApplication.LblPgph5 = QPTrim(fptxtPgph(4))
'    ARptLetterApplication.LblPgph6 = QPTrim(fptxtPgph(5))
'    ARptLetterApplication.LblPgph7 = QPTrim(fptxtPgph(6))
'    ARptLetterApplication.LblPgph8 = QPTrim(fptxtPgph(7))
'    ARptLetterApplication.LblOpt5 = QPTrim(fpTxtOpt5)
'    ARptLetterApplication.LblHead4 = QPTrim(fptxtHead4)
'    ARptLetterApplication.LblHead5 = QPTrim(fptxtHead5)
'    ARptLetterApplication.LblHead6 = QPTrim(fptxtHead6)
'    ARptLetterApplication.LblOpt6 = QPTrim(fpTxtOpt6)
'    ARptLetterApplication.LblOpt7 = QPTrim(fpTxtOpt7)
...
'        Cancel = True
'      Else
'        DCLog "Closed via TempTaxBill print by " + PWUser$
'        CitiTerminate
'      End If
'    End If
'  End If
...
'  Dim ApplDeflen As Integer, Handle As Integer
...
'  If Exist(DCPath$ + "DCApLetr.DAT") Then
'    ReDim DCApplDef(1) As ApplicationDefaultsType
'    ApplDeflen = Len(DCApplDef(1))            'use the length as an error flag
'    Handle = FreeFile
'    Open DCPath$ + "DCApLetr.DAT" For Random Shared As Handle Len = ApplDeflen    'open data file
'    Get #Handle, 1, DCApplDef(1)
'    Close Handle
'    fpcboLogo.ListIndex = DCApplDef(1).dologo
'    fpTxtHead1 = QPTrim(DCApplDef(1).TxtHead1)
'    fpTxtHead2 = QPTrim(DCApplDef(1).TxtHead2)
'    fptxtOpt1 = QPTrim(DCApplDef(1).txtOpt1)
'    fpTxtOpt2 = QPTrim(DCApplDef(1).TxtOpt2)
'    fpTxtOpt3 = QPTrim(DCApplDef(1).TxtOpt3)
'    fpTxtOpt4 = QPTrim(DCApplDef(1).TxtOpt4)
'    fptxtPgph(0) = QPTrim(DCApplDef(1).txtPgph0)
'    fptxtPgph(1) = QPTrim(DCApplDef(1).txtPgph1)
'    fptxtPgph(2) = QPTrim(DCApplDef(1).txtPgph2)
'    fptxtPgph(3) = QPTrim(DCApplDef(1).txtPgph3)
'    fptxtPgph(4) = QPTrim(DCApplDef(1).txtPgph4)
'    fptxtPgph(5) = QPTrim(DCApplDef(1).txtPgph5)
'    fptxtPgph(6) = QPTrim(DCApplDef(1).txtPgph6)
'    fptxtPgph(7) = QPTrim(DCApplDef(1).txtPgph7)
'    fpTxtOpt5 = QPTrim(DCApplDef(1).TxtOpt5)
'    fptxtHead4 = QPTrim(DCApplDef(1).txtHead4)
'    fptxtHead5 = QPTrim(DCApplDef(1).txtHead5)
'    fptxtHead6 = QPTrim(DCApplDef(1).txtHead6)
'    fpTxtOpt6 = QPTrim(DCApplDef(1).TxtOpt6)
'    fpTxtOpt7 = QPTrim(DCApplDef(1).TxtOpt7)
'
'  End If
'
'End Sub
...
'End Sub
'
'Private Sub TestLtrPrint()
'  Dim ToPrint As String, DCRptT As Integer, ReportFile As String
'  'Dim UBBillLetterlen As Integer
'  'Dim UBBillSetuplen As Integer
'
'  ReportFile$ = DCPath$ + "DCtxtApp.PRN"
'  DCRptT = FreeFile
'  Open ReportFile$ For Output As DCRptT
'    ToPrint$ = "2004-1505"
'    ToPrint$ = ToPrint$ + "~" + "JOHN SMITH"
'    ToPrint$ = ToPrint$ + "~" + "P O BOX 1520"
'    ToPrint$ = ToPrint$ + "~337 HWY NORTH"
...
'End Sub
'
'Private Sub SaveDCDef()
'  Dim DCApplDef As ApplicationDefaultsType
'  Dim Handle As Integer, ApplDeflen As Integer
'  ApplDeflen = Len(DCApplDef)
'  Handle = FreeFile
'  Open DCPath$ + "DCApLetr.DAT" For Random Shared As Handle Len = ApplDeflen
'
'    DCApplDef.TxtHead1 = QPTrim(fpTxtHead1)
'    DCApplDef.TxtHead2 = QPTrim(fpTxtHead2)
'    DCApplDef.txtOpt1 = QPTrim(fptxtOpt1)
'    DCApplDef.TxtOpt2 = QPTrim(fpTxtOpt2)
'    DCApplDef.TxtOpt3 = QPTrim(fpTxtOpt3)
'    DCApplDef.TxtOpt4 = QPTrim(fpTxtOpt4)
'    DCApplDef.txtPgph0 = QPTrim(fptxtPgph(0))
'    DCApplDef.txtPgph1 = QPTrim(fptxtPgph(1))
'    DCApplDef.txtPgph2 = QPTrim(fptxtPgph(2))
'    DCApplDef.txtPgph3 = QPTrim(fptxtPgph(3))
'    DCApplDef.txtPgph4 = QPTrim(fptxtPgph(4))
'    DCApplDef.txtPgph5 = QPTrim(fptxtPgph(5))
'    DCApplDef.txtPgph6 = QPTrim(fptxtPgph(6))
'    DCApplDef.txtPgph7 = QPTrim(fptxtPgph(7))
'    DCApplDef.TxtOpt5 = QPTrim(fpTxtOpt5)
'    DCApplDef.txtHead4 = QPTrim(fptxtHead4)
'    DCApplDef.txtHead5 = QPTrim(fptxtHead5)
'    DCApplDef.txtHead6 = QPTrim(fptxtHead6)
'    DCApplDef.TxtOpt6 = QPTrim(fpTxtOpt6)
'    DCApplDef.TxtOpt7 = QPTrim(fpTxtOpt7)
'    DCApplDef.dologo = fpcboLogo.ListIndex
'  Put #Handle, 1, DCApplDef
'  Close Handle

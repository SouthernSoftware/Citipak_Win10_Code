...
Begin VB.Form frmClearDecals 
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdOK 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmClearDecals.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmClearDecals.frx":0AA8
   End
   ...
   End
End
Attribute VB_Name = "frmClearDecals"
...
Private Sub ClearCustomer()
  ...
  ReDim DCCustIdxRec(1) As DCTempIDXRecType
   FrmShowPctComp.Label1 = "Clearing Customer Decals"
   FrmShowPctComp.cmdCancel.Enabled = False
   FrmShowPctComp.Show , frmClearDecals
  'Open Vehicle File
  ...
  For cnt = 1 To IdxTrNumRecs
    FrmShowPctComp.ShowPctComp cnt, IdxTrNumRecs
  ...
  DCLog PWUser$ + " Clear Decals"
MsgBox "Clear Decals Complete.", vbOKOnly, "Complete"

...
Begin VB.Form frmRptInactiveConsump 
   ...
   Begin LpLib.fpCombo fpcboNoLocation 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptInactiveConsump.frx":0BC1
   End
   Begin LpLib.fpCombo fpcboVacant 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptInactiveConsump.frx":0EEF
   End
   Begin LpLib.fpCombo fpcboRptType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptInactiveConsump.frx":121D
   End
              ...
              If PrintMrtFlag Then
                ...
                MeterConsp# = Round#(MeterConsp# * Multi#)
                  ...
                  If MeterConsp# > 0 Then
                    ...
                    Else
                      If Not DidOne = True Then
                        ToPrintN$ = UBCustRec(1).Status + "~" + UBCustRec(1).Book + "-" + UBCustRec(1).SEQNUMB + "~" + Using("  #####", lcnt&)
                      ...
                      Print #RptHandle, ToPrintN$ + "~" + ToPrint$ + "~" + Str(lcnt&)
                    End If
                  End If
              End If

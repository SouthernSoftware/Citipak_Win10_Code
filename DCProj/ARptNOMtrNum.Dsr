...
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptNOMtrNum 
   ...
   _ExtentX        =   13970
   _ExtentY        =   7726
   SectionData     =   "ARptNOMtrNum.dsx":08CA
End
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    If KeyCode = vbKeyE Then
      ...
      DoEvents
      MsgBox "File - NOMtrNum.xls, created in the Citipak Directory.", vbOKOnly
    End If
    If KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      MsgBox "File - NOMtrNum.txt, created in the Citipak Directory.", vbOKOnly
    End If
  End If
End Sub
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & "NOMtrNum.xls"
        oEXL.Export Me.Pages
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & "NOMtrNum.txt"
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","

...
Begin VB.Form frmRptResident 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Resident Report"
   ClientHeight    =   8640
   ClientLeft      =   36
   ClientTop       =   540
   ClientWidth     =   12192
   Icon            =   "frmRptResident.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8640
   ...
   Begin LpLib.fpCombo fpDecalCat 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptResident.frx":08CA
   End
   Begin LpLib.fpCombo fpcboPrintOrder 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptResident.frx":0D61
   End
   Begin LpLib.fpCombo fpcboRptType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptResident.frx":11A0
   End
   ...
   End
End
Attribute VB_Name = "frmRptResident"
...
Private Sub Form_Load()
  ...
  Me.HelpContextID = hlpResidentReport
End Sub
...
Private Sub ResidentListing()
  ...
  Dash120$ = String$(121, "-")
  FrmShowPctComp.Label1 = "Creating Resident List"
...
SkipRecord:
  Next cnt
    ...
    Else
      Load frmLoadingRpt
      frmLoadingRpt.setwherefrom frmRptResident
      ARptResident.txtDate = Now
      ARptResident.txtTown = TOWNNAME$
      ARptResident.Catfield = "Category -" + Category$
      ARptResident.Title = "Customer Resident Report"
      ARptResident.totcust = CustCnt
      ARptResident.GetName ReportFile$
      ARptResident.startrpt
    End If
ExitPrint:
  Exit Sub
...
ERRORSTUFF:
  Unload FrmShowPctComp
  Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "RptResident", "Calc Report", Erl)
    Case emrExitProc:
      Resume Proc_Exit
    Case emrResume:
      Resume

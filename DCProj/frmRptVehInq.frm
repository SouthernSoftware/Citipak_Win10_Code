...
Begin VB.Form frmRptVehInq 
   ...
   Begin EditLib.fpLongInteger fpNext 
      Height          =   300
      Left            =   528
      TabIndex        =   26
      TabStop         =   0   'False
   ...
   Begin MSComctlLib.StatusBar StatusBar1 
      ...
      EndProperty
   End
   Begin EditLib.fpText fpSticker 
      Height          =   324
      Left            =   4554
      TabIndex        =   12
      TabStop         =   0   'False
      ...
      OLEDragMode     =   0
   End
   Begin EditLib.fpText fpExpires 
      Height          =   324
      Left            =   4554
      TabIndex        =   13
      TabStop         =   0   'False
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptVehInq.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdMore 
      Height          =   384
      Left            =   6264
      TabIndex        =   24
      TabStop         =   0   'False
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptVehInq.frx":0AA6
   End
   ...
   End
End
Attribute VB_Name = "frmRptVehInq"
...
startloop:
  If fpVehRecNo > 0 Then
    ...
    If DCVRec(1).Active <> "Y" Then
      ...
      GoTo startloop
    End If
    fpCatcode = QPTrim$(DCVRec(1).DecalCat)
    fpFee = DCVRec(1).Fee
    fpMakeModl = DCVRec(1).makemodel
    fpStateLic = DCVRec(1).StateTag
    fpExpires = Num2Date$(DCVRec(1).ExpireDate)
    fpSticker = DCVRec(1).Sticker
  ...
  Else
    MsgBox "No More Vehicles to Display", vbOKOnly, "No Vehicles"
  End If
End Sub

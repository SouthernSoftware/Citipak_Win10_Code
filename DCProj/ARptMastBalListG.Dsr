VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptMastBalListG 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Master Balance Listing By Group"
   ClientHeight    =   6600
   ClientLeft      =   36
   ClientTop       =   264
   ClientWidth     =   8976
   Icon            =   "ARptMastBalListG.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   15833
   _ExtentY        =   11642
   SectionData     =   "ARptMastBalListG.dsx":08CA
End
Attribute VB_Name = "ARptMastBalListG"

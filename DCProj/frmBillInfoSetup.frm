...
Begin VB.Form frmBillInfoSetup 
   ...
   Begin LpLib.fpCombo fpcboLateNotices 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmBillInfoSetup.frx":0FB7
   End
   Begin LpLib.fpCombo fpcboWhichever 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmBillInfoSetup.frx":133E
   End
   Begin LpLib.fpCombo fpcboBalType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmBillInfoSetup.frx":16A4
   End
   Begin LpLib.fpCombo fpcboPostalBar 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmBillInfoSetup.frx":19FF
   End
   Begin LpLib.fpCombo fpcboAcctBar 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmBillInfoSetup.frx":1D65
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdLtrFormat 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBillInfoSetup.frx":2431
   End

VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptLateLetter 
   ...
   _ExtentX        =   15790
   _ExtentY        =   7726
   SectionData     =   "ARptLateLetter.dsx":08CA
End
Attribute VB_Name = "ARptLateLetter"
...
ERRORSTUFF:
  Unload frmLoadingRpt
  Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "ARptLateLetter", "Fetch Data", Erl)
    Case emrExitProc:
      Resume Proc_Exit
    Case emrResume:
      Resume

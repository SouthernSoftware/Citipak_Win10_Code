...
Begin VB.Form frmTRDispList 
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdOK 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTRDispList.frx":0380
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTRDispList.frx":0559
   End
   Begin fpBtnAtlLibCtl.fpBtn fpcmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTRDispList.frx":0734
   End
...
Private Sub fpCmdPrint_Click()
  ...
  ReportFile$ = DCPath$ + "DCtrlist.RPT"
  DCRpt = FreeFile
...
'  Stop
  ...
  End Select
  frmTRDetail.Caption = "Transaction Detail - " + Label5.Caption + " " + Label7.Caption
  frmTRDetail.Label3 = Num2Date(DCTranRec(1).TransDate)
  frmTRDetail.Label4 = Using("#####.##", DCTranRec(1).TransAmount, True)
  frmTRDetail.Make = QPTrim$(DCTranRec(1).makemodel)
  frmTRDetail.Label5 = QPTrim$(DCTranRec(1).TRVinDesc)
  frmTRDetail.Oper = Str(PWcnt)
  frmTRDetail.Bal = Using("#####.##", DCTranRec(1).BalanceAfterTrans, True)
  frmTRDetail.Label6 = TType$
  frmTRDetail.Label6b = QPTrim$(DCTranRec(1).ExtraDesc)
  frmTRDetail.Cash = Using("#####.##", DCTranRec(1).CashAmount, True)
  If DCTranRec(1).TransTender = 4 Then
    frmTRDetail.Charge = Using("#####.##", DCTranRec(1).ChkAmount, True)
    frmTRDetail.Chk = 0
  Else
    frmTRDetail.Chk = Using("#####.##", DCTranRec(1).ChkAmount, True)
    frmTRDetail.Charge = 0
  End If
  frmTRDetail.State = QPTrim$(DCTranRec(1).StateTag)
  frmTRDetail.Sticker = QPTrim$(DCTranRec(1).Sticker)
  frmTRDetail.Expire = Num2Date(DCTranRec(1).ExpireDate)
  frmTRDetail.Cat = QPTrim$(DCTranRec(1).DecalCat)
  DoEvents
  'preload stuff here

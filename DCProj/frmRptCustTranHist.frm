...
Begin VB.Form frmRptCustTranHist 
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptCustTranHist.frx":0C30
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptCustTranHist.frx":0E0D
   End
...
DOTransDetail:
  ...
  Select Case UBTranRec(1).TransType
    ...
    Case TranBillPayment, TranBillPayment + 100
      Print #UBRpt, Tab(16); "Bill Payment  " + Left$(UBTranRec(1).TransDesc, 25); Tab(57); Using$("$#######.##", UBTranRec(1).Transamt); Tab(71); Using("$#######.##", UBTranRec(1).RunBalance)
      If DetailFlag Then
        GoSub PrintRevDetail
      End If
    ...
    Case TranDepositPayment, TranDepositPayment + 100
      Print #UBRpt, Tab(16); "Deposit Payment  " + Left$(UBTranRec(1).TransDesc, 25); Tab(57); Using$("$#######.##", UBTranRec(1).Transamt); Tab(71); Using("$#######.##", UBTranRec(1).RunBalance)
      If DetailFlag Then
        GoSub PrintRevDetail
      End If
    ...
    Case TranOverPayAdjustment
      Print #UBRpt, Tab(16); "Payment Adjust "; Tab(57); Using$("$#######.##", UBTranRec(1).Transamt); Tab(71); Using("$#######.##", UBTranRec(1).RunBalance)
      If DetailFlag Then
        GoSub PrintRevDetail
      End If
    Case TranDepCreditRemoval
      Print #UBRpt, Tab(16); "DepCredit Remv "; Tab(57); Using$("$#######.##", UBTranRec(1).Transamt); Tab(71); Using("$#######.##", UBTranRec(1).RunBalance)
      If DetailFlag Then
        GoSub PrintRevDetail
      End If
    Case TranDepPaymentVoid
      Print #UBRpt, Tab(16); "DepPaymt Void  "; Tab(57); Using$("$#######.##", UBTranRec(1).Transamt); Tab(71); Using("$#### ###.##", UBTranRec(1).RunBalance)
      If DetailFlag Then
        GoSub PrintRevDetail
      End If

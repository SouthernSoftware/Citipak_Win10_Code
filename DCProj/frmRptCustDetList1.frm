...
Begin VB.Form frmRptCustDetList1 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   540
   ClientWidth     =   12192
   Icon            =   "frmRptCustDetList1.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8640
   ...
   Begin LpLib.fpCombo fpDecalCat 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptCustDetList1.frx":08CA
   End
   Begin LpLib.fpCombo fpcboPrintOrder 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptCustDetList1.frx":0C45
   End
   Begin LpLib.fpCombo fpcboRptType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptCustDetList1.frx":0F68
   End
   ...
   End
End
Attribute VB_Name = "frmRptCustDetList1"

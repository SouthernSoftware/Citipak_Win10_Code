...
Begin VB.Form frmPaymentEntry 
   ...
   Begin LpLib.fpCombo fpcboTenderType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPaymentEntry.frx":0D61
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdCharge 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPaymentEntry.frx":11A0
   End
   Begin fpBtnAtlLibCtl.fpBtn fpcmdCheck 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPaymentEntry.frx":13B5
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPaymentEntry.frx":26BF
   End
   Begin fpBtnAtlLibCtl.fpBtn CmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPaymentEntry.frx":28D3
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdCash 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPaymentEntry.frx":2AE7
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdInfo 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPaymentEntry.frx":3DF0
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpcmdFind 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPaymentEntry.frx":4003
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpcmdDrawer 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPaymentEntry.frx":530C
   End
   Begin EditLib.fpText fpBusPers 
...
Private Function Chk4BalinTax(SSN As String)
  ...
  If Chk4Bal Then
    ...
    If TXBAL > 0 Then
      ...
      MsgText(1) = "Matching Social Sec# for"
      MsgText(2) = QPTrim$(fptxtName)
      MsgText(3) = "Has a Tax Balance Due of " & Str$(TXBAL)
      MsgText(4) = "OK to continue with Decal purchase"
      MsgText(5) = "CANCEL to select another customer"
      If GetOKorNot(MsgText()) Then
...
Public Sub GetVehinfo()
  ...
  Else 'existing payment edit for existing vehicle
    ...
    fpBusPers = DCPaymentRec(1).PersBuss
...
Private Sub SaveTransaction()
  ...
  DCPaymentRec(1).PersBuss = QPTrim$(fpBusPers)

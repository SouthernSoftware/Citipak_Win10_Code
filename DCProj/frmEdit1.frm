...
Begin VB.Form frmEdit1 
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEdit1.frx":0000
   End
   Begin fpBtnAtlLibCtl.fpBtn CmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEdit1.frx":01DC
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdDelete 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEdit1.frx":03B6
   End
   Begin fpBtnAtlLibCtl.fpBtn CmdPageDn 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEdit1.frx":0594
   End
   Begin fpBtnAtlLibCtl.fpBtn CmdPageUp 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEdit1.frx":0770
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdTranHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEdit1.frx":094C
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdList 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEdit1.frx":0B2C
   End

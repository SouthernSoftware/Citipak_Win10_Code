...
Begin VB.Form frmDCMainMenu1 
   ...
   Begin VB.CommandButton cmdReportsMenu 
      ...
      Width           =   4524
   End
   Begin VB.CommandButton cmdCatagoryMaintMenu 
      Caption         =   "&Decal Catagory Maintenance"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   10.2
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmDCMainMenu1"

...
Begin VB.Form frmRptDecalListing1 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   540
   ClientWidth     =   12192
   Icon            =   "frmRptDecalListing1.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8640
   ...
   Begin LpLib.fpCombo fpcboRptType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptDecalListing1.frx":08CA
   End
   Begin LpLib.fpCombo fpcboPrintOrder 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptDecalListing1.frx":0BF8
   End
   Begin LpLib.fpCombo fpDecalCat 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptDecalListing1.frx":0F1B
   End
   ...
   End
End
Attribute VB_Name = "frmRptDecalListing1"

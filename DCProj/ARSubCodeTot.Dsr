VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARSubCodeTot 
   BorderStyle     =   0  'None
   ClientHeight    =   4380
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6996
   Icon            =   "ARSubCodeTot.dsx":0000
   ShowInTaskbar   =   0   'False
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   12340
   _ExtentY        =   7726
   SectionData     =   "ARSubCodeTot.dsx":08CA
End
Attribute VB_Name = "ARSubCodeTot"
...
'    ' or user defined.
    Fields("Code").Value = arr(0)
    Fields("Amt").Value = arr(1)
'If something wrong in file give message instead of crashing
Exit Sub
ERRORSTUFF:
      Unload frmLoadingRpt
  Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "ARptSubCodeTot", "Fetch Data", Erl)
    Case emrExitProc:
      Resume Proc_Exit
    Case emrResume:
      Resume

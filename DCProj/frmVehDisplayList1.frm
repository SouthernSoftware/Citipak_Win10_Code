...
Begin VB.Form frmVehDisplayList1 
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdOK 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVehDisplayList1.frx":0D02
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVehDisplayList1.frx":0EDB
   End
...
'  frmCodeAddEdit.Endedit = True
  ...
  frmPayPurchaseEntry.fpVehRecNo = 0
  frmPayPurchaseEntry.GetVehinfo
...
Private Sub fpList1_DblClick()
  ...
  'load veh info in payment
    frmPayPurchaseEntry.fpVehRecNo = VehRec
    frmPayPurchaseEntry.GetVehinfo
  VehRec = 0
  Unload Me
End Sub

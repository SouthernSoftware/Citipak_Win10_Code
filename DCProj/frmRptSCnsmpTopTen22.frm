...
Begin VB.Form frmRptSCnsmpTopTen22 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   540
   ClientWidth     =   12192
   Icon            =   "frmRptSCnsmpTopTen22.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8640
   ...
   Begin LpLib.fpList fplstGCodes 
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmRptSCnsmpTopTen22.frx":08CA
   End
   Begin LpLib.fpList fplstRates 
      ...
      ResizeRowToFont =   0   'False
      TextTipMultiLine=   0
      ColDesigner     =   "frmRptSCnsmpTopTen22.frx":0C4A
   End
   Begin LpLib.fpCombo fpcboRptType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptSCnsmpTopTen22.frx":0F9E
   End
   ...
   End
End
Attribute VB_Name = "frmRptSCnsmpTopTen22"
...
Private Sub Form_Load()
  ...
  Erase Cycle
  Erase Book
  If InStr(TOWNNAME$, "MOORE") > 0 Then
    MoFlag = True
  Else
    MoFlag = False
  End If
...
DotheDetailTot:
  If RptType = 1 Then
    Print #UBRpt, " Rate Totals : "; Tab(59); Using("###,###,###,###", GTMeterConsp#); Tab(75); Using("###,###,###", Avg4R)
    Print #UBRpt, Dash80$
    LineCnt = LineCnt + 2
  Else
    Print #UBRpt, RCode$ + "~ ~ ~ ~ ~ ~ "
    Print #UBRpt, RCode$ + "~ ~ ~" + "RATE TOTALS:" + "~ ~" + Using("###,###,###,###", GTMeterConsp#) + "~" + Using("###,###,###", Avg4R)
    Print #UBRpt, RCode$ + "~ ~ ~ ~ ~ ~ "
  End If
Return
DoUnitStepFooter:

...
'      Close
    ...
    If fpcboLogo.ListIndex = 1 Then
      If Exist(DCPath$ + "txTNlogo.bmp") Then
        ARptTempTaxBill.Image1.Picture = LoadPicture(DCPath$ + "txTNlogo.bmp")
...
Private Sub Form_Load()
  ...
  If Exist(DCPath$ + "UBTaxBil.DAT") Then

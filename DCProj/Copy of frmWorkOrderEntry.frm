...
Begin VB.Form frmWorkOrderEntry 
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpLoadDefault 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmWorkOrderEntry.frx":0C19
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdMsg 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmWorkOrderEntry.frx":0DFC
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmWorkOrderEntry.frx":0FD6
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdConHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmWorkOrderEntry.frx":11B2
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdTranHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmWorkOrderEntry.frx":138F
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdWorkHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmWorkOrderEntry.frx":156C
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmWorkOrderEntry.frx":1749
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdOwner 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmWorkOrderEntry.frx":192B
   End
...
PrintThemOne:
  ...
  If graphicflag = False Then
    ...
    Print #RptHandle, " "
    Print #RptHandle, "    Date Issued: "; Num2Date$(WorkOrderRec(1).ENTRYDATE) 'Date$

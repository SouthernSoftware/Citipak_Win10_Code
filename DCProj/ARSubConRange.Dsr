VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARSubConRange 
   BorderStyle     =   0  'None
   ClientHeight    =   4380
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9048
   Icon            =   "ARSubConRange.dsx":0000
   ShowInTaskbar   =   0   'False
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   15960
   _ExtentY        =   7726
   SectionData     =   "ARSubConRange.dsx":08CA
End
Attribute VB_Name = "ARSubConRange"
...
'    ' or user defined.
    Fields("Rate").Value = arr(0)
    Fields("AOne").Value = arr(1)
    Fields("One").Value = arr(2)
    Fields("Two").Value = arr(3)
    Fields("Three").Value = arr(4)

...
Begin VB.Form frmCustAddEdit1 
   ...
   EndProperty
   Icon            =   "1frmCustAddEdit1.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "1frmCustAddEdit1.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "1frmCustAddEdit1.frx":0AA5
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdOwner 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "1frmCustAddEdit1.frx":0C80
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdConHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "1frmCustAddEdit1.frx":0E5B
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdTranHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "1frmCustAddEdit1.frx":1037
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdWorkHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "1frmCustAddEdit1.frx":1213
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdPrintInfo 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "1frmCustAddEdit1.frx":13EF
   End
   ...
   End
End
Attribute VB_Name = "frmCustAddEdit1"

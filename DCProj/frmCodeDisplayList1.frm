...
Begin VB.Form frmCodeDisplayList1 
   AutoRedraw      =   -1  'True
   BackColor       =   &H008F8265&
   ...
   EndProperty
   Icon            =   "frmCodeDisplayList1.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin LpLib.fpList fpList1 
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmCodeDisplayList1.frx":08CA
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdOK 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmCodeDisplayList1.frx":0C56
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmCodeDisplayList1.frx":0E2F
   End
   ...
   End
End
Attribute VB_Name = "frmCodeDisplayList1"

VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptLetterApplication 
   ...
   ClientTop       =   270
   ClientWidth     =   12750
   Icon            =   "ARptLetterApplication.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   22490
   _ExtentY        =   11880
   SectionData     =   "ARptLetterApplication.dsx":08CA
End
Attribute VB_Name = "ARptLetterApplication"
...
Private Sub ActiveReport_DataInitialize()
    ...
    headers(10) = "VehNotes"
    headers(11) = "Fee"
'    headers(11) = "ExemptVal"
'    headers(12) = "TaxableVal"
'    headers(13) = "RatePer100"
'    headers(14) = "TaxesDue"
'
    hFile = FreeFile
...
ERRORSTUFF:
  Unload frmLoadingRpt
  Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "ARptLetterApplication", "Fetch Data", Erl)
    Case emrExitProc:
      Resume Proc_Exit
    Case emrResume:
      Resume
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    If KeyCode = vbKeyE Then
      ...
      DoEvents
      MsgBox "File - DCAppLtr.xls, created in the Citipak Directory.", vbOKOnly
    End If
    If KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      MsgBox "File - DCAppLtr.txt, created in the Citipak Directory.", vbOKOnly
    End If
  End If
End Sub
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & "DCAppLtr.xls"
        oEXL.Export Me.Pages
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & "DCAppLtr.txt"
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","

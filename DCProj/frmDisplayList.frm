...
Begin VB.Form frmDisplayList 
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdOK 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDisplayList.frx":0438
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDisplayList.frx":0611
   End
...
'      If OKDepReverse(SearchRec&) Then
'        DeActivateControls Me
'        frmInfo.Label1 = "Loading. . ."
'        frmInfo.Show
'        DoEvents
...
'      '  Unload frmCustEditLookUP
'      End If
    ElseIf SrchDel = 7 Then       'DeActivateControls Me
       frmInfo.Label1 = "Loading. . ."
       frmInfo.Show
       DoEvents
       frmReportOpt.Show 1
       If rptopt = 1 Then
      'do the graphics
        ' PrintCustInfo SearchRec&, 1
       ElseIf rptopt = 2 Then
       'do the text
        ' PrintCustInfo SearchRec&, 2
       End If
       Unload frmInfo

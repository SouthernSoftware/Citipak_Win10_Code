...
Begin VB.Form frmDCCodeMenu2 
   ...
   Begin VB.CommandButton cmdListDecals 
      BackColor       =   &H00C0C0C0&
      Caption         =   "&Print Decal Code Listing"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   10.2
         Charset         =   0
   ...
   Begin VB.CommandButton cmdEditCode 
      Caption         =   "&Edit Existing Decal Code"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   10.2
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmDCCodeMenu2"

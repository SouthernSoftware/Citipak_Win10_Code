...
Begin VB.Form frmExpirationDefault 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Expiration Date Default Setup"
   ClientHeight    =   8640
   ClientLeft      =   36
   ClientTop       =   540
   ClientWidth     =   12192
   Icon            =   "frmExpirationDefault.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8640
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Expiration Date Default"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   13.8
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmExpirationDefault"
  ...
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      If MsgBox("Are You Sure You Wish To Close The Program?", vbYesNo, "Close?") = vbNo Then
        Cancel = True
      Else
        DCLog "Closed via defaultexpiration  by " + PWUser$
        CitiTerminate
      End If
    End If
  End If
...
Private Sub cmdSave_Click()
  ...
  If ValidDate Then
    ...
    DCDate(1).ExpireDate = txtExpDate.Text
    Put DCFile, 1, DCDate(1)
    Close
    DCLog PWUser + " Saved ExpirationDefault- " + txtExpDate.Text
    MsgBox "Expiration Default Date Saved", vbOKOnly, "Saved"
    cmdExit_Click
  End If
End Sub

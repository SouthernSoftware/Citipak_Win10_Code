...
Begin VB.Form frmRptOwner1 
   ...
   Begin LpLib.fpCombo fpDecalCat 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptOwner1.frx":08CA
   End
   Begin LpLib.fpCombo fpcboRptType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptOwner1.frx":0C45
   End
   Begin LpLib.fpCombo fpcboPrintOrder 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptOwner1.frx":0F73
   End
   ...
   End
End
Attribute VB_Name = "frmRptOwner1"

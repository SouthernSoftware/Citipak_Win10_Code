...
Begin VB.Form frmPenaltyEdit 
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEdit.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn CmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEdit.frx":0AA6
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdDelete 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEdit.frx":0C82
   End
   Begin fpBtnAtlLibCtl.fpBtn CmdPageDn 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEdit.frx":1F55
   End
   Begin fpBtnAtlLibCtl.fpBtn CmdPageUp 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEdit.frx":2131
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdTranHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEdit.frx":230B
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdList 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEdit.frx":24E8
   End

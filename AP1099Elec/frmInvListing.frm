...
Begin VB.Form frmInvListing 
   ...
   Begin VB.Label Label2 
      ...
      Caption         =   "To Select Item to Edit, Double-Click Item or Highlight and Click Ok. Use Spacebar to Scroll."
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   10.2
         Charset         =   0
...
Private Sub lstInvEntries_DblClick()
  ...
  Unload frmInvListing
End Sub
Private Sub lstInvEntries_KeyDown(KeyCode As Integer, Shift As Integer)
  Dim TempRec As Integer

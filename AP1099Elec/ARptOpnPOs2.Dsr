VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptOpnPOs2 
   ...
   _ExtentX        =   18330
   _ExtentY        =   9779
   SectionData     =   "ARptOpnPOs2.dsx":08CA
End
Attribute VB_Name = "ARptOpnPOs2"
...
Private Sub Detail_Format()
  TotPOs = Round(TotPOs + Me.Fields("POAmt").Value)
End Sub

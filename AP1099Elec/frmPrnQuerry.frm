...
Begin VB.Form frmPrnQuery 
   ...
   Begin LpLib.fpCombo fpcboAcctType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnQuerry.frx":0D28
   End
   Begin LpLib.fpCombo fpcboFund1 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnQuerry.frx":114F
   End
   Begin LpLib.fpCombo fpcboFund2 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnQuerry.frx":15FA
   End
   Begin LpLib.fpCombo fpcboJournalRef 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmPrnQuerry.frx":1AA5
   End

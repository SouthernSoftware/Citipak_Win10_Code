...
Begin VB.Form frmAPMainMenu 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdInvProcMenu 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPMainMenu.frx":0AEC
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdAPChkMenu 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPMainMenu.frx":0CD6
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdAPReportMenu 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPMainMenu.frx":0EBE
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExitAPMainMenu 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPMainMenu.frx":109D
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPOMenu 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPMainMenu.frx":1282
   End
   Begin VB.Line Line3 

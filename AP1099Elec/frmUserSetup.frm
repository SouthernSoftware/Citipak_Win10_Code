...
Begin VB.Form frmUserSetup 
   ...
   Begin LpLib.fpCombo fpcboCDBank 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmUserSetup.frx":0C51
   End
   Begin LpLib.fpCombo fpcboCRBank 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmUserSetup.frx":0FD8
   End
   Begin LpLib.fpCombo fpcboAPChk 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmUserSetup.frx":135F
   End
   Begin VB.ComboBox cboDupInv 
      ...
      EndProperty
      Height          =   348
      ItemData        =   "frmUserSetup.frx":16E6
      Left            =   10152
      List            =   "frmUserSetup.frx":16E8
   ...
   Begin VB.ComboBox cboPSLFlag 
      ...
      EndProperty
      Height          =   348
      ItemData        =   "frmUserSetup.frx":16EA
      Left            =   10152
      List            =   "frmUserSetup.frx":16EC
      Style           =   2  'Dropdown List
      TabIndex        =   17
      Top             =   5112
      Width           =   612
   ...
   Begin VB.ComboBox cboPOStop 
      ...
      EndProperty
      Height          =   348
      ItemData        =   "frmUserSetup.frx":16EE
      Left            =   10152
      List            =   "frmUserSetup.frx":16F0
      Style           =   2  'Dropdown List
      TabIndex        =   16
      Top             =   4728
      Width           =   612
   ...
   Begin VB.ComboBox txtCDActive 
      ...
      EndProperty
      Height          =   384
      ItemData        =   "frmUserSetup.frx":16F2
      Left            =   3840
      List            =   "frmUserSetup.frx":16F4
      Style           =   2  'Dropdown List
      TabIndex        =   12
      Top             =   6648
      Width           =   612

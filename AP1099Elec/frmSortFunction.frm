...
Begin VB.Form frmSortFunction 
   ...
   Begin VB.Image Image1 
      Height          =   384
      Left            =   408
      Picture         =   "frmSortFunction.frx":0000
      Top             =   600
      Width           =   384
   End
   Begin VB.Label Label1 
      ...
      Caption         =   "Ready to Sort Function Index?"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   13.8
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmSortFunction"
...
Private Sub cmdExit_Click()
  Unload frmSortFunction
End Sub

Private Sub cmdOKSort_Click()
  Call MainLog("Sort Function Started - Menu Option.")
  SortFNCTIndex 'this is in main module
  Call MainLog("Sort Function Complete - Menu Option.")
...
Private Sub Form_Load()
  ...
  Me.Left = vLeft
  Me.Top = vTop
  Me.HelpContextID = hlpFunctionIndex
End Sub

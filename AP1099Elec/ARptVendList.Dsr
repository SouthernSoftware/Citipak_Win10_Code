VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptVendList 
   ...
   _ExtentX        =   16383
   _ExtentY        =   10308
   SectionData     =   "ARptVendList.dsx":08CA
End
Attribute VB_Name = "ARptVendList"
...
'    ' or user defined.
    ...
    Fields("City").Value = arr(2)
    Fields("DefDist").Value = arr(3)
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    If KeyCode = vbKeyE Then
      ...
      DoEvents
      MsgBox "File - VendList.xls, created in the Citipak Directory.", vbOKOnly
    End If
    If KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      MsgBox "File - VendList.txt, created in the Citipak Directory.", vbOKOnly
    End If
  End If
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & "VendList.xls"
        oEXL.Export Me.Pages
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & "VendList.txt"
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","

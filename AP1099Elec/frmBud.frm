...
Begin VB.Form frmBudPrepMaint 
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpBtnCopy3 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBud.frx":1B92
   End
   Begin fpBtnAtlLibCtl.fpBtn fpBtnCopy2 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBud.frx":2E5A
   End
   Begin fpBtnAtlLibCtl.fpBtn fpBtnCopy1 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBud.frx":4122
   End
   ...
   Begin FPSpread.vaSpread vaSpread1 
      ...
      ShadowDark      =   8421504
      ShadowText      =   0
      SpreadDesigner  =   "frmBud.frx":53EA
      VisibleCols     =   9
      ClipboardOptions=   4
   End
...
Dim Revrange As Long, Exprange As Long, tmpst As String, ActDate As Integer
...
'****This is where will need to fix Path or shortcut for excel
 ' this is only temp to see if works
  If MsgBox("Would You Like To Save Your Work Before Exporting?", vbYesNo, "Budget Preparation") = vbYes Then
    SaveBudPrep
  End If
'custom headers will not export to excel
...
'  vaSpread1.Formula = "Sum(R1C:R[-1]C)"
  ...
  MaxNum = vaSpread1.DataRowCnt
  Num = 1
  tmpst = "Sum(R1C:R" & Val(Revrange) & "C)"
  vaSpread1.Row = MaxNum + 1
    vaSpread1.Col = 3
    vaSpread1.Text = "Total Revenues:"
  vaSpread1.Col = 4
  vaSpread1.Formula = tmpst
  vaSpread1.Col = 5
  vaSpread1.Formula = tmpst
  vaSpread1.Col = 6
  vaSpread1.Formula = tmpst
 ...
 '
  MaxNum = vaSpread1.DataRowCnt
  Num = 1
  tmpst = "Sum(R" & Val(Revrange + 1) & "C:R" & Val(Exprange) & "C)"

  vaSpread1.Row = MaxNum + 1
    vaSpread1.Col = 3
    vaSpread1.Text = "Total Expenses:"
  ...
  '
    MaxNum = vaSpread1.DataRowCnt
  Num = 1
   tmpst = "R" & Val(MaxNum - 1) & "C-R" & Val(MaxNum) & "C"
  vaSpread1.Row = MaxNum + 1
    vaSpread1.Col = 3
    vaSpread1.Text = "Revs Over/Under Exp:"
...
'  totRevs
End Function
Public Function SetOptions(Fund1 As String, Fund2 As String, AcctCode As String, Detcode As String, TempDate As Integer)

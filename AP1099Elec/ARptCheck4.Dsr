VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptCheck4 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "A/P Laser Checks"
   ClientHeight    =   7080
   ClientLeft      =   30
   ClientTop       =   270
   ClientWidth     =   8760
   Icon            =   "ARptCheck4.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   15452
   _ExtentY        =   12488
   SectionData     =   "ARptCheck4.dsx":08CA
End
Attribute VB_Name = "ARptCheck4"
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    If KeyCode = vbKeyE Then
      ...
      DoEvents
      MsgBox "File - chk4.xls, created in the Citipak Directory.", vbOKOnly
    End If
    If KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      MsgBox "File - chk4.txt, created in the Citipak Directory.", vbOKOnly
    End If
  End If
End Sub
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & "chk4.xls"
        oEXL.Export Me.Pages
        
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & "chk4.txt"
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","

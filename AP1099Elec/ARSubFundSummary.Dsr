VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARSubFundSummary 
   ...
   ClientTop       =   264
   ClientWidth     =   6600
   Icon            =   "ARSubFundSummary.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   StartUpPosition =   3  'Windows Default
   _ExtentX        =   11642
   _ExtentY        =   7726
   SectionData     =   "ARSubFundSummary.dsx":08CA
End
Attribute VB_Name = "ARSubFundSummary"
...
'    ' or user defined.
    ...
    Fields("Debit").Value = arr(1)
    Fields("Credit").Value = arr(2)

VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptTransSumLand 
   ...
   ClientTop       =   264
   ClientWidth     =   8952
   Icon            =   "ARptTransSumLand.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   15790
   _ExtentY        =   7726
   SectionData     =   "ARptTransSumLand.dsx":08CA
End
Attribute VB_Name = "ARptTransSumLand"
...
Public Sub GetName(RName As String)
  ...
  ReportFile$ = RName$
  Part = Timer
  exfile = "GLUS" + Right$(QPTrim(Str(CLng(Part))), 4) + ".xls"
  txfile = "GLUS" + Right$(QPTrim(Str(CLng(Part))), 4) + ".txt"
End Sub
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    If KeyCode = vbKeyE Then
      ...
      DoEvents
      MsgBox "File - " & exfile & ", created in the Citipak Directory.", vbOKOnly
    End If
    If KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      MsgBox "File - " & txfile & ", created in the Citipak Directory.", vbOKOnly
    End If
  End If
End Sub
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & exfile
        oEXL.Export Me.Pages
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & txfile
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","

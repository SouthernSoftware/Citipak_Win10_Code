VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptCloseEntries 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Fund Balance Closing Entries"
   ClientHeight    =   4380
   ClientLeft      =   36
   ClientTop       =   264
   ClientWidth     =   8628
   Icon            =   "ARptCloseEntries.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   15219
   _ExtentY        =   7726
   SectionData     =   "ARptCloseEntries.dsx":08CA
End
Attribute VB_Name = "ARptCloseEntries"
...
'    ' or user defined.
    ...
    Fields("Amount").Value = arr(1)
    Fields("Entry").Value = arr(2)
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    If KeyCode = vbKeyE Then
      ...
      DoEvents
      MsgBox "File - CloseE.xls, created in the Citipak Directory.", vbOKOnly
    End If
    If KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      MsgBox "File - CloseE.txt, created in the Citipak Directory.", vbOKOnly
    End If
  End If
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & "CloseE.xls"
        oEXL.Export Me.Pages
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & "CloseE.txt"
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","

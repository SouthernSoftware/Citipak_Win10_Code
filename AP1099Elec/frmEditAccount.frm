...
Begin VB.Form frmEditAccount 
   ...
   Begin LpLib.fpCombo txtTyp 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmEditAccount.frx":08CA
   End
   Begin LpLib.fpCombo fpcboFunction 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmEditAccount.frx":0CF1
   End
   ...
   End
End
Attribute VB_Name = "frmEditAccount"
...
Private Sub GetAcct(RecordNum As Integer)
  ...
  If GLAcct.FNCTRec > 0 Then
    ...
    fpcboFunction.SearchText = GLAcct.FNCTRec
...
Private Function AcctSearch()
  ...
  FoundAcct = False 'assume we can't find itLen(txtNum) <> (Val(GLFundLen + GLAcctLen + GLDetLen + 2)) Or
...
Private Sub SaveAcct()
  ...
  Close AcctFile
  Call MainLog("GLAcct: " + txtNum + " Saved - GLUtil.")
  Getsorted
...
Private Sub DeleteAcct()
  ...
  If Not Exist("GJEdit.dat") Then
    OpenAcctFile AcctFile
    Get AcctFile, RecordNum, GLAcct
  'For Utilities allows deletion of accts with trans.
    'If GLAcct.LastTran = 0 Then
      GLAcct.Deleted = -1
      Put AcctFile, RecordNum, GLAcct
      Call MainLog("GLAcct: " + txtNum + " Deleted - GLUtil.")
      txtNum = ""
      txtTitle = ""
      txtTyp.ListIndex = -1
      fpcboFunction.ListIndex = 0
...
Private Sub Getsorted()
  ...
  QSortAcctIndex frmEditAccount
  Call MainLog("GLAccts Sorted - GLUTil Edit Acct.")

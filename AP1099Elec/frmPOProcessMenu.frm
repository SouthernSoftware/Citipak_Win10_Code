...
Begin VB.Form frmPOProcessMenu 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdApprvPO 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPOProcessMenu.frx":0AF4
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrintPONA 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPOProcessMenu.frx":0D1B
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrintPOA 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPOProcessMenu.frx":0F42
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrintPOForms 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPOProcessMenu.frx":1165
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPostApprPO 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPOProcessMenu.frx":138F
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExitPOMenu 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPOProcessMenu.frx":1579
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPOControl 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPOProcessMenu.frx":1769
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdCancelOpenPO 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmPOProcessMenu.frx":1957
   End
   Begin VB.Line Line3 

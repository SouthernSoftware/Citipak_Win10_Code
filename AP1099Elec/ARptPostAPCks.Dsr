VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptPostAPCks 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "A/P Check Posting Report"
   ClientHeight    =   6840
   ClientLeft      =   36
   ClientTop       =   264
   ClientWidth     =   9228
   Icon            =   "ARptPostAPCks.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   16277
   _ExtentY        =   12065
   SectionData     =   "ARptPostAPCks.dsx":08CA
End
Attribute VB_Name = "ARptPostAPCks"
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    If KeyCode = vbKeyE Then
      ...
      DoEvents
      MsgBox "File - APChksPost.xls, created in the Citipak Directory.", vbOKOnly
    End If
    If KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      MsgBox "File - APChksPost.txt, created in the Citipak Directory.", vbOKOnly
    End If
  End If
End Sub
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & "APChksPost.xls"
        oEXL.Export Me.Pages
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & "APChksPost.txt"
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","

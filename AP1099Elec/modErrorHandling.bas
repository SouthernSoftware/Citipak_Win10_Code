...
Public Function ErrorMessage( _
  ...
  If (gblnErrorStop) Then
    MsgBox "Please Call Software Support With Message Information.", vbOKOnly, "Error Found"
  End If
  ...
  Call MainLog("ERROR:" & lngErrorNumber & "," & strDescription & "," & strModuleName & "," & strProcName)

...
Begin VB.Form frmPOEnterEdit 
   ...
   Begin TabproLib.vaTabPro vaTabPro1 
      ...
      Begin LpLib.fpList fplstVendor 
         ...
         ResizeRowToFont =   0   'False
         TextTipMultiLine=   0
         ColDesigner     =   "frmPOEnterEdit.frx":19CF
      End
      Begin LpLib.fpCombo fpcboDepartment 
         ...
         EditAlignH      =   0
         EditAlignV      =   0
         ColDesigner     =   "frmPOEnterEdit.frx":1C93
      End
      Begin LpLib.fpCombo fpcboAcctNumNa 
         ...
         EditAlignH      =   0
         EditAlignV      =   0
         ColDesigner     =   "frmPOEnterEdit.frx":2046
      End
      ...
      Begin FPSpread.vaSpread vaSpread1 
         ...
         SpreadDesigner  =   "frmPOEnterEdit.frx":2449
         VisibleCols     =   6
         VisibleRows     =   10
         ScrollBarTrack  =   1
      End

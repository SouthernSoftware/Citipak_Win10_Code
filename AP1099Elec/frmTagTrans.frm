...
Begin VB.Form frmTagTrans 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Tag Transactions"
   ClientHeight    =   8868
   ClientLeft      =   36
   ClientTop       =   540
   ClientWidth     =   12192
   Icon            =   "frmTagTrans.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8868
...
Dim TransFileNum As Integer, NumTrans As Long
  ...
  MsgBox "Records Marked: " & ToPrint1 & Chr$(13) & "Total Debits: " & ToPrint2 & Chr$(13) & "Total Credits: " & ToPrint3, vbOKOnly, "Tagged Transactions"
  Call MainLog("TagTrans Tot = " + Str$(RCnt&))
End Sub

Private Sub fpLongTransNum1_ChangeMode(EditMode As Integer)
  EditMode = True
End Sub
Private Sub fpLongTransNum2_ChangeMode(EditMode As Integer)
  EditMode = True
End Sub

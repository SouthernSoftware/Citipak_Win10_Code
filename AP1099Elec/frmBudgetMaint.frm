VERSION 5.00
Begin VB.Form frmBudgetMaintMenu 
   BackColor       =   &H008F8265&
   ...
   End
End
Attribute VB_Name = "frmBudgetMaintMenu"
...
Private Sub Form_Load()
  ...
  Me.HelpContextID = hlpBudgetMaintenance
End Sub
...
Private Sub PrnEditList()
  ...
  For cnt = 1 To NumEdTrans
    ...
    If BgtEdit.Deleted = 0 Then
         ...
         ToPrint$ = ToPrint$ + "~" + QPTrim$(BgtEdit.Desc) + " " + QPTrim$(BgtEdit.LDesc) + "~" + BgtEdit.Ref
...
Private Sub PrnEditList2()
  ...
  For cnt = 1 To NumEdTrans
    ...
    If BgtEdit.Deleted = 0 Then
         ...
         Print #PRNFileNum, ToPrint$
         Linecnt = Linecnt + 1
         If Len(QPTrim$(BgtEdit.LDesc)) > 0 Then
           Print #PRNFileNum, Tab(13); QPTrim$(BgtEdit.LDesc)
           Linecnt = Linecnt + 1
         End If
         If Linecnt > MaxLines Then
            Print #PRNFileNum, FF$

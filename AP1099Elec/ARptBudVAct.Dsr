VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptBudVAct 
   ...
   ClientTop       =   270
   ClientWidth     =   12225
   Icon            =   "ARptBudVAct.dsx":0000
   StartUpPosition =   2  'CenterScreen
   WindowState     =   2  'Maximized
   _ExtentX        =   21564
   _ExtentY        =   12515
   SectionData     =   "ARptBudVAct.dsx":08CA
End
Attribute VB_Name = "ARptBudVAct"
...
Private Sub GroupFooter1_Format()
  If breakfund = True Or deptpage = True Then

...
Begin VB.Form frmFAViewPrint 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdAlignment 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmFAViewPrint.frx":0000
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrnScn 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmFAViewPrint.frx":0214
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmFAViewPrint.frx":042F
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmFAViewPrint.frx":0643
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmFAViewPrint.frx":0857
   End
End

...
Begin VB.Form frmFAReportOpt 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmFAReportOpt.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdGraphic 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmFAReportOpt.frx":0ADE
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdText 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmFAReportOpt.frx":0CF5
   End
   ...
   End
End
Attribute VB_Name = "frmFAReportOpt"

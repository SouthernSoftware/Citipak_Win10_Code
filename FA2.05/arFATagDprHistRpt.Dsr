VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arFATagDprHistRpt 
   ...
   ClientTop       =   315
   ClientWidth     =   11655
   Icon            =   "arFATagDprHistRpt.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   20558
   _ExtentY        =   15637
   SectionData     =   "arFATagDprHistRpt.dsx":08CA
End
Attribute VB_Name = "arFATagDprHistRpt"
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    ElseIf KeyCode = vbKeyE Then
      ...
      DoEvents
      MsgBox "File - FATagHistRpt.xls, created in the Citipak Directory.", vbOKOnly
      KeyCode = 0
    ElseIf KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      MsgBox "File - FATagHistRpt.txt, created in the Citipak Directory.", vbOKOnly
      KeyCode = 0
    End If
  End If
End Sub
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & "FATagHistRpt.xls"
        oEXL.Export Me.Pages
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & "FATagHistRpt.txt"
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","
...
Private Sub ActiveReport_DataInitialize()
  Dim x As Integer
  HFile = FreeFile
  Open StartPath & "\FARPTS\FATAGDEPRHIST.RPT" For Input As #HFile
...
'  Fields("fldLifeLeft").Value = arr(5)
  ...
  Else
    Fields("fldLifeLeft").Value = arr(5)
  End If
  Fields("fldReversalYN").Value = arr(12)
End Sub
...
Private Sub GroupFooter1_Format()
  Set SubReport1.object = New arSubTagDprHistRpt

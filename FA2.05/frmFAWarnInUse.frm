...
Begin VB.Form frmFAWarnInUse 
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      BackColor       =   192
      Caption         =   ""
      Picture         =   "frmFAWarnInUse.frx":08CA
      Begin LpLib.fpList fpList1 
         ...
         TextTipMultiLine=   0
         ColDesigner     =   "frmFAWarnInUse.frx":08E6
      End
      ...
      Begin VB.Label Label2 
         Alignment       =   2  'Center
         BackStyle       =   0  'Transparent
         Caption         =   $"frmFAWarnInUse.frx":0C56
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   13.5
            Charset         =   0
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmFAWarnInUse.frx":0DB7
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdContinue 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmFAWarnInUse.frx":0FCB
   End
   ...
   End
End
Attribute VB_Name = "frmFAWarnInUse"
...
Private Sub cmdExit_Click()
  ...
  fptxtHide.Text = "Exit"
  frmFAWarnInUse.Hide
  MainLog ("FA in use warning issued...exit option selected.")
End Sub
...
Private Sub cmdContinue_Click()
  ...
  frmFAWarnInUse.Hide
  MainLog ("FA in use warning issued...continue option selected.")
End Sub
...
Private Sub Form_Load()
  ...
  For x = 1 To NumPassRecs
    ...
    If CitiPass.FlagMod = 5 And CitiPass.Module(5).FullAccess = True Then

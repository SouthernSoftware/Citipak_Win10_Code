...
Begin VB.Form frmFAChangedWarning 
   ...
   ClientTop       =   315
   ClientWidth     =   7410
   Icon            =   "frmFAChangedWarning.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmFAChangedWarning.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdReview 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmFAChangedWarning.frx":0AA5
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmFAChangedWarning.frx":0C82
   End
...
Private Sub cmdReview_Click()
  ...
  MainLog ("Exit warning issued...review option chosen in frmFAChangedWarning.")
End Sub
...
Private Sub cmdExit_Click()
  ...
  Unload frmFAChangedWarning
  MainLog ("Exit warning issued...abandon option chosen in frmFAChangedWarning.")
End Sub
...
Private Sub cmdSave_Click()
  ...
  Unload frmFAChangedWarning
  MainLog ("Exit warning issued...save option chosen in frmFAChangedWarning.")
End Sub

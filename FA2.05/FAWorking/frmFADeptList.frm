...
Private Sub cmdHelp_Click()
  MsgBox "You can cut and paste the correct Department Code number by highlighting the desired number in the list and then double clicking on it. Next double click the field where the number should go and the number will appear there."
End Sub
...
Private Sub Form_Load()
   ...
   For x = 1 To NumOfDepts
     fpList1.InsertRow = DeptList(x) 'QPTrim$(DeptRec.IDEPT)
   Next x
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmFADeptList", "frmFAItemEdit", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

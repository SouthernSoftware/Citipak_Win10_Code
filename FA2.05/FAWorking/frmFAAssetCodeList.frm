...
Private Sub cmdHelp_Click()
  MsgBox "You can cut and paste the correct Asset Code number by highlighting the desired number in the list and then double clicking on it. Next double click the field where the number should go and the number will appear there."
End Sub

VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arFATagMaster 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Master Asset Listing by Tag Number"
   ClientHeight    =   8865
   ClientLeft      =   30
   ClientTop       =   315
   ClientWidth     =   11655
   Icon            =   "arFATagMaster.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   20558
   _ExtentY        =   15637
   SectionData     =   "arFATagMaster.dsx":08CA
End
Attribute VB_Name = "arFATagMaster"
...
Private Sub ActiveReport_DataInitialize()
  Dim x As Integer
  HFile = FreeFile
  Open StartPath & "\FARPTS\FATAGMASTER.RPT" For Input As #HFile
  ...
  Fields.Add ("fldDBookTotal") '21)
  Fields.Add ("fldLifeLeft") '22)
  Fields.Add ("fldDEPYN") '23)
  Fields.Add ("fldDisposalDate") '24)
  Fields.Add ("fldDeprYN") '25)
End Sub
...
Private Sub ActiveReport_FetchData(eof As Boolean)
  ...
  End If
  Fields("fldBookVal").Value = arr(13)
  ...
  Fields("fldDBookTotal").Value = arr(21)
  Fields("fldLifeLeft").Value = arr(10) + "/" + arr(22)
  Fields("fldDEPYN").Value = arr(23)
  Fields("fldDisposalDate").Value = arr(24)
  Fields("fldDeprYN").Value = arr(25)
End Sub

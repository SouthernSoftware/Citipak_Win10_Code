...
Begin VB.Form frmFAWarnFilesMissing 
   BackColor       =   &H000000C0&
   BorderStyle     =   0  'None
   Caption         =   "Form1"
   ClientHeight    =   5196
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      FrameThreeDWidth=   4
      FrameWidth      =   8
      Picture         =   "frmFAWarnFileMissing.frx":0000
      Begin LpLib.fpList fplistFileNames 
         ...
         TextTipMultiLine=   0
         ColDesigner     =   "frmFAWarnFileMissing.frx":001C
      End
      ...
      Begin fpBtnAtlLibCtl.fpBtn cmdReturn 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmFAWarnFileMissing.frx":02A8
      End
      Begin VB.Label Label1 
         Alignment       =   2  'Center
         BackStyle       =   0  'Transparent
         Caption         =   $"frmFAWarnFileMissing.frx":0482
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   12
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmFAWarnFilesMissing"

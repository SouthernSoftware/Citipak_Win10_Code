VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arFATagWrntyRpt 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Fixed Assets By Warranty Expiration Date"
   ClientHeight    =   8868
   ClientLeft      =   30
   ClientTop       =   315
   ClientWidth     =   11655
   Icon            =   "arFATagWrntyRpt.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   20558
   _ExtentY        =   15637
   SectionData     =   "arFATagWrntyRpt.dsx":08CA
End
Attribute VB_Name = "arFATagWrntyRpt"
...
Private Sub ActiveReport_DataInitialize()
  Dim x As Integer
  HFile = FreeFile
  Open StartPath & "\FARPTS\FATAGWRNTYRPT.RPT" For Input As #HFile
  ...
  Fields.Add ("fldGTPurchPr") '13)
  Fields.Add ("fldGTBookVal") '14)
  Fields.Add ("fldTotalCnt") '15)
  Fields.Add ("fldDEPYN") '16)
  Fields.Add ("fldLifeLeft") '17)
  Fields.Add ("fldWrnty") '18)
End Sub
...
Private Sub ActiveReport_FetchData(eof As Boolean)
  ...
  Fields("fldGTPurchPr").Value = arr(13)
  Fields("fldGTBookVal").Value = arr(14)
  Fields("fldTotalCnt").Value = arr(15)
  Fields("fldDEPYN").Value = arr(16)
  Fields("fldLifeLeft").Value = arr(17)
  Fields("fldWrnty").Value = arr(18)
  If arr(16) = "N" Then
...
Private Sub ReportFooter_Format()
  Set SubReport1.object = New arFASubWrnty

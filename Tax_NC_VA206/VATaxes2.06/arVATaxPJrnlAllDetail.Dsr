VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arVATaxPJrnlAllDetail 
   ...
   ClientTop       =   420
   ClientWidth     =   11655
   Icon            =   "arVATaxPJrnlAllDetail.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   20558
   _ExtentY        =   15452
   SectionData     =   "arVATaxPJrnlAllDetail.dsx":08CA
End
Attribute VB_Name = "arVATaxPJrnlAllDetail"
...
Private Sub ActiveReport_DataInitialize()
  ...
  Fields.Add ("fldPers") '17)
  Fields.Add ("fldPersPd") '18)
  Fields.Add ("fldPersDif") '19)
  Fields.Add ("fldInt") '20)
  Fields.Add ("fldIntPd") '21)
  Fields.Add ("fldIntDif") '22)
  Fields.Add ("fldMT") '23)
  Fields.Add ("fldMTPd") '24)
  Fields.Add ("fldMTDif") '25)
  Fields.Add ("fldMC") '26)
  Fields.Add ("fldMCPd") '27)
  Fields.Add ("fldMCDif") '28)
  ...
  Fields.Add ("fldFE") '45)
  Fields.Add ("fldFEPd") '46
  Fields.Add ("fldFEDif") '47
  Fields.Add ("fldMH") '48)
  Fields.Add ("fldMHPd") '49
  Fields.Add ("fldMHDif") '50
  Fields.Add ("fldPen") '48)
  Fields.Add ("fldPenPd") '49
  Fields.Add ("fldPenDif") '50
  Fields.Add ("fldThisOperNum") '51)
End Sub
...
Private Sub ActiveReport_FetchData(eof As Boolean)
  ...
  Fields("fldPers").Value = arr(17)
  Fields("fldPersPd").Value = arr(18)
  Fields("fldPersDif").Value = arr(19)
  Fields("fldInt").Value = arr(20)
  Fields("fldIntPd").Value = arr(21)
  Fields("fldIntDif").Value = arr(22)
  Fields("fldMT").Value = arr(23)
  Fields("fldMTPd").Value = arr(24)
  Fields("fldMTDif").Value = arr(25)
  Fields("fldMC").Value = arr(26)
  Fields("fldMCPd").Value = arr(27)
  Fields("fldMCDif").Value = arr(28)
  ...
  Fields("fldFE").Value = arr(45)
  Fields("fldFEPd").Value = arr(46)
  Fields("fldFEDif").Value = arr(47)
  Fields("fldMH").Value = arr(48)
  Fields("fldMHPd").Value = arr(49)
  Fields("fldMHDif").Value = arr(50)
  Fields("fldPen").Value = arr(48)
  Fields("fldPenPd").Value = arr(49)
  Fields("fldPenDif").Value = arr(50)
  Fields("fldThisOperNum").Value = arr(51)
End Sub
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    ElseIf KeyCode = vbKeyE Then
      ...
      DoEvents
      frmVATaxMsg.Label1.Caption = "File - TaxTransPJrnlRptDet.xls, created in the Citipak Directory."
      frmVATaxMsg.Label1.Top = 900
      frmVATaxMsg.Show vbModal
      KeyCode = 0
    ElseIf KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      frmVATaxMsg.Label1.Caption = "File - TaxTransPJrnlRptDet.txt, created in the Citipak Directory."
      frmVATaxMsg.Label1.Top = 900
      frmVATaxMsg.Show vbModal
      KeyCode = 0
    End If
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & "TaxTransPJrnlRptDet.xls"
        oEXL.Export Me.Pages
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & "TaxTransPJrnlRptDet.txt"
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","
...
Private Sub Detail_Format()
  ...
  If BillNum <> CLng(Fields("fldBill").Value) Then
    Detail.Height = 0
    Field8.Visible = False 'tdate
    Field9.Visible = False 'desc
    Field10.Visible = False 'tax year
    Field11.Visible = False 'ppamt
    Field12.Visible = False 'amt
    Field13.Visible = False 'billnum
    Field14.Visible = False 'thistranstype

    Label36.Visible = False 'pers
    ...
    Label27.Visible = False 'belongsto
    Label60.Visible = False
    '-----------------------
    Label57.Visible = False 'fe
    Field114.Visible = False
    Field115.Visible = False
    
    Label58.Visible = False 'mh
    Field112.Visible = False
    Field113.Visible = False
    
    Label59.Visible = False 'pen
    Field116.Visible = False
    Field117.Visible = False
    
    Label60.Visible = False 'oper#
    Field118.Visible = False '0#
    '-----------------------

...
Begin VB.Form frmVATaxBillPrinting 
   ...
   Begin LpLib.fpCombo fpcmbCommentPlace 
      ...
      Left            =   600
      TabIndex        =   48
      ToolTipText     =   $"frmVATaxBillPrinting.frx":08CA
      Top             =   1800
      Visible         =   0   'False
      Width           =   2100
      _Version        =   196608
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxBillPrinting.frx":098C
   End
   Begin LpLib.fpCombo fpcmbBarCode 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxBillPrinting.frx":0D2B
   End
   Begin LpLib.fpCombo fpcmbType 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxBillPrinting.frx":10CA
   End

...
Begin VB.Form frmVATaxDiscountsGiven 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   420
   ClientWidth     =   11655
   Icon            =   "frmVATaxDiscountsGiven.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MinButton       =   0   'False
   ScaleHeight     =   8760
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      FrameThreeDStyle=   1
      FrameWidth      =   2
      Picture         =   "frmVATaxDiscountsGiven.frx":08CA
      Begin LpLib.fpCombo fpcmbTaxYear 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmVATaxDiscountsGiven.frx":08E6
      End
      Begin LpLib.fpCombo fpcmbTownship 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmVATaxDiscountsGiven.frx":0BDD
      End
      Begin LpLib.fpCombo fpcmbPrintOpt 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmVATaxDiscountsGiven.frx":0ED4
      End
      Begin LpLib.fpCombo fpcmbPrintOrder 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmVATaxDiscountsGiven.frx":11CB
      End
      ...
      Begin fpBtnAtlLibCtl.fpBtn cmdExit 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxDiscountsGiven.frx":14C2
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
         ...
         TabIndex        =   17
         TabStop         =   0   'False
         Tag             =   $"frmVATaxDiscountsGiven.frx":16A0
         Top             =   5760
         Width           =   1740
         _Version        =   131072
         _ExtentX        =   3069
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxDiscountsGiven.frx":174B
      End
      Begin VB.Line Line4 
   ...
   End
End
Attribute VB_Name = "frmVATaxDiscountsGiven"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmVATaxDiscountsGiven.")
      Call Terminate
      End
    End If
  End If
...
'  TaxYear = CInt(fpcmbTaxYear.Text)
  ...
  For x = 1 To NumOfTCRecs
    ...
    If TownShip <> "All" And TownShip <> "No Townships Saved" Then
      If QPTrim$(UCase(TaxCust.TownShip)) <> TownShip Then GoTo SkipIt
    End If
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxDiscountGiven", "PrintGraphics", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

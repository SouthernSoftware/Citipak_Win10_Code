...
Begin VB.Form frmVATaxMortgageExport 
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      Begin LpLib.fpCombo fpcmbPrintOpt 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmVATaxMortgageExport.frx":08E6
      End
      Begin LpLib.fpCombo fpcmbRange 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmVATaxMortgageExport.frx":0C15
      End
      Begin LpLib.fpList fpList 
         Height          =   2448
         Left            =   960
         TabIndex        =   9
         Tag             =   $"frmVATaxMortgageExport.frx":0F44
         Top             =   2400
         Width           =   7452
         _Version        =   196608
         _ExtentX        =   13144
         ...
         ResizeRowToFont =   0   'False
         TextTipMultiLine=   0
         ColDesigner     =   "frmVATaxMortgageExport.frx":10BD
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdExit 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxMortgageExport.frx":1465
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
         ...
         TabIndex        =   7
         TabStop         =   0   'False
         Tag             =   $"frmVATaxMortgageExport.frx":1643
         Top             =   6120
         Width           =   1692
         _Version        =   131072
         _ExtentX        =   2984
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxMortgageExport.frx":16DE
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdClear 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxMortgageExport.frx":18BD
      End

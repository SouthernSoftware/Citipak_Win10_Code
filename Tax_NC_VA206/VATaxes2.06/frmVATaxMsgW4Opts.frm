...
Begin VB.Form frmVATaxMsgW4Opts 
   BackColor       =   &H000000C0&
   ...
   ClientTop       =   432
   ClientWidth     =   7008
   Icon            =   "frmVATaxMsgW4Opts.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdDontSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxMsgW4Opts.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxMsgW4Opts.frx":0AAA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdReview 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxMsgW4Opts.frx":0C85
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdAbandonAll 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxMsgW4Opts.frx":0E61
   End
   ...
   End
End
Attribute VB_Name = "frmVATaxMsgW4Opts"

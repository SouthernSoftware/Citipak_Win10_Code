...
Begin VB.Form frmVATaxLateNoticeReprint 
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      Begin LpLib.fpCombo fpcmbRange 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmVATaxLateNoticeReprint.frx":08E6
      End
      Begin LpLib.fpList fpList 
         Height          =   2232
         Left            =   960
         TabIndex        =   10
         Tag             =   $"frmVATaxLateNoticeReprint.frx":0C15
         Top             =   2520
         Width           =   7452
         _Version        =   196608
         _ExtentX        =   13144
         ...
         ResizeRowToFont =   0   'False
         TextTipMultiLine=   0
         ColDesigner     =   "frmVATaxLateNoticeReprint.frx":0D8E
      End
      ...
      Begin fpBtnAtlLibCtl.fpBtn cmdAlign 
         ...
         TabIndex        =   6
         TabStop         =   0   'False
         Tag             =   $"frmVATaxLateNoticeReprint.frx":1135
         Top             =   5520
         Width           =   1548
         _Version        =   131072
         _ExtentX        =   2730
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxLateNoticeReprint.frx":1214
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdExit 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxLateNoticeReprint.frx":13F0
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
         ...
         TabIndex        =   8
         TabStop         =   0   'False
         Tag             =   $"frmVATaxLateNoticeReprint.frx":15CE
         Top             =   5520
         Width           =   1692
         _Version        =   131072
         _ExtentX        =   2984
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxLateNoticeReprint.frx":1669
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdClear 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxLateNoticeReprint.frx":1848
      End

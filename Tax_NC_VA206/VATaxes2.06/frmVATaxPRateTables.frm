...
Begin VB.Form frmVATaxPRateTables 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   420
   ClientWidth     =   11655
   Icon            =   "frmVATaxPRateTables.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxPRateTables.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxPRateTables.frx":0AA8
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdEdit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxPRateTables.frx":0C84
   End
   ...
   End
End
Attribute VB_Name = "frmVATaxPRateTables"

...
Begin VB.Form frmVATaxPrint 
   BackColor       =   &H00C0C0C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "PrintOptions"
   ClientHeight    =   2436
   ClientLeft      =   48
   ClientTop       =   432
   ClientWidth     =   6912
   Icon            =   "frmVATaxPrint.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin LpLib.fpCombo fpcboPrinters 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxPrint.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdCancel 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxPrint.frx":0E61
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxPrint.frx":1077
   End
   ...
   Begin VB.Image Image1 
      Height          =   276
      Left            =   4320
      Picture         =   "frmVATaxPrint.frx":128C
      Top             =   1056
      Width           =   288
   End
   ...
   End
End
Attribute VB_Name = "frmVATaxPrint"
...
Private Sub cmdPrint_Click()
  ...
  If fpcboPrinters.ListIndex <> -1 Then
    ...
    If InStr(1, DPName, "\\", vbTextCompare) Then
      frmVATaxViewPrint.PrintWSet DPName, Copies
    Else
      frmVATaxViewPrint.PrintWSet DefPrinter, Copies
    End If
  Else

...
Begin VB.Form frmVATaxGLList 
   ...
   Begin LpLib.fpList fpList1 
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmVATaxGLList.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdClose 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxGLList.frx":0BAE
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdHelp 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxGLList.frx":0D8B
   End
   ...
   End
End
Attribute VB_Name = "frmVATaxGLList"
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxGLList", "Form Load", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub fpList1_DblClick()
  ...
  If frmVATaxSystemSetup.Visible = True Then
    Unload Me
  End If
End Sub

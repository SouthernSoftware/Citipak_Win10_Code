...
Begin VB.Form frmVATaxReportOptWOpt 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   432
   ClientWidth     =   7260
   Icon            =   "frmVATaxReportOptWOpt.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3540
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdTextNumber 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportOptWOpt.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdGraphicsNumber 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportOptWOpt.frx":0AB2
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportOptWOpt.frx":0C9D
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdGraphicsName 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportOptWOpt.frx":0E79
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdTextName 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportOptWOpt.frx":1063
   End
   ...
   End
End
Attribute VB_Name = "frmVATaxReportOptWOpt"

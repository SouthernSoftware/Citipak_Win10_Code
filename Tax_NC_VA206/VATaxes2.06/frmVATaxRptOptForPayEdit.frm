...
Begin VB.Form frmVATaxRptOptForPayEdit 
   BackColor       =   &H008F8265&
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdTextNumber 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxRptOptForPayEdit.frx":0000
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdGraphicsNumber 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxRptOptForPayEdit.frx":021F
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxRptOptForPayEdit.frx":0442
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdGraphicsName 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxRptOptForPayEdit.frx":0656
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdTextName 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxRptOptForPayEdit.frx":087F
   End
   ...
   End
End
Attribute VB_Name = "frmVATaxRptOptForPayEdit"
...
Private Sub cmdTextNumber_Click()
  fptxtPrintType.Text = "Text Entry"
  Me.Hide
End Sub
...
Private Sub cmdGraphicsNumber_Click()
  fptxtPrintType.Text = "Graphical Entry"
  Me.Hide
End Sub

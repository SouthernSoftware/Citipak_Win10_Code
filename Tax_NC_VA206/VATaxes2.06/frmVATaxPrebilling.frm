...
Begin VB.Form frmVATaxPrebilling 
   ...
   Begin LpLib.fpCombo fpcmbCycle 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxPrebilling.frx":0FF0
   End
   Begin LpLib.fpCombo fpcmbSplit 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxPrebilling.frx":13AF
   End
   Begin LpLib.fpCombo fpcmbPrintOrder 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxPrebilling.frx":1716
   End
   Begin LpLib.fpCombo fpcmbPrintOpt 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxPrebilling.frx":1A7D
   End
   Begin LpLib.fpCombo fpcmbTownships 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxPrebilling.frx":1DE4
   End

...
Begin VB.Form frmVATaxUnpostedPaylist 
   BackColor       =   &H000000C0&
   ...
   ClientTop       =   420
   ClientWidth     =   7068
   Icon            =   "frmVATaxUnpostedPaylist.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4524
   ...
   Begin LpLib.fpList fpList 
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmVATaxUnpostedPaylist.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxUnpostedPaylist.frx":0CA6
   End
   ...
   End
End
Attribute VB_Name = "frmVATaxUnpostedPaylist"
  ...
  For x = 1 To NumOperRecs
    ...
    If BillType = "R" Or BillType = "B" Then
      If Exist("TAXRCPR" + Operator$ + ".DAT") Then
        fpList.AddItem "# " + Operator + "  " + OpName$ + " " + "REAL"
      End If
    End If
    If BillType = "P" Or BillType = "B" Then
      If Exist("TAXPCPR" + Operator$ + ".DAT") Then
        fpList.AddItem "# " + Operator + "  " + OpName$ + " " + "PERSONAL"
      End If
    End If
  Next x

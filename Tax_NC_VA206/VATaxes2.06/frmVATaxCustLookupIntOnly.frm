...
Begin VB.Form frmVATaxCustLookupIntOnly 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "frmVATaxCustLookupIntOnly.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8730
   ...
   Begin LpLib.fpList fpList1 
      ...
      Left            =   840
      TabIndex        =   11
      Tag             =   $"frmVATaxCustLookupIntOnly.frx":08CA
      Top             =   3444
      Width           =   10200
      _Version        =   196608
      _ExtentX        =   17992
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmVATaxCustLookupIntOnly.frx":0A32
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxCustLookupIntOnly.frx":0D9A
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSearch 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxCustLookupIntOnly.frx":0F78
   End
   ...
   End
End
Attribute VB_Name = "frmVATaxCustLookupIntOnly"
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxCustLookupIntOnly", "cmdSearch_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxCustLookupIntOnly", "fpList1_DblClick", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmVATaxCustLookupIntOnly.")
      Call Terminate
      End
    End If
  End If

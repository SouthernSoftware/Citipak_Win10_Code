...
Begin VB.Form frmVATaxRealLsrItemized 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Real Laser Itemized Tax Bill"
   ClientHeight    =   8760
   ClientLeft      =   36
   ClientTop       =   420
   ClientWidth     =   11652
   Icon            =   "frmVATaxRealLsrItemized.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8760
   ...
   Begin LpLib.fpCombo fpcboLogo 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxRealLsrItemized.frx":08CA
   End
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Tax Real Itemized Bill Letter Printing"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   13.8
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmVATaxRealLsrItemized"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmVATaxRealLsrItemized.")
      Call Terminate
      End
    End If
  End If
...
Private Sub TestLtrBillPrint()
  ...
  Open ReportFile$ For Output As #RptHandle
    ...
    '                61      62      63       64      65      66
    Print #RptHandle, 0; dlm; 0; dlm; 0; dlm; 0; dlm; 1; dlm; ""
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxRealLsrItemized", "TestLtrBillPrint", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxRealLsrItemized", "SaveTxDef", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub LoadMe()
  ...
  If Exist(LaserRealItemBill) Then
    OpenLaserRealItemized TBHandle
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxRealLtrItemized", "LoadMe", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

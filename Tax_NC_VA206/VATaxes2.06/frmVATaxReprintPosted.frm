...
Begin VB.Form frmVATaxReprintPosted 
   ...
   Begin LpLib.fpList fpList1 
      ...
      ResizeRowToFont =   0   'False
      TextTipMultiLine=   0
      ColDesigner     =   "frmVATaxReprintPosted.frx":0BF9
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdClear 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReprintPosted.frx":0F99
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReprintPosted.frx":117A
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReprintPosted.frx":1359
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdAlign 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReprintPosted.frx":1535
   End

...
Begin VB.Form frmVATaxMortCodeRpt 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "frmVATaxMortCodeRpt.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8730
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      FrameThreeDStyle=   1
      FrameWidth      =   2
      Picture         =   "frmVATaxMortCodeRpt.frx":08CA
      Begin LpLib.fpCombo fpcmbTownship 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmVATaxMortCodeRpt.frx":08E6
      End
      Begin LpLib.fpCombo fpcmbPrintOpt 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmVATaxMortCodeRpt.frx":0BDD
      End
      Begin LpLib.fpCombo fpcmbPrintOrder 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmVATaxMortCodeRpt.frx":0ED4
      End
      Begin LpLib.fpCombo fpcmbMortCodes 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmVATaxMortCodeRpt.frx":11CB
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdExit 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxMortCodeRpt.frx":1546
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
         ...
         TabIndex        =   13
         TabStop         =   0   'False
         Tag             =   $"frmVATaxMortCodeRpt.frx":1724
         Top             =   5280
         Width           =   1740
         _Version        =   131072
         _ExtentX        =   3069
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxMortCodeRpt.frx":17CF
      End
   ...
   End
End
Attribute VB_Name = "frmVATaxMortCodeRpt"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmVATaxMortCodeRpt.")
      Call Terminate
      End
    End If
  End If
...
Private Sub LoadMe()
  ...
  fpcmbMortCodes.InsertRow = "All" + Chr(9) + "No Desc" + Chr(9) + "0"
  fpcmbMortCodes.SearchText = "All" + Chr(9) + "No Desc" + Chr(9) + "0"
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxMortCodeRpt", "LoadMe", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub PrintGraphics()
  ...
  End If
  frmVATaxShowPctComp.Label1 = "Gathering Mortgage Code Data"
...
SkipIt:
  ...
  arVATaxMortCodeRpt.Show
  
  Exit Sub

ERRORSTUFF:
   Unload frmVATaxShowPctComp
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxMortCodeRpt", "PrintGraphics", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Unload frmVATaxShowPctComp
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxMortCodeRpt", "PrintText", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

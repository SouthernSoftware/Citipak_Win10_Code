...
Begin VB.Form frmVATaxRealTInfo 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "frmVATaxRealTInfo.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin LpLib.fpList fpList1 
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmVATaxRealTInfo.frx":08CA
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxRealTInfo.frx":0C37
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdDetail 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxRealTInfo.frx":0E15
   End
   ...
   End
End
Attribute VB_Name = "frmVATaxRealTInfo"
...
Private Sub cmdDetail_Click()
  ...
  frmVATaxRealTInfo.fpList1.Col = 3
  frmVATaxRealTInfo.fpList1.Row = frmVATaxRealTInfo.fpList1.ListIndex
  ThisRec = CLng(frmVATaxRealTInfo.fpList1.ColText)
  ...
  If ThisRec > 0 Then
    ...
    If TaxTRec.TranType = 1 Then
      frmVATaxRealTransDetail.Show vbModal
    Else
      frmVATaxRealTransDetailNotBill.Show vbModal
    End If
  Else
    frmVATaxRealTransDetailNotBill.Show vbModal
  End If
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmVATaxRealTInfo.")
      Call Terminate
      End
    End If
  End If
...
Private Sub LoadMe()
  ...
  PropPin = QPTrim$(frmVATaxRealProp.fptxtRealPin.Text)
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxRealTInfo", "LoadMe", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxRealTInfo", "fpList1_DblClick", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

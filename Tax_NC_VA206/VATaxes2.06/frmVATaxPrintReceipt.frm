...
Begin VB.Form frmVATaxPrintReceipt 
   BackColor       =   &H000000C0&
   BorderStyle     =   0  'None
   Caption         =   "Form1"
   ClientHeight    =   3516
   ...
   ClientTop       =   0
   ClientWidth     =   7092
   Icon            =   "frmVATaxPrintReceipt.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   ScaleHeight     =   3516
   ScaleWidth      =   7092
   ...
   Begin LpLib.fpCombo fpcboReceipt 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxPrintReceipt.frx":08CA
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxPrintReceipt.frx":0BED
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdCont 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxPrintReceipt.frx":0E01
   End
   ...
   End
End
Attribute VB_Name = "frmVATaxPrintReceipt"

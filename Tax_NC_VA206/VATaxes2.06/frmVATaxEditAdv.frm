...
Begin VB.Form frmVATaxEditAdv 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxEditAdv.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxEditAdv.frx":0AA6
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdDelete 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxEditAdv.frx":0C82
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrev 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxEditAdv.frx":0E5F
      Begin fpBtnAtlLibCtl.fpBtn fpBtn1 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxEditAdv.frx":103A
      End
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdNext 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxEditAdv.frx":1216
      Begin fpBtnAtlLibCtl.fpBtn fpBtn3 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxEditAdv.frx":13ED
      End
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdHome 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxEditAdv.frx":15C9
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdEnd 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxEditAdv.frx":17A0
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdLookup 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxEditAdv.frx":1976
   End
   ...
   End
End
Attribute VB_Name = "frmVATaxEditAdv"
...
Private Sub cmdLookup_Click()
  If ThisInt <> CDbl(fpCurrInt.Value) Then
    ...
    End If
  End If
  frmVATaxCustLookupAdvOnly.Show
  DoEvents
End Sub
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmVATaxEditAdv.")
      Call Terminate
      End
    End If
  End If

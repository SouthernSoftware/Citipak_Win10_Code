...
Begin VB.Form frmVATaxMailLblsLateNotice 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "frmVATaxMaiLblsLateNotice.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8730
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      FrameThreeDStyle=   1
      FrameWidth      =   2
      Picture         =   "frmVATaxMaiLblsLateNotice.frx":08CA
      Begin LpLib.fpList fpList 
         Height          =   1368
         Left            =   960
         TabIndex        =   6
         Tag             =   $"frmVATaxMaiLblsLateNotice.frx":08E6
         Top             =   3360
         Width           =   7452
         _Version        =   196608
         _ExtentX        =   13144
         ...
         TextTipMultiLine=   0
         ColDesigner     =   "frmVATaxMaiLblsLateNotice.frx":0A5F
      End
      Begin LpLib.fpCombo fpcmbLabel 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmVATaxMaiLblsLateNotice.frx":0E3E
      End
      Begin LpLib.fpCombo fpcmbRange 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmVATaxMaiLblsLateNotice.frx":11A5
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdAlign 
         ...
         TabIndex        =   7
         TabStop         =   0   'False
         Tag             =   $"frmVATaxMaiLblsLateNotice.frx":150C
         Top             =   5520
         Width           =   1548
         _Version        =   131072
         _ExtentX        =   2730
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxMaiLblsLateNotice.frx":15EB
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdExit 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxMaiLblsLateNotice.frx":17C7
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
         ...
         TabIndex        =   9
         TabStop         =   0   'False
         Tag             =   $"frmVATaxMaiLblsLateNotice.frx":19A5
         Top             =   5520
         Width           =   1692
         _Version        =   131072
         _ExtentX        =   2984
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxMaiLblsLateNotice.frx":1A40
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdClear 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxMaiLblsLateNotice.frx":1C1F
      End
   ...
   End
End
Attribute VB_Name = "frmVATaxMailLblsLateNotice"
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxMailLblsLateNotice", "cmdAlign_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxMailLblsLateNotice", "PrintText", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      ...
      ClearInUse PWcnt
      MainLog ("CitiTax.exe terminated via menu bar on frmVATaxMailLblsLateNotice.")
      Call Terminate
      End
    End If
  End If
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxMailLblsLateNotice", "PrintGraphics", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arVATaxSubCustTransJrnl 
   ...
   _ExtentX        =   16785
   _ExtentY        =   5101
   SectionData     =   "arVATaxSubCustTransJrnl.dsx":0000
End
Attribute VB_Name = "arVATaxSubCustTransJrnl"
...
Private Sub ActiveReport_DataInitialize()
  Dim x As Integer
  hFile = FreeFile
  Open StartPath & "\TAXRPTS\SUBCTAXJRNL.RPT" For Input As #hFile

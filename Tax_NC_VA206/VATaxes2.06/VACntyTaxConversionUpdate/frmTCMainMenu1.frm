...
Begin VB.Form frmTCMainMenu1 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdMatch 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTCMainMenu1.frx":0AB1
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdNew 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTCMainMenu1.frx":0C99
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdConvert 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTCMainMenu1.frx":0E82
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTCMainMenu1.frx":1068
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdResults 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTCMainMenu1.frx":124E
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdInstructions 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTCMainMenu1.frx":1430
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdChangeCoNums 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTCMainMenu1.frx":1610
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdAppendwithPP 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTCMainMenu1.frx":17FD
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdClearCntyNums 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTCMainMenu1.frx":19E8
   End

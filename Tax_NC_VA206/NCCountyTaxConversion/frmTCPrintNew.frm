...
Begin VB.Form frmTCPrintNew 
   ...
   Begin LpLib.fpCombo fpcboPrinters 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmTCPrintNew.frx":0000
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdCancel 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTCPrintNew.frx":0367
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTCPrintNew.frx":0545
   End
   ...
   Begin VB.Image Image1 
      Height          =   276
      Left            =   4460
      Picture         =   "frmTCPrintNew.frx":0722
      Top             =   1074
      Width           =   288
   End
End
Attribute VB_Name = "frmTCPrintNew"
...
Private Sub cmdPrint_Click()
  ...
  If fpcboPrinters.ListIndex <> -1 Then
    ...
    If InStr(1, DPName, "\\", vbTextCompare) Then
      frmTCViewPrint.PrintWSet DPName, Copies
    Else
      frmTCViewPrint.PrintWSet DefPrinter, Copies
    End If
  Else

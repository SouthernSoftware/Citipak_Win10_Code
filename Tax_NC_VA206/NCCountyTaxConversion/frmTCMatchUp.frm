...
Begin VB.Form frmTCMatchUp 
   ...
   Begin FPSpread.vaSpread vaSpread 
      ...
      MaxCols         =   4
      MaxRows         =   100
      SpreadDesigner  =   "frmTCMatchUp.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTCMatchUp.frx":1081
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTCMatchUp.frx":130A
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdLoadCoData 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTCMatchUp.frx":14E9
   End
   Begin VB.Label Label2 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   $"frmTCMatchUp.frx":16D0
      ForeColor       =   &H8000000E&
      Height          =   612
      Left            =   480
      TabIndex        =   6
   ...
   End
End
Attribute VB_Name = "frmTCMatchUp"
          ...
          For y = 1 To RowCnt
            If ColData(y) = ColCnt Then 'match up columns
              Select Case y
                ...
                Case 26
                  If QPTrim$(ThisWord) = "" Then ThisWord = "0"
                  TempRec.CData.BLOCK = CInt(ThisWord)
                  Exit For
                Case 27
                  If QPTrim$(ThisWord) = "" Then ThisWord = "0"
                  TempRec.CData.Map = CInt(ThisWord)
                  Exit For
                Case 28
...
NewWord:
      ...
      TempRec.CData.PEXMPSENI = TempRec.CData.PEXMPSENI
LoopIt:
    Loop
  End If
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmTCMatchUp.")
      End
    End If
  End If

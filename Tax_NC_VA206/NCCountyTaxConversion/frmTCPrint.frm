...
Begin VB.Form frmTCPrint 
   ...
   Begin LpLib.fpCombo fpcboPrinters 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmTCPrint.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdCancel 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTCPrint.frx":0C31
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTCPrint.frx":0E0F
   End

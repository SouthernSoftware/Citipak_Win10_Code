...
Public Function TCMsgW3Opts(Top As Integer, Message As String, CmdF5 As String, CmdF10 As String, CmdESC As String) As String
  frmTCMsgW3Opts.Label1.Caption = Message
  frmTCMsgW3Opts.Label1.Top = Top
  frmTCMsgW3Opts.cmdCont.Text = CmdF10 'continue
  frmTCMsgW3Opts.cmdExit.Text = CmdESC 'abort
  frmTCMsgW3Opts.cmdOption.Text = CmdF5 'option
  frmTCMsgW3Opts.Show vbModal
  TCMsgW3Opts = frmTCMsgW3Opts.fptxtChoice.Text
End Function
...
Public Sub CheckDirs()
  ...
  If Not DirExists(ThisDir) Then
    frmTCMsgWOpts.Label1.Caption = "The directory 'TAXRPTS' could not be located in the Citipak directory. Without the 'PRRPTS' directory graphics report printing is not possible. If you wish to create the 'PRRPTS' directory then press F10. Otherwise press ESC and call Southern Software @ 1-800-842-8190 for support."
    frmTCMsgWOpts.Label1.Top = 500
    frmTCMsgWOpts.cmdCont.Text = "F10 Make TAXRPTS"
    frmTCMsgWOpts.cmdExit.Text = "ESC Escape"
    frmTCMsgWOpts.Show vbModal
    If frmTCMsgWOpts.fptxtChoice.Text = "continue" Then
      Unload frmTCMsgWOpts
  ...
  If Not DirExists(ThisDir) Then
    frmTCMsgWOpts.Label1.Caption = "The directory 'TAXRDF' could not be located in the Citipak directory. Without the 'TAXRDF' directory graphics reports reprints are not possible. If you wish to create the 'TAXRDF' directory then press F10. Otherwise press ESC and call Southern Software @ 1-800-842-8190 for support."
    frmTCMsgWOpts.Label1.Top = 500
    frmTCMsgWOpts.cmdCont.Text = "F10 Make TAXRDF"
    frmTCMsgWOpts.cmdExit.Text = "ESC Escape"
    frmTCMsgWOpts.Show vbModal
    If frmTCMsgWOpts.fptxtChoice.Text = "continue" Then
      Unload frmTCMsgWOpts
  ...
  If Not DirExists(ThisDir) Then
    If TCMsgWOpts(700, "The directory 'TAXImages' could not be located in the Citipak directory. Press F10 if you would like to create this necessary directory now. Otherwise, press ESC to skip.", "F10 MAKE 'TAXImages'", "ESC SKIP") = "abort" Then
      Unload frmTCMsgWOpts
    Else
      Unload frmTCMsgWOpts
  ...
  If Not DirExists(ThisDir) Then
    If TCMsgWOpts(700, "The directory 'TAXMortExp' could not be located in the Citipak directory. Press F10 if you would like to create this necessary directory now. Otherwise, press ESC to skip.", "F10 MAKE 'TAXMortExp'", "ESC SKIP") = "abort" Then
      Unload frmTCMsgWOpts
    Else
      Unload frmTCMsgWOpts
  ...
  If Not DirExists(ThisDir) Then
    If TCMsgWOpts(700, "The directory 'TAXBILLBU' could not be located in the Citipak directory. Press F10 if you would like to create this necessary directory now. Otherwise, press ESC to skip.", "F10 MAKE 'TAXBILLBU'", "ESC SKIP") = "abort" Then
      Unload frmTCMsgWOpts
    Else
      Unload frmTCMsgWOpts

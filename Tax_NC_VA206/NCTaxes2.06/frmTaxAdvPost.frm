...
Begin VB.Form frmTaxAdvPost 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdPost 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxAdvPost.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxAdvPost.frx":0AA6
   End
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      BackColor       =   &H000000C0&
      Caption         =   $"frmTaxAdvPost.frx":0C82
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   15.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmTaxAdvPost"
...
Private Sub cmdPost_Click()
  ...
  Dim Cnt&, NextRecord&
  Dim Previous&
'  If InStr(TaxSetupRec(1).Name, "HMLT24TF") > 0 Then
'    HamFlag = True
'  End If
...
'      End If
      ...
      TaxTrans.BillType = ""     'R=Real P=Personal Property C=Combined (NC/GA)
      ...
      TaxTrans.Revenue.PrePaidBal = GetOverPayBalance(TaxAdvRec.CustRec)
...
'      End If
      ...
      TaxTrans.RealPin = TaxAdvRec.RealPin 'added 6/5/07
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxAdvPost", "cmdPost_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmTaxAdvPost.")
      Call Terminate
      End
    End If
  End If

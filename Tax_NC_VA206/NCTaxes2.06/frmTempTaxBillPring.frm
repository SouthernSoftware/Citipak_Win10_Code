...
Private Sub PrintBills()
  ...
  For x = 1 To NumOfTBRecs
    ...
    Print #RptHandle, OldRound(TBRec.RealValue + TBRec.PersValue); dlm; TBRec.RealTaxRate; dlm;
    
    Print #RptHandle, TBRec.TotalBillDue; dlm; QPTrim$(TBRec.CustZip); dlm; TBRec.LateTaxDue; dlm; "$0.00"; dlm; "N"
  Next x
  Close TBHandle
  If fpcboLogo.ListIndex = 1 Then
    If Exist(StartPath$ + "txTNlogo.bmp") Then
      ARptTempTaxBill.Image1.Picture = LoadPicture(StartPath$ + "txTNlogo.bmp")
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTempTaxBillPrint", "PrintBills", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmTempTaxBillPrint.")
      Call Terminate
      End
    End If
  End If
...
Private Sub TestLtrBillPrint()
  ...
  ReportFile$ = StartPath$ + "/Tstbil1.PRN"
  TaxRptT = FreeFile
  ...
  ToPrint$ = ToPrint$ + "~HENDERSONVILLE NC 28793" '4
  ToPrint$ = ToPrint$ + "~001079847" '5
  ToPrint$ = ToPrint$ + "~0798-00-49-7585" '6
  ToPrint$ = ToPrint$ + "~PRIVATE RESIDENCE" '7
  ToPrint$ = ToPrint$ + "~105,200" '8
  ToPrint$ = ToPrint$ + "~0" '9
  ToPrint$ = ToPrint$ + "~0" '10
  ToPrint$ = ToPrint$ + "~105,200" '11
  ToPrint$ = ToPrint$ + "~$0.43" '12
  ToPrint$ = ToPrint$ + "~$467.36" '13
  ToPrint$ = ToPrint$ + "~0" '14
  ToPrint$ = ToPrint$ + "~0" '15
  ToPrint$ = ToPrint$ + "~$10.00" '16
  ToPrint$ = ToPrint$ + "~$5.00" '17
  ToPrint$ = ToPrint$ + "~$.00" '18
  ToPrint$ = ToPrint$ + "~MISC A" '19
  ToPrint$ = ToPrint$ + "~MISC B" '20
  ToPrint$ = ToPrint$ + "~MISC C" '21
  ToPrint$ = ToPrint$ + "~55555-5555" '22
  ToPrint$ = ToPrint$ + "~0.00" '23
  ToPrint$ = ToPrint$ + "~0.00" '24
  ToPrint$ = ToPrint$ + "~False" '25
  ...
  If fpcboLogo.Text = "Yes" Then
    ...
    End If
  End If
  ARptTempTaxBill.Head1 = QPTrim(fpTxtHead1) '0
  ARptTempTaxBill.Head2 = QPTrim(fpTxtHead2) '1
  ARptTempTaxBill.LblOpt1 = QPTrim(fptxtOpt1) '2
  ARptTempTaxBill.LblOpt2 = QPTrim(fpTxtOpt2) '3
  ARptTempTaxBill.LblOpt3 = QPTrim(fpTxtOpt3) '4
  ARptTempTaxBill.LblOpt4 = QPTrim(fpTxtOpt4) '5
  ARptTempTaxBill.LblPgph1 = QPTrim(fptxtPgph(0)) '6
  ARptTempTaxBill.LblPgph2 = QPTrim(fptxtPgph(1)) '7
  ARptTempTaxBill.LblPgph3 = QPTrim(fptxtPgph(2)) '8
  ARptTempTaxBill.LblPgph4 = QPTrim(fptxtPgph(3)) '9
  ARptTempTaxBill.LblPgph5 = QPTrim(fptxtPgph(4)) '10
  ARptTempTaxBill.LblPgph6 = QPTrim(fptxtPgph(5)) '11
  ARptTempTaxBill.LblPgph7 = QPTrim(fptxtPgph(6)) '12
  ARptTempTaxBill.LblPgph8 = QPTrim(fptxtPgph(7)) '13
  ARptTempTaxBill.LblOpt5 = QPTrim(fpTxtOpt5) '14
  ARptTempTaxBill.LblHead4 = QPTrim(fptxtHead4) '15
  ARptTempTaxBill.LblHead5 = QPTrim(fptxtHead5) '16
  ARptTempTaxBill.LblHead6 = QPTrim(fptxtHead6) '17
  ARptTempTaxBill.LblOpt6 = QPTrim(fpTxtOpt6) '18
  ARptTempTaxBill.LblOpt7 = QPTrim(fpTxtOpt7) '19
  ARptTempTaxBill.GetName ReportFile$ '20
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTempTaxBillPrint", "TestLtrBillPrint", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub SaveTxDef()
  Dim TBRec As TxBill1DefaultsType
  Dim TBHandle As Integer
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTempTaxBillPrint", "SaveTxDef", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTempTaxBillPrint", "LoadMe", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

...
Begin VB.Form frmTaxMsgW3Opts 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxMsgW3Opts.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdCont 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxMsgW3Opts.frx":0AA5
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdOption 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxMsgW3Opts.frx":0C84
   End
   ...
   End
End
Attribute VB_Name = "frmTaxMsgW3Opts"

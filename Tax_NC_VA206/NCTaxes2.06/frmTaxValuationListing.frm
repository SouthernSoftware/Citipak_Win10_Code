...
Begin VB.Form frmTaxValuationListing 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "frmTaxValuationListing.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8730
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      FrameThreeDStyle=   1
      FrameWidth      =   2
      Picture         =   "frmTaxValuationListing.frx":08CA
      Begin LpLib.fpCombo fpcmbTownship 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmTaxValuationListing.frx":08E6
      End
      Begin LpLib.fpCombo fpcmbPropType 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmTaxValuationListing.frx":0CC1
      End
      Begin LpLib.fpCombo fpcmbIncInactive 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmTaxValuationListing.frx":109C
      End
      Begin LpLib.fpCombo fpcmbPrintOrder 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmTaxValuationListing.frx":1477
      End
      Begin LpLib.fpCombo fpcmbDetSum 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmTaxValuationListing.frx":1852
      End
      Begin LpLib.fpCombo fpcmbPrintOpt 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmTaxValuationListing.frx":1C2D
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdExit 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxValuationListing.frx":2008
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
         ...
         TabIndex        =   9
         TabStop         =   0   'False
         Tag             =   $"frmTaxValuationListing.frx":21E6
         Top             =   6210
         Width           =   1740
         _Version        =   131072
         _ExtentX        =   3069
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxValuationListing.frx":2291
      End
      Begin EditLib.fpText fptxtAddress 
         Height          =   405
         Left            =   3480
         TabIndex        =   0
         ToolTipText     =   $"frmTaxValuationListing.frx":2470
         Top             =   1800
         Width           =   2820
         _Version        =   196608
         _ExtentX        =   4974
   ...
   End
End
Attribute VB_Name = "frmTaxValuationListing"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmTaxValuationListing.")
      Call Terminate
      End
    End If
  End If
...
Private Sub LoadMe()
  ...
  If Exist(TaxTownships) Then
    ...
    Close TSHandle
  End If
  fpcmbPropType.Text = "Combined"
  fpcmbPropType.AddItem "Combined"
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxValuationListing", "LoadMe", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
  ...
  For x = 1 To NumOfTCRecs
    ...
    If IdxFlag = True Then
      If SearchFlag = True Then
        ...
        If FirstTime = True Then 'added 11/3/06
          NewLtr = ThisLtr
          FirstTime = False
        End If
...
'    End If
    ...
    Do While WhatPers > 0
      ...
      ThisPersVal = 0
      ThisNet = OldRound(ThisRealVal - ThisDscntVal)
      ...
      AlphaTotVal = OldRound(AlphaTotVal + RealRec.PROPVALU + RealRec.EXMPSENI + RealRec.EXMPOTHR)
...
PersOnly:
    If QPTrim$(fpcmbPropType.Text) = "Combined" Then
    ...
    Do While WhatPers > 0
      ...
      GTotCnt = GTotCnt + 1
      ThisRealVal = 0
      ThisDscntVal = OldRound(PersRec.EXMPSENI + PersRec.EXMPOTHR)
      ...
      ReDim Preserve CustDscntVal(1 To ThisCustCnt) As Double
      CustDscntVal(ThisCustCnt) = OldRound(CustDscntVal(ThisCustCnt) + PersRec.EXMPSENI + PersRec.EXMPOTHR)
      CustDscntTot = OldRound(CustDscntTot + ThisDscntVal)
      ...
      GDscntVal = OldRound(GDscntVal + PersRec.EXMPOTHR + PersRec.EXMPSENI)
      GTotVal = OldRound(GTotVal + PersRec.PersVal + PersRec.EXMPSENI + PersRec.EXMPOTHR)
      AlphaCnt = AlphaCnt + 1
      AlphaRealVal = AlphaRealVal + 0
      AlphaPersVal = OldRound(AlphaPersVal + ThisPersVal)
      AlphaDscntVal = OldRound(AlphaDscntVal + PersRec.EXMPSENI + PersRec.EXMPOTHR)
      AlphaTotVal = OldRound(AlphaTotVal + PersRec.PersVal + PersRec.EXMPSENI + PersRec.EXMPOTHR)
      AlphaNet = OldRound(AlphaNet + ThisNet)
      GNet = OldRound(GNet + ThisNet)
      PrintThis = True
'    End If
...
PrintIt:
  ...
  For y = 1 To ThisCustCnt
    ...
    If UseOpt = "Y" Then
      '                    27                    28                         29             30
      Print #RptHandle, ThisOpt; dlm; QPTrim$(TaxCust.OptSrchDesc); dlm; PropType; dlm; PrintOrder
    Else
      '                 27       28          29              30
      Print #RptHandle, ""; dlm; ""; dlm; PropType; dlm; PrintOrder
    End If
  Next y
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxValuationListing", "PrintGraphicsDet", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
'    End If
    ...
    Do While WhatPers > 0
      ...
      CustDscntVal = OldRound(CustDscntVal + RealRec.EXMPSENI + RealRec.EXMPOTHR)
      CustPersVal = CustPersVal + 0
      CustNet = OldRound(CustNet + ThisPersVal + ThisRealVal - ThisDscntVal)
      GRealVal = OldRound(GRealVal + RealRec.PROPVALU)
      GPersVal = GPersVal + 0
      GDscntVal = OldRound(GDscntVal + RealRec.EXMPSENI + RealRec.EXMPOTHR)
      GTotVal = OldRound(GTotVal + RealRec.PROPVALU + RealRec.EXMPSENI + RealRec.EXMPOTHR)
...
PersOnly:
    ...
    Do While WhatPers > 0
      ...
      CustDscntVal = OldRound(CustDscntVal + PersRec.EXMPSENI + PersRec.EXMPOTHR)
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxValuationListing", "PrintGraphics", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
PrintIt:
  ...
  For y = 1 To ThisCustCnt
    Print #RptHandle, Tab(5); ThisPin(y); Tab(31); Using$("##,###,##0.00", CustRealVal(y)); Tab(45); Using$("##,###,##0.00", CustPersVal(y)); Tab(59); Using$("##,###,##0.00", CustDscntVal(y)); Tab(73); Using$("##,###,##0.00", CustNet(y))
    LineCnt = LineCnt + 1
...
PrintHeader:
  ...
  Print #RptHandle, "Acct# "; Tab(7); "Customer Name"; Tab(40); "Real"; Tab(54); "Pers"; Tab(66); "Discnt"; Tab(83); "Net"
...
PrintCustHeader:
  ...
  LineCnt = LineCnt + 1
  End If
  Print #RptHandle, Using$("####0", TaxCust.Acct); Tab(7); ThisName; Tab(31); Using$("##,###,##0.00", CustRealTot); Tab(45); Using$("##,###,##0.00", CustPersTot); Tab(59); Using$("##,###,##0.00", CustDscntTot); Tab(73); Using$("##,###,##0.00", CustNetTot)
  If UseOpt = "Y" Then
...
PrintAlphaHeader:
  ...
  ElseIf ActiveFlag = "I" And LineCnt <> 8 Then
    ...
    LineCnt = LineCnt + 1
  End If
  Print #RptHandle, Tab(2); "Summary for '" + NewLtr + "'"; Tab(18); "Cnt: " + Using$("####0", AlphaCustCnt); Tab(31); Using$("##,###,##0.00", AlphaRealVal); Tab(45); Using$("##,###,##0.00", AlphaPersVal); Tab(59); Using$("##,###,##0.00", AlphaDscntVal); Tab(73); Using$("##,###,##0.00", AlphaNet)
  Print #RptHandle, String(85, "-")
  Print #RptHandle,
  Print #RptHandle,
  LineCnt = LineCnt + 4
...
PrintSummary:
  ...
  Print #RptHandle, "Total Personal Value:   " + Using$("$#,###,###,##0.00", GPersVal)
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxValuationListing", "PrintTextDet", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxValuationListing", "PrintText", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

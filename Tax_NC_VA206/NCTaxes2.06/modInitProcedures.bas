...
Const SW_MAX = 10
  ...
  Global Const hlpRealPropClass = 56
  Global PassP As String 'added 2/14/08
  Global TypeSysOP As Integer 'added 2/14/08
...
Global RcptFileName As String 'added 2/14/08
Type OSVERSIONINFO 'added 2/14/08
...
'  OperNum = 4 'for testing purposes only
      ...
      If Not CitiPassFile = -1 Then
        ...
        If Not CitiPass.DelFlag Then
          If CitiPass.Module(6).FullAccess = True Then
            LevelPass = 1
          ElseIf CitiPass.Module(6).PaymentAccess = True Then 'swapped 3 and 2 on 3/17/08
            LevelPass = 3
...
'    Else
'      PassP$ = "C:\PassTemp.dat" 'don't touch 2/14/08

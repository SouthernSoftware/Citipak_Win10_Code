...
Begin VB.Form frmTaxMsgWOpts 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxMsgWOpts.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdCont 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxMsgWOpts.frx":0AA5
   End
   ...
   End
End
Attribute VB_Name = "frmTaxMsgWOpts"

...
Begin VB.Form frmTaxPersProp 
   ...
   Begin LpLib.fpCombo fpcmbLateListYN 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmTaxPersProp.frx":0D15
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPersProp.frx":1160
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPersProp.frx":133C
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdDelete 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPersProp.frx":1518
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdAdd1 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPersProp.frx":16F5
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPageDown1 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPersProp.frx":18CF
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPageUp1 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPersProp.frx":1AAB
   End

...
Begin VB.Form frmTaxLateNoticeReprint 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "frmTaxLateNoticeReprint.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8730
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      FrameThreeDStyle=   1
      FrameWidth      =   2
      Picture         =   "frmTaxLateNoticeReprint.frx":08CA
      Begin LpLib.fpList fpList 
         Height          =   2232
         Left            =   960
         TabIndex        =   1
         Tag             =   $"frmTaxLateNoticeReprint.frx":08E6
         Top             =   2520
         Width           =   7452
         _Version        =   196608
         _ExtentX        =   13144
         ...
         TextTipMultiLine=   0
         ColDesigner     =   "frmTaxLateNoticeReprint.frx":0A5F
      End
      Begin LpLib.fpCombo fpcmbRange 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmTaxLateNoticeReprint.frx":0EB2
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdAlign 
         ...
         TabIndex        =   3
         TabStop         =   0   'False
         Tag             =   $"frmTaxLateNoticeReprint.frx":128D
         Top             =   5616
         Width           =   1548
         _Version        =   131072
         _ExtentX        =   2730
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxLateNoticeReprint.frx":136C
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdExit 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxLateNoticeReprint.frx":1548
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
         ...
         TabIndex        =   5
         TabStop         =   0   'False
         Tag             =   $"frmTaxLateNoticeReprint.frx":1726
         Top             =   5610
         Width           =   1695
         _Version        =   131072
         _ExtentX        =   2990
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxLateNoticeReprint.frx":17C1
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdClear 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxLateNoticeReprint.frx":19A0
      End
   ...
   End
End
Attribute VB_Name = "frmTaxLateNoticeReprint"
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxLateNoticeReprint", "cmdProcess_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmTaxLateNoticeReprint.")
      Call Terminate
      End
    End If
  End If
...
ERRORSTUFF:
   ...
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxLateNoticeReprint", "PrintGraphicsSelfEdit1", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Unload frmTaxShowPctComp
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxLateNoticeReprint", "PrintTextSelfEdit1", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arTaxAbstractRpt 
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "arTaxAbstractRpt.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   20532
   _ExtentY        =   15399
   SectionData     =   "arTaxAbstractRpt.dsx":08CA
End
Attribute VB_Name = "arTaxAbstractRpt"
...
Private Sub ActiveReport_DataInitialize()
  ...
  Fields.Add ("fldEmpty") '24)
  Fields.Add ("fldBreak") '25)
End Sub
...
Private Sub ActiveReport_FetchData(eof As Boolean)
  ...
  Fields("fldEmpty").Value = arr(24)
  Fields("fldBreak").Value = arr(25)
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    ElseIf KeyCode = vbKeyE Then
      ...
      DoEvents
      frmTaxMsg.Label1.Caption = "File - AbstractRpt.xls, created in the Citipak Directory."
      frmTaxMsg.Label1.Top = 900
      frmTaxMsg.Show vbModal
      KeyCode = 0
    ElseIf KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      frmTaxMsg.Label1.Caption = "File - AbstractRpt.txt, created in the Citipak Directory."
      frmTaxMsg.Label1.Top = 900
      frmTaxMsg.Show vbModal
      KeyCode = 0
    End If
...
Private Sub Detail_Format()
  ...
  If QPTrim$(Fields("fldBreak").Value) = "1" Then
    Detail.NewPage = ddNPNone
  ElseIf QPTrim$(Fields("fldBreak").Value) = "2" Then
...
Private Sub GroupHeader1_Format()
  If QPTrim$(Fields("fldBreak").Value) = "3" Then
...
'  If QPTrim$(Fields("fldBreak").Value) = "1" Then
'    GroupHeader2.DataField = Fields("fldPropType").Value
'  Else

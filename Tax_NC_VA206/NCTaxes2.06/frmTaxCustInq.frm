...
Begin VB.Form frmTaxCustInq 
   ...
   Begin LpLib.fpList fpList 
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmTaxCustInq.frx":08CA
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdHistory 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxCustInq.frx":0BDA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxCustInq.frx":0DB8
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdPropDet 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxCustInq.frx":0F94
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdLookup 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxCustInq.frx":117A
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdMessage 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxCustInq.frx":135C
   End
   ...
   End
End
Attribute VB_Name = "frmTaxCustInq"
...
Private Sub cmdExit_Click()
  ...
  If Not Exist("C:\CPWork\txpyment.dat") And Not Exist("C:\CPWork\prepayrefund.dat") Then
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxCustInq", "cmdPropDet", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub Form_Load()
  ...
  If Exist("C:\CPWork\txpyment.dat") Or Exist("C:\CPWork\prepayrefund.dat") Then
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      KillFile ("C:\CPWork\custinq.dat")
      MainLog ("CitiTaxes.exe terminated via menu bar on frmTaxCustInq.")
      Call Terminate
      End
    End If
  End If
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxCustInq", "LoadCust", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxCustInq", "Check4ValidCustNum", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

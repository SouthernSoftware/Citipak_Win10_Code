...
Begin VB.Form frmTaxRefundOnPrepay 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   420
   ClientWidth     =   11655
   Icon            =   "frmTaxRefundOnPrepay.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin LpLib.fpList fpList1 
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmTaxRefundOnPrepay.frx":08CA
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdListAlpha 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxRefundOnPrepay.frx":0CBC
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdListAcctNum 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxRefundOnPrepay.frx":0EA0
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdPost 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxRefundOnPrepay.frx":108D
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxRefundOnPrepay.frx":1269
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdCustData 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxRefundOnPrepay.frx":1445
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdInfo 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxRefundOnPrepay.frx":1625
   End
   ...
   End
End
Attribute VB_Name = "frmTaxRefundOnPrepay"
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxRefundOnPrepay", "cmdListAcctNum_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxRefundOnPrepay", "cmdListAlpha_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub cmdPost_Click()
  ...
  TransRec.RealPin = ""
  TransRec.TaxYear = TaxMasterRec.TaxYear
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxRefundOnPrepay", "cmdPost_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      KillFile "C:\CPWork\prepayrefund.dat"
      GCustNum = 0
      MainLog ("CitiTaxes.exe terminated via menu bar on frmTaxRefundOnPrepay.")
      Call Terminate
      End
    End If
  End If
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxRefundOnPrepay", "fpList1_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

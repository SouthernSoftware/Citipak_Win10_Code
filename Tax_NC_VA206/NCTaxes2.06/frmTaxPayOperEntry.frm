...
Begin VB.Form frmTaxPayOperEntry 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "frmTaxPayOperEntry.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8730
   ...
   Begin fpBtnAtlLibCtl.fpBtn CmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPayOperEntry.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdOk 
      ...
      TabIndex        =   2
      TabStop         =   0   'False
      Tag             =   $"frmTaxPayOperEntry.frx":0AA6
      Top             =   6330
      Width           =   2160
      _Version        =   131072
      _ExtentX        =   3810
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPayOperEntry.frx":0B5B
   End
   ...
   End
End
Attribute VB_Name = "frmTaxPayOperEntry"
...
Private Sub fpCmdOk_Click()
  frmTaxLoadingRpt.Label1 = "Searching For Receipt Printer"
  ...
  If RcpCheck = False Then
    ...
    frmTaxMsgWOpts.Label1.Top = 300
    frmTaxMsgWOpts.Label1.Height = 1850
    frmTaxMsgWOpts.cmdCont.Text = "F10 Continue"
    frmTaxMsgWOpts.cmdExit.Text = "ESC Abort Load"
  ...
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      If MsgBox("Are You Sure You Wish To Close The Program?", vbYesNo, "Close?") = vbNo Then
        Cancel = True
      Else
        MainLog ("Closed via frmTaxPayOperEntry by " + PWUser$)
        Call Terminate
      End If
    End If
  End If
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPayOperEntry", "GetPayDate", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPayOperEntry", "savePDate", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

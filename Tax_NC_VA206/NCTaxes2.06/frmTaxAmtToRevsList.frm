...
Begin VB.Form frmTaxAmtToRevsList 
   BackColor       =   &H000000C0&
   ...
   ClientTop       =   420
   ClientWidth     =   7104
   Icon            =   "frmTaxAmtToRevsList.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin LpLib.fpList fpList 
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmTaxAmtToRevsList.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxAmtToRevsList.frx":0B1E
   End
   ...
   End
End
Attribute VB_Name = "frmTaxAmtToRevsList"

...
Begin VB.Form frmTaxBillList 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdClose 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxBillList.frx":0DCD
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdTag 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxBillList.frx":0FA9
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxBillList.frx":118B
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdClear 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxBillList.frx":1373
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdTagAll 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxBillList.frx":154E
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdReset 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxBillList.frx":172B
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdDetail 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxBillList.frx":1906
   End
...
Private Sub Form_Load()
  ...
  NumOfLRecs = 0
  Operator$ = CStr(OperNum)
  If Exist("TAXLOP" + Operator$ + ".DAT") Then

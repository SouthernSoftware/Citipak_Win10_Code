...
Begin VB.Form frmTaxRealLookup 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "frmTaxRealLookup.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8730
   ...
   Begin LpLib.fpList fpList1 
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmTaxRealLookup.frx":0A32
   End
   Begin LpLib.fpCombo fpcmbTownship 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmTaxRealLookup.frx":0EB3
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxRealLookup.frx":128E
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSearch 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxRealLookup.frx":146C
   End
   ...
   End
End
Attribute VB_Name = "frmTaxRealLookup"
...
NoMatch:
  ...
  If FoundMatch = 1 Then
    frmTaxRealPropHist.GRealRec = GRealRec
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxRealLookup", "cmdSearch_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxRealLookup", "fpList1_DblClick", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

...
Begin VB.Form frmTaxCustLookupAdvOnly 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "frmTaxCustLookupAdvOnly.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8730
   ...
   Begin LpLib.fpList fpList1 
      ...
      Left            =   240
      TabIndex        =   5
      Tag             =   $"frmTaxCustLookupAdvOnly.frx":08CA
      Top             =   4356
      Width           =   11400
      _Version        =   196608
      _ExtentX        =   20108
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmTaxCustLookupAdvOnly.frx":0A32
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxCustLookupAdvOnly.frx":0EC2
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSearch 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxCustLookupAdvOnly.frx":10A0
   End
   ...
   End
End
Attribute VB_Name = "frmTaxCustLookupAdvOnly"
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxCustLookupAdvOnly", "fpList1_DblClick", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmTaxCustLookupAdvOnly.")
      Call Terminate
      End
    End If
  End If

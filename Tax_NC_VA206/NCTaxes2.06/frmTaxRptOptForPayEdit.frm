...
Begin VB.Form frmTaxRptOptForPayEdit 
   BackColor       =   &H008F8265&
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdTextNumber 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxRptOptForPayEdit.frx":0000
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdGraphicsNumber 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxRptOptForPayEdit.frx":021F
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxRptOptForPayEdit.frx":0442
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdGraphicsName 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxRptOptForPayEdit.frx":0656
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdTextName 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxRptOptForPayEdit.frx":087F
   End
   ...
   End
End
Attribute VB_Name = "frmTaxRptOptForPayEdit"

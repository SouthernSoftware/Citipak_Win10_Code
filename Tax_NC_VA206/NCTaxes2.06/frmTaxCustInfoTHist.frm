...
Begin VB.Form frmTaxCustInfoTHist 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxCustInfoTHist.frx":0CA7
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdDetail 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxCustInfoTHist.frx":0E85
   End
...
'WHY WOULD THE TRANS HISTORY FORM NEED TO DO THIS EVER!!!!!!!!!!!!!!!!!
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmTaxCustInfoTHist.")
      Call Terminate
      End
    End If
  End If
...
Private Sub LoadMe()
  ...
  If PrevTranRec& > 0 Then
    Do While PrevTranRec& > 0
      ...
      If TaxTRec.TranType = 31 Then GoTo SkipIt
      TCnt = TCnt + 1
      ...
      Else
'        TaxTRec.Revenue.Principle1Pd = 13.67 '2/9/06
'        Put TRHandle, PrevTranRec&, TaxTRec

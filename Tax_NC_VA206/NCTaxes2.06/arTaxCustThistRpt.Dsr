VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arTaxCustThistRpt 
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "arTaxCustThistRpt.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   20532
   _ExtentY        =   15399
   SectionData     =   "arTaxCustThistRpt.dsx":08CA
End
Attribute VB_Name = "arTaxCustThistRpt"
...
Private Sub ActiveReport_DataInitialize()
  Dim x As Integer
  hFile = FreeFile
  Open StartPath & "\TAXRPTS\TXCUSHST.RPT" For Input As #hFile

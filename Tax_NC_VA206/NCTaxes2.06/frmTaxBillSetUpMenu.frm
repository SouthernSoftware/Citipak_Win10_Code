...
Begin VB.Form frmTaxBillSetUpMenu 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "frmTaxBillSetUpMenu.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8730
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdGLSUBilling 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxBillSetUpMenu.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdTaxGLSUPayments 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxBillSetUpMenu.frx":0ABB
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdMortCodeMaint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxBillSetUpMenu.frx":0CAD
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdDefaultSettings 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxBillSetUpMenu.frx":0E9A
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdRelinkAbs 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxBillSetUpMenu.frx":1089
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxBillSetUpMenu.frx":126D
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdRelinkTrans 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxBillSetUpMenu.frx":144A
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdRateTables 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxBillSetUpMenu.frx":1631
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdReindex 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxBillSetUpMenu.frx":1821
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExport 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxBillSetUpMenu.frx":19FC
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdImport 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxBillSetUpMenu.frx":1BEA
   End
   ...
   End
End
Attribute VB_Name = "frmTaxBillSetUpMenu"
...
Private Sub cmdImport_Click()
  ...
  frmTaxImpExpMsg.txtFileName.Text = "TxPostal.cmv" ' "Enter Import File Name Here"
  frmTaxImpExpMsg.txtFileName.Visible = True
  frmTaxImpExpMsg.Label1 = msgtogo
  frmTaxImpExpMsg.Show 1, Me
  If frmTaxImpExpMsg.Exout <> 1 Then
    DeActivateControls Me
    ImpPostalCass
    ActivateControls Me
  Else
      ...
      If QPTrim$(TaxMasterRec.OptRev2) = "" Then
        If QPTrim$(TaxMasterRec.OptRev3) = "" Then
          ...
          Else
            ...
            Close AHandle
            frmTaxSystemSetup.Show
            frmTaxSystemSetup.vaTabPro1.ActiveTab = 1
            frmTaxSystemSetup.vaSpread1.SetActiveCell 1, 5
            DoEvents
            Unload Me
            Exit Sub
          End If
...
Private Sub cmdReindex_Click()
  frmTaxSaveAnimation.Label1.Caption = "Reindexing"
...
Private Sub cmdRelinkAbs_Click()
  ...
  frmTaxShowPctComp.Label1 = "Relinking"
  ...
  For x = 1 To NumOfRRecs&  'clear real pointers
    ...
    frmTaxShowPctComp.ShowPctComp x, NumOfRRecs
    DoEvents
  Next x
  ...
  For PersCnt& = 1 To NumOfPRecs&
    ...
    End If
    frmTaxShowPctComp.ShowPctComp PersCnt, NumOfPRecs
    DoEvents
  Next PersCnt
  ...
  For RealCnt& = 1 To NumOfRRecs&
    ...
    End If
    frmTaxShowPctComp.ShowPctComp RealCnt, NumOfRRecs
    DoEvents
  Next RealCnt
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxBillSetUpMenu", "cmdReLinkAbs_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub cmdRelinkTrans_Click()
  ...
  For Cnt& = 1 To NumOfTTRecs&
    ...
    Else
      ...
      BadTran(BadCnt) = Cnt&
    End If
    frmTaxShowPctComp.ShowPctComp Cnt, NumOfTTRecs
    DoEvents
  Next Cnt
  Unload frmTaxShowPctComp
  EnableCloseButton Me.hwnd, True
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxBillSetUpMenu", "cmdRelinkTrans", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmTaxBillSetupMenu.")
      Call Terminate
      End
    End If
  End If
...
Private Sub ExpPostalCass()
  ...
  frmTaxShowPctComp.Label1 = "Creating Export File"
  frmTaxShowPctComp.cmdCancel.Enabled = False
  frmTaxShowPctComp.Show , Me
  q$ = ","
  ...
  frmTaxShowPctComp.ShowPctComp 1, 1
  If Export& > 0 Then
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxBillSetUpMenu", "ExpPostalCass", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxBillSetUpMenu", "ImpPostalCass", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

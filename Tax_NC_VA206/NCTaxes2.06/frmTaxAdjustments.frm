...
Begin VB.Form frmTaxAdjustments 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdPost 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxAdjustments.frx":0BF9
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxAdjustments.frx":0DD5
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdHistory 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxAdjustments.frx":0FB1
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdLookup 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxAdjustments.frx":118F
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdBills 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxAdjustments.frx":1371
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdMessage 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxAdjustments.frx":154D
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdHelp 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxAdjustments.frx":172B
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdReset 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxAdjustments.frx":190D
   End
   Begin VB.Line Line4 
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      KillFile "C:\CPWork\txadjust.dat"
      GCustNum = 0
      MainLog ("CitiTaxes.exe terminated via menu bar on frmTaxAdjustments.")
      Call Terminate
      End
    End If
  End If
...
Private Sub LoadMe()
  ...
  One = 1
  AHandle = FreeFile
  Open "C:\CPWork\txadjust.dat" For Output As AHandle
  Print #AHandle, One
  Close AHandle
  fptxtDate.Text = Date
...
Private Sub fpcboAdjType_LostFocus()
  ...
  If fpLngIntBill = 0 Then
    If frmTaxAdjustBillList.Visible = True Then Exit Sub
...
Private Sub LoadMeBill()
  ...
  TestBillNum$ = ParseBillNum(TaxRec.Description)
...
PrePayOnly:
  ...
  If InStr(fpcboAdjType.Text, "1") Or InStr(fpcboAdjType.Text, "4") Then
    ...
    '                       31                                            32                           33            34
    Print #RptHandle, fpLngIntBill.Text; dlm; OldRound(CDbl(fpCurrTotOwed) - CDbl(fpCurrTotAdj)); dlm; 0; dlm; fptxtNote.Text
  Else
    If InStr(fpcboAdjType.Text, "2") Then
      '                              12                             13
      Print #RptHandle, CDbl(fpCurrPrincAdj.Value); dlm; CDbl(fpCurrIntAdj.Value); dlm;
      ...
      '                       31                      32                                              33                                                     34
      Print #RptHandle, fpLngIntBill.Text; dlm; NewBalThisBill; dlm; Abs(OldRound(CDbl(fpCurrPrepayBal.Value) - CDbl(fpCurrPrepayAdjBal.Value))); dlm; fptxtNote.Text
...
'  Dif = OldRound(Disc1 + Disc6 + Disc7 + Disc8 + Disc9) 'remmed out on 11/14/2007
''  If Dif <> 0 Then

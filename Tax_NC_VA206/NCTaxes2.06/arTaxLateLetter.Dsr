VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arTaxLateLetter 
   ...
   _ExtentX        =   20532
   _ExtentY        =   15399
   SectionData     =   "arTaxLateLetter.dsx":08CA
End
Attribute VB_Name = "arTaxLateLetter"
...
Private Sub ActiveReport_DataInitialize()
  Dim x As Integer
  hFile = FreeFile
  'MsgBox (StartPath$ & "\TAXRPTS\LATENOTICE.RPT")
  Open StartPath$ + "\TAXRPTS\LATELET.RPT" For Input Shared As #hFile
 ' MsgBox ("File opened")
...
'  MsgBox ("reading data")
  ...
  Fields("fldTotalOnly").Value = arr(56)
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    ElseIf KeyCode = vbKeyE Then
      ...
      DoEvents
      frmTaxMsg.Label1.Caption = "File - TaxLateLtr.xls, created in the Citipak Directory."
      frmTaxMsg.Label1.Top = 900
      frmTaxMsg.Show vbModal
      KeyCode = 0
    ElseIf KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      frmTaxMsg.Label1.Caption = "File - TaxLateLtr.txt, created in the Citipak Directory."
      frmTaxMsg.Label1.Top = 900
      frmTaxMsg.Show vbModal
      KeyCode = 0
    End If
...
Private Sub Detail_Format()
  ...
  If Fields("fldTotalOnly").Value = "Y" Then
    If CDbl(Fields("fldPrevBal").Value) < 0 Then

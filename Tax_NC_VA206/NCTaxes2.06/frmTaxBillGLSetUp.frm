...
Private Sub cmdExit_Click()
  ...
  If Exit2Bill = True Then
    If Exist("C:\CPWork\revglbill.dat") Then KillFile "C:\CPWork\revglbill.dat"
    frmTaxPrebilling.Show
    DoEvents
    Unload Me
    Exit Sub
  ElseIf Exit2Adv = True Then
    If Exist("C:\CPWork\revgladv.dat") Then KillFile "C:\CPWork\revgladv.dat"
...
MoveOn:
  ...
  If Exist("C:\CPWork\revglbill.dat") Then
    KillFile "C:\CPWork\revglbill.dat"
  ElseIf Exist("C:\CPWork\revgladv.dat") Then
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxBillGLSetUp", "cmdSave_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      ...
      KillFile "C:\CPWork\taxbillGL.dat"
      ClearInUse PWcnt
      MainLog ("CitiTaxes.exe terminated via menu bar on frmTaxBillGLSetUp.")
      Call Terminate
      End
    End If
  End If
...
Private Sub Form_Load()
  ...
  MainLog ("User opened frmTaxBillGLSetUp.")
  Call LoadMe
End Sub
...
Private Sub LoadMe()
  ...
  Me.HelpContextID = hlpTaxGLAccountsSetup
  ...
  One = 1
  AHandle = FreeFile
  Open "C:\CPWork\taxbillGL.dat" For Output As AHandle
  Print #AHandle, One
  Close AHandle
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxBillGLSetUp", "LoadMe", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxBillGLSetUp", "fpListYear_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxBillGLSetUp", "LogSaves", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxSBillGLSetup", "VerifyGLNum", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

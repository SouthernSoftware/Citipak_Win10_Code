...
Begin VB.Form frmTaxPrintCountyUsers 
   ...
   ClientTop       =   435
   ClientWidth     =   8670
   Icon            =   "frmTaxPrintCountyUsers.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin LpLib.fpList fpList1 
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmTaxPrintCountyUsers.frx":08CA
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdConvert 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPrintCountyUsers.frx":0C92
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPrintCountyUsers.frx":0E70
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPrintCountyUsers.frx":104E
   End
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   $"frmTaxPrintCountyUsers.frx":122B
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   9.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmTaxPrintCountyUsers"
...
Private Sub cmdConvert_Click()
  ...
  For x = 1 To NumOfTCRecs
    ...
    If TaxCustRec.County4BillNum = CLng(frmTaxCountySetup.ThisNumber) Then
      TaxCustRec.County4BillNum = frmTaxCountySetup.NewNum
      CnvtCnt = CnvtCnt + 1
...
Private Sub Form_Load()
  ...
  fptxtBillingCounty.Text = "# " + CStr(frmTaxCountySetup.ThisNumber) + " " + QPTrim$(frmTaxCountySetup.ThisDesc)
...
Private Sub PrintGraphics()
  ...
  For x = 1 To NumOfTCRecs
    Get TCHandle, x, TaxCustRec
    If TaxCustRec.County4BillNum = frmTaxCountySetup.ThisNumber Then
      '                   0            1                  2                      3
  ...
  Close TCHandle
  Close RptHandle
  arTaxCounty.Show vbModal
  
  Exit Sub

ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPrintCountyUsers", "PrintGraphics", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPrintCountyUsers", "PrintText", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

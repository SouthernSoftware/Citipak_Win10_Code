...
Begin VB.Form frmTaxCustTHistRpt 
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      Begin LpLib.fpList fpList 
         ...
         ResizeRowToFont =   0   'False
         TextTipMultiLine=   0
         ColDesigner     =   "frmTaxCustTHistRpt.frx":0CC1
      End
      Begin LpLib.fpCombo fpcmbDataType 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmTaxCustTHistRpt.frx":10E1
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdExit 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxCustTHistRpt.frx":14BC
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
         ...
         TabIndex        =   7
         TabStop         =   0   'False
         Tag             =   $"frmTaxCustTHistRpt.frx":169A
         Top             =   6570
         Width           =   1740
         _Version        =   131072
         _ExtentX        =   3069
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxCustTHistRpt.frx":1745
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdMessage 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxCustTHistRpt.frx":1924
      End
      ...
      Begin fpBtnAtlLibCtl.fpBtn cmdLookup 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxCustTHistRpt.frx":1B02
      End
      ...
      Begin fpBtnAtlLibCtl.fpBtn cmdPropDet 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxCustTHistRpt.frx":1CE4
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdAll 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxCustTHistRpt.frx":1ECA
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdClear 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxCustTHistRpt.frx":20A7
      End
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxCustTHistRpt", "cmdPropDet_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      KillFile "C:\CPWork\custtranshist.dat"
      MainLog ("CitiTaxes.exe terminated via menu bar on frmTaxCustTHistRpt.")
      Call Terminate
      End
    End If
  End If
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxCustTHistRpt", "fptxtAcctNum_LostFocus", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxCustTHistRpt", "LoadCust", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxCustTHistRpt", "Check4ValidCustNum", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
    ...
    If YrCnt = 0 Then
     ...
     Select Case TaxTrans.TranType
       ...
       Case 2
         ...
         TotByYrAndType(2, ThisYear) = OldRound(TotByYrAndType(2, ThisYear) + TaxTrans.Amount + TaxTrans.DiscAmt) 'added .DiscAmt on 1/18/07
      ...
      End Select
      TCnt = TCnt + 1
      If TaxTrans.TranType = 2 Then 'added 1/18/07
...
PrintSub:
  ...
  ReDim HoldCnt(1 To 17, 1 To YrCnt) As Double
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxCustTHistRpt", "PrintGraphics", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
'  Dim TMHandle As Integer
  ...
  ReDim TotByYrAndType(1 To 17, 1 To 1) As Double
  ReDim CntByYrAndType(1 To 17, 1 To 1) As Double
  ReDim TheYear(1 To 1) As Integer
  ...
  Do While ThisRec > 0
    Get TTHandle, ThisRec, TaxTrans
      ...
      If YrCnt = 0 Then
         ...
         TheYear(YrCnt) = TaxTrans.TaxYear
         ReDim Preserve TotByYrAndType(1 To 17, 1 To YrCnt) As Double
         ReDim Preserve CntByYrAndType(1 To 17, 1 To YrCnt) As Double
         For y = 1 To 17
           TotByYrAndType(y, YrCnt) = 0
         Next y
       Else
       ...
       Select Case TaxTrans.TranType
         ...
         Case 2
           ThisTransType = "Payment"
           TotByYrAndType(2, ThisYear) = OldRound(TotByYrAndType(2, ThisYear) + TaxTrans.Amount + TaxTrans.DiscAmt) 'added 1/18/07
           CntByYrAndType(2, ThisYear) = OldRound(CntByYrAndType(2, ThisYear) + 1)
         Case 3
           ThisTransType = "Release"
           TotByYrAndType(3, ThisYear) = OldRound(TotByYrAndType(3, ThisYear) + TaxTrans.Amount)
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxCustTHistRpt", "PrintText", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub PrintGraphicsByProp()
  ...
  frmTaxShowPctComp.Label1 = "Gathering Tax Transactions"
  ...
  For y = 1 To PropCnt
    ...
    For x = 1 To PropTransCnt
      ...
      If TaxTrans.DiscAmt > 0 Then GoSub ApplyDisc 'added 1/24/07
  ...
  For y = 1 To PropCnt
    ...
    For x = 1 To PropTransCnt
      ...
      If TaxTrans.TranType = 1 Then
        ...
        For z = 1 To PropTransCnt
          Get TTHandle, ThisPropTrans(z), TaxTrans
          If TaxTrans.DiscAmt > 0 Then GoSub ApplyDisc '1/24/07
          If TaxTrans.BelongTo = BillRec Then
            PrincDif = 0
            IntDif = 0
            AdvDif = 0
...
ApplyDisc:
  ...
  Dif = OldRound(Disc1 + Disc2 + Disc3 + Disc4 + Disc5 + Disc6 + Disc7 + Disc8 + Disc9) 'added 9/19/07
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxCustTHistRpt", "PrintGraphicsByProp", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
        ...
        For z = 1 To PropTransCnt
          ...
          If TaxTrans.BelongTo = BillRec Then
            ...
            If LineCnt >= MaxLines Then
              ...
              LineCnt = LineCnt + 2
              GoSub PrintBillHeader
              Print #RptHandle, MakeRegDate(TaxTrans.TransDate); Tab(12); ThisType; Tab(35); TaxTrans.TaxYear; Tab(55); Using$("$##,##0.00", TaxTrans.Amount + TaxTrans.DiscAmt)
              LineCnt = LineCnt + 1
            End If
            Print #RptHandle, Tab(20); "Advertising  "; Tab(40); Using$("$##,##0.00", TaxTrans.Revenue.Collection); Tab(55); Using$("$##,##0.00", TaxTrans.Revenue.CollectionPd)
            LineCnt = LineCnt + 1
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxCustTHistRpt", "PrintTextByProp", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

...
Begin VB.Form frmTaxPersProp 
   ...
   Begin LpLib.fpCombo fpcmbLateListYN 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmTaxPersProp.frx":08CA
   End
   Begin LpLib.fpCombo fpcmbDiscoveryYN 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmTaxPersProp.frx":0CA5
   End
   Begin LpLib.fpCombo fpcmbGoToPins 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmTaxPersProp.frx":1080
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPersProp.frx":14B3
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPersProp.frx":168F
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdDelete 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPersProp.frx":186B
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdAdd 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPersProp.frx":1A48
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPageDown 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPersProp.frx":1C22
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPageUp 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPersProp.frx":1DFE
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdGo 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPersProp.frx":1FDA
   End
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPersProp", "cmdAdd_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub cmdDelete_Click()
  ...
  If Check4UnpostedBilling(PersRecs(WhichRec)) = True Then Exit Sub
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPersProp", "cmdDelete_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPersProp", "cmdPageUp_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPersProp", "cmdPageDown_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
'  'on error goto ERRORSTUFF
  ...
  PersVal# = OldRound(CDbl(fpCurrPersVal.Value) + CDbl(fpCurrMobHome.Value) + CDbl(fpCurrMerchCap.Value) + CDbl(fpCurrFarmEq.Value) + CDbl(fpCurrMachTools.Value))
  XVal# = OldRound(CDbl(fpCurrSnCitizen.Value) + CDbl(fpCurrOther.Value))
  
  If XVal > PersVal Then
    frmTaxMsg.Label1.Caption = "Total exemptions " + QPTrim$(Using$("$##,###,##0.00", XVal)) + " cannot exceed total personal value " + QPTrim$(Using$("$##,###,##0.00", PersVal)) + "."
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPersProp", "cmdSave_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPersProp", "LoadMe", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPersProp", "LoadAgain", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPersProp", "LoadAdd", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
'    Me.Show
  ...
  If ThatDesc <> ThisDesc Then
    frmTaxMsgW4Opts.Label1.Caption = "The 'Optional Search' field has been changed from " + ThatDesc + " to " + ThisDesc + ". Press F10 to save the change. Press F5 to review the change. Press F3 to abandon this change. Otherwise, press ESC to abandon all changes."
    frmTaxMsgW4Opts.Label1.Top = 575
    'Me.ZOrder 0
    'frmTaxCustAddEdit.Visible = False
    If EditCust = True Then
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPersProp", "LogSaves", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPersProp", "Check4DupPinsPers", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

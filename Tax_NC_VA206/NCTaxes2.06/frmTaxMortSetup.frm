...
Begin VB.Form frmTaxMortSetup 
   ...
   Begin LpLib.fpList fpList1 
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmTaxMortSetup.frx":08CA
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxMortSetup.frx":0CBE
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxMortSetup.frx":0E9D
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdClear 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxMortSetup.frx":107A
   End
   ...
   End
End
Attribute VB_Name = "frmTaxMortSetup"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      ClearInUse PWcnt
      MainLog ("CitiTaxes.exe terminated via menu bar on frmTaxMortSetup.")
      Call Terminate
      End
    End If
  End If
...
Private Sub Form_Load()
  ...
  MainLog ("User opened frmTaxMortSetUp.")
  Call LoadMe
End Sub
...
Private Function Check4Changes() As Boolean
  ...
  Else
    ...
    Or ThisPhone <> "" Or QPTrim$(fptxtXFileName.Text) <> "" Then
      ...
      frmTaxMsgWOpts.Label1.Top = 1000
      ...
      If frmTaxMsgWOpts.fptxtChoice.Text = "continue" Then
        ...
        Exit Function
      Else
        MainLog ("frmTaxMortSetup: User elected to exit this screen without saving any data.")
        Exit Function
      End If
    Else
      Exit Function
  ...
  If OldStr <> NewStr Then
    frmTaxMsgW4Opts.Label1.Caption = "The 'Mortgage Code' field has been changed from " + OldStr + " to " + NewStr + ". Press F10 to save the change. Press F5 to review the change. Press F3 to abandon this change. Otherwise, press ESC to abandon all changes."
  ...
  If OldStr <> NewStr Then
    frmTaxMsgW4Opts.Label1.Caption = "The 'Company Name' field has been changed from " + OldStr + " to " + NewStr + ". Press F10 to save the change. Press F5 to review the change. Press F3 to abandon this change. Otherwise, press ESC to abandon all changes."
    frmTaxMsgW4Opts.Label1.Top = 575
    frmTaxMsgW4Opts.Show vbModal
    choice = frmTaxMsgW4Opts.fptxtChoice.Text
    Unload frmTaxMsgW4Opts
  ...
  If OldStr <> NewStr Then
    frmTaxMsgW4Opts.Label1.Caption = "The 'Address #1' field has been changed from " + OldStr + " to " + NewStr + ". Press F10 to save the change. Press F5 to review the change. Press F3 to abandon this change. Otherwise, press ESC to abandon all changes."
    frmTaxMsgW4Opts.Label1.Top = 575
    frmTaxMsgW4Opts.Show vbModal
    choice = frmTaxMsgW4Opts.fptxtChoice.Text
    Unload frmTaxMsgW4Opts
  ...
  If OldStr <> NewStr Then
    frmTaxMsgW4Opts.Label1.Caption = "The 'Address #2' field has been changed from " + OldStr + " to " + NewStr + ". Press F10 to save the change. Press F5 to review the change. Press F3 to abandon this change. Otherwise, press ESC to abandon all changes."
    frmTaxMsgW4Opts.Label1.Top = 575
    frmTaxMsgW4Opts.Show vbModal
    choice = frmTaxMsgW4Opts.fptxtChoice.Text
    Unload frmTaxMsgW4Opts
  ...
  If OldStr <> NewStr Then
    frmTaxMsgW4Opts.Label1.Caption = "The 'Address #3' field has been changed from " + OldStr + " to " + NewStr + ". Press F10 to save the change. Press F5 to review the change. Press F3 to abandon this change. Otherwise, press ESC to abandon all changes."
    frmTaxMsgW4Opts.Label1.Top = 575
    frmTaxMsgW4Opts.Show vbModal
    choice = frmTaxMsgW4Opts.fptxtChoice.Text
    Unload frmTaxMsgW4Opts
  ...
  If OldStr <> NewStr Then
    frmTaxMsgW4Opts.Label1.Caption = "The 'Contact' field has been changed from " + OldStr + " to " + NewStr + ". Press F10 to save the change. Press F5 to review the change. Press F3 to abandon this change. Otherwise, press ESC to abandon all changes."
    frmTaxMsgW4Opts.Label1.Top = 575
    frmTaxMsgW4Opts.Show vbModal
    choice = frmTaxMsgW4Opts.fptxtChoice.Text
    Unload frmTaxMsgW4Opts
  ...
  If OldStr <> NewStr Then
    frmTaxMsgW4Opts.Label1.Caption = "The 'Telephone #' field has been changed from " + OldStr + " to " + NewStr + ". Press F10 to save the change. Press F5 to review the change. Press F3 to abandon this change. Otherwise, press ESC to abandon all changes."
    frmTaxMsgW4Opts.Label1.Top = 575
    frmTaxMsgW4Opts.Show vbModal
    choice = frmTaxMsgW4Opts.fptxtChoice.Text
    Unload frmTaxMsgW4Opts
  ...
  If OldStr <> NewStr Then
    frmTaxMsgW4Opts.Label1.Caption = "The 'Export File Name' field has been changed from " + OldStr + " to " + NewStr + ". Press F10 to save the change. Press F5 to review the change. Press F3 to abandon this change. Otherwise, press ESC to abandon all changes."
    frmTaxMsgW4Opts.Label1.Top = 575
    frmTaxMsgW4Opts.Show vbModal
    choice = frmTaxMsgW4Opts.fptxtChoice.Text
    Unload frmTaxMsgW4Opts
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxMortSetup", "Check4Changes", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arTaxMasterBalDet 
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "arTaxMasterBalDet.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   20532
   _ExtentY        =   15399
   SectionData     =   "arTaxMasterBalDet.dsx":08CA
End
Attribute VB_Name = "arTaxMasterBalDet"
...
Private Sub ActiveReport_DataInitialize()
  Dim x As Integer
  hFile = FreeFile
  Open StartPath & "\TAXRPTS\TXMSTBALDET.RPT" For Input As #hFile
  ...
  Fields.Add ("fldPrincBal") '7)
  Fields.Add ("fldIntBal") '8)
  Fields.Add ("fldAdvBal") '9)
  Fields.Add ("fldLateListBal") '10)
  Fields.Add ("fldOpt1Bal") '11)
  Fields.Add ("fldOpt2Bal") '12)
  Fields.Add ("fldOpt3Bal") '13)
  Fields.Add ("fldGPrincTot") '14)
  Fields.Add ("fldGIntTot") '15)
  Fields.Add ("fldGAdvTot") '16)
  Fields.Add ("fldGLateListTot") '17)
  ...
  Fields.Add ("fldOverPay") '30)
  Fields.Add ("fldMainYear") '31)
End Sub
...
Private Sub ActiveReport_FetchData(eof As Boolean)
  ...
  Fields("fldPrincBal").Value = arr(7)
  Fields("fldIntBal").Value = arr(8)
  Fields("fldAdvBal").Value = arr(9)
  Fields("fldLateListBal").Value = arr(10)
  Fields("fldOpt1Bal").Value = arr(11)
  Fields("fldOpt2Bal").Value = arr(12)
  Fields("fldOpt3Bal").Value = arr(13)
  Fields("fldGPrincTot").Value = arr(14)
  Fields("fldGIntTot").Value = arr(15)
  Fields("fldGAdvTot").Value = arr(16)
  Fields("fldGLateListTot").Value = arr(17)
  ...
  Fields("fldOverPay").Value = arr(30)
  Fields("fldMainYear").Value = arr(31)
End Sub
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    ElseIf KeyCode = vbKeyE Then
      ...
      DoEvents
      frmTaxMsg.Label1.Caption = "File - MasterBalDet.xls, created in the Citipak Directory."
      frmTaxMsg.Label1.Top = 900
      frmTaxMsg.Show vbModal
      KeyCode = 0
    ElseIf KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      frmTaxMsg.Label1.Caption = "File - MasterBalDet.txt, created in the Citipak Directory."
      frmTaxMsg.Label1.Top = 900
      frmTaxMsg.Show vbModal
      KeyCode = 0
    End If
...
AllTrue:
  Line1.Visible = True
  Set SubReport1 = New arSubTaxMastBalDet

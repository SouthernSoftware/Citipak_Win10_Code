...
Begin VB.Form frmTaxPrint 
   ...
   Begin LpLib.fpCombo fpcboPrinters 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmTaxPrint.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdCancel 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPrint.frx":0E9D
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPrint.frx":10B3
   End
   ...
   Begin VB.Image Image1 
      Height          =   276
      Left            =   4512
      Picture         =   "frmTaxPrint.frx":12C8
      Top             =   1092
      Width           =   288
   End
End
Attribute VB_Name = "frmTaxPrint"
...
Private Sub cmdPrint_Click()
  ...
  If fpcboPrinters.ListIndex <> -1 Then
    ...
    If InStr(1, DPName, "\\", vbTextCompare) Then
      frmTaxViewPrint.PrintWSet DPName, Copies
    Else
      frmTaxViewPrint.PrintWSet DefPrinter, Copies
    End If
  Else

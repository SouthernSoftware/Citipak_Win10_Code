...
Begin VB.Form frmTaxManualBillEntry 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "frmTaxManualBillEntry.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8730
   ...
   Begin LpLib.fpList fpListInEdit 
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmTaxManualBillEntry.frx":08CA
   End
   Begin LpLib.fpList fpPropList 
      ...
      ResizeRowToFont =   0   'False
      TextTipMultiLine=   0
      ColDesigner     =   "frmTaxManualBillEntry.frx":0D16
   End
   Begin LpLib.fpCombo fpcmbBillType 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmTaxManualBillEntry.frx":1136
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxManualBillEntry.frx":1511
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxManualBillEntry.frx":16ED
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdLookup 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxManualBillEntry.frx":18C9
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdMessage 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxManualBillEntry.frx":1AAB
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPropDet 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxManualBillEntry.frx":1C89
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdDelete 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxManualBillEntry.frx":1E6F
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdCancel 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxManualBillEntry.frx":204C
   End
   ...
   End
End
Attribute VB_Name = "frmTaxManualBillEntry"
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxManualBillEntry", "cmdDelete_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub cmdExit_Click()
  ...
  Else
    ...
    ThisTot = OldRound(ThisTot + CDbl(fpCurrLateList.Value) + CDbl(fpCurrOpt1.Value))
  ...
  If Exist("C:\CPWork\manualedit.dat") Then
    Call frmTaxManualBillEdit.ClearAndUpdateList
    Unload Me
    DoEvents
    Exit Sub
  Else
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxManualBillEntry", "cmdPropDet_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub cmdSave_Click()
  ...
  If RevsAndGLsOK(Me, ThatYear) = False Then
    Exit Sub
  End If

  TotalBill = 0
  TotalBill = OldRound(CDbl(fpCurrPrinc.Value) + CDbl(fpCurrInt.Value) + CDbl(fpCurrAdvCol.Value))
  TotalBill = OldRound(TotalBill + CDbl(fpCurrLateList.Value) + CDbl(fpCurrOpt1.Value))
...
'      OverAmt = GetOverPayBalance(GCustNum)
      OverAmt = GetCustBalance(GCustNum, -1)
      If OverAmt < 0 Then
        If TaxMsgWOpts(700, "This customer has a credit balance of " + QPTrim$(Using$("$##,##0.00", OverAmt)) + ". If you wish to apply the credit to this bill then press F10. Otherwise, press ESC to ignore the credit amount.", "F10 Apply", "ESC Ignore") = "abort" Then
          Unload frmTaxMsgWOpts
          OverAmt = 0
          MainLog ("A credit balance of " + QPTrim$(Using$("$##,##0.00", OverAmt)) + " was not applied to this manual bill.")
        Else
          Unload frmTaxMsgWOpts
          Call TaxMsg(900, "A credit of " + QPTrim$(Using$("$##,##0.00", OverAmt)) + " will be applied at posting for this manual bill.")
...
'    fpListInEdit.Col = 4
  ...
  Call Savemsg(900, "Manual bill data has been saved successfully.")
  ...
  If TaxMsgWOpts(800, "Press F10 to enter another manual tax bill. Otherwise, press ESC to return to the Manual Tax Billing Menu.", "F10 Enter New", "ESC Exit") = "abort" Then
    Unload frmTaxMsgWOpts
    If LookUpMode = True Then
      Unload frmTaxManualBillEdit
    End If
    KillFile "C:\CPWork\manualbill.dat"
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxManualBillEntry", "cmdSave_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      ClearInUse PWcnt
      KillFile "C:\CPWork\manualbill.dat"
      MainLog ("CitiTaxes.exe terminated via menu bar on frmTaxManualBillEntry.")
      Call Terminate
      End
    End If
  End If
...
Private Sub Form_Load()
  ...
  MainLog ("User opened frmTaxManualBillEntry.")
  PersRec = 0
  RealRec = 0
  ExitOK = False
  InListActive = False
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxManualBillEntry", "LoadMeWOEdit", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub LoadMe()
  ...
  If TaxMasterRec.RealPersSplit = "Y" Then
    fpcmbBillType.AddItem "REAL ESTATE ONLY"
    fpcmbBillType.AddItem "PERSONAL ONLY"
  End If
  Exit Sub
  
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxManualBillEntry", "LoadMe", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxManualBillEntry", "Check4ValidCustNum", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Public Sub LoadMeEdit()
  ...
  If ThisMRec > 0 Then
    ...
    If TaxMRec.BillType = "C" Then
      fpcmbBillType.Text = "COMBINED"
    ElseIf TaxMRec.BillType = "R" Then
...
'        If TaxMRec.RealRec = InEdit(y) Then 'changed 6/15/06
        If x = InEdit(y) Then
  ...
  For x = 1 To NumOfPersRecs
    ...
    If TaxCustRec.PIN = PersPropRec.CustPin Then
      ...
      For y = 1 To EditCnt
        ...
        If TaxMRec.Class <> "P" Then GoTo NotThisOne
...
NotThisOne:
    ...
    PersList = ""
  Next x
  If HighLight = False And EditLoadCnt > 0 Then
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxManualBillEntry", "LoadMeEdit", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxManualBillEntry", "EnterEditCheck", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxManualBillEntry", "fpListInEdit_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxManualBillEntry", "fptxtAcctNum_LostFocus", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxManualBillEntry", "Check4Changes", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
'  fptxtAcctNum.Text = "0"
  ...
  fpcmbBillType.Text = "COMBINED"
  fptxtBillDate = Date
  fpLongTaxYear = TaxMasterRec.TaxYear
  fptxtActiveProp.Text = "NOTHING SELECTED"
End Sub

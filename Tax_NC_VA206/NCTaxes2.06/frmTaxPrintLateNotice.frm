...
Begin VB.Form frmTaxPrintLateNotice 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "frmTaxPrintLateNotice.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8730
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      FrameThreeDStyle=   1
      FrameWidth      =   2
      Picture         =   "frmTaxPrintLateNotice.frx":08CA
      Begin LpLib.fpCombo fpcmbBillType 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmTaxPrintLateNotice.frx":08E6
      End
      Begin LpLib.fpCombo fpcmbPrintOrder 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmTaxPrintLateNotice.frx":0BE1
      End
      Begin LpLib.fpCombo fpcmbTaxYear 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmTaxPrintLateNotice.frx":0EDC
      End
      Begin LpLib.fpCombo fpcmbPrintOpt 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmTaxPrintLateNotice.frx":11D7
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdExit 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxPrintLateNotice.frx":14D2
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
         ...
         TabIndex        =   9
         TabStop         =   0   'False
         Tag             =   $"frmTaxPrintLateNotice.frx":16B0
         Top             =   6210
         Width           =   1740
         _Version        =   131072
         _ExtentX        =   3069
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxPrintLateNotice.frx":175B
      End
   ...
   End
End
Attribute VB_Name = "frmTaxPrintLateNotice"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmTaxPrintLateNotice.")
      Call Terminate
      End
    End If
  End If
...
'  'on error goto ERRORSTUFF
  ...
  GTaxYear = CInt(TaxMasterRec.TaxYear)
  
'  fpcmbTaxYear.Text = CStr(GTaxYear)
...
'ERRORSTUFF:
'   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPrintLateNotice", "LoadMe", Erl)
'     Case emrExitProc:
'       Resume Proc_Exit
'     Case emrResume:
'       Resume
...
'  'on error goto ERRORSTUFF
  ...
  For x = 1 To NumOfTCRecs
    ...
    Balance# = 0
    TotBal = GetCustBalance(ThisCustRec, -1)
    If ThisTaxYear <> -1 Then
      CurrBal = GetCustBalanceForYear(ThisCustRec, ThisTaxYear)
    Else
      CurrBal = GetCustBalanceForYear(ThisCustRec, GTaxYear)
    End If
    PrevBal = OldRound(TotBal - CurrBal)
    ThisPrevBal = CStr(PrevBal)
    If InStr(ThisPrevBal, "E") Then PrevBal = 0
    If Notified = True Then GoTo Flagged
    If PrevBal < 0 And TotBal > 0 Then
      Notified = True
...
Flagged:
    Do While NextRec > 0
      ...
      If TaxTrans.TranType = 1 Then
        If ThisTaxYear = -1 And TaxTrans.TaxYear = GTaxYear Then
          ...
          Balance = OldRound#(PrincBal + IntBal + AdvBal + LateListBal + Opt1Bal + Opt2Bal + Opt3Bal - TaxTrans.DiscAmt) 'added - TaxTrans.DiscAmt on 2/16/07
      ...
      If ThisTaxYear = -1 And Balance = 0 And PrevBal > 0 Then GoTo GoAnyway
      If Balance > 0 Then
GoAnyway:
        LLCnt = LLCnt + 1
...
'        LLRec.PayDate = Date2Num(fptxtPayByDate.Text)
        ...
        If ThisTaxYear = -1 Then LLRec.TaxYear = GTaxYear
        ...
        ElseIf TaxTrans.CustPin > 0 Then 'Windows transaction if <> 0
          ...
          Else
            ...
            If ThisRealRec > 0 Then
              ...
              LLRec.RealExemp = OldRound(RealRec.EXMPOTHR + RealRec.EXMPSENI)
            Else
              LLRec.RealValue = 0
              LLRec.RealExemp = 0
            End If
          ...
          Else
            ...
            If ThisPersRec > 0 Then
              ...
              LLRec.PersExemp = OldRound(PersRec.EXMPOTHR + PersRec.EXMPSENI)
            Else
              LLRec.PersValue = 0
              LLRec.PersExemp = 0
            End If
...
'ERRORSTUFF:
'   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPrintLateNotice", "GetPrintData", Erl)
'     Case emrExitProc:
'       Resume Proc_Exit
'     Case emrResume:
'       Resume
...
'  'on error goto ERRORSTUFF
'  TotalsOnly = "N"
'  If chkTotalsOnly.Value Then TotalsOnly = "Y"
  ...
  For x = 1 To NumOfLLRecs
    ...
    Next y
    '                     51                  52                   53                  54                55             56
    Print #RptHandle, LLRec.TotBal; dlm; LLRec.CurrBal; dlm; LLRec.PrevBal; dlm; LLRec.CustAcct; dlm; GTaxYear; dlm; NegOpt
...
NextYear:
  ...
  arTaxLateLetter.Show
  
  Exit Sub

'ERRORSTUFF:
'   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPrintLateNotice", "PrintGraphicsSelfEdit1", Erl)
'     Case emrExitProc:
'       Resume Proc_Exit
'     Case emrResume:
'       Resume
...
'ERRORSTUFF:
'   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPrintLateNotice", "PrintTextSelfEdit1", Erl)
'     Case emrExitProc:
'       Resume Proc_Exit
'     Case emrResume:
'       Resume

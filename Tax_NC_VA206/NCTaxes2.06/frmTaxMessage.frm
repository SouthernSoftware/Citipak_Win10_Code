...
Begin VB.Form frmTaxMessage 
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxMessage.frx":08CA
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxMessage.frx":0AA5
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdClear 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxMessage.frx":0C80
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxMessage.frx":0E5B
   End
...
Private Sub fpCmdClear_Click()
  ...
  If frmTaxMsgWOpts.fptxtChoice.Text = "continue" Then
    ...
    Savemsg
    Clear = False
'    If Exist("C:\CPWork\txpyment.dat") Then
...
'      frmTaxPaymentEntry.MsgAlertTimer.Enabled = False
    If Exist("C:\CPWork\txadjust.dat") Then
    ...
    ElseIf Exist("C:\CPWork\prepayrefund.dat") Then
      frmTaxRefundOnPrepay.cmdInfo.FontSize = 12
      frmTaxRefundOnPrepay.cmdInfo.BackColor = &H8000000F
      frmTaxRefundOnPrepay.cmdInfo.ForeColor = &H80000012
      frmTaxRefundOnPrepay.MsgAlertTimer.Enabled = False
    Else
...
Private Sub Savemsg()
  ...
  For x = 1 To 15
    If QPTrim$(Me.fpCMsg(x - 1).Text) <> "" Then
      ...
      ElseIf Exist("C:\CPWork\prepayrefund.dat") Then
        frmTaxRefundOnPrepay.MsgAlertTimer.Enabled = True
      Else

...
Begin VB.Form frmTaxMailLblsAdv 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "frmTaxMailLblsAdv.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8730
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      FrameThreeDStyle=   1
      FrameWidth      =   2
      Picture         =   "frmTaxMailLblsAdv.frx":08CA
      Begin LpLib.fpCombo fpcmbLabel 
         Height          =   384
         Left            =   3120
         TabIndex        =   1
         Tag             =   $"frmTaxMailLblsAdv.frx":08E6
         Top             =   1848
         Width           =   4476
         _Version        =   196608
         _ExtentX        =   7895
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmTaxMailLblsAdv.frx":09A4
      End
      Begin LpLib.fpList fpList 
         Height          =   1368
         Left            =   960
         TabIndex        =   2
         Tag             =   $"frmTaxMailLblsAdv.frx":0D7F
         Top             =   3240
         Width           =   7452
         _Version        =   196608
         _ExtentX        =   13144
         ...
         ResizeRowToFont =   0   'False
         TextTipMultiLine=   0
         ColDesigner     =   "frmTaxMailLblsAdv.frx":0EF8
      End
      Begin LpLib.fpCombo fpcmbRange 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmTaxMailLblsAdv.frx":134E
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdAlign 
         ...
         TabIndex        =   3
         TabStop         =   0   'False
         Tag             =   $"frmTaxMailLblsAdv.frx":1729
         Top             =   5616
         Width           =   1548
         _Version        =   131072
         _ExtentX        =   2730
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxMailLblsAdv.frx":1808
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdExit 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxMailLblsAdv.frx":19E4
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
         ...
         TabIndex        =   5
         TabStop         =   0   'False
         Tag             =   $"frmTaxMailLblsAdv.frx":1BC2
         Top             =   5610
         Width           =   1695
         _Version        =   131072
         _ExtentX        =   2990
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxMailLblsAdv.frx":1C5D
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdClear 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxMailLblsAdv.frx":1E3C
      End
   ...
   End
End
Attribute VB_Name = "frmTaxMailLblsAdv"
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxMailLblsAdv", "cmdAlign_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxMailLblsAdv", "PrintText", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxMailLblsAdv", "PrintGraphics", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

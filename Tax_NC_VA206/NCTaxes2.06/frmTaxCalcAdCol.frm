...
Begin VB.Form frmTaxCalcAdCol 
   ...
   Begin LpLib.fpCombo fpcmbPrintOpt 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmTaxCalcAdCol.frx":0999
   End
   Begin LpLib.fpCombo fpcmbPrintOrder 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmTaxCalcAdCol.frx":0D74
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxCalcAdCol.frx":114F
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxCalcAdCol.frx":132E
   End
   ...
   End
End
Attribute VB_Name = "frmTaxCalcAdCol"
...
'  Dim UsingSrchIdx As Boolean
  ...
  If RevsAndGLsOK(Me, TaxYear) = False Then
    Exit Sub
  End If
...
'    OptFlag = True
  ...
  CustCnt = 0
  frmTaxShowPctComp.Label1 = "Calculating Advertising Charges"
 ...
 '     If TransRecord& = 356861 Then Stop
      Get TTHandle, TransRecord&, TaxTrans
      CurTransRecord& = TransRecord&
      If TaxTrans.TranType = 1 And TaxTrans.TaxYear = TaxYear And Len(QPTrim$(TaxTrans.RealPin)) > 0 Then
        ...
        If Balance# > 0 Then
          ...
          ReDim PropDesc$(0 To 1)
            'Get Prop Desc Here
'          PropRec& = TaxCustRec.FirstPropRec
          NewOwnerFlag = False
          CurrOwnerPin = 0
          ...
          If PropertyRec.Deleted <> 0 Then GoTo MoveOn
          
'          z1 = z1 + 1
'          ReDim Preserve PropDesc$(0 To z1)
'          PropDesc$(z1) = QPTrim$(PropertyRec.Map) + "\ " + QPTrim$(PropertyRec.BLOCK) + "\ " + QPTrim$(PropertyRec.LOTNUMB) + "\ " + QPTrim$(PropertyRec.PROPNOT1)
'          ThisPropDesc$ = PropDesc$(z1)
          ...
          If AmountCharged# <> 0 Then   'Now Add Amt to Bill and Put Back
            ...
            End If
            AdvTrans.DelFlag = 0
            AdvTrans.RealPin = TaxTrans.RealPin 'added 6/5/07
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxCalcAdCol", "cmdProcess_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmTaxCalcAdCol.")
      Call Terminate
      End
    End If
  End If
...
Private Function FindPropRec(RealPin$, CustPin As Long, CurrOwnerPin As Long) As Long
  ...
  FindPropRec = 0
  If QPTrim$(RealPin$) = "0" Or QPTrim$(RealPin$) = "" Then Exit Function
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxCalcAdCol", "FindPropRec", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxCalcAdCol", "FindNewOwner", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxCalcAdCol", "PrintGraphics", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxCalcAdCol", "PrintText", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

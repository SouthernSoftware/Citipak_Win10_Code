...
Begin VB.Form frmTaxPayGLSetup 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "frmTaxPayGLSetup.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8730
   ...
   Begin LpLib.fpList fpListYear 
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmTaxPayGLSetup.frx":08CA
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPayGLSetup.frx":0B1E
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPayGLSetup.frx":0CFD
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdGLList 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPayGLSetup.frx":0EDA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdGLTest 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTaxPayGLSetup.frx":10B9
   End
   ...
   End
End
Attribute VB_Name = "frmTaxPayGLSetup"
...
Private Sub cmdExit_Click()
  ...
  If Exit2Pay = True Then
    If Exist("C:\CPWork\revglpay.dat") Then KillFile "C:\CPWork\revglpay.dat"
    frmTaxPayMenu.Show
    DoEvents
    Unload Me
    Exit Sub
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPayGLSetup", "cmdGLTest_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub cmdSave_Click()
  ...
  If VerifyGLNum(QPTrim$(fptxtTPDebit.Text)) = False Then
    frmTaxMsgWOpts.Label1.Caption = "The Tax Principle Debit number could not be located in the current GL index file. If you wish to save it anyway then press F10. Otherwise, press ESC to return to the screen without saving."
  ...
  If VerifyGLNum(QPTrim$(fptxtTPCredit.Text)) = False Then
    frmTaxMsgWOpts.Label1.Caption = "The Tax Principle Credit number could not be located in the current GL index file. If you wish to save it anyway then press F10. Otherwise, press ESC to return to the screen without saving."
    frmTaxMsgWOpts.Label1.Top = 800
    frmTaxMsgWOpts.cmdCont.Text = "F10 Continue"
    frmTaxMsgWOpts.Show vbModal
    If frmTaxMsgWOpts.fptxtChoice.Text = "continue" Then
  ...
  If VerifyGLNum(QPTrim$(fptxtIDebit.Text)) = False Then
    frmTaxMsgWOpts.Label1.Caption = "The Tax Interest Debit number could not be located in the current GL index file. If you wish to save it anyway then press F10. Otherwise, press ESC to return to the screen without saving."
    frmTaxMsgWOpts.Label1.Top = 800
    frmTaxMsgWOpts.cmdCont.Text = "F10 Continue"
    frmTaxMsgWOpts.Show vbModal
    If frmTaxMsgWOpts.fptxtChoice.Text = "continue" Then
  ...
  If VerifyGLNum(QPTrim$(fptxtICredit.Text)) = False Then
    frmTaxMsgWOpts.Label1.Caption = "The Tax Interest Credit number could not be located in the current GL index file. If you wish to save it anyway then press F10. Otherwise, press ESC to return to the screen without saving."
    frmTaxMsgWOpts.Label1.Top = 800
    frmTaxMsgWOpts.cmdCont.Text = "F10 Continue"
    frmTaxMsgWOpts.Show vbModal
    If frmTaxMsgWOpts.fptxtChoice.Text = "continue" Then
  ...
  If VerifyGLNum(QPTrim$(fptxtACDebit.Text)) = False Then
    frmTaxMsgWOpts.Label1.Caption = "The Tax Adv/Collect Debit number could not be located in the current GL index file. If you wish to save it anyway then press F10. Otherwise, press ESC to return to the screen without saving."
    frmTaxMsgWOpts.Label1.Top = 800
    frmTaxMsgWOpts.cmdCont.Text = "F10 Continue"
    frmTaxMsgWOpts.Show vbModal
    If frmTaxMsgWOpts.fptxtChoice.Text = "continue" Then
  ...
  If VerifyGLNum(QPTrim$(fptxtACCredit.Text)) = False Then
    frmTaxMsgWOpts.Label1.Caption = "The Tax Adv/Collect Credit number could not be located in the current GL index file. If you wish to save it anyway then press F10. Otherwise, press ESC to return to the screen without saving."
    frmTaxMsgWOpts.Label1.Top = 800
    frmTaxMsgWOpts.cmdCont.Text = "F10 Continue"
    frmTaxMsgWOpts.Show vbModal
    If frmTaxMsgWOpts.fptxtChoice.Text = "continue" Then
  ...
  If VerifyGLNum(QPTrim$(fptxtLLDebit.Text)) = False Then
    frmTaxMsgWOpts.Label1.Caption = "The Tax Late Listing Debit number could not be located in the current GL index file. If you wish to save it anyway then press F10. Otherwise, press ESC to return to the screen without saving."
    frmTaxMsgWOpts.Label1.Top = 800
    frmTaxMsgWOpts.cmdCont.Text = "F10 Continue"
    frmTaxMsgWOpts.Show vbModal
    If frmTaxMsgWOpts.fptxtChoice.Text = "continue" Then
  ...
  If VerifyGLNum(QPTrim$(fptxtLLCredit.Text)) = False Then
    frmTaxMsgWOpts.Label1.Caption = "The Tax Late Listing Credit number could not be located in the current GL index file. If you wish to save it anyway then press F10. Otherwise, press ESC to return to the screen without saving."
    frmTaxMsgWOpts.Label1.Top = 800
    frmTaxMsgWOpts.cmdCont.Text = "F10 Continue"
    frmTaxMsgWOpts.Show vbModal
    If frmTaxMsgWOpts.fptxtChoice.Text = "continue" Then
  ...
  If VerifyGLNum(QPTrim$(fptxtOR1Debit.Text)) = False Then
    frmTaxMsgWOpts.Label1.Caption = "The Tax Optional Revenue #1 Debit number could not be located in the current GL index file. If you wish to save it anyway then press F10. Otherwise, press ESC to return to the screen without saving."
    frmTaxMsgWOpts.Label1.Top = 800
    frmTaxMsgWOpts.cmdCont.Text = "F10 Continue"
    frmTaxMsgWOpts.Show vbModal
    If frmTaxMsgWOpts.fptxtChoice.Text = "continue" Then
  ...
  If VerifyGLNum(QPTrim$(fptxtOR1Credit.Text)) = False Then
    frmTaxMsgWOpts.Label1.Caption = "The Tax Optional Revenue #1 Credit number could not be located in the current GL index file. If you wish to save it anyway then press F10. Otherwise, press ESC to return to the screen without saving."
    frmTaxMsgWOpts.Label1.Top = 800
    frmTaxMsgWOpts.cmdCont.Text = "F10 Continue"
    frmTaxMsgWOpts.Show vbModal
    If frmTaxMsgWOpts.fptxtChoice.Text = "continue" Then
...
MoveTo2:
  ...
  If VerifyGLNum(QPTrim$(fptxtOR2Debit.Text)) = False Then
    frmTaxMsgWOpts.Label1.Caption = "The Tax Optional Revenue #2 Debit number could not be located in the current GL index file. If you wish to save it anyway then press F10. Otherwise, press ESC to return to the screen without saving."
    frmTaxMsgWOpts.Label1.Top = 800
    frmTaxMsgWOpts.cmdCont.Text = "F10 Continue"
    frmTaxMsgWOpts.Show vbModal
    If frmTaxMsgWOpts.fptxtChoice.Text = "continue" Then
  ...
  If VerifyGLNum(QPTrim$(fptxtOR2Credit.Text)) = False Then
    frmTaxMsgWOpts.Label1.Caption = "The Tax Optional Revenue #2 Credit number could not be located in the current GL index file. If you wish to save it anyway then press F10. Otherwise, press ESC to return to the screen without saving."
    frmTaxMsgWOpts.Label1.Top = 800
    frmTaxMsgWOpts.cmdCont.Text = "F10 Continue"
    frmTaxMsgWOpts.Show vbModal
    If frmTaxMsgWOpts.fptxtChoice.Text = "continue" Then
...
MoveTo3:
  ...
  If VerifyGLNum(QPTrim$(fptxtOR3Debit.Text)) = False Then
    frmTaxMsgWOpts.Label1.Caption = "The Tax Optional Revenue #3 Debit number could not be located in the current GL index file. If you wish to save it anyway then press F10. Otherwise, press ESC to return to the screen without saving."
    frmTaxMsgWOpts.Label1.Top = 800
    frmTaxMsgWOpts.cmdCont.Text = "F10 Continue"
    frmTaxMsgWOpts.Show vbModal
    If frmTaxMsgWOpts.fptxtChoice.Text = "continue" Then
  ...
  If VerifyGLNum(QPTrim$(fptxtOR3Credit.Text)) = False Then
    frmTaxMsgWOpts.Label1.Caption = "The Tax Optional Revenue #3 Credit number could not be located in the current GL index file. If you wish to save it anyway then press F10. Otherwise, press ESC to return to the screen without saving."
    frmTaxMsgWOpts.Label1.Top = 800
    frmTaxMsgWOpts.cmdCont.Text = "F10 Continue"
    frmTaxMsgWOpts.Show vbModal
    If frmTaxMsgWOpts.fptxtChoice.Text = "continue" Then
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPayGLSetup", "cmdSave_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      ...
      KillFile "C:\CPWork\taxpayGL.dat"
      ClearInUse PWcnt
      MainLog ("CitiTaxes.exe terminated via menu bar on frmTaxPayGLSetUp.")
      Call Terminate
      End
    End If
  End If
...
Private Sub Form_Load()
  ...
  MainLog ("User opened frmTaxPayGLSetUp.")
  Call LoadMe
End Sub
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPayGLSetup", "LoadMe", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPayGLSetup", "fpListYear_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPayGLSetUp", "Check4Changes", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub LogSaves()
  ...
  If QPTrim$(TempTaxDBAcct) <> ThisDesc Then
    MainLog ("frmTaxBillSetUp: For Year " + CStr(TempYear) + ": Tax Principle Debit was changed from " + QPTrim$(TempTaxDBAcct) + " to " + ThisDesc + " and saved.")
  End If
  ...
  If QPTrim$(TempTaxCRAcct) <> ThisDesc Then
    MainLog ("frmTaxBillSetUp: For Year " + CStr(TempYear) + ": Tax Principle Credit was changed from " + QPTrim$(TempTaxCRAcct) + " to " + ThisDesc + " and saved.")
  End If
  ...
  If QPTrim$(TempIntDBAcct) <> ThisDesc Then
    MainLog ("frmTaxBillSetUp: For Year " + CStr(TempYear) + ": Interest Debit was changed from " + QPTrim$(TempIntDBAcct) + " to " + ThisDesc + " and saved.")
  End If
  ...
  If QPTrim$(TempIntCRAcct) <> ThisDesc Then
    MainLog ("frmTaxBillSetUp: For Year " + CStr(TempYear) + ": Interest Credit was changed from " + QPTrim$(TempIntCRAcct) + " to " + ThisDesc + " and saved.")
  End If
  ...
  If QPTrim$(TempAdvDBAcct) <> ThisDesc Then
    MainLog ("frmTaxBillSetUp: For Year " + CStr(TempYear) + ": Adv/Collect Debit was changed from " + QPTrim$(TempAdvDBAcct) + " to " + ThisDesc + " and saved.")
  End If
  ...
  If QPTrim$(TempAdvCRAcct) <> ThisDesc Then
    MainLog ("frmTaxBillSetUp: For Year " + CStr(TempYear) + ": Adv/Collect Credit was changed from " + QPTrim$(TempAdvCRAcct) + " to " + ThisDesc + " and saved.")
  End If
  ...
  If QPTrim$(TempLtLstDBAcct) <> ThisDesc Then
    MainLog ("frmTaxBillSetUp: For Year " + CStr(TempYear) + ": Late Listing Debit was changed from " + QPTrim$(TempLtLstDBAcct) + " to " + ThisDesc + " and saved.")
  End If
  ...
  If QPTrim$(TempLtLstCRAcct) <> ThisDesc Then
    MainLog ("frmTaxBillSetUp: For Year " + CStr(TempYear) + ": Late Listing Credit was changed from " + QPTrim$(TempLtLstCRAcct) + " to " + ThisDesc + " and saved.")
  End If
  ...
  If QPTrim$(TempOpt1DBAcct) <> ThisDesc Then
    MainLog ("frmTaxBillSetUp: For Year " + CStr(TempYear) + ": " + Label10.Caption + " Debit was changed from " + QPTrim$(TempOpt1DBAcct) + " to " + ThisDesc + " and saved.")
  End If
  ...
  If QPTrim$(TempOpt1CRAcct) <> ThisDesc Then
    MainLog ("frmTaxBillSetUp: For Year " + CStr(TempYear) + ": " + Label10.Caption + " Credit was changed from " + QPTrim$(TempOpt1CRAcct) + " to " + ThisDesc + " and saved.")
  End If
  ...
  If QPTrim$(TempOpt2DBAcct) <> ThisDesc Then
    MainLog ("frmTaxBillSetUp: For Year " + CStr(TempYear) + ": " + Label12.Caption + " Debit was changed from " + QPTrim$(TempOpt2DBAcct) + " to " + ThisDesc + " and saved.")
  End If
  ...
  If QPTrim$(TempOpt2CRAcct) <> ThisDesc Then
    MainLog ("frmTaxBillSetUp: For Year " + CStr(TempYear) + ": " + Label12.Caption + " Credit was changed from " + QPTrim$(TempOpt2CRAcct) + " to " + ThisDesc + " and saved.")
  End If
  ...
  If QPTrim$(TempOpt3DBAcct) <> ThisDesc Then
    MainLog ("frmTaxBillSetUp: For Year " + CStr(TempYear) + ": " + Label13.Caption + " Debit was changed from " + QPTrim$(TempOpt3DBAcct) + " to " + ThisDesc + " and saved.")
  End If
  ...
  If QPTrim$(TempOpt3CRAcct) <> ThisDesc Then
    MainLog ("frmTaxBillSetUp: For Year " + CStr(TempYear) + ": " + Label13.Caption + " Credit was changed from " + QPTrim$(TempOpt3CRAcct) + " to " + ThisDesc + " and saved.")
  End If
  
  Exit Sub
  
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPayGLSetup", "LogSaves", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub fptxtTPDebit_LostFocus()
  ...
  ChkGL$ = QPTrim$(fptxtTPDebit.Text)
  If ChkGL$ = "" Then Exit Sub
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxPayGLSetUp", "VerifyGLNum", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

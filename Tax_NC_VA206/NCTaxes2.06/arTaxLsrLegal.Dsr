VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arTaxLsrLegal 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Legal Size Tax Bill"
   ClientHeight    =   8760
   ClientLeft      =   30
   ClientTop       =   420
   ClientWidth     =   11655
   Icon            =   "arTaxLsrLegal.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   20558
   _ExtentY        =   15452
   SectionData     =   "arTaxLsrLegal.dsx":08CA
End
Attribute VB_Name = "arTaxLsrLegal"
...
Private Sub ActiveReport_DataInitialize()
  ...
  hFile = FreeFile
  Open StartPath & "\TAXRPTS\TXLSRLEGAL.RPT" For Input As #hFile
...
Private Sub ActiveReport_Initialize()
  ...
  Close
  If InStr(MasterRec.Name, "CANTON") Then
    Canton = True
  Else
    Canton = False
  End If
...
Private Sub PageHeader_Format()
  If Canton = True And GCnt = 1 Then

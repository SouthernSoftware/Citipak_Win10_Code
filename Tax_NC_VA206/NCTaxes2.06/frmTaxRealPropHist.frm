...
Begin VB.Form frmTaxRealPropHist 
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      Begin LpLib.fpCombo fpcmbTransType 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmTaxRealPropHist.frx":0CC1
      End
      Begin LpLib.fpCombo fpcmbDetSum 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmTaxRealPropHist.frx":109C
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdExit 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxRealPropHist.frx":1477
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
         ...
         TabIndex        =   11
         TabStop         =   0   'False
         Tag             =   $"frmTaxRealPropHist.frx":1655
         Top             =   6090
         Width           =   1740
         _Version        =   131072
         _ExtentX        =   3069
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxRealPropHist.frx":1700
      End
      ...
      Begin fpBtnAtlLibCtl.fpBtn cmdLookup 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxRealPropHist.frx":18DF
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdLookUpByOwner 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxRealPropHist.frx":1ACC
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdDetail 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmTaxRealPropHist.frx":1CBA
      End
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      KillFile "C:\CPWork\realhist.dat"
      MainLog ("CitiTaxes.exe terminated via menu bar on frmTaxRealPropHist.")
      Call Terminate
      End
    End If
  End If
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxRealPropHist", "LoadMe", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxRealPropHist", "Check4ValidPin", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxRealPropHist", "PrintGraphicsDet", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
'          ThisTransType = "Overpayment"
        ...
        If ThisTransType <> "Billing" Then
          ...
          End If
        Else
          Print #RptHandle, Tab(15); "Principal         "; Tab(40); Using$("$##,##0.00", TaxTrans.Revenue.Principle1); Tab(60); Using$("$##,##0.00", TaxTrans.Revenue.Principle1Pd + TaxTrans.DiscAmt); Tab(80); Using$("$##,##0.00", PrincDif)
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxRealPropHist", "PrintTextDet", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub PrintGraphics()
  ...
  For x = 1 To NumOfTTRecs
    Get TTHandle, x, TaxTrans
    If QPTrim$(TaxTrans.Description) = "SoSoft: Link Real Pin" Then TaxTrans.Description = "Original Linkup"
    If QPTrim$(TaxTrans.RealPin) = ThisPin Then
      If ThisClass <> 0 And TaxTrans.TranType <> ThisClass Then GoTo SkipIt
      If TaxTrans.TransDate >= BegDate And TaxTrans.TransDate <= EndDate Then
        Select Case TaxTrans.TranType
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxRealPropHist", "PrintGraphics", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmTaxRealPropHist", "PrintText", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

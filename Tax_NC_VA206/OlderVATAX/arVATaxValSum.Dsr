VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arVATaxValSum 
   ...
   _ExtentX        =   20532
   _ExtentY        =   15399
   SectionData     =   "arVATaxValSum.dsx":08CA
End
Attribute VB_Name = "arVATaxValSum"
...
Private Sub ActiveReport_DataInitialize()
  ...
  Fields.Add ("fldBldgVal") '27)
  Fields.Add ("fldAlphaBldgVal") '28)
  Fields.Add ("fldGBldgVal") '29)
  Fields.Add ("fldGTPersVal") '30)
  Fields.Add ("fldGTMTVal") '31)
  Fields.Add ("fldGTMCVal") '32)
  Fields.Add ("fldGTMHVal") '33)
  Fields.Add ("fldGTFarmVal") '34)
End Sub
...
Private Sub ActiveReport_FetchData(eof As Boolean)
  ...
  Fields("fldBldgVal").Value = arr(27)
  Fields("fldAlphaBldgVal").Value = arr(28)
  Fields("fldGBldgVal").Value = arr(29)
  Fields("fldGTPersVal").Value = arr(30)
  Fields("fldGTMTVal").Value = arr(31)
  Fields("fldGTMCVal").Value = arr(32)
  Fields("fldGTMHVal").Value = arr(33)
  Fields("fldGTFarmVal").Value = arr(34)
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    ElseIf KeyCode = vbKeyE Then
      ...
      DoEvents
      frmVATaxMsg.Label1.Caption = "File - TaxValSum.xls, created in the Citipak Directory."
      frmVATaxMsg.Label1.Top = 900
      frmVATaxMsg.Show vbModal
      KeyCode = 0
    ElseIf KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      frmVATaxMsg.Label1.Caption = "File - TaxValSum.txt, created in the Citipak Directory."
      frmVATaxMsg.Label1.Top = 900
      frmVATaxMsg.Show vbModal
      KeyCode = 0
    End If

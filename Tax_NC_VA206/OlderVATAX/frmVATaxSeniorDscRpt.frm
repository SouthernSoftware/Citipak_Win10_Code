...
Begin VB.Form frmVATaxSeniorDscRpt 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "frmVATaxSeniorDscRpt.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8730
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      FrameThreeDStyle=   1
      FrameWidth      =   2
      Picture         =   "frmVATaxSeniorDscRpt.frx":08CA
      Begin LpLib.fpCombo fpcmbTownship 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmVATaxSeniorDscRpt.frx":08E6
      End
      Begin LpLib.fpCombo fpcmbPrintOpt 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmVATaxSeniorDscRpt.frx":0BDD
      End
      Begin LpLib.fpCombo fpcmbPrintOrder 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmVATaxSeniorDscRpt.frx":0ED4
      End
      ...
      Begin fpBtnAtlLibCtl.fpBtn cmdExit 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxSeniorDscRpt.frx":11CB
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
         ...
         TabIndex        =   12
         TabStop         =   0   'False
         Tag             =   $"frmVATaxSeniorDscRpt.frx":13A9
         Top             =   4800
         Width           =   1740
         _Version        =   131072
         _ExtentX        =   3069
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxSeniorDscRpt.frx":1454
      End
   ...
   End
End
Attribute VB_Name = "frmVATaxSeniorDscRpt"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmVATaxSeniorDscRpt.")
      Call Terminate
      End
    End If
  End If
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxSeniorDscRpt", "LoadMe", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub PrintGraphics()
  ...
  End If
  frmVATaxShowPctComp.Label1 = "Gathering Discount Data"
  ...
  For x = 1 To NumOfTCRecs
    ...
    If ThisTownship <> "No Townships Saved" Then
      ...
      End If
    End If
'    If TaxCust.FirstPersRec > 0 Then '6/14/06 no more pers exemptions
    ...
    If TaxCust.FirstPropRec > 0 Then
      ...
      Do While NextRec > 0
        ...
        If RealRec.Deleted = 0 Then
          If RealRec.EXMPOTHR > 0 Then '6/14/06 Or RealRec.EXMPSENI > 0 Then
            CustCnt = CustCnt + 1
            NextRec = 0
            Exit Do
          Else
...
GotCount:
    ...
    If TaxCust.FirstPropRec > 0 Then
      ...
      Do While NextRec > 0
        ...
        SnrX = 0 '6/14/06RealRec.EXMPSENI
...
Deleted1:
    ...
    If TaxCust.FirstPersRec > 0 Then
      ...
      Do While NextRec > 0
        ...
        SnrX = 0 ' 6/14/06 no more pers exemptions PersRec.EXMPSENI
        OthX = 0 ' 6/14/06 no more pers exemptionsPersRec.EXMPOTHR
        ThisVal = OldRound(SnrX + OthX)
        ThisBothDsc = OldRound(ThisBothDsc + ThisVal)
        TotBothDsc = OldRound(TotBothDsc + ThisVal)
        ThisVal = SnrX
...
SkipIt:
  ...
  arVATaxDiscountRpt.Show
  
  Exit Sub

ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxSeniorDscRpt", "PrintGraphics", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
GotCount:
    ...
    If TaxCust.FirstPropRec > 0 Then
      ...
      Do While NextRec > 0
        Get RHandle, NextRec, RealRec
        If RealRec.Deleted = -1 Then GoTo Deleted1
        SnrX = 0 ' 6/14/06 RealRec.EXMPSENI
        OthX = RealRec.EXMPOTHR
        ThisVal = OldRound(SnrX + OthX)
        ThisBothDsc = OldRound(ThisBothDsc + ThisVal)
        TotBothDsc = OldRound(TotBothDsc + ThisVal)
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxSeniorDscRpt", "PrintText", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

...
Begin VB.Form frmVATaxRateTables 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Optional Real Revenue Rate Tables"
   ClientHeight    =   8730
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "frmVATaxRateTables.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8730
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxRateTables.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxRateTables.frx":0AA8
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdEdit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxRateTables.frx":0C84
   End
   ...
   End
End
Attribute VB_Name = "frmVATaxRateTables"
...
Private Sub cmdEdit_Click()
  ...
  If Check4Changes = True Then
    ...
    Exit Sub
  End If
  frmVATaxRateListPop.Show 'vbModal
End Sub
...
Private Sub LoadMe()
  ...
  Call LoadDesc
  If Exist("C:\CPWork\addrtbl.dat") Then
    EditMode = False
  ...
  If Exist(TaxRateTableFile) Then
    ...
    For x = 1 To NumOfTRRecs
      ...
      If TblRec.Deleted = False And TblRec.RevType = "R" Then
        Exit For
      End If
    Next x
    Close TRHandle
...
Private Function Check4DupDescs() As Boolean
  ...
  For x = 1 To NumOfTRRecs
    Get TRHandle, x, TblRec
    If TblRec.RevType = "P" Then GoTo SkipIt

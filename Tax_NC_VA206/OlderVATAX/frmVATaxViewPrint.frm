...
Begin VB.Form frmVATaxViewPrint 
   ...
   ClientTop       =   435
   ClientWidth     =   10485
   Icon            =   "frmVATaxViewPrint.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdAlignment 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxViewPrint.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrnScn 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxViewPrint.frx":0AA5
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxViewPrint.frx":0C87
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxViewPrint.frx":0E62
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxViewPrint.frx":103D
   End
End
Attribute VB_Name = "frmVATaxViewPrint"
...
Private Sub cmdAlignment_Click()
  frmVATaxPrint.Show 1
End Sub

Private Sub cmdExit_Click()
  Unload frmVATaxViewPrint
  DoEvents
End Sub

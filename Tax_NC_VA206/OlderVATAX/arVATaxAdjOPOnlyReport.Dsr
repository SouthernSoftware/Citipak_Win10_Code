VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arVATaxAdjOPOnlyReport 
   ...
   ClientTop       =   420
   ClientWidth     =   11655
   Icon            =   "arVATaxAdjOPOnlyReport.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   20558
   _ExtentY        =   15452
   SectionData     =   "arVATaxAdjOPOnlyReport.dsx":08CA
End
Attribute VB_Name = "arVATaxAdjOPOnlyReport"
...
Private Sub ActiveReport_DataInitialize()
  Dim x As Integer
  hFile = FreeFile
'  Open StartPath & "\TAXRPTS\TXPADJRPT.RPT" For Input As #hFile
  Open StartPath & "\TAXRPTS\TXADJRPT.RPT" For Input As #hFile 'changed 9/16/08
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    ElseIf KeyCode = vbKeyE Then
      ...
      DoEvents
      frmVATaxMsg.Label1.Caption = "File - TaxAdjRptOPOnly.xls, created in the Citipak Directory."
      frmVATaxMsg.Label1.Top = 900
      frmVATaxMsg.Show vbModal
      KeyCode = 0
    ElseIf KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      frmVATaxMsg.Label1.Caption = "File - TaxAdjRptOPOnly.txt, created in the Citipak Directory."
      frmVATaxMsg.Label1.Top = 900
      frmVATaxMsg.Show vbModal
      KeyCode = 0
    End If

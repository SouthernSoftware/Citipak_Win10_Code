...
Begin VB.Form frmVATaxExpCustInfo 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   420
   ClientWidth     =   11655
   Icon            =   "frmVATaxExpCustInfo.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdUntagAll 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxExpCustInfo.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdTagAll 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxExpCustInfo.frx":0AA7
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxExpCustInfo.frx":0C82
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
      ...
      TabIndex        =   47
      TabStop         =   0   'False
      Tag             =   $"frmVATaxExpCustInfo.frx":0E60
      Top             =   7920
      Width           =   1740
      _Version        =   131072
      _ExtentX        =   3069
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxExpCustInfo.frx":0F0B
   End
   Begin VB.Frame Frame1 
      ...
      Top             =   1580
      Width           =   2172
      Begin VB.OptionButton OptPersOnly 
         BackColor       =   &H008F8265&
         ...
         Width           =   2172
      End
      Begin VB.OptionButton OptRealOnly 
         BackColor       =   &H008F8265&
         Caption         =   "Real Only"
         BeginProperty Font 
            Name            =   "Tahoma"
   ...
   End
End
Attribute VB_Name = "frmVATaxExpCustInfo"
...
Private Sub cmdProcess_Click()
  ...
  If OptBoth.Value = True Then
    PrintType = "B"
  ElseIf OptRealOnly.Value = True Then
    PrintType = "R"
  ElseIf OptPersOnly.Value = True Then
    PrintType = "P"
  Else
    PrintType = "N"
  End If
  ...
  For x = 1 To NumOfTCRecs
    ...
    If OptRealOnly.Value = True Then
      If TaxCust.FirstPropRec = 0 Then GoTo NotThisOne
    ElseIf OptPersOnly.Value = True Then
      If TaxCust.FirstPersRec = 0 Then GoTo NotThisOne
    End If
...
DoHeaders:
  ...
  If chkCustCnty.Value = 1 Then Print #TaxRpt, qcq$; "Customer County";
  ...
  If PrintType = "R" Or PrintType = "B" Then
    ...
    If ThisRec > 0 Then
      Do While ThisRec > 0
        ...
        If chkCustCnty.Value = 1 Then Print #TaxRpt, qcq$; QPTrim$(TaxCust.County4BillName);
'        If chkCoStrNum.Value = 1 Then Print #TaxRpt, qcq$; QPTrim$(TaxCust.CountyAcctString);
        ...
        If chkBalance.Value = 1 Then
          ThisBal = GetCustRealBalance(x, -1)
...
'        If chkCoStrNum.Value = 1 Then Print #TaxRpt, qcq$; QPTrim$(TaxCust.CountyAcctString);
        ...
        End If
        If chkBalance.Value = 1 Then
          ThisBal = GetCustPersBalance(x, -1)
          Print #TaxRpt, qcq$; Using$("$###,###,##0.00", ThisBal);
        End If
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmVATaxExpCustInfo.")
      Call Terminate
      End
    End If
  End If

...
Begin VB.Form frmVATaxCustLookupPPenOnly 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Personal Penalty Customer Lookup"
   ClientHeight    =   8760
   ClientLeft      =   30
   ClientTop       =   420
   ClientWidth     =   11655
   Icon            =   "frmVATaxCustLookupPPenOnly.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin LpLib.fpList fpList1 
      ...
      Left            =   732
      TabIndex        =   0
      Tag             =   $"frmVATaxCustLookupPPenOnly.frx":08CA
      Top             =   3456
      Width           =   10200
      _Version        =   196608
      _ExtentX        =   17992
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmVATaxCustLookupPPenOnly.frx":0A32
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxCustLookupPPenOnly.frx":0D9A
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSearch 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxCustLookupPPenOnly.frx":0F78
   End
   ...
   End
End
Attribute VB_Name = "frmVATaxCustLookupPPenOnly"
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxCustLookupPPenOnly", "cmdSearch_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxCustLookupPPenOnly", "fpList1_DblClick", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmVATaxCustLookupPPenOnly.")
      Call Terminate
      End
    End If
  End If

...
Begin VB.Form frmVATaxBillPostOpt 
   BackColor       =   &H008F8265&
   BorderStyle     =   0  'None
   ClientHeight    =   2880
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6588
   Icon            =   "frmVATaxBillPostOpt.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   ScaleHeight     =   2880
   ScaleWidth      =   6588
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxBillPostOpt.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdReal 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxBillPostOpt.frx":0AA6
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPersonal 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxBillPostOpt.frx":0C81
   End
   ...
   End
End
Attribute VB_Name = "frmVATaxBillPostOpt"

...
Begin VB.Form frmVATaxReportOpt 
   BackColor       =   &H008F8265&
   BorderStyle     =   0  'None
   Caption         =   "Form1"
   ClientHeight    =   2856
   ...
   ClientTop       =   0
   ClientWidth     =   6600
   Icon            =   "frmVATaxReportOpt.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   ScaleHeight     =   2856
   ScaleWidth      =   6600
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportOpt.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdGraphic 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportOpt.frx":0AA6
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdText 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportOpt.frx":0C85
   End
   ...
   End
End
Attribute VB_Name = "frmVATaxReportOpt"

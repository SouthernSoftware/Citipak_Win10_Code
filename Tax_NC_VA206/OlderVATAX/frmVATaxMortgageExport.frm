...
Begin VB.Form frmVATaxMortgageExport 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "frmVATaxMortgageExport.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      FrameThreeDStyle=   1
      FrameWidth      =   2
      Picture         =   "frmVATaxMortgageExport.frx":08CA
      Begin LpLib.fpList fpList 
         Height          =   2448
         Left            =   960
         TabIndex        =   9
         Tag             =   $"frmVATaxMortgageExport.frx":08E6
         Top             =   2400
         Width           =   7452
         _Version        =   196608
         _ExtentX        =   13144
         ...
         TextTipMultiLine=   0
         ColDesigner     =   "frmVATaxMortgageExport.frx":0A5F
      End
      Begin LpLib.fpCombo fpcmbRange 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmVATaxMortgageExport.frx":0E3F
      End
      Begin LpLib.fpCombo fpcmbPrintOpt 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmVATaxMortgageExport.frx":11A6
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdExit 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxMortgageExport.frx":150D
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
         ...
         TabIndex        =   7
         TabStop         =   0   'False
         Tag             =   $"frmVATaxMortgageExport.frx":16EB
         Top             =   6120
         Width           =   1692
         _Version        =   131072
         _ExtentX        =   2984
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxMortgageExport.frx":1786
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdClear 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxMortgageExport.frx":1965
      End
   ...
   End
End
Attribute VB_Name = "frmVATaxMortgageExport"
...
Private Sub cmdExit_Click()
  If Exist("frombillpost.dat") Then
    Call frmVATaxBillingMenu.cmdPost_Click
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxMortgageExport", "cmdProcess_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmVATaxMortgageExport.")
      Call Terminate
      End
    End If
  End If
...
Private Sub PrintMortFiles(SpreadIdx() As Long, ListCnt As Integer)
  ...
  Close TMHandle
  ThisYear$ = CStr(TaxMasterRec.RTaxYear)
  ...
  frmVATaxShowPctComp.Label1 = "Creating Mortgage Company Export Files"
  ...
  For x = 1 To ListCnt
    ...
    Else
      ...
      Close RptOut
    End If
    frmVATaxShowPctComp.ShowPctComp x, ListCnt
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxMortgageExport", "PrintMortFiles", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub PrintGraphics(MortCodeCos() As String, MortCodeXName() As String, MortCustCnt() As Long, MortTaxTot() As Double, MCCnt As Integer)
  ...
  arVATaxMortXRpt.Show
  
  Exit Sub

ERRORSTUFF:
   Unload frmVATaxShowPctComp
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxMortgageExport", "PrintGraphics", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Unload frmVATaxShowPctComp
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxMortgageEXport", "PrintText", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arVATaxMasterBalDet 
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "arVATaxMasterBalDet.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   20532
   _ExtentY        =   15399
   SectionData     =   "arVATaxMasterBalDet.dsx":08CA
End
Attribute VB_Name = "arVATaxMasterBalDet"
...
Private Sub ActiveReport_DataInitialize()
  ...
  Fields.Add ("fldPenBal") '30)
  Fields.Add ("fldGPenTot") '31)
  Fields.Add ("fldBillNum") '32)
  Fields.Add ("fldOP") '33)
  Fields.Add ("fldMainYear") '34
End Sub
...
Private Sub ActiveReport_FetchData(eof As Boolean)
  ...
  Fields("fldPenBal").Value = arr(30)
  Fields("fldGPenTot").Value = arr(31)
  Fields("fldBillNum").Value = arr(32)
  Fields("fldOP").Value = arr(33)
  Fields("fldMainYear").Value = arr(34)
End Sub
...
AllTrue:
  Line1.Visible = True
  Set SubReport1 = New arVASubTaxMastBalDet

...
Begin VB.Form frmVATaxPersProp 
   ...
   Begin LpLib.fpCombo fpcmbDiscoveryYN 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxPersProp.frx":0C69
   End
   Begin LpLib.fpCombo fpcmbProRateYN 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxPersProp.frx":1008
   End
   Begin LpLib.fpCombo fpcmbPRVal 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxPersProp.frx":13A7
   End
   Begin LpLib.fpCombo fpcmbPPTRAYN 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxPersProp.frx":1746
   End
   Begin LpLib.fpCombo fpcmbOptRev1 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxPersProp.frx":1AE5
   End
   Begin LpLib.fpCombo fpcmbOptRev2 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxPersProp.frx":1EDC
   End
   Begin LpLib.fpCombo fpcmbOptRev3 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxPersProp.frx":22D3
   End
   Begin LpLib.fpCombo fpcmbGoToPins 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxPersProp.frx":26CA
   End

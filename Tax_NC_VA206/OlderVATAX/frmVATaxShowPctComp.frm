...
Begin VB.Form frmVATaxShowPctComp 
   BackColor       =   &H00D0D0D0&
   ...
   ClientTop       =   420
   ClientWidth     =   5592
   Icon            =   "frmVATaxShowPctComp.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   2796
   ...
   Begin fpBtnAtlLibCtl.fpBtn CmdCancel 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxShowPctComp.frx":08CA
   End
   ...
   End
End
Attribute VB_Name = "frmVATaxShowPctComp"
...
Public Sub ShowPctComp(ByVal cnt As Long, ByVal TotalCnt As Long)
  ...
  frmVATaxShowPctComp.Label3 = PctComp

...
Begin VB.Form frmVATaxMortDetail 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   435
   ClientWidth     =   8400
   Icon            =   "frmVATaxMortDetail.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxMortDetail.frx":08CA
   End
   ...
   End
End
Attribute VB_Name = "frmVATaxMortDetail"
...
Private Sub Form_Load()
  ...
  ThisCode = QPTrim$(frmVATaxRealProp.fpcmbMortCode.Text)

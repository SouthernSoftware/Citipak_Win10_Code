...
Begin VB.Form frmVATaxDMVTransmissionFile 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Tax DMV Transmission File"
   ClientHeight    =   8760
   ClientLeft      =   30
   ClientTop       =   420
   ClientWidth     =   11655
   Icon            =   "frmVATaxDMVTransmissionFile.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   ScaleHeight     =   8760
   ScaleWidth      =   11655
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxDMVTransmissionFile.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxDMVTransmissionFile.frx":0AA6
   End
   ...
   End
End
Attribute VB_Name = "frmVATaxDMVTransmissionFile"
...
Private Sub cmdProcess_Click()
  ...
  RptHandle10 = FreeFile
  Open PayJourName$ For Output As RptHandle10
  Close RptHandle10
  ...
  For x = 1 To NumOfTCRecs
    ...
    Do While TransRecord& > 0
      ...
      If TransRec.DMVSubmitted = "Y" Then GoTo NextLoop
...
DMVLines:
  For Records = 1 To veh
    Print #RptHandle10, "D@";
    Print #RptHandle10, RTrim$(LTrim$(Str$(Records))) + "@";
    Print #RptHandle10, RTrim$(SSN1$(Records)) + "@";
    Print #RptHandle10, RTrim$(LastName1$(Records)) + "@";
    Print #RptHandle10, RTrim$(FirstName1$(Records)) + "@";
    Print #RptHandle10, "@";
    Print #RptHandle10, "@";
    Print #RptHandle10, "@";
    Print #RptHandle10, "@";
    Print #RptHandle10, "@";
    Print #RptHandle10, RTrim$(Addr1$(Records)) + "@";
    Print #RptHandle10, RTrim$(Addr2$(Records)) + "@";
    Print #RptHandle10, RTrim$(City$(Records)) + "@";
    Print #RptHandle10, RTrim$(State$(Records)) + "@";
    Print #RptHandle10, RTrim$(Zip$(Records)) + "@";
    Print #RptHandle10, RTrim$(Vin$(Records)) + "@";
    VehValueS$ = LTrim$(Str$(VehValue#(Records)))
    Print #RptHandle10, RTrim$(VehValueS$) + "@";
    Print #RptHandle10, RTrim$(PPTaxPd$(Records)) + "@";
    Print #RptHandle10, RTrim$(PPTaxReimb$(Records)) + "@";
    Print #RptHandle10, LTrim$(TaxYear$) + SMth$(Records) + "@";
    Print #RptHandle10, LTrim$(TaxYear$) + EMth$(Records) + "@";
    Print #RptHandle10, Jury$ + "@";
    Print #RptHandle10, RTrim$(ReplaceString(ThisDateS, "/", "")) + "@"        'ADDED NEW CODE FOR 2001
...
DMVHeaderWrite:
  ...
  Print #RptHandle10, "1@";
  Print #RptHandle10, Jury$ + "@";
  Print #RptHandle10, Right$(Date$, 4) + "@";
  Print #RptHandle10, RTrim$(ThisDateS$) + "@";
  Print #RptHandle10, RTrim$(VehiclesS$) + "@";
  Print #RptHandle10, TotalAmt$ + "@";
  Print #RptHandle10, TotalCrCnt$ + "@";
  Print #RptHandle10, TotalCrAmt$
  Return
...
Private Sub Form_Load()
  ...
  Me.HelpContextID = hlpPrepareDMV
  Call LoadMe
End Sub
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmVATaxDMVTransmissionFile.")
      Call Terminate
      End
    End If
  End If

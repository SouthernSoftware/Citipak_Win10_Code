...
Begin VB.Form frmVATaxCustTHistRpt 
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      Begin fpBtnAtlLibCtl.fpBtn cmdPropDet 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxCustTHistRpt.frx":14D2
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdAll 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxCustTHistRpt.frx":16F0
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdClear 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxCustTHistRpt.frx":18CD
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdExit 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxCustTHistRpt.frx":1AA9
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
         ...
         TabIndex        =   16
         TabStop         =   0   'False
         Tag             =   $"frmVATaxCustTHistRpt.frx":1CBF
         Top             =   6480
         Width           =   1740
         _Version        =   131072
         _ExtentX        =   3069
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxCustTHistRpt.frx":1D6A
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdMessage 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxCustTHistRpt.frx":1F81
      End

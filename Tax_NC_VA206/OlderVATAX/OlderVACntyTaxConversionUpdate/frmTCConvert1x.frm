...
'    If QPTrim$(TempRec.CData.CountyAcctString) = "2298148" Then Stop
'    If QPTrim$(TempRec.CData.PinNum) = "2FMDA51644BA16913" Then Stop
    ...
    For y = 1 To NumOfTCRecs
      ...
      ElseIf QPTrim$(TempRec.CData.CountyAcctString) <> "" Then 'make sure a valid county number exists
        If QPTrim$(TaxCust.CountyAcctString) = "00" + QPTrim$(TempRec.CData.CountyAcctString) Or QPTrim$(TaxCust.CountyAcctString) = QPTrim$(TempRec.CData.CountyAcctString) Then 'find existing customer
          If PersValue > 0 And RealValue > 0 Then
            ErrorCode = 1
            GoSub SaveErrors
            GoTo CustErrors

...
Begin VB.Form frmVATaxMailLblsLateNotice 
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      Begin LpLib.fpCombo fpcmbRange 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmVATaxMaiLblsLateNotice.frx":08E6
      End
      Begin LpLib.fpCombo fpcmbLabel 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmVATaxMaiLblsLateNotice.frx":0C15
      End
      Begin LpLib.fpList fpList 
         Height          =   1368
         Left            =   960
         TabIndex        =   6
         Tag             =   $"frmVATaxMaiLblsLateNotice.frx":0F44
         Top             =   3360
         Width           =   7452
         _Version        =   196608
         _ExtentX        =   13144
         ...
         ResizeRowToFont =   0   'False
         TextTipMultiLine=   0
         ColDesigner     =   "frmVATaxMaiLblsLateNotice.frx":10BD
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdAlign 
         ...
         TabIndex        =   7
         TabStop         =   0   'False
         Tag             =   $"frmVATaxMaiLblsLateNotice.frx":1464
         Top             =   5520
         Width           =   1548
         _Version        =   131072
         _ExtentX        =   2730
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxMaiLblsLateNotice.frx":1543
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdExit 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxMaiLblsLateNotice.frx":171F
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
         ...
         TabIndex        =   9
         TabStop         =   0   'False
         Tag             =   $"frmVATaxMaiLblsLateNotice.frx":18FD
         Top             =   5520
         Width           =   1692
         _Version        =   131072
         _ExtentX        =   2984
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxMaiLblsLateNotice.frx":1998
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdClear 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmVATaxMaiLblsLateNotice.frx":1B77
      End

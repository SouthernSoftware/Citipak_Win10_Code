...
Begin VB.Form frmVATaxExpRealInfo 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   420
   ClientWidth     =   11655
   Icon            =   "frmVATaxExpRealInfo.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MinButton       =   0   'False
   ScaleHeight     =   8760
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdUntagAll 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxExpRealInfo.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdTagAll 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxExpRealInfo.frx":0AA7
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxExpRealInfo.frx":0C82
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
      ...
      TabIndex        =   36
      TabStop         =   0   'False
      Tag             =   $"frmVATaxExpRealInfo.frx":0E60
      Top             =   7800
      Width           =   1740
      _Version        =   131072
      _ExtentX        =   3069
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxExpRealInfo.frx":0F0B
   End
   ...
   End
End
Attribute VB_Name = "frmVATaxExpRealInfo"
...
Private Sub cmdProcess_Click()
  ...
  frmVATaxShowPctComp.Label1 = "Printing Real Property Data"
...
DoHeaders:
  ...
  If chkTownship.Value = 1 Then Print #TaxRpt, qcq$; "Township";
  Print #TaxRpt, q$
...
ExportThisOne:
  ...
  If chkSnrDisc.Value = 1 Then Print #TaxRpt, qcq$; Using$("$###,###,##0.00", 0); '6/14/06 RealRec.EXMPSENI);
  ...
  End If
  If chkTownship.Value = 1 Then Print #TaxRpt, qcq$; QPTrim$(RealRec.TownShip);
  Print #TaxRpt, q$
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmVATaxExpRealInfo.")
      Call Terminate
      End
    End If
  End If

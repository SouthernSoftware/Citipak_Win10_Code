VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arVATaxMessage 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Tax Customer Mesage"
   ClientHeight    =   8730
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "arTaxMessage.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   20532
   _ExtentY        =   15399
   SectionData     =   "arTaxMessage.dsx":08CA
End
Attribute VB_Name = "arVATaxMessage"
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    ElseIf KeyCode = vbKeyE Then
      ...
      DoEvents
      MsgBox "File - TaxMsgRpt.xls, created in the Citipak Directory.", vbOKOnly
      KeyCode = 0
    ElseIf KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      MsgBox "File - TaxMsgRpt.txt, created in the Citipak Directory.", vbOKOnly
      KeyCode = 0
    End If
  End If
End Sub
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & "TaxMsgRpt.xls"
        oEXL.Export Me.Pages
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & "TaxMsgRpt.txt"
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","
...
Private Sub ActiveReport_DataInitialize()
  hFile = FreeFile
  Open StartPath & "TAXMSG.RPT" For Input As #hFile
  Fields.Add "fld1" '0
  Fields.Add "fld2" '1
  Fields.Add "fld3" '2
  Fields.Add "fld4" '3

...
Begin VB.Form frmVATaxRealLookupByOwner 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "frmVATaxRealLookupByOwner.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin LpLib.fpList fpList1 
      ...
      Left            =   420
      TabIndex        =   19
      Tag             =   $"frmVATaxRealLookupByOwner.frx":08CA
      Top             =   6360
      Width           =   10800
      _Version        =   196608
      _ExtentX        =   19050
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmVATaxRealLookupByOwner.frx":0A32
   End
   Begin LpLib.fpCombo fpcmbAcctNum 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxRealLookupByOwner.frx":0E3F
   End
   Begin LpLib.fpCombo fpcmbSearchName 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxRealLookupByOwner.frx":11FE
   End
   Begin LpLib.fpCombo fpcmbCurrOwner 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxRealLookupByOwner.frx":15BD
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxRealLookupByOwner.frx":197C
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSearch 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxRealLookupByOwner.frx":1B5A
   End
   Begin VB.Label Label4 
      Alignment       =   2  'Center
      BackColor       =   &H0080FFFF&
      Caption         =   $"frmVATaxRealLookupByOwner.frx":1D38
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   9.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmVATaxRealLookupByOwner"
...
Private Sub cmdSearch_Click()
  ...
  If RealCnt = 1 Then
    frmVATaxRealPropHist.GRealRec = ThisRealRec
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxRealLookupByOwner", "cmdSearch_Click", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxRealLookupByOwner", "LoadMe", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxRealLookupByOwner", "Check4DupDescs", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

...
Begin VB.Form frmVATaxReportsMenu 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   435
   ClientWidth     =   11640
   Icon            =   "frmVATaxReportsMenu.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8730
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdExpReal 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportsMenu.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdAdvRpt 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportsMenu.frx":0AB3
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdMastCustList 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportsMenu.frx":0C9F
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdMailLbls 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportsMenu.frx":0E8A
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdMasterVal 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportsMenu.frx":106C
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdTransJrnl 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportsMenu.frx":1258
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdMastBalList 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportsMenu.frx":143F
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdLateList 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportsMenu.frx":1629
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdMortCodeRpt 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportsMenu.frx":1809
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdCustInq 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportsMenu.frx":19F1
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdCustTransHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportsMenu.frx":1BD5
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSenCtzns 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportsMenu.frx":1DBF
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrintAbs 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportsMenu.frx":1FA6
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdRealHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportsMenu.frx":2189
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdCollRate 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportsMenu.frx":2372
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdCustExp 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportsMenu.frx":2556
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportsMenu.frx":273E
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdDiscsGiven 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxReportsMenu.frx":291B
   End
   ...
   End
End
Attribute VB_Name = "frmVATaxReportsMenu"
...
Private Sub cmdMailLbls_Click()
  ...
  frmVATaxMailingLblsGeneral.Show
  DoEvents
  Unload Me
End Sub
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmVATaxReportsMenu.")
      Call Terminate
      End
    End If
  End If
...
Private Sub PrintGraphicsAbRpt()
  ...
  frmVATaxShowPctComp.Label1 = "Gathering Property Data"
...
PrintPers:
  ...
  '                      22                  23
  Print #RptHandle, QPTrim$(PersRec.Desc4); dlm; PersRec.Desc5
  
  PCnt = PCnt + 1
  Return
  
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxReportsMenu", "PrintGraphicsAbRpt", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxReportsMenu", "PrintTextAbRpt", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

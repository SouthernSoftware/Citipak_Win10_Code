...
Begin VB.Form frmVATaxPrintCycleUsers 
   ...
   ClientTop       =   435
   ClientWidth     =   8700
   Icon            =   "frmVATaxPrintCycleUsers.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin LpLib.fpList fpList1 
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmVATaxPrintCycleUsers.frx":08CA
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdConvert 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxPrintCycleUsers.frx":0B76
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxPrintCycleUsers.frx":0D54
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxPrintCycleUsers.frx":0F32
   End
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   $"frmVATaxPrintCycleUsers.frx":110F
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   9.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmVATaxPrintCycleUsers"
...
Private Sub cmdConvert_Click()
  ...
  For x = 1 To NumOfTCRecs
    ...
    If TaxCustRec.Cycle = CLng(frmVATaxCycleSetup.ThisNumber) Then
      TaxCustRec.Cycle = frmVATaxCycleSetup.NewNum
      CnvtCnt = CnvtCnt + 1
...
Private Sub Form_Load()
  ...
  fptxtBillingCycle.Text = "# " + CStr(frmVATaxCycleSetup.ThisNumber) + " " + QPTrim$(frmVATaxCycleSetup.ThisDesc)
  For x = 1 To CycleCnt
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxPrintCycleUsers", "Form_Load", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub PrintGraphics()
  ...
  For x = 1 To NumOfTCRecs
    Get TCHandle, x, TaxCustRec
    If TaxCustRec.Cycle = frmVATaxCycleSetup.ThisNumber Then
      '                   0            1                  2                      3
  ...
  Close TCHandle
  Close RptHandle
  arVATaxCycle.Show vbModal
  
  Exit Sub

ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxPrintCycleUsers", "PrintGraphics", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxPrintCycleUsers", "PrintText", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

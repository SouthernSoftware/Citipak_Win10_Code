...
Begin VB.Form frmVATaxMainMenu 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdEnterTaxPayments 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxMainMenu.frx":0AEB
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdCustMaint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxMainMenu.frx":0D09
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdAbstractMaint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxMainMenu.frx":0F29
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdTaxReportingSystem 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxMainMenu.frx":1149
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxMainMenu.frx":1369
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdManualEntry 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxMainMenu.frx":157F
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdTaxBillAdj 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxMainMenu.frx":17A0
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdTaxAdvertising 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxMainMenu.frx":19C3
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSetUpAndUtil 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxMainMenu.frx":1BE6
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPPTRA 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxMainMenu.frx":1E10
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdDMV 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmVATaxMainMenu.frx":2029
   End

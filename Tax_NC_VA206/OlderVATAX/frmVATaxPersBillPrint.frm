...
Begin VB.Form frmVATaxPersBillPrint 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Personal Tax Billing Laser Form"
   ClientHeight    =   8760
   ClientLeft      =   30
   ClientTop       =   420
   ClientWidth     =   11655
   Icon            =   "frmVATaxPersBillPrint.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin LpLib.fpCombo fpcboLogo 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmVATaxPersBillPrint.frx":08CA
   End
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Tax Personal Bill Letter Printing"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   13.5
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmVATaxPersBillPrint"
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    ElseIf MsgBox("Are You Sure You Wish To Close Program?", vbYesNo, "Close?") = vbNo Then
      Cancel = True
    Else
      MainLog ("CitiTaxes.exe terminated via menu bar on frmVATaxPersBillPrint.")
      Call Terminate
      End
    End If
  End If
...
Private Sub TestLtrBillPrint()
  ...
  ReportFile$ = StartPath$ + "/TstbilPers.PRN"
  TaxRptT = FreeFile
  Open ReportFile$ For Output As TaxRptT
  ToPrint$ = "1500" '0
  ToPrint$ = ToPrint$ + "~" + "JOHN SMITH" '1
  ToPrint$ = ToPrint$ + "~" + "P O BOX 1520" '2
  ToPrint$ = ToPrint$ + "~337 HWY NORTH" '3
  ToPrint$ = ToPrint$ + "~HENDERSONVILLE NC" '4
  ToPrint$ = ToPrint$ + "~001079847" '5
  ToPrint$ = ToPrint$ + "~25,200.00" '6
  ToPrint$ = ToPrint$ + "~2004 DISCOVERY" '7
  ToPrint$ = ToPrint$ + "~25,200.00" '8
  ToPrint$ = ToPrint$ + "~0" '9
  ToPrint$ = ToPrint$ + "~0" '10
  ToPrint$ = ToPrint$ + "~20000.00" '11
  ToPrint$ = ToPrint$ + "~35.00" '12
  ToPrint$ = ToPrint$ + "~27.50" '13
  ToPrint$ = ToPrint$ + "~0" '14
  ToPrint$ = ToPrint$ + "~0" '15
  ToPrint$ = ToPrint$ + "~0" '16
  ToPrint$ = ToPrint$ + "~0" '17
  ToPrint$ = ToPrint$ + "~62.50" '18
  ToPrint$ = ToPrint$ + "~27.50" '19
  ToPrint$ = ToPrint$ + "~.25" '20
  ToPrint$ = ToPrint$ + "~.00" '21
  ToPrint$ = ToPrint$ + "~.25" '22
  ToPrint$ = ToPrint$ + "~.00" '23
  ToPrint$ = ToPrint$ + "~.25" '24
  ToPrint$ = ToPrint$ + "~.00" '25
  ToPrint$ = ToPrint$ + "~.25" '26
  ToPrint$ = ToPrint$ + "~.00" '27
  ToPrint$ = ToPrint$ + "~.25" '28
  ToPrint$ = ToPrint$ + "~1.00" '29
  ToPrint$ = ToPrint$ + "~.00" '30
  ToPrint$ = ToPrint$ + "~.00" '31
  ToPrint$ = ToPrint$ + "~STORM WATER" '32
  ToPrint$ = ToPrint$ + "~" '33
  ToPrint$ = ToPrint$ + "~" '34
  ToPrint$ = ToPrint$ + "~" '35 '7/13/06
  ToPrint$ = ToPrint$ + "~22113" '36
  ToPrint$ = ToPrint$ + "~55555-5555" '37
  ToPrint$ = ToPrint$ + "~0" '38
  ToPrint$ = ToPrint$ + "~0" '39
  ToPrint$ = ToPrint$ + "~False" '40
  Print #TaxRptT, ToPrint$
  ...
  If fpcboLogo.Text = "Yes" Then
    ...
    End If
  End If
  arVATaxBillPersLaser.Head1 = QPTrim(fpTxtHead1)
  arVATaxBillPersLaser.Head2 = QPTrim(fpTxtHead2)
  arVATaxBillPersLaser.LblOpt1 = QPTrim(fpTxtOpt1)
  arVATaxBillPersLaser.LblOpt2 = QPTrim(fpTxtOpt2)
  arVATaxBillPersLaser.LblOpt3 = QPTrim(fpTxtOpt3)
  arVATaxBillPersLaser.LblOpt4 = QPTrim(fpTxtOpt4)
  arVATaxBillPersLaser.LblPgph1 = QPTrim(fptxtPgph(0))
  arVATaxBillPersLaser.LblPgph2 = QPTrim(fptxtPgph(1))
  arVATaxBillPersLaser.LblPgph3 = QPTrim(fptxtPgph(2))
  arVATaxBillPersLaser.LblPgph4 = QPTrim(fptxtPgph(3))
  arVATaxBillPersLaser.LblPgph5 = QPTrim(fptxtPgph(4))
  arVATaxBillPersLaser.LblPgph6 = QPTrim(fptxtPgph(5))
  arVATaxBillPersLaser.LblPgph7 = QPTrim(fptxtPgph(6))
  arVATaxBillPersLaser.LblPgph8 = QPTrim(fptxtPgph(7))
  arVATaxBillPersLaser.LblOpt5 = QPTrim(fpTxtOpt5)
  arVATaxBillPersLaser.LblHead4 = QPTrim(fptxtHead4)
  arVATaxBillPersLaser.LblHead5 = QPTrim(fptxtHead5)
  arVATaxBillPersLaser.LblHead6 = QPTrim(fptxtHead6)
  arVATaxBillPersLaser.LblOpt6 = QPTrim(fpTxtOpt6)
  arVATaxBillPersLaser.LblOpt7 = QPTrim(fpTxtOpt7)
  arVATaxBillPersLaser.GetName ReportFile$
  arVATaxBillPersLaser.startrpt
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxPersBillPrint", "TestLtrBillPrint", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub SaveTxDef()
  Dim TBRec As TxBillLaser1DefaultsType
  ...
  OpenTxBillPersFile TBHandle
    ...
    TBRec.TxtOpt4 = QPTrim(fpTxtOpt4)
    ...
    TBRec.txtPgph5 = QPTrim(fptxtPgph(5))
    TBRec.txtPgph6 = QPTrim(fptxtPgph(6))
    TBRec.txtPgph7 = QPTrim(fptxtPgph(7))
    TBRec.TxtOpt5 = QPTrim(fpTxtOpt5)
    TBRec.txtHead4 = QPTrim(fptxtHead4)
    TBRec.txtHead5 = QPTrim(fptxtHead5)
    TBRec.txtHead6 = QPTrim(fptxtHead6)
    TBRec.TxtOpt6 = QPTrim(fpTxtOpt6)
    TBRec.TxtOpt7 = QPTrim(fpTxtOpt7)
    If fpcboLogo.Text = "Yes" Then
      TBRec.dologo = 1
    Else
      TBRec.dologo = 0
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxPersBillPrint", "SaveTxDef", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume
...
Private Sub LoadMe()
  ...
  If Exist(TaxBillPersName) Then
    ...
    fpTxtOpt4 = QPTrim(TBRec.TxtOpt4)
    ...
    fptxtPgph(5) = QPTrim(TBRec.txtPgph5)
    fptxtPgph(6) = QPTrim(TBRec.txtPgph6)
    fptxtPgph(7) = QPTrim(TBRec.txtPgph7)
    fpTxtOpt5 = QPTrim(TBRec.TxtOpt5)
    fptxtHead4 = QPTrim(TBRec.txtHead4)
    fptxtHead5 = QPTrim(TBRec.txtHead5)
    fptxtHead6 = QPTrim(TBRec.txtHead6)
    fpTxtOpt6 = QPTrim(TBRec.TxtOpt6)
    fpTxtOpt7 = QPTrim(TBRec.TxtOpt7)
  Else
    fpcboLogo.Text = "No"
  End If
...
ERRORSTUFF:
   Select Case ErrorMessage(Err.Number, Err.Description, Err.Source, "frmVATaxPersBillPrint", "LoadMe", Erl)
     Case emrExitProc:
       Resume Proc_Exit
     Case emrResume:
       Resume

...
Private Sub ActiveReport_DataInitialize()
  ...
  Fields.Add "LowDate"
  Fields.Add "EndDate"
  Fields.Add "fldRothdt"
  Fields.Add "fldRothTotgf"
  Fields.Add "fldRothTotrf"
End Sub
Private Sub ActiveReport_FetchData(eof As Boolean)
  ...
  Fields("fldRothdt").Value = arr(30)
  Fields("fldRothTotgf").Value = arr(31)
  Fields("fldRothTotrf").Value = arr(32)

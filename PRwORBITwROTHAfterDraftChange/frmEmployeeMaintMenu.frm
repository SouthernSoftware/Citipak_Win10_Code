...
Begin VB.Form frmEmployeeMaintMenu 
   ...
   Begin fpBtnAtlLibCtl.fpBtn EditViewEmplRecordCmmd 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmployeeMaintMenu.frx":0AB6
   End
   Begin fpBtnAtlLibCtl.fpBtn AddNewEmplyeeCmmd 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmployeeMaintMenu.frx":0CA3
   End
   Begin fpBtnAtlLibCtl.fpBtn PrintEmplListCmmd 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmployeeMaintMenu.frx":0E90
   End
   Begin fpBtnAtlLibCtl.fpBtn PrintTerminatedEmplListCmmd 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmployeeMaintMenu.frx":1077
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdEmergency 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmployeeMaintMenu.frx":1269
   End
   Begin fpBtnAtlLibCtl.fpBtn exitCmd 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmployeeMaintMenu.frx":145A
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdQuickMaint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmployeeMaintMenu.frx":164C
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdMailLabels 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmployeeMaintMenu.frx":1836
   End

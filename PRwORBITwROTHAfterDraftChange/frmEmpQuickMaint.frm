...
Begin VB.Form frmEmpQuickMaintPers 
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaint.frx":1C35A
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdEscape 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaint.frx":1C536
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExitNow 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaint.frx":1C712
   End
...
Private Sub cmdSave_Click()
  ...
  Dim x As Integer
  Dim ThisRec As Integer
  Dim PayRate As PayRateType 'added 1/22/08
  Dim PHandle As Integer 'added 1/22/08
  Dim NumOfPayRate As Integer 'added 1/22/08
  ...
  OpenPayRateFile PHandle 'added 1/22/08
  For x = 1 To ThisChange 'NumOfRows
    ...
    If QPTrim$(PayRate.EmpNo) <> QPTrim$(EmpRec.EmpNo) Then 'added 1/22/08

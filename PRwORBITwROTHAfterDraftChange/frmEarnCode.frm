...
Begin VB.Form frmEarningsCodeMaint 
   ...
   Begin LpLib.fpCombo fpcmb401KXN 
      ...
      Left            =   7875
      TabIndex        =   7
      ToolTipText     =   $"frmEarnCode.frx":08CA
      Top             =   3450
      Width           =   540
      _Version        =   196608
      _ExtentX        =   952
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmEarnCode.frx":0958
   End
   Begin LpLib.fpCombo fpcomboFWT 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmEarnCode.frx":0C4F
   End
   Begin LpLib.fpCombo fpcomboSWT 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmEarnCode.frx":0F46
   End
   Begin LpLib.fpCombo fpcomboSOC 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmEarnCode.frx":123D
   End
   Begin LpLib.fpCombo fpcomboMED 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmEarnCode.frx":1534
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdClear 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEarnCode.frx":226A
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSaveContinue 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEarnCode.frx":2454
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSaveExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEarnCode.frx":263E
   End
...
'   If x > 3 Then MsgBox "You have reached the maximum allowable deductions."
   If x > 3 Then

...
Begin VB.Form frmViewPrintChks 
   BackColor       =   &H00D0D0D0&
   Caption         =   "Form1"
   ClientHeight    =   8400
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10455
   Icon            =   "frmViewPrintChks.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   ScaleHeight     =   8400
   ScaleWidth      =   10455
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdAlignment 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmViewPrintChks.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrnScn 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmViewPrintChks.frx":0AA5
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmViewPrintChks.frx":0C87
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmViewPrintChks.frx":0E62
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmViewPrintChks.frx":103D
   End
End
Attribute VB_Name = "frmViewPrintChks"
...
PrintAlignMask:
    ...
    If MsgBox("Do You Wish to Print Another Mask?", vbYesNo, "Print Mask") = vbYes Then
      ...
      GoSub PrintAlignMask
    Else 'added 4/23/04
      If frmPrintChks.Visible = True Then 'added 4/23/04
        Unload frmPrintChks 'added 4/23/04
      End If 'added 4/23/04
    End If
Cancel:

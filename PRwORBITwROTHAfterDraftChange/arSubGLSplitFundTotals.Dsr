...
Private Sub ActiveReport_DataInitialize()
  ...
  Fields.Add "fldEIC" '222 - added 5/6/09
  Fields.Add "TotEIC" ' 223 - added 5/6/09
  End Sub
Private Sub ActiveReport_FetchData(eof As Boolean)
  ...
  Fields("fldFSMTot").Value = CDbl(arrT(3)) + CDbl(arrT(5)) + CDbl(arrT(9)) + CDbl(arrT(4)) + CDbl(arrT(8) + CDbl(arrT(222)))
  ...
  Fields("TotFSM").Value = CDbl(arrT(112)) + CDbl(arrT(113)) + CDbl(arrT(114)) + CDbl(arrT(117)) + CDbl(arrT(118) + CDbl(arrT(223)))
  ...
  Fields("fldEIC").Value = arrT(222)
  Fields("TotEIC").Value = arrT(223)
  PrintIt = PrintIt + 1
End Sub

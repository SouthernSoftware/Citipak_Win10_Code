...
Begin VB.Form frmEmpQuickMaintWageDist 
   ...
   Begin FPSpread.vaSpread vaSpread 
      ...
      SpreadDesigner  =   "frmEmpQuickMaintWageDist.frx":0B89
      VisibleCols     =   6
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintWageDist.frx":1C496
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdEscape 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintWageDist.frx":1C672
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExitNow 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintWageDist.frx":1C84E
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdGL 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintWageDist.frx":1CA2E
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdClearClip 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintWageDist.frx":1CC0D
   End

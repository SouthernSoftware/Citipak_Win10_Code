...
Type SupDetailRecType '"SUPDETAIL.DAT"
  TransCode As String * 3
  SeqCode As String * 2
  PlanNum As String * 6
  Filler3 As String * 3
  ParticID As String * 9
  SubPlanNum As String * 6
  Filler6 As String * 6
  Investment1 As String * 2
  SourceEmpe As String * 1
  ConEmpeAmt1 As String * 9
  Investment2 As String * 2
  SourceEmpr As String * 1
  ConEmprAmt2 As String * 9
  Investment3 As String * 2
  SourceRoth As String * 1
  ConRothAmt3 As String * 9
  Filler36 As String * 36
  PayPrdEndDt As String * 8
  MarStatus As String * 1
  Filler4 As String * 4
  Name As String * 30
  Filler148 As String * 148
End Type

Type SupHeaderRecType '"SUPHEADER.DAT"
  RecType As String * 3
  FileType As String * 10
  ClientID As String * 10
  CreateDate As String * 8
  CreateTime As String * 6
  Sender As String * 1
  Filler260 As String * 260
  'Filler283 As String * 283
'  CrLf        As String * 2
End Type

Type SupLoanRecType '"SUPLOAN.DAT"
  TransCode As String * 3
  Filler2 As String * 2
  PlanNum As String * 6
  Filler3A As String * 3
  ParticID As String * 9
  SubPlanNum As String * 6
  DateXOverRide As String * 1
  Filler4 As String * 4
  LoanRepay As String * 9
  Filler10 As String * 10
  LoanPayOverRide As String * 1
  Filler3B As String * 3
  LoanPayRollCode As String * 4
  Filler237 As String * 237
End Type

Type SupTrailerRecType '"SUPTRAILER.DAT"
  RecordType As String * 3
  FileType As String * 10
  ClientID As String * 10
  CreateDate As String * 8
  CreateTime As String * 6
  DetRecCnt As String * 9
  Filler1 As String * 1
  TotContrib As String * 11
  TotLnRePay As String * 11
  Filler228 As String * 228
End Type
...
Type PayRateType
    RegPayRate(1 To 30)  As Double
    OTPayRate(1 To 30)   As Double
    EMPPFREQ(1 To 30)    As String * 16
    EMPPTYPE(1 To 30)    As String * 10
    PayChngDate(1 To 30) As Integer
    EMPJOB(1 To 30)      As String * 28
    EmpRecNum            As Integer
    EmpNo                As String * 10
    EmpLName             As String * 24
    EmpFName             As String * 24
    EMPHDATE             As Integer
...
Type K401DedType
    VolDed  As String * 14
    LPDed   As String * 14
    RothDed As String * 14 'added 3/28/06
End Type
...
Type OrbitHeader
  RecType As String * 1
  AgencyNum As String * 5
  RptPeriod As String * 6
  FrmtVersion As String * 3
  FileCreateDate As Integer
  PayPrdBeginDate As Integer
  PayPrdEndDate As Integer
  MaxSalary As Double
End Type
...
Type OrbitDetail
  ...
  RecType As String * 1
  AgencyNum As String * 5
  PlanCode As String * 10
  SSN As String * 9
  MemberID As String * 9
  FirstName As String * 50
  MiddleName As String * 50
  LastName As String * 50
  Suffix As String * 10
  Gender As String * 1
  DateOfBirth As String * 8
  AddLine1 As String * 50
  AddLine2 As String * 50
  City As String * 25
  State As String * 2
  Zip As String * 9
  OutOfCntryAdd As String * 50
  JobClass As String * 6
  DeptNum As String * 6
  EmployDate As String * 8
  EligibleDate As String * 8
  PayPrdBeginDate As String * 8
  PayPrdEndDate As String * 8
  IncDecSalary As String * 1
  Salary As String * 12
  IncDecEmpleeCntrb As String * 1
  EmployeeCntrb As String * 12
  Adjustment As String * 10
  PayType As String * 10
  VacHours As String * 5
  ContrPdEmpPrd As String * 10
  ContrPdEmpBegDate As String * 8
  ContrPdEmpEndDate As String * 8
  TerminationDate As String * 8
  TermType As String * 10
  SharedPosition As String * 6
  Deleted As Boolean
  CheckNum As Long
  CheckDate As Integer
  OTPay As String * 12
  RegPay As String * 12
  EmployerCntrb As String * 12
  PostedYN As String * 1
 End Type
 ...
 Type OrbitTrailer
  ...
  AgencyNum As String * 5
  RptPeriod As String * 6
  RecCount As String * 11
  IncDecSalary As String * 1
  TotalSalary As String * 12
  IncDecTtlEmpContrb As String * 1
  TotalEmpCntrb As String * 12
 End Type
...
'this type is a file kept in the citipak folder to indicate what type of code is used in the pr draft file
Type CitiPRDraftCodeType
  DraftCode  As String * 3
  Line1number As String * 10
  Line5number  As String * 10
  BankAcctNum As String * 17
  RountNum As String * 9
End Type

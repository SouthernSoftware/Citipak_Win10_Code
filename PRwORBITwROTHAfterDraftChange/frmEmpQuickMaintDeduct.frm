...
Begin VB.Form frmEmpQuickMaintDeduct 
   ...
   Begin LpLib.fpCombo fpcmbDeds 
      ...
      EditAlignH      =   1
      EditAlignV      =   0
      ColDesigner     =   "frmEmpQuickMaintDeduct.frx":0B89
   End
   ...
   Begin FPSpread.vaSpread vaSpread 
      ...
      SpreadDesigner  =   "frmEmpQuickMaintDeduct.frx":0E48
      VisibleCols     =   7
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintDeduct.frx":1C1AF
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdEscape 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintDeduct.frx":1C38B
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExitNow 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintDeduct.frx":1C567
   End

...
Type W2ElectronicSubRE
  ...
  '011112
  EmprType As String * 1
End Type

Type W2ElectronicSubRS
    RecID      As String * 2    'RS
    StateCode  As String * 2    'State Code    nc 37  employee
    Fill1      As String * 5
    SSN        As String * 9
    FName      As String * 15
    MName      As String * 15
    LName      As String * 20
    Fill2      As String * 4
    EmpAddr    As String * 22
    DelAddr    As String * 22     'employee delivery address
    City       As String * 22
    State      As String * 2
    Zip5       As String * 5
    ZipPlus4   As String * 4
    Fill3      As String * 98
    EmpAcctNo  As String * 20    '9 digit left justify space fill
    Fill4      As String * 8
    StateWage  As String * 11    'Right justify zero fill
    StateTax   As String * 11    'Right justify zero fill
    Vested     As String * 1     'space
    PadFill    As String * 214
End Type

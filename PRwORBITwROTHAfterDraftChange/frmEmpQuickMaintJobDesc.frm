...
Begin VB.Form frmEmpQuickMaintJobDesc 
   ...
   Begin FPSpread.vaSpread vaSpread 
      ...
      SpreadDesigner  =   "frmEmpQuickMaintJobDesc.frx":0B89
      VisibleCols     =   13
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintJobDesc.frx":1C2A8
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdEscape 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintJobDesc.frx":1C484
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdExitNow 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmEmpQuickMaintJobDesc.frx":1C660
   End
...
Private Sub LoadMe()
  ...
  Close XHandle 'added XHandle 3/6/08 because of problem with this closing all
  'files and affecting the save routine if the Payrate update took place from
  'the employee maintenance screen saving...checks to see if this screen is
  'open to determine how to handle the payrate update (see UpdatePayRate in common module)

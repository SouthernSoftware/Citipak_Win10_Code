VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arW2PrintFormsH4 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "W2 Forms 4 Horizontal Forms Per Page"
   ClientHeight    =   8865
   ClientLeft      =   30
   ClientTop       =   315
   ClientWidth     =   11655
   Icon            =   "arW2PrintFormsH4.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   20558
   _ExtentY        =   15637
   SectionData     =   "arW2PrintFormsH4.dsx":08CA
End
Attribute VB_Name = "arW2PrintFormsH4"
...
Private Sub ActiveReport_Error(ByVal Number As Integer, ByVal Description As DDActiveReports2.IReturnString, ByVal Scode As Long, ByVal Source As String, ByVal HelpFile As String, ByVal HelpContext As Long, ByVal CancelDisplay As DDActiveReports2.IReturnBool)
  If Number <> 5007 Then 'ignore the no printer warning
    ...
    Unload Me
  End If
  Unload frmLoadingRpt  'dump out if an error occures
...
'  If arr(15) = "0" Then arr(15) = ""
  ...
  Fields("fldEmpSSN").Value = QPTrim$(arr(16))

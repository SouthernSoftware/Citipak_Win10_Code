Attribute VB_Name = "modSTRUCTDos2Win"
Option Explicit
...
Type DosEmpData2Type
    ...
    EmpDed(1 To 12)  As DosEmpDedType
...
Type TransRecType
    ...
    VoidRec         As Long 'added 12/17/04
    Pad1            As String * 3 'changed on 12/17/04 from 8 to 3
'-----------------------------

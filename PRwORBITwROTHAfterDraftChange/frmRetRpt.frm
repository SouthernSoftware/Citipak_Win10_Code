...
Begin VB.Form frmRetRpt 
   ...
   Begin ImpproLib.vaImprint vaImprint1 
      ...
      Begin LpLib.fpCombo fpcmbMagDiskYN 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmRetRpt.frx":0BDD
      End
      Begin LpLib.fpCombo fpcmbDestination 
         ...
         EditAlignH      =   1
         EditAlignV      =   0
         ColDesigner     =   "frmRetRpt.frx":0ED4
      End
      ...
      Begin fpBtnAtlLibCtl.fpBtn cmdProcess 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmRetRpt.frx":11CB
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdEscape 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmRetRpt.frx":13AA
      End
  ...
  For RecNo = 1 To NumOfRecs
    ...
    Do
      ...
      Case LowDate To HighDate
        If TransHRec(1).RetireAmt <> 0 Or TransHRec(1).MatchRetAmt <> 0 Then 'added MatchRetAmt 3/24/08

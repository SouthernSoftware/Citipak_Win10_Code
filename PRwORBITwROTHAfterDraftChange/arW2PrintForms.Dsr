VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} arW2PrintForms 
   ...
   _ExtentX        =   21855
   _ExtentY        =   15663
   SectionData     =   "arW2PrintForms.dsx":0000
End
Attribute VB_Name = "arW2PrintForms"
...
Private Sub ActiveReport_DataInitialize()
  hFile = FreeFile
  Open StartPath & "\PRRPTS\W2FORMS.RPT" For Input As #hFile
  ...
  Fields.Add "fldBox13TX2" ' 42)
  Fields.Add "fldBox13AM2" '43)
  Fields.Add "fldBox13TX3" '44)
  Fields.Add "fldBox13AM3" '45)
  End Sub
...
Private Sub ActiveReport_FetchData(eof As Boolean)
  ...
  Fields("fldEmpFName").Value = arr(19) ' + "  " + arr(20)
  ...
  Fields("fldEmpAddr1").Value = arr(24)
  Fields("fldEmpAddr2").Value = arr(25)
  ...
  Fields("fldEmpCity").Value = arr(31)
  ...
  Fields("fldBox13TX2").Value = arr(42)
  If Val(arr(43)) = 0 Then arr(43) = ""
  Fields("fldBox13AM2").Value = arr(43)
  Fields("fldBox13TX3").Value = arr(44)
  If Val(arr(45)) = 0 Then arr(45) = ""
  Fields("fldBox13AM3").Value = arr(45)

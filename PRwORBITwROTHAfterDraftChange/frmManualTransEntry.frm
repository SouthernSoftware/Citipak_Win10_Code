...
Begin VB.Form frmManualTransEntry 
   ...
   Begin TabproLib.vaTabPro vaTabPro1 
      ...
      Begin ImpproLib.vaImprint vaImprint5 
         ...
         BackColor       =   9405029
         Caption         =   ""
         Picture         =   "frmManualTransEntry.frx":1F12
   ...
   Begin fpBtnAtlLibCtl.fpBtn cmdCont 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmManualTransEntry.frx":1F2E
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdDelete 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmManualTransEntry.frx":210E
   End
...
'  Date$ = FormatDateTime(Date, vbShortDate)
  ...
  ManTrans(1).RegHrs = CDbl(fptxtHrsWkd.Text) 'changed from Val to CDbl 10/15/09
  ManTrans(1).PERSHRS = CDbl(fptxtPerHrs.Text)
  ManTrans(1).SICKHRS = CDbl(fptxtSckHrs.Text)
  ManTrans(1).VACHRS = CDbl(fptxtVacHrs.Text)
  ManTrans(1).COMPHRS = CDbl(fptxtCmpHrs.Text)
  ManTrans(1).HOLHOURS = CDbl(fptxtHolHrs.Text)
  ManTrans(1).OTHRSPD = CDbl(fptxtOTHrs.Text) 'number of hours
...
'  ManTrans(1).TOTTAX = ManTrans(1).FedGross + ManTrans(1).STAGROSS + ManTrans(1).SocGross + ManTrans(1).MedGross
...
'  fptxtFG.Text = Format(AllGLDeds, Image)'7/19/06 removed this automatic refiguring

...
Begin VB.Form frmAssignRate 
   ...
   Begin LpLib.fpCombo fpcboRevenues 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmAssignRate.frx":08CA
   End
   Begin LpLib.fpCombo fpComboRates2 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmAssignRate.frx":0C61
   End
   Begin LpLib.fpCombo fpComboRates 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmAssignRate.frx":0FCC
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAssignRate.frx":1337
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdOK 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAssignRate.frx":154B
   End
   ...
   End
End
Attribute VB_Name = "frmAssignRate"
...
Private Sub SetRate2cust()
  ...
  End If
  If fpComboRates2.ListIndex = -1 Then
    RateNew = 0
    NewRate$ = ""
  Else

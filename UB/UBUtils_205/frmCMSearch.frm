...
Begin VB.Form frmCMSearch 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Search Criteria for CM Transactions"
   ClientHeight    =   8865
   ClientLeft      =   3930
   ClientTop       =   1890
   ClientWidth     =   12210
   Icon            =   "frmCMSearch.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin LpLib.fpCombo fpcboSource 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmCMSearch.frx":08CA
   End
  ...
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      If MsgBox("Are You Sure You Wish To Close The Program?", vbYesNo, "Close?") = vbNo Then
        Cancel = True
      Else
        CMLog "Closed via cmsearch UBUTIL"
        'CitiTerminate
      End If
    End If
  End If
...
Private Sub Search4Payments()
  ...
  Dim FromRecp As Long, ThruRecp As Long
  ...
  If NumOfRecs& > 0 Then
    For cnt& = 1 To NumOfRecs&
      ...
      'this is to be able to edit any trans type
  ...
  Else
    ...
    frmCMDispList.Wheretogo frmCMSearch, frmCmTransactionEdit, 2, 1 'code 2 for list
...
CheckForMatch:
  ...
  If UseAcct Then
    ...
    End If
  End If
  If Check2.Value <> 1 Then 'ignore dates

...
Begin VB.Form frmSetBillCopies 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   1890
   ClientWidth     =   12210
   Icon            =   "frmSetBillCopies.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin LpLib.fpCombo fpComboRates 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmSetBillCopies.frx":08CA
   End
   Begin VB.CheckBox Check1 
      Alignment       =   1  'Right Justify
      BackColor       =   &H80000004&
      Caption         =   "Include all Customers"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   12
         Charset         =   0
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmSetBillCopies.frx":0C35
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdOK 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmSetBillCopies.frx":0E11
   End
   ...
   Begin VB.Label Label5 
      Alignment       =   1  'Right Justify
      BackStyle       =   0  'Transparent
      Caption         =   "Assign This Number to Bill Copies:"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   12
         Charset         =   0
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Set Bill Copies by Rate Code Criteria"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   13.5
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmSetBillCopies"
...
Private Sub Check1_Click()
  If Check1.Value = ValueTrue Then
    fpComboRates.Enabled = False
  Else
    fpComboRates.Enabled = True
  End If
End Sub
...
Private Sub SetMult2cust()
  ...
  Dim UBRateTblRecLen As Integer, NumOfRateRecs As Integer, numset As Long
  ReDim UBRateTblRec(1) As UBRateTblRecType
  numset = 0
  FromBook = Val(fptxtRoute1)
  'If FromBook = 0 Then FromBook = 1
  ThruBook = Val(fptxtRoute2)
  If fpComboRates.ListIndex = -1 And Check1.Value = ValueFalse Then
  ...
  If NuMult <= 0 Then
    MsgBox "Invalid Copies", vbOKOnly, "Invalid Entry"
    Exit Sub
  End If
  If RateRec > 0 Then
    UBRateTblRecLen = Len(UBRateTblRec(1))
    ...
    Close Handle
  End If
  DeActivateControls frmSetBillCopies
  FrmShowPctComp.Label1 = "Change Bill Copies ..."
  FrmShowPctComp.Show , Me
  UBLog "Setbillcopies - " & ", book(" & fptxtRoute1 & "-" & fptxtRoute2 & "),Mult-" & fptxtMult.Text
...
UBLog "setcopies:" & fptxtMult.Text & " Using Util set billcopies"
MsgBox "Set billcopies to:" & fptxtMult.Text & " for " & Str(numset), vbOKOnly, " copies"
'ReIndexSystem False
ActivateControls frmSetBillCopies
End Sub

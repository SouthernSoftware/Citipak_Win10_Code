...
Begin VB.Form frmReSequenceLoc1 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Re-Sequence Locations Utility"
   ClientHeight    =   8868
   ClientLeft      =   3924
   ClientTop       =   1884
   ClientWidth     =   12216
   Icon            =   "frmReSequenceLoc1.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReSequenceLoc1.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn cmdOK 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmReSequenceLoc1.frx":0ADE
   End
   ...
   Begin EditLib.fpText fptxtRoute1 
      ...
      OLEDragMode     =   0
   End
   Begin EditLib.fpText fptxtIncrement 
      Height          =   348
      Left            =   5688
      TabIndex        =   2
      Top             =   3912
   ...
   End
End
Attribute VB_Name = "frmReSequenceLoc1"
...
Private Sub ResequenceEm()
  Dim UBCustRecLen As Integer, WhatSeq As Long
  Dim UBFile As Integer, IdxRecLen As Integer
  Dim NumOfRecs As Long, IdxFileSize As Long
  Dim CCnt As Long, ReSeq As Long, IdxNumOfRecs As Long
  Dim CustLen As Integer, Handle As Integer, ThisBook As String
  Dim cnt As Long, RCnt As Integer, CurrBook As String
  Dim CustBook As Integer, SeqStart As Long, ThisCust As Long
  ...
  If Val(fptxtIncrement.Text) > 0 Then
  Else
    MsgBox "Invalid Increment Amount.", vbOKOnly, "Invalid Entry"
    Exit Sub
  End If
  SeqStart& = Val(fptxtIncrement.Text)
  DeActivateControls frmReSequenceLoc
  FrmShowPctComp.Label1 = "Re-Sequence Locations..."
  FrmShowPctComp.Show , Me
  UBLog "ReSeqLoc - " & ", book(" & fptxtRoute1 & "-" & fptxtRoute2 & "),Incre-" & fptxtIncrement.Text
...
UBLog "ReSequenced:" & ReSeq & " Using Util Resequence Loc"
MsgBox "ReSequenced:" & ReSeq, vbOKOnly, " Locations"
ReIndexSystem False
ActivateControls frmReSequenceLoc
End Sub
Private Function MakeSeqNumb$(WhatSeq&)
  Dim Seq As String
  Seq$ = "000000" + QPTrim$(Str$(WhatSeq&))
  MakeSeqNumb$ = Right$(Seq$, 6)
End Function
Private Sub Setcycle()
  Dim UBCustRecLen As Integer, Whatcycle As Integer
  Dim UBFile As Integer, IdxRecLen As Integer
  Dim NumOfRecs As Long, IdxFileSize As Long
  Dim CCnt As Long, ReSeq As Long, IdxNumOfRecs As Long
  Dim CustLen As Integer, Handle As Integer
  Dim cnt As Long, RCnt As Integer
  Dim FromBook As Integer, ThruBook As Integer
  FromBook = Val(fptxtRoute1)
  'If FromBook = 0 Then FromBook = 1
  ThruBook = Val(fptxtRoute2)
  If Val(fptxtCycle.Text) > 0 Then
  Else
    MsgBox "Invalid Cycle Number.", vbOKOnly, "Invalid Entry"
    Exit Sub
  End If
  Whatcycle& = Val(fptxtCycle.Text)
  DeActivateControls frmReSequenceLoc
  FrmShowPctComp.Label1 = "Re-Sequence Locations..."
  FrmShowPctComp.Show , Me
  UBLog "ReSeqLoc - " & ", book(" & fptxtRoute1 & "-" & fptxtRoute2 & "),Incre-" & fptxtIncrement.Text

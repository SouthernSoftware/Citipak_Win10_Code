...
Begin VB.Form frmBillPostedRePrn 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Utility Posted Bill Reprinting"
   ClientHeight    =   8865
   ClientLeft      =   3930
   ClientTop       =   1890
   ClientWidth     =   12210
   Icon            =   "frmBillPostedRePrn.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin LpLib.fpCombo fpcboBillTo 
      Height          =   375
      Left            =   4755
      TabIndex        =   1
      Top             =   3885
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmBillPostedRePrn.frx":08CA
   End
   ...
   Begin EditLib.fpText fptxtMessage 
      ...
      OLEDragMode     =   0
   End
   Begin EditLib.fpText fptxtBillDate 
      Height          =   324
      Left            =   4728
      TabIndex        =   18
      TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmBillPostedRePrn"
...
Dim BLType As Integer, ThisTrans As Long
Dim FoundBill As Boolean, RecNo As Long
...
Private Sub cmdPrint_Click()
  Dim BillTo As String, Msg1 As String, Msg2 As String, Msg3 As String
  Dim Msg4 As String
  BillTo$ = Left$(fpcboBillTo.Text, 1)
  Msg1$ = QPTrim$(fptxtMessage(0))
  Msg2$ = QPTrim$(fptxtMessage(1))
  Msg3$ = QPTrim$(fptxtMessage(2))
  Msg4$ = QPTrim$(fptxtMessage(3))
  
  frmBillPrinting.PBillPrn RecNo&, ThisTrans&, BillTo, Msg1, Msg2, Msg3, Msg4, fpDueDate.Text
  cmdExit_Click
End Sub
  ...
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      If MsgBox("Are You Sure You Wish To Close The Program?", vbYesNo, "Close?") = vbNo Then
        Cancel = True
      Else
        UBLog "Closed via BillPostedreprint by " + PWUser$
        CitiTerminate
      End If
    End If
  End If
End Sub
Private Sub fpcboBillTo_KeyDown(KeyCode As Integer, Shift As Integer)
  If KeyCode = vbKeySpace Then
    fpcboBillTo.ListDown = True
  End If
  If fpcboBillTo.ListDown <> True Then
  ...
  If KeyCode = vbKeyReturn Then
    ...
    Else
      If cmdPrint.Enabled = True Then
        cmdPrint.SetFocus
      ElseIf cmdExit.Enabled = True Then
        cmdExit.SetFocus
      End If
    End If
  End If
...
Private Sub Form_Load()
  ...
  Me.HelpContextID = hlpPostedBill
  UBLog " IN: Posted Bill Reprinting."
  fpcboBillTo.AddItem "Customer"
  fpcboBillTo.AddItem "Owner"
  fpcboBillTo.ListIndex = 0
...
Private Sub Form_Resize()
  ...
  End If
End Sub
Private Sub Chk4Bill(CustAcctNo&)
  Dim UBCustRecLen As Integer, UBCust As Integer
  Dim UBTran As Integer, UBBillRecLen As Integer
...
'  TownName$ = UBSetUpRec(1).UTILNAME
  fptxtCustName = UBCustRec(1).CustName
  UBTran = FreeFile
  ...
  Loop
  If FoundBill Then
    fptxtBillDate = Num2Date$(UBBillRec(1).BillDate)
    fpDueDate = Num2Date$(UBBillRec(1).BillDate)
  ...
  If FoundBill = False Then   'show can't find a bill error
    Label2.Visible = True
    Label2.Caption = "This Account Has NO Bill Transaction, Press Escape to Continue."
    cmdPrint.Enabled = False
    Close
    UBLog "No Posted Bill to reprint for ACCT:" + Str$(CustAcctNo&)
    Exit Sub

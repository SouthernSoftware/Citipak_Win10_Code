...
Begin VB.Form frmBillInfoLetter2 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   1890
   ClientWidth     =   12210
   Icon            =   "frmBillInfoLetter2.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin LpLib.fpCombo fpcboLogo 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmBillInfoLetter2.frx":08CA
   End
   Begin LpLib.fpCombo fpcboMtrNum 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmBillInfoLetter2.frx":0C30
   End
   ...
   End
End
Attribute VB_Name = "frmBillInfoLetter2"

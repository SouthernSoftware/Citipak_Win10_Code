...
Begin VB.Form frmSecurityPassGL 
   ...
   Caption         =   "CitiPak G/L Password Sign-In"
   ClientHeight    =   8916
   ClientLeft      =   36
   ClientTop       =   264
   ClientWidth     =   12216
   ...
   Begin VB.Label Label2 
      ...
      Caption         =   "GENERAL LEDGER PASSWORD"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   13.8
         Charset         =   0
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Enter General Ledger Password"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   12
         Charset         =   0
    ...
    If Len(Dir$("Citipass.dat")) Then
      ...
      Else
        ...
        If Findnum = -1 Then
          ...
          Call MainLog("Password in session, NO GL Access.")
          Notvalid = False
          txtPW = ""
          txtPW.SetFocus
        End If

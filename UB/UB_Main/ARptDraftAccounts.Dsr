VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptDraftAccounts 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Utility Billing Bank Draft Register"
   ClientHeight    =   5496
   ClientLeft      =   36
   ClientTop       =   264
   ClientWidth     =   11592
   Icon            =   "ARptDraftAccounts.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   20447
   _ExtentY        =   9694
   SectionData     =   "ARptDraftAccounts.dsx":08CA
End
Attribute VB_Name = "ARptDraftAccounts"
...
Public Sub GetName(RName As String, SName As String, Detail As Integer)
  ReportFile$ = RName$
  If SName$ <> "" Then
    SubFile$ = SName$
  End If
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    If KeyCode = vbKeyE Then
      ...
      DoEvents
      MsgBox "File - DrftAcct.xls, created in the Citipak Directory.", vbOKOnly
    End If
    If KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      MsgBox "File - DrftAcct.txt, created in the Citipak Directory.", vbOKOnly
    End If
  End If
...
Private Sub ActiveReport_QueryClose(Cancel As Integer, CloseMode As Integer)
  KillFile ReportFile$
  If Det = 1 Then KillFile SubFile$
End Sub
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & "DrftAcct.xls"
        oEXL.Export Me.Pages
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & "DrftAcct.txt"
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","
...
Private Sub ReportFooter_Format()
  If Det = 1 Then
    Set Me.SubReport1.object = New ARSubBanks

...
Begin VB.Form frmRptTransJournalxx 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   540
   ClientWidth     =   12195
   Icon            =   "frmRptTransJournalxx.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8640
   ...
   Begin LpLib.fpCombo fpcboTransType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptTransJournalxx.frx":08CA
   End
   Begin LpLib.fpCombo fpcboPrintOrder 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptTransJournalxx.frx":0BED
   End
   Begin LpLib.fpCombo fpcboDetail 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptTransJournalxx.frx":0F10
   End
   Begin LpLib.fpCombo fpcboRptType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptTransJournalxx.frx":123E
   End
   ...
   End
End
Attribute VB_Name = "frmRptTransJournalxx"
  ...
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      If MsgBox("Are You Sure You Wish To Close The Program?", vbYesNo, "Close?") = vbNo Then
        Cancel = True
      Else
        UBLog "Closed via RptTransJournal by " + PWUser$
        CitiTerminate
      End If
    End If
  End If
...
Private Sub DetailedTransJournal()
  ...
  Dim ReportFile As String, MoFlag As Boolean

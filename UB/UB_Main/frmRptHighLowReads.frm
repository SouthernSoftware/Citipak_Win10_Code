...
Begin VB.Form frmRptHighLowReads 
   ...
   Begin LpLib.fpCombo fpcboLow 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptHighLowReads.frx":0BF8
   End
   Begin LpLib.fpCombo fpcboHigh 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptHighLowReads.frx":0F26
   End
   Begin LpLib.fpCombo fpcboRptType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptHighLowReads.frx":1254
   End
...
Private Sub Form_Load()
  ...
  Me.HelpContextID = hlpPrintHighLow
End Sub
...
Private Sub PrintHighLowReport()
  ...
  For lcnt& = 1 To IdxNumOfRecs
    ...
    ''''If IdxBuff(lcnt&).RecNum = 9831 Then Stop
    ...
    If UBCustRec(1).DelFlag = 0 Then
      If InStr(UBCustRec(1).HHMSG1, "NOREAD") = 0 Then
        ...
        If (Book >= BegRoute And Book <= EndRoute) And UBCustRec(1).Status = "A" Then
          ...
          ''''If UBCustRec(1).SEQNUMB = "000051" Then Stop

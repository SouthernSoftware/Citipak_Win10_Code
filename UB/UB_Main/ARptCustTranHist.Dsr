...
Public Sub GetName(RName As String, RevSource As Integer)
  ReportFile$ = RName$
'  SubFile$ = SName$
  Rev = RevSource
End Sub
...
'      Rev = 9
'    End If
'    If Me.Fields("Rev10").Value <> " " Then
'      Rev = 10
'    End If
'    If Me.Fields("Rev11").Value <> " " Then
'      Rev = 11
'    End If
'    If Me.Fields("Rev12").Value <> " " Then
'      Rev = 12
'    End If
'    If Me.Fields("Rev13").Value <> " " Then
'      Rev = 13
'    End If
'    If Me.Fields("Rev14").Value <> " " Then
'      Rev = 14
'    End If
'    If Me.Fields("Rev15").Value <> " " Then
'      Rev = 15
'    End If
'
 ' End If

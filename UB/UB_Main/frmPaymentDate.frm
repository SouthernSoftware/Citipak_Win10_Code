...
Private Sub fpCmdOk_Click()
  ...
  If BadDate = False Then
    ...
    If entdate > (chkthedate + 30) Or entdate < (chkthedate - 30) Then
      ...
      UBLog "Invalid Date entered payentry, give opt to cancel- OPER:" + Str$(OPERNUM)
      ...
      If GetOKorNot(MsgText()) Then
        UBLog "Continue pay entry with out of range date-" + txtDate1.Text
      Else
        UBLog "Cancel pay entry so can check date."
        Exit Sub
      End If
    End If
'*****************************
    savePDate
'*****************************
    frmUBPaymentMenu.setstuff txtDate1.Text
  ...
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      If MsgBox("Are You Sure You Wish To Close The Program?", vbYesNo, "Close?") = vbNo Then
        Cancel = True
      Else
        UBLog "Closed via PaymentDate by " + PWUser$
        CitiTerminate
      End If
    End If
  End If
...
Private Sub savePDate()
  ...
  Close
  UBLog PWUser + " " + Str(OPERNUM) + " Log in payments with date - " + txtDate1
End Sub

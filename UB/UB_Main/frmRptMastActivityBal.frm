...
Begin VB.Form frmRptMastActivityBal 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Balance Report w/Last Transaction Date Option"
   ClientHeight    =   8640
   ClientLeft      =   30
   ClientTop       =   540
   ClientWidth     =   12195
   Icon            =   "frmRptMastActivityBal.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8640
   ...
   Begin LpLib.fpCombo fpcboRevenues 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMastActivityBal.frx":08CA
   End
   Begin LpLib.fpCombo fpcboCustStatus 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMastActivityBal.frx":0C25
   End
   Begin LpLib.fpCombo fpcboBalType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMastActivityBal.frx":0F80
   End
   Begin LpLib.fpCombo fpcboRptType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMastActivityBal.frx":12DB
   End
   Begin LpLib.fpCombo fpcboPrintOrder 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMastActivityBal.frx":1641
   End
   Begin LpLib.fpCombo fpcboDetRev 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMastActivityBal.frx":199C
   End
   ...
   Begin MSComctlLib.StatusBar StatusBar1 
      ...
      EndProperty
   End
   Begin EditLib.fpDateTime fpActDate 
      Height          =   348
      Left            =   8448
      TabIndex        =   0
      Top             =   1440
   ...
   Begin VB.Label Label3 
      ...
      Caption         =   "*This report not intended to be used in place of  MASTER BALANCE REPORT!"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   9
         Charset         =   0
   ...
   Begin VB.Label Label3 
      ...
      BackStyle       =   0  'Transparent
      Caption         =   "Customers with Last Transactions dated on or after above date will not be on this report!!"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   10.5
         Charset         =   0
   ...
   Begin VB.Label Label3 
      Alignment       =   1  'Right Justify
      BackStyle       =   0  'Transparent
      Caption         =   "Include Customers only if Last Transaction Date Prior To:"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmRptMastActivityBal"
  ...
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      If MsgBox("Are You Sure You Wish To Close The Program?", vbYesNo, "Close?") = vbNo Then
        Cancel = True
      Else
        UBLog "Closed via RptMastActiviBal by " + PWUser$
        CitiTerminate
      End If
    End If
  End If
...
Private Sub fpActDate_KeyDown(KeyCode As Integer, Shift As Integer)
  If KeyCode = vbKeyReturn Then
...
Private Sub MasterBalanceListing()
  ...
  Dim ReportFile As String, UBTransRecLen As Integer, UBTrans As Integer
  Dim Trans As Long, ActivityDate As Integer
  RCnt = RCnt + 1
  UsingAcct = False
  UseStatus = False
  UsingName = False
  ...
  fmt$(2) = "#####"
  fmt$(3) = "######,#.##"
  ActivityDate = Date2Num(fpActDate)
  'Main Body Start
  FrmShowPctComp.Label1 = "Creating Balance Listing"
  ...
  For cnt = 1 To NumOfRecs
    ...
    If UBTransRec(1).TransDate > ActivityDate Then
      GoTo bskipem
    End If
...
bskipem:
 ...
 ' If Not AbortFlag Then
    ViewPrint ReportFile$, "Balance w/Cust Activity Date"
 ' End If
  Else
...
DoCustRptHeader:
  ...
  Print #UBRpt, Tab(26); "Balance w/Cust Activity Date"; Tab(70); "Page #"; PageNo
  Print #UBRpt, "Report Date: "; Date$; Tab(25); "Activity Date Cutoff: "; fpActDate
  Print #UBRpt, "Customers w/Last Transactions dated on or after Activity Date not included!!"
...
Private Sub MasterBalanceListing2()
  ...
  Dim Report2 As String, UBTransRecLen As Integer, UBTrans As Integer
  Dim Trans As Long, ActivityDate As Integer
  RCnt = RCnt + 1
  UsingAcct = False
  UseStatus = False
  ...
  ReportFile$ = UBPath$ + "UBDtBAL.RPT"
  UBRpt = FreeFile
  Open ReportFile$ For Output As UBRpt
  
  Report2$ = UBPath$ + "UBDtSBal.RPT"
  UBRpt2 = FreeFile
...
bskipem:
  ...
  If CustCnt > 0 Then
  Load frmLoadingRpt
  frmLoadingRpt.setwherefrom frmRptMastActivityBal
  ARptMastBalList.txtDate = Now
  ARptMastBalList.txtTown = TOWNNAME$
  ARptMastBalList.Title = "Balance w/Cust Activity Date"
  ARptMastBalList.txtRptParm1.Caption = ToPrintH1$
  ARptMastBalList.txtRptParm2.Caption = "Customers w/Last Transactions dated on or after Activity Date not included-" + fpActDate
...
DoCustRptFooter:
 ...
 ' Print #UBRpt, "Totals:"; Tab(10); "Customers: "; Using("#####,#", CustCnt);
  ...
  'Print #UBRpt, "******************"
  'Print #UBRpt, "Report Parameters"
  ToPrintH1$ = "Routes:" + Str$(BegRoute) + " to" + Str$(EndRoute) + "  Order:" + POrder$
'  If CoFlag Then
'    Print #UBRpt, "       Minimum Balance: N/A       ";
'  Else
  ToPrintH1$ = ToPrintH1$ + "  MinBal: " + Using("$######.##", MinBal#) + "  Status:" + Stat$
'  End If
  ToPrintH2$ = ToPrintH2$ + "  Bal Type:" + Bal$ + "  Rev: " + fpcboRevenues.Text
  '  If RevSource > 0 Then
    'Print #UBRpt, Tab(39);
 ' End If
 ' Print #UBRpt,

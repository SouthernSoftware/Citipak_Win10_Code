...
Begin VB.Form frmRptSCnsmpRateCode 
   ...
   Begin LpLib.fpCombo fpcboRptType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptSCnsmpRateCode.frx":0BC1
   End
   Begin VB.CheckBox ChkMo 
      Caption         =   "Old Style Report"
      Enabled         =   0   'False
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   10.5
...
Dim rptopt As Integer, Doall As Boolean, MoFlag As Boolean
...
Private Sub Form_Load()
  ...
  Me.HelpContextID = hlpConsumptionByRate
  ...
  If InStr(TOWNNAME$, "MOORE COUNTY") Then
    MoFlag = True
    ChkMo.Visible = True
    ChkMo.Enabled = True
  Else
...
'2 is Irrigation Consumption Report
  ...
  If ValidDate Then
    ...
    If fpcboRptType.ListIndex = 0 Then
      'do the graphics
      If MoFlag Then
        If ChkMo.Value = 1 Then
          ConsumpUnitStep222 0
        Else
          ConsumpUnitStep 0
        End If
      Else
        ...
        If ValidCustomer = 1 Then
          ...
          For MCnt = 1 To 7
           ...
           ' LPRINT CustomerRecord
            'STOP
            'END IF
        ' Print #UBRpt, Tab(12); UBTransRec(1).CustAcctNo; Tab(30); Using("###,###", TMeterConsp#)
...
Private Sub ConsumpUnitStep222(RptType As Integer)
  ...
  Dim ReportFile As String, TotTotcust As Long, RCnt As Integer
  MaxLines = 56
  Dash80$ = String$(80, "-")
...
dothestuff:
      ...
      FrmShowPctComp.Label1 = "Creating Consumption Rpt for - " + Ratecode$
      FrmShowPctComp.Show
...
DoUnitStepHeader:
  ...
  Print #UBRpt, "Report Date: "; Now
  Print #UBRpt, " "
  Print #UBRpt, "    For Rate Code: "; Ratecode$
  Print #UBRpt, " Period Beginning: "; txtDate1
  Print #UBRpt, "    Period Ending: "; txtDate2
  Print #UBRpt,
  Print #UBRpt, "**Totals are based on total consumption per transaction and on Current Settings."
  Print #UBRpt,
  Print #UBRpt, Tab(50); "Usage Charge    Min Charge"
  Print #UBRpt, Dash80$
  LineCnt = 10
Return
...
DoUnitStepFooter:
  ...
  For LL = 1 To MaxStep
    ...
    If TotalCust(LL) > 0 Then
      ...
      'PRINT #UBRpt, "  Avg Use= "; USING "#####,#.##"; TotalConsp#(LL) / Tota
      TotTotcust = TotTotcust + TotalCust(LL)
    Else
      Print #UBRpt, ""
    End If
    Print #UBRpt, Dash80$
  Next LL
  Print #UBRpt, "Rate Totals:"; Using("#,###,###,###", GTMeterConsp);
  Print #UBRpt, Tab(36); Using("###,###,###", TotTotcust);
  Print #UBRpt, Tab(50); Using("#,###,###.##", BigTotal#);
  Print #UBRpt, Tab(63); Using("#######,#.##", Round#(MINAMT# * TotTotcust))
  If RptType = 1 Then
    Print #UBRpt, Chr$(12);
  End If
  For LL = 1 To MaxStep

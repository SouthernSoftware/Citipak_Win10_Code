...
'decide later on what to do.
 'CleveFlag = True
  Me.HelpContextID = hlpApplyDepositTo
  LoadRevs
End Sub
...
'  End If
  ...
  For RevCnt = 1 To NumofRevs - 1
    If fpCurrent(RevCnt - 1).Enabled = True Then
      fpCurrent(RevCnt - 1) = UBCustRec(1).CurrRevAmts(RevCnt)
    End If
  Next

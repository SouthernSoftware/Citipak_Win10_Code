...
Begin VB.Form frmBillInfoSetup 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   1890
   ClientWidth     =   12210
   Icon            =   "frmBillInfoSetup.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin LpLib.fpCombo fpcboRte 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmBillInfoSetup.frx":08CA
   End
   Begin LpLib.fpCombo fpcboAcctBar 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmBillInfoSetup.frx":0C30
   End
   Begin LpLib.fpCombo fpcboPostalBar 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmBillInfoSetup.frx":0F96
   End
   Begin LpLib.fpCombo fpcboBalType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmBillInfoSetup.frx":12FC
   End
   Begin LpLib.fpCombo fpcboWhichever 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmBillInfoSetup.frx":1657
   End
   Begin LpLib.fpCombo fpcboLateNotices 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmBillInfoSetup.frx":19BD
   End
   Begin LpLib.fpCombo fpcboBills 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmBillInfoSetup.frx":1D44
   End
   Begin LpLib.fpCombo fpcboPermit 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmBillInfoSetup.frx":20CB
   End
   Begin LpLib.fpCombo fpPSNCombo 
      Height          =   330
      Left            =   4755
      TabIndex        =   62
      Top             =   3680
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmBillInfoSetup.frx":2431
   End
   ...
   Begin EditLib.fpText fpTxtOpt8 
      ...
      OLEDragMode     =   0
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdLtrFormat 
      Height          =   450
      Left            =   600
      TabIndex        =   54
      Top             =   7800
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBillInfoSetup.frx":2797
   End
   Begin EditLib.fpCurrency fp2ndPenAmt 
      Height          =   348
      Left            =   8184
      TabIndex        =   56
      Top             =   3696
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpBtn1 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmBillInfoSetup.frx":3A78
   End
   Begin VB.Label Label14 
      Alignment       =   1  'Right Justify
      BackStyle       =   0  'Transparent
      Caption         =   "Use Electronic  Bills Configuration: "
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   10.5
         Charset         =   0
   ...
   Begin VB.Label Label13 
      Alignment       =   1  'Right Justify
      BackStyle       =   0  'Transparent
      Caption         =   "Print Postal Route Code on Bill (#4-only): "
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   10.5
         Charset         =   0
   ...
   Begin VB.Label Label3 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "**2nd Penalty Added to Total for Customers with a Previous Balance.  Regular Penalty Not Applied. "
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   7.5
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmBillInfoSetup"
...
Private Sub fpBtn1_Click()
  If ChkStuff Then
    Savebillset
    Load frmBillInfo21Linetxt
    DoEvents
    frmBillInfo21Linetxt.Show
  End If
End Sub
...
Private Sub fpcboAcctBar_KeyDown(KeyCode As Integer, Shift As Integer)
  ...
  End If
End Sub
Private Sub fpcboRte_KeyDown(KeyCode As Integer, Shift As Integer)
  If KeyCode = vbKeySpace Then
    fpcboRte.ListDown = True
  End If
  If fpcboRte.ListDown <> True Then
    If KeyCode = vbKeyDown Or KeyCode = vbKeyReturn Then
...
Private Sub fpCmdLtrFormat_Click()
  If ChkStuff Then
    Savebillset
    Load frmBillInfoLetter
    DoEvents
    frmBillInfoLetter.Show
  End If
End Sub
...
Private Sub fpMinBal_KeyDown(KeyCode As Integer, Shift As Integer)
  If KeyCode = vbKeyReturn Then
    If fpcboBills.ListIndex = 0 Then
      fp2ndPenAmt.SetFocus
    Else
      cmdSave.SetFocus
    End If
  End If
End Sub
Private Sub fp2ndPenAmt_KeyDown(KeyCode As Integer, Shift As Integer)
  If KeyCode = vbKeyReturn Then
    If fpcboBills.ListIndex = 0 Then
      fpTxtHead1.SetFocus
    Else
...
Private Sub Form_Load()
  ...
  Me.HelpContextID = hlpBillInformation
  ...
  fpcboBills.InsertRow = "17" & Chr$(9) & "Laser 3Bill Legal(3F)-Preprinted Stock"
  fpcboBills.InsertRow = "18" & Chr$(9) & "New Standard 24Line - Txt"
  fpcboBills.InsertRow = "19" & Chr$(9) & "Laser Letter Bill-Preprinted"
  fpcboBills.InsertRow = "20" & Chr$(9) & "Laser 3Bill Legal-Preprinted 10LF"
  fpcboBills.InsertRow = "21" & Chr$(9) & "Blank Stock 21 line TXT"
  fpcboBills.InsertRow = "97" & Chr$(9) & "External Bill File Transfer-All Meters"
  fpcboBills.InsertRow = "98" & Chr$(9) & "External Bill File Transfer"
  fpcboBills.InsertRow = "99" & Chr$(9) & "External Bill File Transfer-Type 3"
  ...
  fpcboLateNotices.InsertRow = "9" & Chr$(9) & "Laser 3Notice LegalSz"
  fpcboLateNotices.InsertRow = "10" & Chr$(9) & "Laser 3Notice LegalSz2"
  fpcboLateNotices.InsertRow = "21" & Chr$(9) & "Blank Stock 21 line TXT"
  '???? 97 not at this time
  fpcboLateNotices.InsertRow = "98" & Chr$(9) & "External Late Notice File Transfer"
  fpcboPostalBar.AddItem "No"
  fpcboPostalBar.AddItem "Yes"
  fpcboAcctBar.AddItem "No"
  fpcboAcctBar.AddItem "Yes"
  fpcboRte.AddItem "No"
  fpcboRte.AddItem "Yes"
  fpcboPermit.AddItem "No"
  fpcboPermit.AddItem "Yes"
  fpPSNCombo.AddItem "No"
  fpPSNCombo.AddItem "Yes"
  ...
  If Exist(UBPath$ + "UBBilSet.DAT") Then
    ...
    Select Case UBBillSetup(1).Bill
      ...
      Case 17:
        fpcboBills.ListIndex = 16
      Case 18:
        fpcboBills.ListIndex = 17
      Case 19:
        fpcboBills.ListIndex = 18
      Case 20:
        fpcboBills.ListIndex = 19
      Case 21:
        fpcboBills.ListIndex = 20
      Case 97:
        fpcboBills.ListIndex = 21
      Case 98:
        fpcboBills.ListIndex = 22
      Case 99
        fpcboBills.ListIndex = 23
      Case Else
        fpcboBills.ListIndex = 0
    End Select
    Select Case UBBillSetup(1).LateNotice
      ...
      Case 9:
        fpcboLateNotices.ListIndex = 8
      Case 10:
        fpcboLateNotices.ListIndex = 9
      Case 21:
        fpcboLateNotices.ListIndex = 10
      Case 98:
        fpcboLateNotices.ListIndex = 11
      Case Else
        fpcboLateNotices.ListIndex = 0
    End Select
    ...
    If UBBillSetup(1).RtePrint = 1 Then
      fpcboRte.ListIndex = 1
    Else
      fpcboRte.ListIndex = 0
    End If
    ...
    fp2ndPenAmt = UBBillSetup(1).AmtChge2
    ...
    If QPTrim(UBBillSetup(1).PSNBills) = "Y" Then
      fpPSNCombo.ListIndex = 1
    Else
      fpPSNCombo.ListIndex = 0
    End If
...
Private Sub Savebillset()
  ...
  Select Case fpcboBills.ListIndex
    ...
    Select Case fpcboLateNotices.ListIndex
      ...
      Case 8:
        UBBillSetup.LateNotice = 9
      Case 9:
        UBBillSetup.LateNotice = 10
      Case 10:
        UBBillSetup.LateNotice = 21
      Case 11:
        UBBillSetup.LateNotice = 98
      Case Else
    ...
    End If
    If fpcboRte.ListIndex = 1 Then
      UBBillSetup.RtePrint = 1
    Else
      UBBillSetup.RtePrint = 0
    End If
    ...
    UBBillSetup.AmtChge2 = fp2ndPenAmt.Value
...
'03/12/2020
    If fpPSNCombo.ListIndex = 1 Then
      UBBillSetup.PSNBills = "Y"
    Else
      UBBillSetup.PSNBills = "N"
    End If
...
Private Sub TestLBillPrint()
  ...
  Open ReportFile$ For Output As UBRptT
    ...
    ToPrint$ = ToPrint$ + "~" + "JOHN WILBER WALTON"
    ToPrint$ = ToPrint$ + "~" + "2003 NORTH FIRST AVENUE"

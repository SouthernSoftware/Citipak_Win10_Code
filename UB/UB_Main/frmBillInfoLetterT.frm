...
Begin VB.Form frmBillInfoLetterT 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   1884
   ClientWidth     =   12216
   Icon            =   "frmBillInfoLetterT.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin LpLib.fpCombo fpcboLogo 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmBillInfoLetterT.frx":08CA
   End
   Begin LpLib.fpCombo fpcboMtrNum 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmBillInfoLetterT.frx":0C30
   End
   ...
   Begin VB.Label Label6 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Letter Laser Bill Format #16 Default Information"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   10.2
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmBillInfoLetterT"

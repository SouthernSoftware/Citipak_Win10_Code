VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptSCnsmpRate 
   ...
   _ExtentX        =   21273
   _ExtentY        =   12044
   SectionData     =   "ARptSCnsmpRate.dsx":08CA
End
Attribute VB_Name = "ARptSCnsmpRate"
...
Public Sub GetName(RName As String, PBrk As Boolean) ', Optional SName As String, Optional Detail As Integer, Optional RevSource As Integer)
  ReportFile$ = RName$
  PgBrk = PBrk
  If PgBrk = False Then
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    If KeyCode = vbKeyE Then
      ...
      DoEvents
      MsgBox "File - CnsmRate.xls, created in the Citipak Directory.", vbOKOnly
    End If
    If KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      MsgBox "File - CnsmRate.txt, created in the Citipak Directory.", vbOKOnly
    End If
  End If
End Sub
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & "CnsmRate.xls"
        oEXL.Export Me.Pages
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & "CnsmRate.txt"
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","

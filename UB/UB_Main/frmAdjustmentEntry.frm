...
Begin VB.Form frmAdjustmentEntry 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   540
   ClientWidth     =   12225
   Icon            =   "frmAdjustmentEntry.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin LpLib.fpCombo fpcboAdjType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmAdjustmentEntry.frx":08CA
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAdjustmentEntry.frx":0BED
   End
   Begin fpBtnAtlLibCtl.fpBtn CmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAdjustmentEntry.frx":0DCF
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdClear 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAdjustmentEntry.frx":0FAB
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdTranHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAdjustmentEntry.frx":227D
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdFind 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAdjustmentEntry.frx":245A
   End
   ...
   Begin VB.Label Label14 
      Caption         =   $"frmAdjustmentEntry.frx":2635
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   7.5
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmAdjustmentEntry"
...
Private Sub Form_Load()
  ...
  Me.HelpContextID = hlpUtilityBilling
End Sub
...
Private Sub SaveTransaction()
  ...
  Case 2
    ...
    UBLog "OVERPAY ADJUSTED CUST:" + Str$(CustAcct&)
  End Select
...
Private Sub PrintAdj(rptopt As Integer)  'rptopt is from report opt 1=graph
  ...
  If Graph Then
    ...
    ARptAdjustment.lblOperator = Oper$

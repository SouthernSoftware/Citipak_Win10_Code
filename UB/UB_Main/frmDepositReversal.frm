...
Begin VB.Form frmDepositReversal 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Deposit Payment Reversal"
   ClientHeight    =   8868
   ClientLeft      =   3924
   ClientTop       =   1884
   ClientWidth     =   12216
   Icon            =   "frmDepositReversal.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositReversal.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdReverse 
      Height          =   480
      Left            =   7632
      TabIndex        =   1
      TabStop         =   0   'False
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositReversal.frx":0AE0
   End
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Reverse Deposit Payment"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   13.8
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmDepositReversal"
...
Private Sub fpCmdRefund_Click()
  DoDepositReverse
  MsgBox "REVERSE procedure complete.", vbOKOnly, "Completed"
  cmdExit_Click
End Sub
   

Private Sub DoDepositReverse()

...
Begin VB.Form frmRptCustInq 
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdOwner 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptCustInq.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdMsg 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptCustInq.frx":0AA6
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptCustInq.frx":0C80
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptCustInq.frx":0E62
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdConHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptCustInq.frx":103E
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdTranHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptCustInq.frx":121B
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdWorkHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptCustInq.frx":13F8
   End
   Begin fpBtnAtlLibCtl.fpBtn fpcmdPrintinfo 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmRptCustInq.frx":15D5
   End
   ...
   End
End
Attribute VB_Name = "frmRptCustInq"
  ...
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      If MsgBox("Are You Sure You Wish To Close The Program?", vbYesNo, "Close?") = vbNo Then
        Cancel = True
      Else
        UBLog "Close via CustInq by " + PWUser$
        CitiTerminate
      End If
    End If
  End If
...
Private Sub LoadCustInfo2Form()
 ...
 CustRecLen = Len(tmpCustRec)
  ...
  RecNo& = Val(frmRptCustInq.fpCustRecNo)
  frmRptCustInq.fpCustRecNo = 0
...
Private Sub PrintCustInq()  'this is graphics
  ...
  Close
  Load frmLoadingRpt
  frmLoadingRpt.setwherefrom frmRptCustInq
  ARptCustInq.txtDate = Now
  ARptCustInq.txtTown = TOWNNAME$
  ARptCustInq.GetName ReportFile$
  ARptCustInq.startrpt

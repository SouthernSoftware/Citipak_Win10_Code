...
Begin VB.Form frmUBSysDraftEdit 
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmUBSysDraftEdit.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmUBSysDraftEdit.frx":0AA5
   End
   Begin fpBtnAtlLibCtl.fpBtn btnPageInfo 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmUBSysDraftEdit.frx":0C80
   End
...
Private Sub Form_Load()
  ...
  Me.HelpContextID = hlpBankDraftSetup
...
Private Sub BlankInfoError()
  ...
  MsgText(3) = ""
  MsgText(4) = ""
  MsgText(5) = "Enter information for Every Field."

...
Begin VB.Form frmDepCreditRemoval 
   BackColor       =   &H008F8265&
   ...
   ClientTop       =   1890
   ClientWidth     =   12210
   Icon            =   "frmDepCreditRemoval.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepCreditRemoval.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn CmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepCreditRemoval.frx":0AA6
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdTranHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepCreditRemoval.frx":0C82
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdMsg 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepCreditRemoval.frx":0E5F
   End
   ...
   End
End
Attribute VB_Name = "frmDepCreditRemoval"
  ...
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      If MsgBox("Are You Sure You Wish To Close The Program?", vbYesNo, "Close?") = vbNo Then
        Cancel = True
      Else
        UBLog "Closed via DepCredRem by " + PWUser$
        CitiTerminate
      End If
    End If
  End If
...
'decide later on what to do.
 'CleveFlag = True
  Me.HelpContextID = hlpDepositCredit
  LoadRevs
End Sub

...
Private Sub cmdAddNewRate_Click()
  frmEditAddRateTable.HelpContextID = hlpAddANewRate
...
Private Sub cmdDeleteRateCode_Click()
  ...
  If Not Exist(UBPath$ + "UBRate.dat") Then
    ...
    Exit Sub
  Else
    frmRateDelete.HelpContextID = hlpDeleteAnExisting
    Load frmRateDelete
...
Private Sub cmdEditRateCode_Click()
  ...
  If Not Exist(UBPath$ + "UBRate.dat") Then
    ...
    Exit Sub
  Else
    frmEditAddRateTable.HelpContextID = hlpEditAnExistingRate
    Load frmEditAddRateTable
    DoEvents
...
Private Sub Form_Load()
  ...
  Me.HelpContextID = hlpRateTableMenu
  wf = 0
End Sub

...
Begin VB.Form frmRptMastBalG 
   ...
   Begin LpLib.fpList fplstCodes 
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmRptMastBalG.frx":08CA
   End
   Begin LpLib.fpCombo fpcboDetRev 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMastBalG.frx":0C4A
   End
   Begin LpLib.fpCombo fpcboPrintOrder 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMastBalG.frx":0FE8
   End
   Begin LpLib.fpCombo fpcboRptType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMastBalG.frx":137B
   End
   Begin LpLib.fpCombo fpcboBalType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMastBalG.frx":1719
   End
   Begin LpLib.fpCombo fpcboCustStatus 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMastBalG.frx":1AAC
   End
   Begin LpLib.fpCombo fpcboRevenues 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMastBalG.frx":1E3F
   End
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Print Master Balance Report by Group"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   13.5
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmRptMastBalG"
  ...
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      If MsgBox("Are You Sure You Wish To Close The Program?", vbYesNo, "Close?") = vbNo Then
        Cancel = True
      Else
        UBLog "Closed via RptMastBalG by " + PWUser$
        CitiTerminate
      End If
    End If
  End If
...
Private Sub fplstCodes_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyDown Or KeyCode = vbKeyReturn Then
...
Private Sub cmdPrint_Click()
 If fplstCodes.SelCount > 0 Then
 'If ValidRoutes Then
    GetGCodestoReport fplstCodes
...
Private Sub MasterBalanceListing()
  ...
  Dim ReportFile As String, CodeName As String, Grp As String
...
'    End If
    ...
    If RevSource > 0 Then
      If UBCustRec(1).CurrRevAmts(RevSource) <> 0 Then
        ...
        Print #UBRpt, Tab(18); Grp$;
        Print #UBRpt, Tab(23); Left$(UBCustRec(1).CustName, 25);
...
DoCustRptHeader:
  ...
  Print #UBRpt, "Acct #"; Tab(8); "Location"; Tab(17); "Group"; Tab(24); "Customer Name";
  If RevSource > 0 Then
...
DoCustRptFooter:
  ...
  For GCnt = 1 To NumOfcdsrpt
    Get Codefile, GCnt, CodestoRpt
    Print #UBRpt, QPTrim$(CodestoRpt.GroupCode);
    If GCnt <> NumOfcdsrpt Then
      Print #UBRpt, ", ";
    End If
  Next
  Print #UBRpt,
...
Private Sub MasterBalanceListing2()
  ...
  Dim NumOfcdsrpt As Integer, Codefile As Integer, GCnt As Integer
  Dim CodeName As String, Grp As String, Report2 As String
  Dim CodestoRpt As GroupCodeRptType
  CodeName$ = "grpcds.LST"
  RCnt = RCnt + 1
  UsingAcct = False
...
Next
  ...
  If CustCnt > 0 Then
  Load frmLoadingRpt
  frmLoadingRpt.setwherefrom frmRptMastBalG
  ARptMastBalListG.txtDate = Now
  ARptMastBalListG.txtTown = TOWNNAME$
  ARptMastBalListG.Title = "Master Customer Balance Report By Group"
  ARptMastBalListG.txtRptParm1.Caption = ToPrintH1$
  ARptMastBalListG.txtRptParm2.Caption = ToPrintH2$
  ARptMastBalListG.txtTotCust = CustCnt
  ARptMastBalListG.txtTotCur.DataValue = TCurrBalance#
  ARptMastBalListG.txtTotPast.DataValue = TPrevBalance#
  ARptMastBalListG.txtHead = fpcboRevenues.Text
  ARptMastBalListG.txtTotAcctBal.DataValue = Round#(TCurrBalance# + TPrevBalance#)
  ARptMastBalListG.GetName ReportFile$, Report2$, DetFlag, RevSource
  ARptMastBalListG.startrpt
  Else
    MsgBox "No Information to print.", vbOKOnly, "No Information"
    ActivateControls Me, True
  End If
...
DoCustRptFooter:
 ...
 ' Print #UBRpt, "Totals:"; Tab(10); "Customers: "; Using("#####,#", CustCnt);
  ...
  For GCnt = 1 To NumOfcdsrpt
    Get Codefile, GCnt, CodestoRpt
    ToPrintH1$ = ToPrintH1$ + QPTrim$(CodestoRpt.GroupCode)
    If GCnt <> NumOfcdsrpt Then
      ToPrintH1$ = ToPrintH1$ + ", "
    End If
  Next
  ToPrintH1$ = ToPrintH1$ + "  Printing Order:" + POrder$
'  If CoFlag Then
'    Print #UBRpt, "       Minimum Balance: N/A       ";
'  Else
...
'  If Det Then
    'Print #UBRpt,
    Print #UBRpt, ToPrint$ + "~" + ToPrintD$ + Grp$
 '  Else
    'Linecnt = DLineCnt
 '   Print #UBRpt, ToPrint$ + "~" + ToPrintD$ + Grp$
 ' End If

...
Begin VB.Form frmUBMeterMenu 
   ...
   Begin VB.CommandButton cmdMtrAvg 
      Caption         =   "Stored &Average Consumption List"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   10.2
         Charset         =   0
...
Private Sub cmdMtrAvg_Click()
  frmRptMeterAverages.Show
  Unload Me
End Sub
...
'send value of 1 for list
  ...
  frmRptMeterReadList.HelpContextID = hlpPrintMeterReadingList
  frmRptMeterReadList.Show
  Unload frmUBMeterMenu
End Sub

Private Sub cmdReadingNotes_Click()
  frmRptMeterNotes.HelpContextID = hlpPrintMeterReadingNotes
...
'send value of 2 for report
  ...
  frmRptMeterReadList.HelpContextID = hlpPrintMeterReadingReport
  frmRptMeterReadList.Show
  Unload frmUBMeterMenu
End Sub
...
Private Sub Form_Load()
  ...
  Me.HelpContextID = hlpMeterReadings
End Sub

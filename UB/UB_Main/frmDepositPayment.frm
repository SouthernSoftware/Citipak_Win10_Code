...
Begin VB.Form frmDepositPayment 
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdCharge 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositPayment.frx":0BF1
   End
   Begin fpBtnAtlLibCtl.fpBtn fpcmdCheck 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositPayment.frx":0DCE
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositPayment.frx":20A0
   End
   Begin fpBtnAtlLibCtl.fpBtn CmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositPayment.frx":227C
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdCash 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositPayment.frx":2458
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdInfo 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositPayment.frx":3729
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpcmdFind 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositPayment.frx":3904
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpcmdDrawer 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmDepositPayment.frx":4BD5
   End
...
Private Sub fptxtDesc_KeyDown(KeyCode As Integer, Shift As Integer)
  ...
  If KeyCode = vbKeyReturn Then
   For cnt = 0 To 14
    If fpAmtPaid(cnt).Enabled = True Then
      fpAmtPaid(cnt).SetFocus
      Exit For
    End If
   Next
  End If
...
Private Sub Form_Load()
  ...
  Me.HelpContextID = hlpDepositTransaction
  noreset = False
...
'  ReDim Preserve RevText$(1 To MaxRevsCnt)
 ...
 If Caldwell = True Then
  ...
  Print #RHandle, Tab(7); "UTILITY DEPOSIT PAYMENT"; Tab(43); "UTILITY DEPOSIT PAYMENT"
  ...
  Print #RHandle,
  Print #RHandle, Tab(7); "Total Paid:  "; Using("$##,###,###.##", UBPaymentRec(1).AMTRECD); Tab(43); "Total Paid:  "; Using("$##,###,###.##", UBPaymentRec(1).AMTRECD)

...
Begin VB.Form frmRptMastBal12 
   ...
   Begin LpLib.fpCombo fpcboRevenues 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMastBal12.frx":08CA
   End
   Begin LpLib.fpCombo fpcboCustStatus 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMastBal12.frx":0C5D
   End
   Begin LpLib.fpCombo fpcboBalType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMastBal12.frx":0FF0
   End
   Begin LpLib.fpCombo fpcboRptType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMastBal12.frx":1383
   End
   Begin LpLib.fpCombo fpcboPrintOrder 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMastBal12.frx":1721
   End
   Begin LpLib.fpCombo fpcboDetRev 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMastBal12.frx":1AB4
   End
   ...
   Begin VB.Label Label3 
      ...
      Caption         =   "Include Customers only if Last Transaction Dated Prior To:"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmRptMastBal12"
...
Private Sub MasterBalanceListing22()
  Dim RCnt As Integer, UBCustRecLen As Integer, UBSetupreclen As Integer
  Dim MaxRevenue As Integer, TRevName As String, AndPos As String
  Dim UsingBook As Boolean, RStatus As String, UsingName As Boolean
  Dim PageNo As Integer, UseStatus As Boolean, AcctNo As Long

...
Begin VB.Form frmBillBalanceDuePrint 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Balance Due Bill Printing"
   ClientHeight    =   8868
   ClientLeft      =   3924
   ClientTop       =   1884
   ClientWidth     =   12216
   Icon            =   "frmBillBalanceDuePrint.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin LpLib.fpCombo fpcboBalanceType 
      Height          =   348
      Left            =   4752
      TabIndex        =   2
      Top             =   3888
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmBillBalanceDuePrint.frx":08CA
   End
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Print Balance Due Bills"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   13.8
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmBillBalanceDuePrint"
...
Private Sub cmdPrint_Click()
  Dim BillD As String, Msg1 As String, Msg2 As String, Msg3 As String
  Dim Msg4 As String, BalType As String
  If fpcboBalanceType.ListIndex = -1 Then
    fpcboBalanceType.ListIndex = 0
  End If
  If Len(fpBillingDate.Text) = 0 Then
    BillD = Date$
  Else
    BillD = fpBillingDate.Text
  End If
  BalType$ = Left$(QPTrim$(fpcboBalanceType.Text), 1)
  Msg1$ = QPTrim$(fptxtMessage(0))
  Msg2$ = QPTrim$(fptxtMessage(1))
  Msg3$ = QPTrim$(fptxtMessage(2))
  Msg4$ = QPTrim$(fptxtMessage(3))
  frmBillPrinting.BBillPrn BillD, BalType$, Msg1, Msg2, Msg3, Msg4, fpDueDate.Text
'  cmdExit_Click
End Sub
  ...
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      If MsgBox("Are You Sure You Wish To Close The Program?", vbYesNo, "Close?") = vbNo Then
        Cancel = True
      Else
        UBLog "Closed via BalanceDue bill Print by " + PWUser$
        CitiTerminate
      End If
    End If
  End If
...
Private Sub fpBillingDate_KeyDown(KeyCode As Integer, Shift As Integer)
  If KeyCode = vbKeyReturn Then
    fpcboBalanceType.SetFocus
  End If
End Sub

Private Sub fpcboBalanceType_KeyDown(KeyCode As Integer, Shift As Integer)
  If KeyCode = vbKeySpace Then
    fpcboBalanceType.ListDown = True
  End If
  If fpcboBalanceType.ListDown <> True Then
...
Private Sub Form_Load()
  ...
  fpcboBalanceType.AddItem "Balance Due Customer"
  fpcboBalanceType.AddItem "Credit Due Customer"
  fpcboBalanceType.AddItem "All Credit & Balance Due"
  fpcboBalanceType.ListIndex = 0
  BLType = UBBillSetup(1).Bill
  Me.HelpContextID = hlpPrintBStatus
  Select Case BLType

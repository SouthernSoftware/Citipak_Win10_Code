...
Begin VB.Form frmRptTransJournal 
   ...
   Begin LpLib.fpCombo fpcboDetail 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptTransJournal.frx":0BF8
   End
   Begin LpLib.fpCombo fpcboPrintOrder 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptTransJournal.frx":0F26
   End
   Begin LpLib.fpCombo fpcboTransType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptTransJournal.frx":1249
   End
...
DefineType:
  ...
  Case 4, 104
    TransDesc$ = "Reg Payment"
        Amount# = Round#(UBTransRec(1).Transamt)
        'Amount
  Case 5, 105

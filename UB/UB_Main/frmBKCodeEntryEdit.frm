...
Begin VB.Form frmBKCodeEntryEdit 
   BackColor       =   &H008F8265&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "BKCode Entry/Edit"
   ClientHeight    =   8640
   ClientLeft      =   48
   ClientTop       =   324
   ClientWidth     =   12216
   ClipControls    =   0   'False
   Icon            =   "frmBKCodeEntryEdit.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8640
   ...
   End
End
Attribute VB_Name = "frmBKCodeEntryEdit"

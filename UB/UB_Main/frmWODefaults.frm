...
Begin VB.Form frmWODefaults 
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdPrint 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmWODefaults.frx":0C19
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmWODefaults.frx":0DF5
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmWODefaults.frx":0FD1
   End
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdDelete 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmWODefaults.frx":11AD
   End

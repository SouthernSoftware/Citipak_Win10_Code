...
Begin VB.Form frmPenaltyEdit 
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdSave 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPenaltyEdit.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn CmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPenaltyEdit.frx":0AA6
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdDelete 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPenaltyEdit.frx":0C82
   End
   Begin fpBtnAtlLibCtl.fpBtn CmdPageDn 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPenaltyEdit.frx":1F55
   End
   Begin fpBtnAtlLibCtl.fpBtn CmdPageUp 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPenaltyEdit.frx":2131
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdTranHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPenaltyEdit.frx":230B
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdList 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmAPenaltyEdit.frx":24E8
   End
...
'  ShowFlag = True
  ...
  fpAmount = Using$("######.##", UBTranRec(1).TransAmt)
  If DelFlag Then
    LabelDel.Visible = True
  Else
...
Private Function Chk4Change()
  ...
  If UBTranRec(1).ActiveFlag = 0 Then
    DelFlag = True
  End If
  If UBTranRec(1).TransAmt <> fpAmount.DoubleValue Then
    Changed = True
  Else
    Changed = False
  End If

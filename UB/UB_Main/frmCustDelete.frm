...
Begin VB.Form frmCustDelete 
   ...
   Begin fpBtnAtlLibCtl.fpBtn fpCmdDelete 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmCustDelete.frx":08CA
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmCustDelete.frx":0AA8
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdTranHist 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmCustDelete.frx":0C86
   End
   ...
   Begin VB.Label Label6 
      BackStyle       =   0  'Transparent
      Caption         =   "DELETE THIS CUSTOMER ARE YOU SURE?"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmCustDelete"
...
Private Sub Form_Load()
  ...
  Me.HelpContextID = hlpDeleteCustomer
  ...
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      If MsgBox("Are You Sure You Wish To Close The Program?", vbYesNo, "Close?") = vbNo Then
        Cancel = True
      Else
        UBLog "Closed via CustDelete by " + PWUser$
        CitiTerminate
      End If
    End If
  End If
...
'      KeyCode = 0
  ...
  End Select
End Sub
Private Sub ExitCustDelete()
  UBLog "OUT: DELETE Account."
  DoEvents
  RecNo = 0
  BeenDone = False
  TransRec = 0
...
Private Sub fpCmdDelete_Click()
  ...
  If MsgBox("Are You Sure You Wish to Delete This Account?", vbYesNo, "Delete Account") = vbYes Then
    DeActivateControls Me
    DeleteCustomer
    ReIndexSystem False
  '  ******************************
    MsgBox "Account Deletion Complete", vbOKOnly, "Deleted"
    UBLog "OUT: DELETE Account."
    DoEvents
    RecNo = 0
    BeenDone = False

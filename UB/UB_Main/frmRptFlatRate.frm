...
Begin VB.Form frmRptFlatRate 
   ...
   Begin LpLib.fpCombo fpcboRptType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptFlatRate.frx":0BED
   End
   Begin LpLib.fpCombo fpcboPrintOrder 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptFlatRate.frx":0F1B
   End
  ...
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      If MsgBox("Are You Sure You Wish To Close The Program?", vbYesNo, "Close?") = vbNo Then
        Cancel = True
      Else
        UBLog "Closed via RptFlatRate by " + PWUser$
        CitiTerminate
      End If
    End If
  End If
...
SkipEmFlat:
  ...
  If CustCnt > 0 Then
    Load frmLoadingRpt
    frmLoadingRpt.setwherefrom frmRptFlatRate

...
Begin VB.Form frmTRDispList1 
   ...
   Begin LpLib.fpList fpTRList 
      ...
      TextTipMultiLine=   0
      ColDesigner     =   "frmTRDispList1.frx":0000
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdOK 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTRDispList1.frx":03C4
   End
   Begin fpBtnAtlLibCtl.fpBtn fpCmdExit 
      ...
      DropShadowColor =   0
      Redraw          =   -1  'True
      ButtonDesigner  =   "frmTRDispList1.frx":059D
   End
   ...
   End
End
Attribute VB_Name = "frmTRDispList1"

VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptQCustListB 
   ...
   _ExtentX        =   15790
   _ExtentY        =   7726
   SectionData     =   "ARptQCustListB.dsx":08CA
End
Attribute VB_Name = "ARptQCustListB"
...
Private Sub ReportFooter_Format()
  If Rate = True Then
    Me.labRate2.Visible = True
    Me.labRate2 = Me.lableRate
    Set Me.SubReport1.object = New ARSubRate
  End If
End Sub

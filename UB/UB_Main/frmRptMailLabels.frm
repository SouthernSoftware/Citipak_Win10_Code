...
Begin VB.Form frmRptMailLabels 
   ...
   Begin LpLib.fpCombo fpcboLocNum 
      Height          =   375
      Left            =   5250
      TabIndex        =   7
      Top             =   5910
   ...
   Begin LpLib.fpCombo fpcboSvcAddr 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMailLabels.frx":0CA4
   End
   Begin LpLib.fpCombo fpcboRevenues 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMailLabels.frx":107E
   End
   Begin LpLib.fpCombo fpcboLabelType 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMailLabels.frx":144D
   End
   Begin LpLib.fpCombo fpcboPrintOrder 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMailLabels.frx":1827
   End
   Begin LpLib.fpCombo fpcboIncludeInactive 
      ...
      EditAlignH      =   0
      EditAlignV      =   0
      ColDesigner     =   "frmRptMailLabels.frx":1BF6
   End
  ...
  If ((UnloadMode = vbFormControlMenu)) Then
    ...
    Else
      If MsgBox("Are You Sure You Wish To Close The Program?", vbYesNo, "Close?") = vbNo Then
        Cancel = True
      Else
        UBLog "Closed via RptMailLabels by " + PWUser$
        CitiTerminate
      End If
    End If
  End If
...
Private Sub fpcboPrintOrder_KeyDown(KeyCode As Integer, Shift As Integer)
  ...
  End If
End Sub
Private Sub fpcboLocNum_KeyDown(KeyCode As Integer, Shift As Integer)
  If KeyCode = vbKeySpace Then
    fpcboLocNum.ListDown = True
  End If
  If fpcboLocNum.ListDown <> True Then
    If KeyCode = vbKeyDown Or KeyCode = vbKeyReturn Then
  ...
  If ValidRoutes Then
    ...
    If fpcboLabelType.ListIndex = 0 Then
      ...
      ElseIf fpcboLabelType.ListIndex = 2 Then
        MailingLabel
        ActivateControls Me, True
      ElseIf fpcboLabelType.ListIndex = 3 Then
        MailingLabel2
      Else
        ActivateControls Me, True
    End If
...
Private Sub Form_Load()
  ...
  fpcboPrintOrder.AddItem "Z/L ZipCode/Location Order"
  ...
  fpcboLocNum.AddItem "No"
  fpcboLocNum.AddItem "Yes"
  fpcboLocNum.ListIndex = 0
...
Private Sub MailingLabel()
  ...
  Dim Align As String, MaskLabel As String, Filler As String, LNum As String
  Dim Loc2Prn As Boolean
...
'    End If
'  Next
If fpcboLocNum.ListIndex = 1 Then
  Loc2Prn = True
End If
ToPrint(1) = ""
ToPrint(2) = ""
...
ToPrint(5) = ""
  ...
  Filler$ = Space(23)
      ...
      Case "Pos"
        ...
        UsingPos = True
      Case "Z/L"
        MakeZipLocationIndex "Zip/Location"
        IndexName$ = TempIndexName
        UsingZip = True
      Case Else
      End Select
...
GoodCust:
    CustPCnt = CustPCnt + 1
    Zip$ = QPStripStuff$(UBCustRec(1).ZIPCODE)
...
GotZip:
    ...
    LNum$ = "Location # " + UBCustRec(1).Book + "-" + UBCustRec(1).SEQNUMB
    Select Case LType
    Case 1
      If Not Loc2Prn Then
      ...
      Else
        Print #UBRpt, LNum$
      End If
      Print #UBRpt, Left$(CustName$, 26)
      Print #UBRpt, Left$(ADDR1$, 26)
      If Len(ADDR2$) > 0 Then
        Print #UBRpt, Left$(ADDR2$, 26)
    ...
    Case 2
      ...
      Else
        Mid$(ToPrint(1), OSet(LabelCnt)) = LNum$
      End If
...
Private Sub MailingLabel2()
  ...
  Dim Loc2Prn As Boolean, LNum As String, ToPrint5 As String
  If fpcboSvcAddr.ListIndex = 0 Then
    BeechFlag = True
  End If
  Dim PrnArray() As UBPostalIndexType
...
GotZip:
    ...
    LNum$ = "Location # " + UBCustRec(1).Book + "-" + UBCustRec(1).SEQNUMB
      ...
      Else
       ...
       ToPrint4 = ToPrint4 + " ~"
      End If
      If Loc2Prn = True Then
        ToPrint5 = ToPrint5 + LNum$ + "~"
      Else
        ToPrint5 = ToPrint5 + " ~"
      End If
      If LabelCnt = 3 Then
       ' For cnt = 1 To 4
          'LPRINT QPTrim$(ToPrint(PCnt))
          Print #UBRpt, ToPrint1 + ToPrint2 + ToPrint3 + ToPrint4 + ToPrint5
          ToPrint1 = ""
          ToPrint2 = ""
          ToPrint3 = ""
          ToPrint4 = ""
...
NextLabel:
 '   ShowPctComp cnt, NumOfRecs
  ...
  Next
'  If LType = 2 Or LType = 3 Then
    If LabelCnt > 0 And LabelCnt < 3 Then
      If LabelCnt = 1 Then
        ToPrint1 = ToPrint1 + " ~ ~"
        ToPrint2 = ToPrint2 + " ~ ~"
        ToPrint3 = ToPrint3 + " ~ ~"
...
'  GoSub DoAlignLabelMask
  Load frmLoadingRpt
  frmLoadingRpt.setwherefrom frmRptMailLabels

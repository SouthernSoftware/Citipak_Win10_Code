VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptCustInq2 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Customer Inquiry Report"
   ClientHeight    =   7692
   ClientLeft      =   36
   ClientTop       =   264
   ClientWidth     =   10356
   Icon            =   "ARptCustInq2.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   18267
   _ExtentY        =   13568
   SectionData     =   "ARptCustInq2.dsx":08CA
End
Attribute VB_Name = "ARptCustInq2"

VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptMeterNotes 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Meter Reading Notes Report"
   ClientHeight    =   4380
   ClientLeft      =   36
   ClientTop       =   264
   ClientWidth     =   8172
   Icon            =   "ARptMeterNotes.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   14415
   _ExtentY        =   7726
   SectionData     =   "ARptMeterNotes.dsx":08CA
End
Attribute VB_Name = "ARptMeterNotes"

VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ARptSConsRange 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Consumption Range Analysis"
   ClientHeight    =   10110
   ClientLeft      =   30
   ClientTop       =   270
   ClientWidth     =   13830
   Icon            =   "ARptSConsRange.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   _ExtentX        =   24395
   _ExtentY        =   17833
   SectionData     =   "ARptSConsRange.dsx":08CA
End
Attribute VB_Name = "ARptSConsRange"
...
Public Sub GetName(RName As String, SFile As String, Optional Detail As Boolean)
  ReportFile$ = RName$
  SubFile$ = SFile$
  If Detail = True Then
    Det = 1
...
'  Set Me.SubReport1.object = New ARSubConRange
'End Sub
...
Private Sub ActiveReport_KeyDown(KeyCode As Integer, ByVal Shift As Integer)
  ...
  If Shift = 4 Then
    ...
    If KeyCode = vbKeyE Then
      ...
      DoEvents
      MsgBox "File - CnspList.xls, created in the Citipak Directory.", vbOKOnly
    End If
    If KeyCode = vbKeyT Then
      ...
      Screen.MousePointer = vbDefault
      DoEvents
      MsgBox "File - CnspList.txt, created in the Citipak Directory.", vbOKOnly
    End If
  End If
End Sub
...
Private Sub ExportReport(x As Integer)
  ...
  Select Case x
    Case 1   '"Excel"
        ...
        oEXL.FileName = outfile & "CnspList.xls"
        oEXL.Export Me.Pages
    Case 2   '"Text"
        Set oTXT = New ActiveReportsTextExport.ARExportText
        oTXT.FileName = outfile & "CnspList.txt"
        oTXT.PageDelimiter = ";"
        oTXT.TextDelimiter = ","
